...
|단계|설명|
|:-----|:-----|
|Office 365에 대 한 테 넌 트 계정 만들기   <br/> |[Office 365](https://go.microsoft.com/fwlink/p/?LinkId=254980)의 office 365에 대해 알아봅니다.  <br/> 사용자 환경이 Office 365에 대 한 준비가 되었는지 확인 하려면 [시스템 요구 사항을](https://products.office.com/en-US/office-system-requirements)참조 하세요.  <br/> Office 365을 설정 하는 방법에 대 한 자세한 내용은 [office 365 시작](https://go.microsoft.com/fwlink/p/?LinkId=254982)을 참조 하십시오.  <br/> |
