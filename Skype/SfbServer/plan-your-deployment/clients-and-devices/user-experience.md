...
**요약:** Skype for business Online, 비즈니스용 skype 서버 2019, 비즈니스용 skype 서버 2015, 2013 Lync server 2010 등의 새로운 비즈니스용 Skype와 사용자에 게 업데이트를 위해 수행할 수 있는 단계에 대해 알아봅니다.
...
환경을 구성 하는 데 사용할 수 있는 첫 번째 실행 환경과 PowerShell 스크립트를 제어 하는 방법에 대 한 단계를 포함 하 여 비즈니스용 Skype Online으로 클라이언트 환경을 구성 하는 방법에 대 한 자세한 내용은 [비즈니스용 skype 및 Lync 클라이언트 사용자 인터페이스 간 전환을](https://aka.ms/SfBOUI)참조 하세요.
