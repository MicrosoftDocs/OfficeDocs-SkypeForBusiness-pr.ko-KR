...
이 섹션에서는 클라이언트를 지원하는 데 필요한 소프트웨어를 비즈니스용 Skype Windows 설명합니다. 이러한 클라이언트는 설치 또는 Microsoft 365 Office 365 설치될 때 설치될 수 있으며 모든 디바이스에서 다운로드 비즈니스용 Skype [사용할 수도 있습니다](https://products.office.com/skype-for-business/download-app?tab=tabs-3).
...
|**시스템 구성 요소**|**지원되는 버전**|
|:-----|:-----|
|Windows 운영 체제  <br/> |Windows 10  <br/> Windows 8.1  <br/> Windows 8 <br/> Windows 최신 서비스 팩이 있는 Windows Server 2008 R2 이상  <br/> **참고:** 비즈니스용 Skype 및 온라인 모임 추가 비즈니스용 Skype Vista 또는 Windows XP(모든 버전)에서는 Windows 지원되지 않습니다. <br/> |
|설치 및 업데이트  <br/> |관리자 권한 및 사용 권한  <br/> |
|브라우저  <br/> |Microsoft Edge  <br/> Internet Explorer 11 인터넷 브라우저  <br/>  Internet Explorer 10 브라우저 <br/> Internet Explorer 9 브라우저  <br/> Internet Explorer 8 브라우저  <br/> Internet Explorer 7 브라우저  <br/> Mozilla Firefox 웹 브라우저  <br/>  Google Chrome 웹 브라우저  <br/>**참고:** 조직에서 비즈니스용 SKYPE 사용하여 Microsoft Exchange Online 인증 HTTP 프록시를 배포한 경우 Internet Explorer 8 이상이 필요합니다.           |
|Microsoft Office 통합  <br/> | Outlook 2010 이상 |
|Microsoft Exchange 통합  <br/> | Microsoft Exchange Server 2010 이상  | 
   
## <a name="hardware"></a>하드웨어

클라이언트를 Microsoft 365 Office 하드웨어에 대한 시스템 요구 사항 및 비즈니스용 Skype [](https://products.office.com/office-system-requirements) 참조하세요.
  
## <a name="skype-meetings-app-and-skype-for-business-web-app"></a>Skype 앱 및 비즈니스용 Skype Web App 
