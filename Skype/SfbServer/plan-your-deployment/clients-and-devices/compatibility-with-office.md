...
다음 표에서는 비즈니스용 Skype와 통합에 설명된 비즈니스용 Skype 배포 및 통합된 Office Exchange 버전에서 지원되는 비즈니스용 Skype 서버 [기능을 Exchange Server](../../deploy/integrate-with-exchange-server/integrate-with-exchange-server.md).
...
|Exchange Server 2013  <br/> |추가 Exchange Server 2010 지원과 동일  <br/>&bull;&nbsp;&nbsp;통합 연락처 저장소  <br/>&bull;&nbsp;&nbsp;고해상도 그림  <br/>&bull;&nbsp;&nbsp;보관 통합  <br/> **참고:** 자세한 내용은 [통합 비즈니스용 Skype 서버 통합을 Exchange Server](../../deploy/integrate-with-exchange-server/integrate-with-exchange-server.md).  <br/> |
