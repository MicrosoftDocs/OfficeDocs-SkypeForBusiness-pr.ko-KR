...
사용자가 Skype 모임 앱을 사용 하 여 비즈니스용 Skype Online에서 호스트 되는 모임에 참가할 수 있도록 허용 하려면 Microsoft 365 또는 Office 365를 사용 하지 않는 조직의 네트워크 관리자가 허용 하거나 사용 가능 하도록 설정 해야 합니다.
