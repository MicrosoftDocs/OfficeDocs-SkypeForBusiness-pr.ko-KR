...
IT 전문가는 조직에서 이미 사용 중이거나 사용 고려 중인 노트북의 적합성을 평가할 때 이 정보를 유용하게 사용할 수 있습니다. 또한 특정 [디바이스에서 Microsoft Teams](https://www.microsoft.com/microsoft-teams/across-devices/device) 정보를 검색할 수도 있습니다.
...
|하드웨어 가속 H.264 인코딩: 카메라 요구 사항  <br/> |UVC(USB Video Class) 사양 버전 1.5를 준수하는 통합 H.264 하드웨어 인코더가 포함된 USB 비디오 카메라  <br/> **참고:** 비즈니스용 Skype UVC 1.5에 대한 지원을 포함하는 Windows 8 Windows 8.1 UVC 1.5 카메라를 지원할 수 있습니다. Windows 7에는 UVC 1.5에 대한 지원이 포함되어 있지 비즈니스용 Skype UVC 1.5 카메라를 하드웨어 인코딩 지원이 없는 일반 카메라로 취급합니다. <br/> |
...
다음 표에서는 지원되는 모바일 장치에서 사용할 수 있는 최대 비디오 해상도에 대해 설명하고 있습니다. 모바일 장치 지원에 대한 자세한 내용은 모바일 클라이언트 기능 비교를 [비즈니스용 Skype](mobile-feature-comparison.md).
