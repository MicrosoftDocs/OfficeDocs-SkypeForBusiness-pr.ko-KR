...
IT 전문가는 조직에서 이미 사용 중이거나 사용 고려 중인 노트북의 적합성을 평가할 때 이 정보를 유용하게 사용할 수 있습니다. 또한 특정 [디바이스에서](https://www.microsoft.com/microsoft-teams/across-devices/device) Microsoft Teams 정보를 검색할 수도 있습니다.
