...
- Exchange 2010 SP1 이전의 Exchange UM을 사용하는 원격 사용자를 위한 UM Exchange UM 사용
...
하드웨어 부하 균형 조정 기능이 하드웨어 부하 비즈니스용 Skype 서버 지원할지 여부를 확인하려면 [Infrastructure for 비즈니스용 Skype](../../../SfbPartnerCertification/certification/infra-gateways.md). 
...
> [!CAUTION]
> 타사 하드웨어 부하 균형 조정 장치에 대한 자세한 내용은 [Infrastructure for 비즈니스용 Skype](../../../SfbPartnerCertification/certification/infra-gateways.md).  
