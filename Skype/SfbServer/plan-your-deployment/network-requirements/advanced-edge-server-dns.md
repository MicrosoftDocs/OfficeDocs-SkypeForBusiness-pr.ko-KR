...
이 경우 가중치가 고려됩니다. 이 경우 더 큰 가중치가 선택될 확률이 높아야 합니다. 서버 선택이 없는 경우 DNS 관리자는 가중치 0을 사용해야 합니다. 가중치가 0보다 큰 레코드가 있는 경우 가중치가 0인 레코드는 선택될 가능성이 매우 적습니다.
