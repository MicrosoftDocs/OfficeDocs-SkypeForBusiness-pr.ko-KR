...
비즈니스용 Skype 서버는 프런트 엔드 풀에 대한 재해 복구 옵션도 제공합니다. 서로 다른 지리적 영역에 두 개의 풀을 설정하여 서로 백업으로 사용할 수 있습니다. 그런 다음 전체 풀 또는 사이트가 다운된 경우 백업 풀은 두 사이트의 사용자에게 서비스를 계속 제공할 수 있습니다.
