...
**요약:** 이 항목을 읽고 비즈니스용 Skype 서버 2015의 영구 채팅 서버에 대한 범주, 채팅방 및 사용자 및 관리자 역할에 대해 자세히 알아보는 방법을 제공합니다.
...
> [!IMPORTANT]
> 범주의 허용 구성원 및 거부 구성원은 영구  채팅방에 적용되는 구성원 역할과 동일하지 않습니다.> 검색을 수행한 사용자가 허용 및 거부 구성원 목록에 있는 열려 있는 대화방과 닫힌 대화방이 모두 표시됩니다. 비밀 채팅방은 검색 수행 사용자가 해당 방의 구성원이 아니면 표시되지 않습니다. 사용자는 자신이 구성원으로 속해 있거나 구성원 자격을 요청할 수 있는 방만 검색할 수 있습니다. 
...
- [영구 채팅 서버에서 비즈니스용 Skype 서버 2015의 범주 관리](../../manage/persistent-chat/categories.md)
