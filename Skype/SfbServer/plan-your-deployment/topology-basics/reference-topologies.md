...
- **Office Web Apps 서버.** 웹 회의를 사용하는 모든 조직에서 Office Web Apps Server 또는 Office Web Apps Server 팜을 배포하는 것이 좋습니다. Office Web Apps 서버를 사용하면 웹 회의에 PowerPoint 슬라이드를 열 수 있습니다.
...
- **백 엔드 서버가 미러링됩니다.** 기본 사용자 기능에 대한 고가용성을 제공하기 위해 조직은 각 프런트 엔드 풀에 대해 미러된 백 엔드 서버 쌍을 배포했습니다. 이는 선택적 토폴로지이며 대신 단일 백 엔드 서버를 배포할 수 있습니다. SQL 및 AlwaysOn 가용성 그룹도 지원됩니다. 자세한 내용은 백 엔드 서버의 고가용성을 [비즈니스용 Skype 서버](../../plan-your-deployment/high-availability-and-disaster-recovery/back-end-server.md).
