...
---
# <a name="plan-for-busy-options-for-skype-for-business-server"></a>비즈니스용 Skype 서버의 사용 중 옵션 계획
...
이 항목에서는 다른 사용 중 옵션의 기능에 대해 설명합니다. 사용 중 옵션을 설치 및 구성하는 방법에 대한 자세한 내용은 비즈니스용 Skype 서버에 대한 다른용 Skype 옵션 설치 [및 구성을 참조하세요.](../../deploy/deploy-enterprise-voice/install-and-configure-busy-options.md)
...
다른용 옵션 기능은 장애 조치(failover) 기능을 제공합니다. 문제가 발생하고 사용자가 다른 프런트 엔드 서버 또는 비즈니스용 Skype 서버의 다른 풀로 장애 조치(fail over)되면 사용자의 다른 사용 중 옵션 설정이 유지됩니다.
...
- 기업의 모든 사용자에 대해 다른 사용자에 대해 다른 사용자가 다른용 또는 다른 사용자의 다른 사용자에 대해
...
- 사용자 한 명에 대해 다른 사용자의 다른 사용자 또는 다른 사용자가 다른 사용자의 다른 사용자에 대해 다른 사용자의 다른 음성사서명을 관리합니다.
...
- 응답 그룹(RGS)
  ...
  - RGS가 아닌 에이전트 관련 통화는 통화 중 옵션 설정에 따라 적용됩니다.
    
- Team Call(팀 호출)
    
  - 팀 통화에 대해 설정된 사용자의 수신 전화에 우선 순위가 지정되어 통화 중에는 다른 사용자가 통화 중일 때를 무시하고 다른 사용자의 음성 메일 설정은 무시합니다.
...
- 관리자/관리자 위임 
  ...
  - 중고/관리자 위임에 대해 설정된 사용자에 대한 수신 전화는 통화 중의 다른 사람에 대해 통화 중 및 통화 중 설정의 음성 메일은 무시하는 우선 순위가 지정됩니다.
    
  - 현재의 상사/관리자 위임 환경은 관리자 또는 상사에 대해 설정된 다른 사용 중 옵션으로 변경되지 않습니다.
    
  - 관리자에 대한 비사용자/관리자 위임 관련 통화는 다른 통화 옵션 설정에 의해 적용됩니다.
    
- 회선 공유 기능 
    
  - 공유 행 모양에 대해 설정된 사용자 계정의 다른 사용 중 옵션 설정은 무시됩니다. 
    
  - 대신 공유 행 모양의 다른 다른 사용자와 다른 사용자들이 다른 일정에 있는 음성메일 옵션을 사용할 수 있습니다.
...
- 통화 회의
  ...
  - 회의의 사용자는 여전히 새 전화 회의 초대를 받을 수 있지만 다른 피어 투 피어 통화는 다른 통화 옵션 설정에 따라 거부됩니다.
