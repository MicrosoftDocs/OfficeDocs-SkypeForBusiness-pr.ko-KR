...
|**위치**|**유형**|**Port(포트)**|**FQDN 또는 DNS 레코드**|**IP 주소 또는 FQDN**|**참고 사항**|
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|**위치**|**유형**|**Port(포트)**|**FQDN**|**FQDN 호스트 레코드**|**참고 사항**|
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|**위치**|**유형**|**Port(포트)**|**FQDN**|**IP 주소 또는 FQDN 호스트 레코드**|**참고 사항**|
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|**구성 요소**|**SN(주체 이름)**|**SAN(주체 대체 이름)/순서**|**참고 사항**|
|:-----|:-----|:-----|:-----|
...
|**역할 또는 프로토콜**|**TCP 또는 UDP**|**대상 포트 또는 포트 범위**|**원본 IP 주소**|**대상 IP 주소**|**참고 사항**|
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|**Protocol(프로토콜)**|**TCP 또는 UDP**|**Port(포트)**|**원본 IP 주소**|**대상 IP 주소**|**참고 사항**|
|:-----|:-----|:-----|:-----|:-----|:-----|
