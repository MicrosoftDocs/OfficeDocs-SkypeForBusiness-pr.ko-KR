...
---
# <a name="estimating-voice-usage-and-traffic-for-skype-for-business-server"></a>비즈니스용 Skype 서버에 대 한 음성 사용량 및 트래픽 추정
 
다음 메트릭을 사용 하 여 각 사이트의 사용자 소통량과 해당 트래픽을 지 원하는 데 필요한 포트 수를 추정할 수 있습니다.
