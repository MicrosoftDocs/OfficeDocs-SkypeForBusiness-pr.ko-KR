...
|**하드웨어 구성 요소**|**권장**|
|:-----|:-----|
|CPU  <br/> |64비트 듀얼 프로세서, 16진수 코어, 2.26GHz 이상입니다.  <br/> Intel Itanium 프로세서는 서버 역할에 비즈니스용 Skype 서버 지원되지 않습니다.  <br/> |
|메모리  <br/> |32GB  <br/> |
...
|A/V 회의  <br/> |프런트 엔드 풀에서 제공하는 A/V 회의 서비스는 최대 회의 크기가 250명인 풀의 회의를 지원하며, 한에 하나의 대규모 회의만 실행됩니다.  <br/> **참고:** 또한 대규모 회의를 호스팅하기 위해 프런트 엔드 서버가 2대인 별도의 프런트 엔드 풀을 배포하여 250~1,000명 사이의 대규모 회의를 지원할 수 있습니다. 자세한 내용은 [Plan for large meetings in 비즈니스용 Skype 서버.](../../plan-your-deployment/conferencing/large-meetings.md)  <br/> |
