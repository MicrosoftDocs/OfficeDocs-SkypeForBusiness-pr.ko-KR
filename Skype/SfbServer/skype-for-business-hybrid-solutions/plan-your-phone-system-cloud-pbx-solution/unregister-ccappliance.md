...
description: 이 Unregister-CcAppliance cmdlet은 온라인 테넌트 구성의 PSTN 사이트에서 비즈니스용 Skype 클라우드 커넥터 버전 현재 비즈니스용 Skype 클라우드 커넥터 버전 어플라이언스 등록을 해지합니다.
ms.openlocfilehash: c48a7b53d757dab446a8939a3e3203d8e66fccab
ms.sourcegitcommit: 556fffc96729150efcc04cd5d6069c402012421e
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 08/26/2021
ms.locfileid: "58603657"
---
# <a name="unregister-ccappliance"></a>Unregister-CcAppliance
 
이 Unregister-CcAppliance cmdlet은 온라인 테넌트 구성의 PSTN 사이트에서 비즈니스용 Skype 클라우드 커넥터 버전 현재 비즈니스용 Skype 클라우드 커넥터 버전 어플라이언스 등록을 해지합니다.
...
다음 예에서는 온라인 테넌트 구성에서 현재 어플라이언스 등록을 등록하지 않습니다.
...
Register-CcAppliance cmdlet과 마찬가지로 SiteName과 에지 서버 외부 FQDN이 CloudConnector.ini PSTN 사이트 ID로 간주됩니다. 마찬가지로, CloudConnector.ini 파일의 중재 서버 FQDN과 결합된 ApplianceName은 어플라이언스 ID로 간주됩니다.
