...
|:-----|:-----|:-----|
|에 정의된 통화 기능  <br/> |음성 정책  <br/> |사용자가 전화 시스템에 대한 라이선스를 부여할 때 자동으로 할당되는 미리 정의된 음성 정책입니다.  <br/> |
