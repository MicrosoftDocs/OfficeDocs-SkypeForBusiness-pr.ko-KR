...
비즈니스용 Skype Online의 전화 시스템(클라우드 PBX) 음성 서비스와의 통합을 가능하게 하도록 최소한의 비즈니스용 Skype 클라우드 커넥터 버전인 비즈니스용 Skype 클라우드 커넥터 Edition을 구성하는 방법을 알아보고, 
  
시작하기 전에 비즈니스용 Skype 클라우드 커넥터 버전 계획의 선행 [준비를 검토해야 합니다.](plan-skype-for-business-cloud-connector-edition.md)
...
|**단계**|**설명**|
|:-----|:-----|
|[클라우드 커넥터 어플라이언스 준비](prepare-your-cloud-connector-appliance.md) <br/> |설치 파일을 다운로드하고, 인증서를 준비하고, Hyper-V를 구성하고, 클라우드 커넥터 배포를 위한 환경을 준비합니다.  <br/> |
