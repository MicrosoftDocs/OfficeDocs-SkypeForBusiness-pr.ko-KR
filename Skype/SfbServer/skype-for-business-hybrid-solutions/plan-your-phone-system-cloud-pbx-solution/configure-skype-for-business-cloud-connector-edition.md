---
title: 구성 및 관리 비즈니스용 Skype 클라우드 커넥터 버전
ms.reviewer: ''
ms.author: crowe
author: CarolynRowe
manager: serdars
...
비즈니스용 Skype 클라우드 커넥터 버전 Online의 클라우드 PBX(클라우드 PBX) 음성 서비스와의 전화 시스템 통합할 수 있도록 최소한의 사내 비즈니스용 Skype 토폴로지 구성하는 방법에 대해 알아보고 
  
시작하기 전에 Plan [for](plan-skype-for-business-cloud-connector-edition.md)비즈니스용 Skype 클라우드 커넥터 버전.
...
## <a name="steps-to-configure-skype-for-business-cloud-connector-edition"></a>구성 단계 비즈니스용 Skype 클라우드 커넥터 버전
...
|[조직 또는 조직과 클라우드 커넥터 Microsoft 365 Office 365 구성](configure-cloud-connector-integration-with-your-office-365-tenant.md) <br/> |DNS 레코드를 추가하고, 하이브리드를 구성하고, PSTN 게이트웨이를 설정하고, 사용자가 음성 메일을 전화 시스템 사용하도록 설정할 수 있습니다.  <br/> |
