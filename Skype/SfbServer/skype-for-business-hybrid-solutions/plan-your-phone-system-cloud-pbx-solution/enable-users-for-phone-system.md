...
---
# <a name="enable-users-for-phone-system-in-office-365-with-on-premises-pstn-connectivity-in-skype-for-business-server"></a>비즈니스용 Skype 서버에서 온-프레미스 PSTN 연결을 사용 하는 Office 365에서 사용자가 전화 시스템을 사용할 수 있도록 설정
 
이 항목에서는 온-프레미스 PSTN 연결을 사용 하 여 Office 365에서 전화 시스템용 사용자를 설정 하는 방법에 대해 설명 합니다. 이 항목의 단계를 수행 하기 전에 다음을 읽어야 합니다.
...
- 배포 계획에 대 한 자세한 내용은 [비즈니스용 Skype 서버에서 온-프레미스 PSTN 연결을 사용 하는 Office 365의 전화 시스템 계획](plan-phone-system-with-on-premises-pstn-connectivity.md)을 참조 하십시오.
...
## <a name="moving-users-to-phone-system-in-office-365-with-on-premises-pstn-connectivity"></a>온-프레미스 PSTN 연결을 사용 하 여 Office 365에서 전화 시스템으로 사용자 이동
...
- Office 365 음성 메일 (원격 PowerShell을 사용 하 여 수행) [에서 Enterprise Voice online 및 전화 시스템에 대해 사용자를 사용 하도록 설정](enable-users-for-enterprise-voice-online-and-phone-system-voicemail.md) 합니다.
