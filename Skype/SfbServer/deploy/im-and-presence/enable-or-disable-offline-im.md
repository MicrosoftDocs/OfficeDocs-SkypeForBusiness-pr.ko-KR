...
동일한 조직 내에서 전송된 오프라인 메시지의 경우 메시지 클래스가 IM.Note.MissedConversation인 전자 메일 메시지로 수신되고 Outlook 부재 중 대화 폴더 및 비즈니스용 Skype 클라이언트의 최근  목록/대화 기록 탭에 선택될 대화 기록에 포함됩니다.
