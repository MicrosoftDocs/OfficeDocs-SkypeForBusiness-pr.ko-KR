...
|**서버 대 서버 인증 구성(Microsoft Exchange 통합을 사용하는 경우만 해당)** <br/> |서버와 서버 간에 인증을 사용하도록 비즈니스용 Skype 서버 Exchange. 보관을 사용하도록 설정하기 전에 Testuser_sipUri 저장소 연결의 유효성을 검사하기 위해 **Test-CsExchangeStorageConnectivity Exchange -Folder Dumpster** 를 실행하는 것이 좋습니다. <br/> |서버에서 인증서를 관리하기 위한 적합한 권한이 있는 계정  <br/> |서버 대 서버 인증 관리  <br/> |
