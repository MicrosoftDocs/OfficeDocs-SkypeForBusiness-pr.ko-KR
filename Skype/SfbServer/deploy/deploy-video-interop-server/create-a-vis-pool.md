...
2. 그러면 새 Video Interop 서버 풀 **만들기 마법사가 열립니다.** 새 Video Interop 서버에 대한 풀 FQDN을  제공하고 이 풀에 서버가 하나만 있는 경우 또는 이 풀에 요구 사항에 따라 여러 서버가 있는 풀을 선택하고 **다음을 누르십시오.** 
...
이제 토폴로지 작성기에서 수행된 모든 작업이 완료됩니다. 새 VIS 서버 또는 서버에 소프트웨어를 계속 설치합니다.
