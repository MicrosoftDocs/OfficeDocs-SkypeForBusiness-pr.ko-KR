...
이 항목을 읽고 다중 포리스트의 온라인 환경에서 Skype 룸 시스템을 배포하는 방법을 배워야 합니다.
...
사서함을 만들고 나면 사서함을 구성하는 데 Set-CalendarProcessing 수 있습니다. 자세한 내용은 단일 포리스트의 단일 포리스트 배포에서 3-6단계를 참조하세요. Skype 룸 시스템에 대한 Exchange 리소스 사서함을 만들고 나면 단일 포리스트의 단일 포리스트에 있는 비즈니스용 Skype에 대해 Skype 룸 시스템 계정을 사용하도록 설정하는 단계를 수행하여 비즈니스용 Skype에 대한 계정을 사용하도록 설정하세요.
