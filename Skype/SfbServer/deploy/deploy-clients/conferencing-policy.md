...
|VideoBitRateKb  <br/> |5000  <br/> |허용되는 최대 아웃바운드 비디오 비트 속도입니다. Skype 룸 시스템은 이 비트 전송률로 Pano와 함께 1080 스트림을 보낼 수 있습니다(RoundTable을 사용하는 경우). \*  <br/> |
...
Skype 회의실 시스템은 사용자가 모임 참가 링크를 사용하여 제한된 모임에 참가할 때 인증을 요청합니다. 예를 들어 모임 대기실 옵션이 구성된 모임은 Outlook. 이 설정은 사용자 지정된 모임에 대해 항상 설정하며 사용자에게 항상 메시지가 표시될 수 있습니다. 그러나 무제한 모임의 경우 사용자는 인증 없이 모임에 참가할 수 있습니다. 
