...
1. 로컬 컴퓨터에서 Windows 8을 실행 중인 경우 이 단계를 건너뜁니 다. 로컬 컴퓨터에서 Windows 7 SP1을 실행하는 경우 최신 버전의 원격 데스크톱 서비스 클라이언트를 [설치합니다.](https://go.microsoft.com/fwlink/p/?LinkId=268032)
...
- **필요한 파일이 올바르게 설치되지 않음**
    ...
    로컬 컴퓨터에 플러그 인을 설치한 후 이러한 파일이 C:\Program Files\Microsoft Office\Office15(또는 적절한 드라이브 문자) 아래에 있는지 확인합니다.
