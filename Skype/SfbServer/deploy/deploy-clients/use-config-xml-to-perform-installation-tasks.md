...
기본적으로 핵심 Config.xml 폴더(예 _: \ 제품_)에 저장된 파일입니다. WW) 설치 프로그램이 이 제품을 설치하도록 지시합니다. 예를 들어 다음 폴더의 Config.xml 파일을 설치하면 다음 비즈니스용 Skype.
...
| 설정  <br/>           | Windows Installer 속성의 값을 지정합니다. 일반적인 특성은 다음과 같습니다.<br/>  Setting Id=" *name*"(Installer Windows 이름)  <br/>  Value=" *value*"(속성에 할당할 값)  <br/>                                                             |
...
Config.xml 파일을 사용하여 설치 및 유지 관리 Office 수행하는 자세한 내용은 에서 사용할 수 있습니다[https://go.microsoft.com/fwlink/p/?linkid=267514](/previous-versions/office/office-2013-resource-kit/cc179195(v=office.15)).
