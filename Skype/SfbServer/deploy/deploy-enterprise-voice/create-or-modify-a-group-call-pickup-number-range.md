...
비즈니스용 Skype 서버 2013에서 그룹 통화 선택 번호 범위를 만들거나 Enterprise Voice.
...
> [!NOTE]
> 비즈니스용 Skype 서버 관리 셸을 사용하여 통화 파크 파운데이트 표에서 그룹 통화 선택 번호 범위를 만들고, 수정하고, 제거하고, 보아야 합니다. 비즈니스용 Skype 서버 제어판에서는 그룹 통화 선택 번호 범위를 사용할 수 없습니다.
