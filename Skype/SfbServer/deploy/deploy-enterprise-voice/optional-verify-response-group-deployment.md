...
- 에이전트가 다른 전화를 받는 중에 사용자가 응답 그룹에 전화를 걸어 사용자가 큐로 이동됩니다.
    ...
    > [!NOTE]
    > 응답 그룹이 예상대로 작동하지 않는 경우 다음 링크를 확인하세요. https://support.office.com/article/troubleshooting-for-response-groups-ca72d8f8-4054-4974-b832-4f173611bd89
