...
영구 채팅 서버 사용자 정책은 전역, 사이트 또는 사용자 수준에서 관리할 수 있습니다. 처음에는 배포의 모든 사용자에 대해 영구 채팅 설정을 사용하도록 전역 정책을 구성한 다음 추가 사용자 및 사이트 정책을 만들어 특정 사용자 및 사이트에 대해 영구 채팅이 설정되어 있는지 여부를 제어합니다.
...
전역 정책 및 사용자가 속한 사이트 정책을 다시 정의하는 사용자별 정책을 만들 수 있습니다. 사용자 정책을 만들 수 있는 경우:
