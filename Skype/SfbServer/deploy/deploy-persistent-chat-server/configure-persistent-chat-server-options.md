...
**요약:** 비즈니스용 Skype 서버 2015에서 전역, 사이트 또는 풀 수준에서 영구 채팅 서버 옵션을 구성하는 방법을 학습합니다.
  
영구 채팅 서버에 대해 전역적으로, 사이트 내의 모든 풀 또는 사이트 내의 특정 풀에 적용할 수 있는 몇 가지 옵션을 지정할 수 있습니다. 영구 채팅 서버 옵션은 다음과 같습니다. 
  
- 기본 채팅 기록입니다. 첫 번째 요청 시 각 대화방에 사용할 수 있는 채팅 메시지 수입니다. 전역 기본값은 채팅 메시지 30개입니다. 
    
- 최대 파일 크기입니다. 방에 업로드하거나 방에서 다운로드할 수 있는 파일의 최대 크기입니다. 전역 기본값은 20MB입니다.
