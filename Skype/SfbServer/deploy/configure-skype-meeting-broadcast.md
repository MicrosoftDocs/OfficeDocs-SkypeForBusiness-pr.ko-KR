...
Skype 모임 브로드캐스트는 Office 365. 비즈니스용 Skype 서버 실행 중이고 환경에서 Skype 모임 Broadcast를 사용하려는 경우 이 항목의 구성 단계를 따라야 합니다. 시작하기 전에 온라인에서 하이브리드 환경으로 환경을 비즈니스용 Skype 합니다. 자세한 내용은 온라인과 비즈니스용 Skype 서버 비즈니스용 Skype 하이브리드 연결 계획 및 비즈니스용 Skype 서버 [Online](../../SfbHybrid/hybrid/plan-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json)과 비즈니스용 Skype [배포를 참조하세요](../../SfbHybrid/hybrid/configure-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json).
...
2. **SIP 페더타이트 공급자를 선택하고** 새로 고치 **기 를 클릭합니다**.
...
2. **SIP 페더전 도메인을 선택하고** 새로 추가를 **클릭합니다**.
...
이러한 구성 단계를 완료한 후 배포에서 Skype 모임 브로드캐스트를 사용할 수 있습니다. 브로드캐스트에 Skype 모임 자세한 내용은 [Skype 모임 브](https://go.microsoft.com/fwlink/?LinkId=617071)로드캐스트란? 및 브로드[캐스트 Skype 모임 참조하세요](../../SfbOnline/set-up-your-network-for-skype-meeting-broadcast/set-up-your-network-for-skype-meeting-broadcast.md).
