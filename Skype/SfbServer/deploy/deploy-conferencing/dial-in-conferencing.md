...
자세한 내용은 [Get-CsDialPlan을 참조하세요.](https://docs.microsoft.com/powershell/module/skype/get-csdialplan?view=skype-ps)
...
7. 줄 **URI에서** 번호 앞의 + 기호와 공백 제외를 포함하여 전화 접속 액세스 번호의 E.164 번호를 TEL URI 형식으로 입력합니다. 예: tel:+14255550200.
    ...
    > [!NOTE]
    > 동일한 줄 URI를 다른 전화 접속 회의 액세스 번호에서 다시 사용할 수 없습니다. 
