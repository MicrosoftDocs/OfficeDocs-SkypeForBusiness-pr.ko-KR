...
description: '요약: Lync Server 2013에서 2015에서 2015로 비즈니스용 Skype 서버 방법을 설명하는 문서입니다. Microsoft 평가판 센터에서 비즈니스용 Skype 서버 2015 무료 평가판을 다운로드합니다https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server.'
...
**요약:** Lync Server 2013에서 2015로 업그레이드하는 비즈니스용 Skype 서버 대해 자세히 알아보습니다. Microsoft 평가판 센터에서 비즈니스용 Skype 서버 2015 무료 평가판[을 다운로드합니다](https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server).
  
이 문서의 절차에 따라 비즈니스용 Skype 서버 토폴로지 작성기 및 새로운 In-Place 업그레이드 기능을 사용하여 Lync Server 2013에서 비즈니스용 Skype 서버 2015로 업그레이드합니다. Lync Server 2010 또는 Office Communications Server 2007 R2에서 업그레이드하려면 [Plan to upgrade to 비즈니스용 Skype 서버 2015](../plan-your-deployment/upgrade.md)을 참조합니다.
...
- [2015의 서버 요구 비즈니스용 Skype 서버 검토합니다](../plan-your-deployment/requirements-for-your-environment/server-requirements.md).
...
2. 비즈니스용 Skype 서버 2015 설치 미디어에서Setup.exe **\OCS_Volume\AMD64에서 OCS_Volume 실행합니다**.**** 
    
3. **설치** 를 클릭합니다. 
    
4. 사용권 계약에 동의합니다.
    
5. 배포 마법사에서 관리자 도구 설치를 **클릭** 하고 설치 단계에 따라 설치합니다.
...
7. 기존 **배포에서 토폴로지 다운로드를 클릭** 하고 다음을 **클릭합니다**.
...
1. 토폴로지 작성기에서 Lync Server 2013 풀을 마우스 오른쪽 단추로 클릭하고 비즈니스용 Skype 서버 **2015** 로 업그레이드를 선택한 다음 단계를 따릅니다. 
    
     ![Lync Server 2013의 업그레이드 옵션이 있는 마우스 오른쪽 단추 클릭 메뉴 스크린샷](../media/7d5b25b1-e5c0-474c-a024-a5ba33f1b3a1.png)
  
2. 토폴로지 작성기에서 **ActionPublish**  >  토폴로지 또는 **ActionTopologyPublish** >  > **를 클릭합니다**. 
...
3. Lync Server 2013 풀을 마우스 오른쪽 단추로 클릭하고 비즈니스용 Skype 서버 **2015** 로 업그레이드를 선택한 다음 단계를 따릅니다. 
    
     ![Lync Server 2013의 업그레이드 옵션이 있는 마우스 오른쪽 단추 클릭 메뉴 스크린샷](../media/7d5b25b1-e5c0-474c-a024-a5ba33f1b3a1.png)
  
4. 토폴로지 작성기에서 **ActionPublish**  >  토폴로지 또는 **ActionTopologyPublish** >  > **를 클릭합니다**. 
...
6. 토폴로지 작성기에서 **ActionPublish**  >  토폴로지 또는 **ActionTopologyPublish** >  > **를 클릭합니다**. 
...
1. 각 서버에서Setup.exe2015 설치 **미디어** 의 OCS_Volume **\setup\amd64** 에서 비즈니스용 Skype 서버 실행합니다.
