...
description: '요약: 설치하는 데 필요한 관리 도구를 설치하는 방법을 비즈니스용 Skype 서버. Microsoft 평가판 센터에서 비즈니스용 Skype 서버 평가판을 다운로드합니다https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server.'
---

# <a name="install-administrative-tools-in-skype-for-business-server"></a>2016에 관리 도구 비즈니스용 Skype 서버
 
**요약:** 설치에 필요한 관리 도구를 설치하는 방법을 비즈니스용 Skype 서버. Microsoft 평가판 센터에서 비즈니스용 Skype 서버 평가판을 다운로드합니다[https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server](https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server).
...
1. 설치 비즈니스용 Skype 서버 삽입합니다. 설치가 자동으로 시작되지 않는 경우 설치를 두 번 **클릭합니다**.
...
4. 사용권 계약을 신중하게 검토하고, 동의하는 경우 **동의** 를 선택하고 확인을 **클릭합니다**.
...
5. 핵심 비즈니스용 Skype 서버 구성 요소가 서버에 설치됩니다. 
   ...
   - **비즈니스용 Skype 서버 배포** 마법사의 다양한 구성 요소를 설치하기 위한 시작 패드를 제공하는 배포 비즈니스용 Skype 서버.
    
   - **비즈니스용 Skype 서버 관리** 셸 관리 셸을 관리하기 위한 미리 비즈니스용 Skype 서버.
    
     핵심 구성 요소 설치가 완료되면 그림과 비즈니스용 Skype 서버 배포 마법사가 자동으로 시작됩니다. 
    
     ![비즈니스용 Skype 서버 배포 마법사를 실행합니다.](../../media/310c3437-83f9-48fa-a1e1-9fd09009fe31.png)
...
8. 설치가 완료되면 마친을 **클릭합니다**. 이제 그림과 같이 관리 도구가 서버에 추가됩니다.
    
    ![비즈니스용 Skype 서버 관리 도구를 사용합니다.](../../media/760873dd-9c87-4efb-bf98-7162d876fd18.png)
  
   - **비즈니스용 Skype 서버 토** 폴로지 작성기 토폴로지 작성, 배포 및 관리에 사용되는 프로그램입니다.
