...
|DialogCategory  <br/> |bit  <br/> |대화 범주: 0은 비즈니스용 Skype 서버-중재 서버 레그입니다. 1은 중재 서버-PSTN 게이트웨이 레그입니다.  <br/> |
...
|CorrelationKey  <br/> ||상관 관계 키입니다. [SessionCorrelation](sessioncorrelation.md)테이블에서 참조됩니다.  <br/> |
...
|CallerMicGlitchRate  <br/> |int  <br/> |발신자 마이크 캡처에 대한 5분당 평균 불투명도입니다. 적정 품질을 위해서는 5분당 1 미만이어야 합니다. A/V 회의 서버, 중재 서버 또는 IP 전화에서 보고되지 않습니다.  <br/> |
...
|CallerTimestampErrorSpkMs  <br/> |decimal(9,2)  <br/> |통화의 지난 20초 동안 발신자 스피커 렌더링 스트림 타임스탬프 오류의 평균(밀리초)입니다.  <br/> |
...
|CallerRxAGCNoiseLevel  <br/> |int  <br/> |중재 서버에서 발신자 오디오 게이트웨이로부터 수신된 신호 수준입니다. 중재 서버에만 적용됩니다. 이 메트릭의 단위는 dBoV입니다. 적정 품질을 위해 허용되는 범위는 -50 dBoV 미만입니다.  <br/> |
...
|CalleeTimestampErrorSpkMs  <br/> |decimal(9,2)  <br/> |통화의 지난 20초 동안의 발신자 스피커 렌더링 스트림 타임스탬프 오류의 평균(밀리초)입니다.  <br/> |
...
|CalleeEchoPercentMicIn  <br/> |decimal(5,2)  <br/> |에코가 발신자 마이크 캡처 스트림에서 감지되는 시간의 백분율입니다. 헤드셋을 사용할 경우 값이 낮아집니다.  <br/> |
|CalleeEchoPercentSend  <br/> |decimal(5,2)  <br/> |에코가 발신자 전송 스트림에서 감지되는 시간의 백분율입니다. 전송 스트림에서 에코 비율이 높으면 에코 누출을 나타낼 수 있습니다.  <br/> |
...
|CalleeRxAGCNoiseLevel  <br/> |int  <br/> |중재 서버에서 수신자 오디오 게이트웨이로부터 수신된 신호 수준입니다. 중재 서버에만 적용됩니다. 이 메트릭의 단위는 dBoV입니다. 적정 품질을 위해 허용되는 범위는 -50 dBoV 미만입니다.  <br/> |
|CalleeRxAGCGain  <br/> |int  <br/> |중재 서버 쪽 AGC(자동 게인 컨트롤)는 발신자 오디오에 적용됩니다.  <br/> |
