...
UserAgentDef 테이블은 사용자 에이전트 식별자를 에이전트의 설명이 있는 이름에 매핑합니다. 사용자 에이전트는 사용자 에이전트에 연결하는 데 사용되는 소프트웨어 비즈니스용 Skype 서버.
...
|16397  <br/> |응용 프로그램 공유  <br/> |ASMCU  <br/> |
