...
|**OrganizerType** <br/> |nvarchar(256)  <br/> |회의를 구성한 사용자의 URI 형식입니다. 자세한 내용은 [UriTypes 테이블을](uritypes.md) 참조하세요. <br/> |
|**OrganizerTenant** <br/> |nvarchar(256)  <br/> |회의를 구성한사용자의 테넌트입니다. 자세한 내용은 [Tenants 테이블을](tenants.md) 참조하세요. <br/> |
