...
|**미디어** <br/> |nvarchar(256)  <br/> || MediaID 및 미디어 값의 정적 매핑: <br/>  1 -- IM <br/>  2 - 파일 전송 <br/>  3 - 원격 지원 <br/>  4 - 응용 프로그램 공유 <br/>  5 -- 오디오 <br/>  6 -- 비디오 <br/>  7 - 앱 초대 <br/> |
   
LcsCDR.SessionDetailsView.MediaTypes의 값에 대한 형식 형식을 확인하려는 경우 다음 조인 코드문을 사용해야 합니다. 
