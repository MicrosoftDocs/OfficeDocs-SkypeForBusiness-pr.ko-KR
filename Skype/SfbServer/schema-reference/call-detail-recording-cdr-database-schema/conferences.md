...
|**SessionIdSeq** <br/> |int  <br/> |Primary  <br/> |세션을 식별하기 위한 ID 번호입니다. **SessionIdTime** 과 함께 회의 인스턴스를 고유하게 식별하는 데 사용됩니다. * <br/> |
|**ConferenceUriId** <br/> |int  <br/> |외계인  <br/> |회의 URI입니다. 자세한 내용은 [비즈니스용 Skype 서버 2015의 ConferenceUris 테이블](conferenceuris.md)을 참조하세요. <br/> |
|**ConfInstance** <br/> |uniqueidentifier  <br/> | <br/> |재발 회의에 유용합니다. 각 재발 회의 인스턴스는 **ConferenceUri** 가 같지만 **ConfInstance가 다릅니다**. <br/> |
|**ConferenceStartTime** <br/> |datetime  <br/> | <br/> |회의 시작 시간입니다.  <br/> |
|**ConferenceEndTime** <br/> |datetime  <br/> | <br/> |회의 시작 시간입니다.  <br/> |
|**PoolId** <br/> |int  <br/> |외계인  <br/> |회의가 캡처된 풀을 식별하기 위한 ID 번호입니다. 자세한 내용은 [Pools 테이블](pools.md) 을 참조하십시오. <br/> |
|**OrganizerId** <br/> |임계값  <br/> |외계인  <br/> |이 회의의 이끌이 URI를 식별하는 ID 번호입니다. 자세한 내용은 [Users 테이블](users.md) 을 참조하십시오. <br/> |
