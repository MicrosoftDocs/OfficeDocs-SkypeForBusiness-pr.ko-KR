...
---
# <a name="conferences-table-in-skype-for-business-server-2015"></a>비즈니스용 Skype 서버의 전화 회의 테이블
 
이 표의 각 레코드에는 한 회의에 대한 통화 세부 정보가 포함되어 있습니다.
...
|**ConferenceUriId** <br/> |int  <br/> |외계인  <br/> |회의 URI입니다. 자세한 내용은 [비즈니스용 Skype 서버 2015의 ConferenceUris](conferenceuris.md) 테이블을 참조하세요. <br/> |
|**ConfInstance** <br/> |uniqueidentifier  <br/> | <br/> |재발하는 회의에 유용합니다. 재발 회의의 각 인스턴스는 **ConferenceUri가** 같지만 **ConfInstance는 다릅니다.** <br/> |
...
|**OrganizerId** <br/> |임계값  <br/> |외계인  <br/> |이 회의의 이끌이 URI를 식별하기 위한 ID 번호입니다. 자세한 내용은 [Users 테이블을](users.md) 참조하십시오. <br/> |
