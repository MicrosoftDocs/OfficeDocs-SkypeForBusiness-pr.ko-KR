...
다음 표에는 영구 채팅 Windows PowerShell 관리하는 데 사용할 수 있는 Windows PowerShell cmdlet이 요약되어 있습니다. 사용 가능한 모든 매개 변수를 포함하여 구문에 대한 자세한 내용은 비즈니스용 Skype 서버 [2015 Management Shell을 참조합니다](../management-shell.md).
