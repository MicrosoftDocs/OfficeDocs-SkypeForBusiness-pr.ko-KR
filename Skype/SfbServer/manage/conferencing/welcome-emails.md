...
일반적으로 **Set-CsClientPin** cmdlet을 사용하여 PIN을 다시 설정하지만 PIN 정보가 있는 소개 환영 전자 메일을 보내고 싶은 경우 이 항목의 절차를 사용할 수 있습니다. 전자 메일을 보내지 않을 경우 **Set-CsClientPin** 을 대신 사용할 수 있습니다.
