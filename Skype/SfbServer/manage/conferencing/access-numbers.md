...
9. **풀에서** 이 전화 접속 액세스 번호를 지원하는 회의 참석자 인스턴스를 실행하는 풀을 클릭합니다.
...
12. 전화 접속 액세스 번호에 대한 지역을 추가하려면 연결된 지역 아래에서 **추가를** 클릭하고 이 전화 접속 액세스 번호에 대한 다이얼 플랜과 연결된 지역을 하나 이상 클릭한 다음 **확인을 클릭합니다.**
