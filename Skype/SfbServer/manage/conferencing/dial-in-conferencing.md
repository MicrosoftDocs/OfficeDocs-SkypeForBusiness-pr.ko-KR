...
이 항목에서는 전화 접속 회의를 관리하는 방법에 대해 설명합니다. 배포 시 전화 접속 회의를 계획하고 구성하는 방법에 대한 자세한 내용은 [Plan for dial-in conferencing in Skype for Business Server](../../plan-your-deployment/conferencing/dial-in-conferencing.md) 및 Configure [dial-in conferencing in Skype for Business Server을](../../deploy/deploy-conferencing/dial-in-conferencing.md)참조하십시오.
