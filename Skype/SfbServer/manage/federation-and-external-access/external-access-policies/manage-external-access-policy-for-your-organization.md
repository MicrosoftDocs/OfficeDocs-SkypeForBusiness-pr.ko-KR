...
이러한 옵션에는 다음과 같은 유형의 외부 액세스가 포함됩니다.
  ...
  - **페더러드 사용자와**   의 통신 사용   페더타 파트너 도메인에 대한 사용자 액세스를 지원하려면 이 옵션을 사용하도록 설정하세요. 이 설정은 사용자가 다른 SIP 페더니트 도메인뿐만 아니라 호스트된 공급자(Microsoft 365 또는 페더리트 도메인)와 통신할 Microsoft 365 Office 365. 
