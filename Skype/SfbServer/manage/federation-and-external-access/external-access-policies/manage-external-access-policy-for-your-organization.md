...
이러한 옵션에는 다음과 같은 유형의 외부 액세스가 포함됩니다.
  ...
  - **페더레이션된 사용자와의 통신 사용**   페더레이션된 파트너 도메인에 대한 사용자 액세스를 지원하려는 경우 이를 사용하도록 설정합니다. 이 설정은 사용자가 다른 SIP 페더레이션 도메인뿐만 아니라 Microsoft 365 또는 Office 365 같은 호스트된 공급자와 통신하는 기능을 구성합니다. 


  - **원격 사용자와의 통신 사용**   통신 및 이동 중인 사용자와 같이 방화벽 외부에 있는 조직의 사용자가 인터넷을 통해 비즈니스용 Skype 서버 연결할 수 있도록 하려면 이 옵션을 사용하도록 설정합니다.

  - **공용 사용자와의 통신 사용**   내부 사용자가 공용 IM 공급자 연락처와 통신할 수 있도록 하려면 이 옵션을 사용하도록 설정합니다.
