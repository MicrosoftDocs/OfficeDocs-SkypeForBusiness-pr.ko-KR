...
비즈니스용 Skype 서버 제어판을 사용하여 토폴로지에서 비즈니스용 Skype 서버를 실행하는 모든 컴퓨터의 목록을 보고, 서비스 상태를 보고, 서비스를 시작 또는 중지하고, 서비스에 대한 세션을 방지할 수 있습니다.
...
자세한 내용은 [Get-CsWindowsService를 참조합니다.](https://docs.microsoft.com/powershell/module/skype/Get-CsWindowsService)
