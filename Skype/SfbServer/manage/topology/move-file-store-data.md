...
7. 파일 저장소를 사용하는 서버 또는 풀을 선택하고 다음을 실행합니다.
   ...
   b. 속성 **편집의** **연결 아래에** 있는 **파일 저장소에서** 새로 시작을 **클릭합니다**.

   c. 새 **파일 저장소** 정의의 파일 서버 **FQDN** 에서 파일 서버의 FQDN(정식 도메인 이름)을 입력합니다. 파일 **공유에서** 새 파일 공유의 폴더 이름을 입력한 다음 확인을 **클릭합니다**.
...
13. 서비스를 중지한 각 서버 또는 풀에 대해 서버 또는 풀을 선택하고 작업을 **클릭한 다음** 모든 서비스 시작 **을 클릭합니다**.
