...
4. 보관 구성 목록에서 적절한 전역, 사이트 또는 풀 구성의 이름을 클릭하고 편집을 클릭한 다음 세부 정보 **표시를 클릭합니다.** 
...
자세한 내용은 [Set-CsArchivingConfiguration](https://docs.microsoft.com/powershell/module/skype/set-csarchivingconfiguration?view=skype-ps) cmdlet에 대한 도움말 항목을 참조하십시오.
