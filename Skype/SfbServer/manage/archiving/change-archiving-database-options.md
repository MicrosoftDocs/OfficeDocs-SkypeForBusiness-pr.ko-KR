...
**요약:** 비즈니스용 Skype 서버의 보관 데이터베이스 옵션을 변경하는 방법에 대해 자세히 알아보습니다.
...
이러한 변경 내용을 적용하려면 토폴로지 작성기에서 변경한 다음 토폴로지 다시 게시해야 합니다. Exchange 서버에  SQL Server 비즈니스용 Skype 사용자가  없는 경우를 SQL Server 미러링 정보를 저장하도록 설정하거나 보관 저장소를 지정하지 않습니다.
