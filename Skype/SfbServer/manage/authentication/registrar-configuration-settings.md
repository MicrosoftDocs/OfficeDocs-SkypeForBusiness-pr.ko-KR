...
등록자에서 프록시 서버 인증 방법을 구성할 수 있습니다. 지정하는 인증 프로토콜에 따라 풀에 있는 서버가 클라이언트에 대해 어떤 유형의 문제를 챌린지로 챌린지할지 결정됩니다. 사용 가능한 프로토콜은 다음입니다.
