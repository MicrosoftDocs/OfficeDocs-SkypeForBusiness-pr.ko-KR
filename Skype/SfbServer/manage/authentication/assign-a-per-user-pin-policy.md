...
사용자당 PIN 정책은 **Grant-CsPinPolicy** cmdlet과 Windows PowerShell 할당할 수 있습니다. 비즈니스용 Skype 서버 관리 셸 또는 Windows PowerShell의 원격 세션에서이 cmdlet을 실행할 수 있습니다. 원격 서버를 사용하여 비즈니스용 Skype Windows PowerShell 대한 자세한 내용은 [Microsoft Lync Remote PowerShell Administration"을 참조하세요.](https://blog.insideo365.com/2011/08/remote-lync-powershell-administration/) 이 프로세스는 비즈니스용 Skype 서버에서 동일합니다.
