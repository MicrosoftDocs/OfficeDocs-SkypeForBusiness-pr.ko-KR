...
2. **트렁크** 구성 탭에는 모든 트렁크 구성 설정 컬렉션 목록이 표시됩니다. 각 컬렉션에  대해 **이름,** **범위,** 상태 및 **미디어** 우회 속성의 값과 함께 **PSTN** 사용법, 호출 번호 규칙 및 컬렉션과 연결된 호출된 번호 규칙의 수가 표시됩니다.  트렁크 구성 설정 컬렉션에 대한 추가 세부 정보를 보려면 관심 있는 컬렉션을 클릭하고 편집을 클릭한 다음 세부 정보 **표시를 클릭합니다.** 트렁크 구성 설정 컬렉션 하나에 대한 자세한 정보는 한 번만 볼 수 있습니다.
