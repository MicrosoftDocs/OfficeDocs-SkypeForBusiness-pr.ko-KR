...
|:-----|:-----|:-----|
|**순위** <br/> |예  <br/> |보고 된 세션의 수를 기준으로 상대 순위를 지정 합니다.  <br/> |
|**보고 된 세션** <br/> |예  <br/> |진단 ID 및 SIP 응답 코드에 따라 실패 한 총 세션 수입니다.  <br/> |
|**사용자에 게 영향을 받음** <br/> |예  <br/> |실패 한 세션의 영향을 받는 총 사용자 수입니다.  <br/> |
