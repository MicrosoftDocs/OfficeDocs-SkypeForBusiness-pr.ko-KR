...
**요약:** 비즈니스용 Skype 서버의 피어 투 피어 IM 보고서에 대해 자세히 알아보세요.
...
[비즈니스용 Skype 서버에서 피어 투 피어 활동 요약 보고서](peer-to-peer-activity-summary-report.md) 를 열고 다음 메트릭 중 하나를 클릭 하 여 피어 투 피어 IM 보고서에 액세스할 수 있습니다.
...
|**이름**|**설명**|
|:-----|:-----|
|**보낸 사람** <br/> |시간 범위에 대 한 시작 날짜 및 시간입니다. 시간별로 데이터를 보려면 시작 날짜와 시간을 모두 다음과 같이 입력 합니다.  <br/> 오후 7/7/2015 1:00  <br/> 시작 시간을 입력 하지 않으면 지정한 날짜에 오전 12:00부터 보고서가 자동으로 시작 됩니다. 날짜별로 데이터를 보려면 날짜만 입력 합니다.  <br/> 7/7/2015  <br/> 주별 또는 월별로 보려면 주 또는 월에 속하는 날짜를 입력 합니다 (주 또는 월의 첫 번째 요일을 입력할 필요는 없음).  <br/> 7/3/2015  <br/> 주는 항상 일요일 ~ 토요일을 실행 합니다.  <br/> |
...
|**간격만** <br/> | 시간 간격. 다음 중 하나를 선택 합니다. <br/>  매시간 (최대 25 시간 표시할 수 있음) <br/>  매일 (최대 31 일이 표시 될 수 있음) <br/>  주간 (최대 12 주를 표시할 수 있음) <br/>  월간 (최대 12 개월을 표시할 수 있음) <br/>  시작 및 끝 날짜가 선택한 기간에 허용 되는 최대 값을 초과 하면 시작 날짜부터 시작 하 여 최대 값만 표시 됩니다. 예를 들어 시작 날짜가 7/7/2015이 고 종료 날짜가 2/28/2015 인 일일 간격을 선택 하는 경우에는 8/7/2015 12:00 AM ~ 9/7/2015 12:00 AM (즉, 총 31 일 "의 데이터)에 대 한 데이터가 표시 됩니다. <br/> |
|**보고서 기준** <br/> | 보고서에 사용할 값을 나타냅니다. 다음 중 하나를 선택 합니다. <br/>  세션 수 <br/>  메시지 수 <br/> |
...
**인증 유형별 피어 투 피어 IM 세션에 대 한 메트릭**

|**이름**|**이 항목을 정렬할 수 있나요?**|**설명**|
|:-----|:-----|:-----|
|**인증 유형** <br/> |아니요  <br/> | 세션 참가자가 사용 하는 인증 유형입니다. 값은 일반적으로 다음 중 하나입니다. <br/>  Enterprise <br/>  제휴 <br/>  PIC <br/> |
|**날짜/시간** <br/> |아니요  <br/> |세션이 발생 한 날짜 및 시간입니다.  <br/> |
|**Total** <br/> |아니요  <br/> |총 세션 수 또는 총 메시지 수입니다.  <br/> |
