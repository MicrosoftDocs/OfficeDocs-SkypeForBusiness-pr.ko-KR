...
피어 투 피어 세션 세부 정보 보고서 내에서 진단 보고서(세부 정보[) 메트릭을 클릭하여](diagnostic-report.md) 비즈니스용 Skype 서버 진단 보고서에 액세스할 수 있습니다. 다음 두 메트릭 중 하나를 클릭하여 Top Failures Report에 액세스할 수도 있습니다.
