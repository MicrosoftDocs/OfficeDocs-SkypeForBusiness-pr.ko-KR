...
이러한 왕복 시간의 평균은 500밀리초(5000을 10으로 나눈 수)입니다. 500밀리초는 매우 큰 왕복 시간입니다. 따라서 네트워크 정체에 심각한 문제가 있는 것으로 생각할 수 있습니다. 왕복 시간이 길면 네트워크가 과부하될 수 있습니다.
  
물론, 실제로 통화의 90%에 대한 왕복 시간은 상당히 양호하며 단지 한 번의 불량 통화로 전체 결과가 왜곡되었습니다. 평균 왕복 시간만 보면 매우 잘못된 결론으로 이동하게 될 수 있습니다.
  
미디어 품질 메트릭 배포 보고서는 지정된 메트릭의 그래픽 배포(예: 왕복 시간)를 표시하여 잘못된 결론으로 이동하지 않도록 합니다. 이러한 그래프를 통해 9개의 아주 좋은 통화와 한 번의 불량 통화가 있는 것이 명확해지는 데 도움이 될 수 있습니다. 한 번의 통화에 대한 추가 조사가 필요한 경우도 있습니다. 그러나 10개 통화 중 9개가 매우 양호했다는 사실은 적어도 이 시점이 아니라 네트워크에 큰 변화가 없는 것일 수 있습니다.
