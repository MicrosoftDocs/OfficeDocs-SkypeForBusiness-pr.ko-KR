...
비즈니스용 Skype 서버 모바일 서비스(Mcx)에 대해 IIS(인터넷 정보 서비스) 요청 추적을 사용하도록 설정하면 생성되는 로그 파일은 하루에 최대 3기가바이트의 디스크 공간을 사용할 수 있습니다. IIS 추적 로깅은 기본적으로 사용하도록 설정됩니다. 프런트 엔드 서버가 디스크 공간이 모두 손실되지 않는지 모니터링해야 합니다. 
...
**httpLogging** 명령에 대한 자세한 내용은 명령 [참조를 참고합니다.](https://go.microsoft.com/fwlink/p/?linkId=234927)
