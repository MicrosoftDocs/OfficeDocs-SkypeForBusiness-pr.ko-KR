...
- 보고서[의](comparison.md) 미디어 품질 비교 비즈니스용 Skype 서버(비즈니스용 Skype 서버 목록 보고서를 클릭한 다음 세부 정보 [](call-list-report-0.md) 메트릭 클릭)
    
- 서버 [성능 보고서(](server-performance.md)비즈니스용 Skype 서버 볼륨 또는 불량 통화율 메트릭 클릭)
    
- 보고서[의 통화 비즈니스용 Skype 서버](call-list-report-0.md)(세부 정보 메트릭 클릭)
    
통화 정보 보고서 내에서 다음 메트릭 중 하나를 클릭하여 비즈니스용 Skype 서버 [](device-report.md) 보고서에 액세스할 수 있습니다.
