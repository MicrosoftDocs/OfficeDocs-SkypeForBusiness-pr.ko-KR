...
|:-----|:-----|:-----|
|**순위** <br/> |아니오  <br/> |진단 ID에 따른 실패한 세션의 상대적 순위입니다. 진단 ID는 오류 문제를 해결할 때 종종 유용한 정보를 제공하는 SIP 메시지에 연결된 고유 식별자(ms-diagnostics 헤더 형식)입니다.  <br/> |
|**상위 진단 이유** <br/> |아니요  <br/> |세션에서 생성된 진단 ID입니다.  <br/> |
|**세션** <br/> |아니오  <br/> |지정된 진단 ID가 생성된 실패한 총 세션 수입니다.  <br/> |
...
|**이름**|**이 항목에 대한 정렬 가능 여부**|**설명**|
|:-----|:-----|:-----|
|**순위** <br/> |아니오  <br/> |세션 유형을 기반으로 하는 실패한 세션의 상대적 순위입니다(예: 오디오/비디오 회의 또는 피어 투 피어 파일 전송 세션).  <br/> |
|**상위 형식** <br/> |아니오  <br/> |세션 유형  <br/> |
|**세션** <br/> |아니오  <br/> |지정된 형식을 포함하는 실패한 총 세션 수입니다.  <br/> |
...
|**이름**|**이 항목에 대한 정렬 가능 여부**|**설명**|
|:-----|:-----|:-----|
|**순위** <br/> |아니오  <br/> |세션이 수행된 등록자 풀 또는 에지 서버를 기준으로 실패한 세션의 상대적 순위입니다.  <br/> |
|**상위 풀** <br/> |아니오  <br/> |등록자 풀 또는 에지 서버의 이름입니다.  <br/> |
|**세션** <br/> |아니오  <br/> |등록자 풀 또는 에지 서버당 실패한 총 세션 수입니다.  <br/> |
