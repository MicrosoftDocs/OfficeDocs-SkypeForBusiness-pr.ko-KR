...
*신뢰할 수 있는 응용 프로그램* 은 비즈니스용 Skype 서버에서 신뢰 하는 Microsoft 통합 커뮤니케이션 관리 API (의) 3.0 Core SDK를 기반으로 하는 응용 프로그램입니다. 부분 https://go.microsoft.com/fwlink/p/?linkId=210320ma 응용 프로그램에 대 한 자세한 내용은의 "통합 커뮤니케이션 관리 API 3.0 Core SDK 설명서"를 참조 하세요.

서버 역할을 추가하거나 제거할 때 토폴로지를 게시, 사용하도록 설정 또는 사용하지 않도록 설정하려면 RTCUniversalServerAdmins 및 Domain Admins 그룹의 구성원인 사용자로 로그온해야 합니다. 

이 문서를 사용 하 여 신뢰할 수 있는 새 응용 프로그램 서버를 구성 하 고, 신뢰할 수 있는 응용 프로그램 목록을 보고, 신뢰할 수 있는 응용 프로그램 정보를 확인 하는 방법을 알아보세요. 
...
9.  최상위 노드인 **비즈니스용 Skype 서버**를 선택 하 고 **동작** 메뉴에서 **토폴로지 게시**를 클릭 합니다.
...
비즈니스용 Skype 서버 제어판을 사용 하 여 비즈니스용 Skype 서버 환경에 배포한 신뢰할 수 있는 응용 프로그램의 목록을 볼 수 있습니다. 신뢰할 수 있는 응용 프로그램은 비즈니스용 Skype 서버에서 신뢰 하는 Microsoft 통합 커뮤니케이션 관리 API (의) 3.0 Core SDK를 기반으로 하는 응용 프로그램입니다. 이 트러스트 관계는 다음 목록에 요약 되어 있습니다.

  - 신뢰할 수 있는 응용 프로그램은 비즈니스용 Skype 서버의 인증에 문제가 되지 않습니다.

  - 신뢰할 수 있는 응용 프로그램은 SIP 트랜잭션, 연결 또는 나가는 VoIP (Voice over Internet Protocol) 통화를 위해 비즈니스용 Skype 서버에 의해 제한 되지 않습니다.

  - 신뢰할 수 있는 응용 프로그램은 사용자를 가장 하 여 명단에 표시 하지 않고도 회의에 참가할 수 있습니다.

  - 신뢰할 수 있는 응용 프로그램은 가용성이 높아야 하며 탄력적으로 사용 가능 합니다.

비즈니스용 Skype 서버 제어판에서 응용 프로그램의 이름, 실행 하는 풀 및 사용 하는 포트를 볼 수 있습니다.


### <a name="to-view-a-list-of-trusted-applications"></a>신뢰할 수 있는 응용 프로그램 목록을 보려면

1.  CsServerAdministrator, CsAdministrator, CsHelpDesk 또는 Csserveradministrator 관리자 역할에 할당 된 사용자 계정에서 내부 배포의 임의 컴퓨터에 로그온 합니다. 비즈니스용 Skype 서버에서 사용할 수 있는 미리 정의 된 관리 역할에 대 한 자세한 내용은 [RBAC (역할 기반 액세스 제어](../plan-your-deployment/security/role-based-access-control-rbac.md))를 참조 하세요.
...
Windows PowerShell 및 **new-cstrustedapplication** cmdlet을 사용 하 여 신뢰할 수 있는 응용 프로그램에 대 한 정보를 볼 수 있습니다. 이 cmdlet은 비즈니스용 Skype 서버 관리 셸 또는 Windows PowerShell의 원격 세션에서 실행할 수 있습니다. 


### <a name="to-view-trusted-applications"></a>신뢰할 수 있는 응용 프로그램을 보려면

신뢰할 수 있는 응용 프로그램을 모두 보려면 비즈니스용 Skype 서버 관리 셸에서 다음 명령을 입력 하 고 enter 키를 누릅니다.
