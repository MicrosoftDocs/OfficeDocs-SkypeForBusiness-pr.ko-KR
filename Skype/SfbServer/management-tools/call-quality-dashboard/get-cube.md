...
**요약:** 통화 품질 대시보드에 대한 데이터 API의 일부인 큐브 보기 작업에 대해 자세히 알아보습니다. 통화 품질 대시보드는 비즈니스용 Skype 서버용 도구입니다.
 ...
 *KPIS*  - 예약되어 있습니다. 요청 페이로드의 KPIS 섹션을 사용하면 쿼리 실행 작업을 통해 큐브에 정의된 KPIS의 값을 반환할 수 있습니다. QoE 큐브에는 아직 KPIS가 없습니다.
