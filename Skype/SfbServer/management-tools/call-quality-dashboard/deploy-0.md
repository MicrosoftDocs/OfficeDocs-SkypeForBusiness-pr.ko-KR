...
서브넷을 가져와서 마지막 단계에서 가져온 건물에 매핑합니다. NetworkName을 채우지 않기로 결정 한 경우이 테이블의 각 항목은 Networkname 0을 사용 하는지 확인 합니다. 통화 품질 대시보드의 SQL 구문 및 매개 변수에 대 한 자세한 내용은 [비즈니스용 Skype 서버에 대 한 통화 품질 대시보드 사용](https://docs.microsoft.com/skypeforbusiness/management-tools/call-quality-dashboard/use)을 참조 하십시오.
