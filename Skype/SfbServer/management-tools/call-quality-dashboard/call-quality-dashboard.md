...
비즈니스용 Skype Server 통화 품질 대시보드 (CQD)는 비즈니스용 Skype 서버 및 Lync Server 2013의 모니터링 서버에 있는 경력 수준의 데이터베이스 위에 있는 보고 계층입니다. CQD는 Microsoft SQL Server Analysis Services를 사용 하 여 데이터 집합에 대해 필터링 및 피벗을 비롯 한 집계 사용 및 통화 품질 정보를 제공 합니다.
