...
> [!NOTE]
>  계획 도구는 사이트 및 토폴로지 디자인 시 의사 결정 프로세스를 알리는 자세한 가이드가 있는 마법사 기반 도구입니다. 이 항목은 단순한 지침이 아니라 디자인 세션에서 계획 도구를 사용하는 데 도움이 됩니다.

### <a name="to-get-started-using-the-planning-tool-and-create-the-initial-design"></a>계획 도구 사용을 시작하고 초기 디자인을 만들하려면

1. 비즈니스용 Skype 서버 2015 계획 도구 시작: **시작,** **모든** 프로그램, 비즈니스용 Skype **서버 2015를** 클릭한 다음 계획 **도구를 클릭합니다.**
