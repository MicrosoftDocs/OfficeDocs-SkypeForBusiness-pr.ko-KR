...
2. 콘솔 창에서 다음 명령을 입력 하 고 enter 키를 누릅니다. 비즈니스용 Skype Server 설치 파일에 대 한 적절 한 경로를 입력 해야 합니다. D:\Setup.exe/BootstrapLocalMgmtTo 핵심 비즈니스용 Skype 서버 구성 요소가 설치 되어 있는지 확인 하 고, **시작**을 클릭 하 고, **모든 프로그램**을 클릭 합니다. **skype For Business server 2015**을 클릭 한 다음 비즈니스용 **Skype server Management Shell**을 클릭 합니다. 비즈니스용 Skype 서버 관리 셸에서 다음 Windows PowerShell 명령을 입력 하 고 enter 키를 누릅니다.
