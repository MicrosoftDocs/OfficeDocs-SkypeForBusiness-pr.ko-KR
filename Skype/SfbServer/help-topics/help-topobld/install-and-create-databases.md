...
> [!CAUTION]
> 데이터베이스를 SQL Server 인스턴스에 대해 구성한 경우 방화벽 포트를 열고 데이터베이스를 배포하는 인스턴스를 수용해야 합니다. 자세한 내용은 [Configure SQL Server for Lync Server 2013 Preview](https://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx)을 참조하십시오.
