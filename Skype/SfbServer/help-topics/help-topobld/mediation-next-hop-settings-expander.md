...
중재 서버 풀 또는 조정 서버의 설정에 대 한 자세한 내용은 배포 설명서의 [비즈니스용 Skype 서버 2015의 토폴로지 작성기에서 중재 서버 배포](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) 를 참조 하세요.
