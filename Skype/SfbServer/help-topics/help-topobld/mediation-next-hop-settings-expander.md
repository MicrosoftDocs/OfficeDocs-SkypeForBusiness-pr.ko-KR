...
중재 서버 풀 또는 중재 서버의 설정에 대한 자세한 내용은 배포 설명서의 비즈니스용 Skype 서버 [2015에서](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) 토폴로지 작성기에서 중재 서버 배포를 참조하십시오.
