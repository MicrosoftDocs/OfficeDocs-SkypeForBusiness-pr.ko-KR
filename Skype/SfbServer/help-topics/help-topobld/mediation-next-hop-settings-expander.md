...
중재 서버 풀 또는 중재 서버의 설정에 대한 자세한 내용은 배포 설명서에서 [Deploy a Mediation Server in topology Builder in 비즈니스용 Skype 서버 2015를](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) 참조하십시오.
