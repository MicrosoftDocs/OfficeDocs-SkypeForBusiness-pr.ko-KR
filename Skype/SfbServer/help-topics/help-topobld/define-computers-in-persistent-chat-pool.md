...
컴퓨터 **FQDN(FQDN)을** 입력하여 영구 채팅 서버 풀의 일부가 될 컴퓨터를 정의합니다. 이 FQDN은 DNS(Domain Name System) 호스트(A 또는 AAAA) 레코드에 정의된 컴퓨터의 이름이어야 합니다.
...
영구 **채팅** 서버 풀 정의를 계속하려면 이 풀의 컴퓨터 구성원을 입력한 후 다음을 클릭합니다.
