...
새로 **추가를** 클릭하여 새 SQL Server 영구 채팅 준수 데이터에 대한 새 인스턴스를 정의합니다.
  
영구 **채팅** 준수 SQL Server 미러링 데이터베이스를 제공할 SQL Server 및 선택적 인스턴스를 구성하려면 SQL Server 저장소 미러링 사용 확인란을 선택합니다.
  
영구 채팅 준수 정책  에 SQL Server 미러링 SQL Server 및 선택적 인스턴스를 SQL Server 미러링 목록에서 SQL Server.
...
새로 **고침** 을 클릭하여 미러링 SQL Server 미러링된 미러링 SQL Server 인스턴스에 대한 새 미러링 SQL Server 정의합니다.
