...
영구 **채팅** 준수 SQL Server 미러된 데이터베이스를 제공할 SQL Server 데이터베이스 및 선택적 인스턴스를 구성하려면 SQL Server 저장소 미러링 사용 확인란을 선택합니다.
  
영구 채팅  준수 정책에 SQL Server 미러링 SQL Server 및 선택적 인스턴스를 SQL Server 미러링 목록에서 SQL Server.
