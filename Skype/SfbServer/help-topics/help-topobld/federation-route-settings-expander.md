...
- 모든 사이트에 대한 **페더ation 경로 할당 허용** 이 설정은 모든 사이트에 영향을 미치게 됩니다. 이 사이트에서 구성하는 설정이 모든 사이트에 대해 적합해야 합니다.
    
- **SIP 페더ation 사용** SIP 페더전 경로를 사용하도록 설정하려면 이 옵션을 선택한 다음 페더임 경로로 Director 또는 에지 풀을 선택합니다.
    
- **XMPP 페더ation 사용** XMPP 페더전 경로를 사용하도록 설정하려면 이 옵션을 선택한 다음 페더럴 경로로 Director 또는 에지 풀을 선택합니다.
