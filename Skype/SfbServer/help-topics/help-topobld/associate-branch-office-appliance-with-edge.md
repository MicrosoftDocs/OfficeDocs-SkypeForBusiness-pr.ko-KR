...
에지 서버를 배포하고 외부에서 사용할 미디어 서비스를 제공해야 하는 경우 드롭다운 목록에서 해당 서버를 선택하여 SSS(Survivable Branch Appliance) 또는 Survivable Branch Server와 연결될 에지 서버 또는 풀을 선택합니다. **다음** 을 클릭하여 계속합니다.
