...
description: 에 지 서버 풀을 구성 하는 컴퓨터를 정의 하려면 레거시 부하 분산 통합에 지 풀에 속하는 하나 이상의 컴퓨터에 대 한 FQDN (정규화 된 도메인 이름)을 입력 합니다.
...
에 지 서버 풀을 구성 하는 컴퓨터를 정의 하려면 레거시 부하 분산 통합에 지 풀에 속하는 하나 이상의 컴퓨터에 대 한 FQDN (정규화 된 도메인 이름)을 입력 합니다. 
