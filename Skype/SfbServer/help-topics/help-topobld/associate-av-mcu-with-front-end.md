...
회의를 사용 하는 모든 Enterprise Edition 프런트 엔드 풀에는 A/V 회의 서비스 collocated 있어야 하며, 독립 실행형 A/V 회의 풀을 사용 해야 합니다. 현재 A/V 회의 서비스 collocated를 보유 하 고 있는 기존의 모든 Enterprise Edition 프런트 엔드 풀은이 새로운 독립 실행형 A/V 회의 풀을 대신 사용 하도록 선택 될 수 있습니다.
