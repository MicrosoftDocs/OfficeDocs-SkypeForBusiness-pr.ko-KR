...
디렉터 풀에서 사용할 파일 공유. 토폴로지 작성기에 이미 정의 된 기존 파일 공유를 선택 하거나 **새로** 만들기를 클릭 하 여 새 파일 공유 정의를 만듭니다.
