...
> [!IMPORTANT]
> 인프라에 대한 중앙 관리 저장소를 정의, 게시 및 배포한 경우 외부 프로세스로 중앙 관리 저장소를 다른 프런트 엔드로 재배치하지 않고서는 중앙 관리 저장소의 위치를 변경할 수 없습니다. 
  
중앙 관리 서버 저장소를 이동 하는 방법에 대 한 자세한 내용은 Windows PowerShell cmdlet 참조에서 [move-csmanagementserver](https://docs.microsoft.com/powershell/module/skype/move-csmanagementserver?view=skype-ps) 를 참조 하십시오.
