...
- **특징 및 기능** 에서 이 풀과 배치하려는 추가 역할을 정의합니다. 다음과 같은 설정을 구성할 수 있습니다.
  ...
  - **Enterprise Voice**. 적격한 수화기 및 장치 및 비즈니스용 Skype 클라이언트에 대한 내부 음성 OVER IP 통화를 사용할 수 있습니다. 외부 통화 기능을 사용하도록 설정하려면 중재 서버를 포함해야 합니다. 자세한 내용은 이 항목 뒷부분의 "중재 서버"를 참조하십시오.
