...
ms.locfileid: "58581572"
---
# <a name="pin-policy"></a>PIN 정책

무슨 작업을 하고 싶으십니까? 수행할 작업에 대한 링크를 클릭합니다.

 **IP 전화에 대한 PIN 정책 사용** 이 PIN(개인 식별 번호) 정책은 IP 전화를 사용하여 비즈니스용 Skype 서버 사용자에 대한 인증을 지원합니다.
- [2015년 8월에 새 PIN 비즈니스용 Skype 서버 만들기](../../manage/authentication/create-a-new-pin-policy.md)

- [2015년 8월에 기존 PIN 비즈니스용 Skype 서버 수정](../../manage/authentication/modify-an-existing-pin-policy.md)
