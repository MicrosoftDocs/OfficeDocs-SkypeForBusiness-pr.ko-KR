...
|사용자가 비즈니스용 Skype 서버를 사용할 수 있도록 설정 선택적으로 이전 릴리스에서 마이그레이션하는 경우 사용자를 비즈니스용 Skype 서버로 이동합니다.  <br/> |**사용자** <br/> |[사용자 관리](https://technet.microsoft.com/library/8021087e-5084-4a39-9fef-ab9376c6d371.aspx) <br/> |
