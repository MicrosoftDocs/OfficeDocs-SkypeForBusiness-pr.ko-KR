...
이 항목에서 참조 하는 작업을 검토 한 다음 조직의 Lync Server 배포에 적합 한 절차를 수행 하는 것이 좋습니다.
...
|모니터링 서버를 배포한 경우 모니터링 서버 보고서에서 사용 및 진단 정보를 확인합니다.  <br/> |**홈** <br/> |[비즈니스용 Skype의 상태 관리 및 모니터링](../../manage/health-and-monitoring/health-and-monitoring.md) <br/> |
