...
하나 이상의 채팅방을 관리할 수 있는 영구 채팅방 관리자는 클라이언트를 사용하여 채팅방 관리 웹 응용 프로그램을 시작하여 채팅방을 만들고 관리할 수 있습니다(또는 고객이 호출할 사용자 지정 솔루션 및 워크플로를 만들 수 있습니다). 영구 채팅
  
영구 채팅 관리자는 또한 제어판 또는 cmdlet을 사용하여 Windows PowerShell 및 관리할 수 있습니다.
