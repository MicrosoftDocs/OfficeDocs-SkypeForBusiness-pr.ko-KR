...
ms.locfileid: "62410291"
---
# <a name="clients-mobility-policy"></a>클라이언트: 이동성 정책

클라이언트 **모바일** **정책 페이지에** 는 배포에서 사용할 수 있는 모바일 정책이 표시됩니다.
...
- **새로운** 새로 **만들기** 를 클릭한 다음 사이트 또는  사용자를 선택하여  새 모바일 정책을 만들 수 있습니다.

- **편집** 정책을 선택한 다음 편집 **을 클릭하여 선택한** 정책의 속성을 편집합니다.

- **새로 고침** 표시되는 정책 목록을 새로 고쳐서 표시합니다. 새로 고침 **을** 클릭하면 검색 필터 문자열이 지워지며 모든 기존 정책이 표시됩니다.
