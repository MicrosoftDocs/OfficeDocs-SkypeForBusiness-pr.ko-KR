...
- **기본 작업** 사용자가 특정 클라이언트 버전 정책이 없는 클라이언트 응용 프로그램을 사용하여 로그온을 시도할 때 적용되는 기본 작업을 선택할 수 있습니다. 다음 옵션을 사용할 수 있습니다.
  ...
  - **URL을 사용하여 허용** 클라이언트 버전이 클라이언트 버전 정책 목록의 필터와 일치하지 않는 경우 클라이언트 로그온을 허용하고 최신 클라이언트를 다운로드할 수 있는 URL이 포함된 오류 메시지를 포함합니다.
