...
> [!NOTE]
> microsoft Exchange 통합을 사용하여 Microsoft Exchange 보관 데이터를 저장하는 경우 Exchange 2013 정책은 Exchange 2013에 있는 사용자에 대한 보관을 제어합니다. 이러한 사용자에 대해 보관을 사용하도록 설정하려면 사용자의 사서함이 보류된 In-Place 합니다. 
