...
- Exchange 2013에 속한 사용자의 Exchange 2013 저장소 통합
...
> [!NOTE]
> 보관 구성은 비즈니스용 Skype 서버에 속한 사용자에 게 적용 되며, exchange를 사용 하 여 Exchange 2013에 있는 사용자에 게 Microsoft Exchange에 보관 데이터를 저장 하는 경우 exchange 2013에 속한 사용자에 게 약간 다르게 구현 됩니다. 차이점은 다음 섹션에 설명 되어 있습니다. 
