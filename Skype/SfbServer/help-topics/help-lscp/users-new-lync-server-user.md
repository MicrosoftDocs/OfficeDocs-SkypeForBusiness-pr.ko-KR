...
ms.locfileid: "60748004"
---
# <a name="users-new-lync-server-user"></a>사용자: 새 Lync Server 사용자

무슨 작업을 하고 싶으십니까? 수행할 작업에 대한 링크를 클릭합니다.

- [Lync Server 2010에 새 사용자 추가](/previous-versions/office/lync-server-2013/lync-server-2013-add-and-enable-user-account-for-lync-server)
