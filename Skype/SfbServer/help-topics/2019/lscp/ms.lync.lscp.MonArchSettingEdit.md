...
- **Microsoft Exchange 통합** 사용자가 있는 경우 이 옵션을 Exchange. 이 옵션을 Exchange 사서함이 보류된 경우 해당 사용자에 대한 데이터를 저장하는 In-Place 사용됩니다. 모든 사용자가 Exchange 경우 보관 데이터 저장을 위해 별도의 SQL Server 데이터베이스를 설정할 필요가 없습니다.
