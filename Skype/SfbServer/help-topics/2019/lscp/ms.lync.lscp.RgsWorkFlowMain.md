...
- **워크플로 만들기 또는 편집** 워크플로를 만들거나 편집하는 데 사용할 응답 그룹 구성 도구를 열 수 있습니다.
...
응답 그룹 기능에 대한 자세한 내용은 계획 설명서에서 비즈니스용 [Skype 서버의](../../../plan-your-deployment/enterprise-voice-solution/response-group.md) 응답 그룹 응용 프로그램 계획을 참조하십시오. 응답 그룹 워크플로 사용에 대한 자세한 [](https://technet.microsoft.com/library/42cfccdd-2844-4875-b4e3-813e1df15f08.aspx) 내용은 작업 설명서에서 응답 그룹 워크플로 관리를 참조하십시오.
