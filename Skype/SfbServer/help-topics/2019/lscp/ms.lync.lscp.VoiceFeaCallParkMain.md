...
통화 **파크 페이지에** 는 조직에 대해 정의된 모든 통화 파크 번호 범위의 목록이 표시됩니다.
...
통화 파크 기능에 대한 자세한 내용은 [Plan for Call Park in 비즈니스용 Skype](../../../plan-your-deployment/enterprise-voice-solution/call-park.md). 통화 파킹된 번호 범위 사용에 대한 자세한 내용은 [Configure 전화 Number Extensions for Parking Calls을 참조합니다](/previous-versions/office/lync-server-2013/lync-server-2013-configure-phone-number-extensions-for-parking-calls).