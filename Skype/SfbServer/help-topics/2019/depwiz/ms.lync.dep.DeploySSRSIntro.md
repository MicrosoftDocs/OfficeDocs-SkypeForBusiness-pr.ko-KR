...
사이트의 모든 풀 및 여러 중앙 사이트의 풀은 사용량이 모니터링 서버의 용량을 초과하지 않는 경우 동일한 모니터링 서버를 사용할 수 있습니다. 모니터링을 지원하기 위해 토폴로지 디자인에 대한 자세한 내용은 배포 설명서에서 [Associate a monitoring store with a Front End pool in 비즈니스용 Skype 서버](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md) 참조하십시오.
