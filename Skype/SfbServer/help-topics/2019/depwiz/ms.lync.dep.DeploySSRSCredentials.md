...
모니터링을 실행 하는 서버에 대해 Reporting Services 보고서를 배포 하는 방법에 대 한 자세한 내용은 [비즈니스용 Skype 서버에서 모니터링 보고서 설치](../../../deploy/deploy-monitoring/install-monitoring-reports.md)를 참조 하세요.
