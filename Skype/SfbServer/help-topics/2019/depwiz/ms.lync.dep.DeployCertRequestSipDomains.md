...
> [!NOTE]
> 나열된 SIP 도메인을 아무것도 선택하지 않을 수 있습니다. 그러나 사용할 기본 SIP 도메인은 선택하는 것이 좋습니다. 나열된 SIP 도메인을 아무것도 선택하지 않은 상태에서 구성이나 요구 사항이 변경되면 새 인증서를 요청하고 새 구성에 필요한 SIP 도메인을 선택해야 합니다. 
