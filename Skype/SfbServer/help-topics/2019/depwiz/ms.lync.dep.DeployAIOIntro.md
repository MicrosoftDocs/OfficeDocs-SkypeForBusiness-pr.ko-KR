...
이 특정 작업은 Standard Edition 서버를 인프라의 첫 번째 서버로 설치하도록 디자인되었습니다. 이 작업은 Express에 있는 중앙 관리 SQL Server Standard Edition 서버에 설치합니다. 이미 다른 Standard Edition 서버 또는 프런트 엔드 풀을 배포한 경우 **취소** 를 클릭해야 합니다.
