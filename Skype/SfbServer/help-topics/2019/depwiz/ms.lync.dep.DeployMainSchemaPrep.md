...
클래스 및 특성은 비즈니스용 Skype 서버 서버, 서비스 및 사용자 개체를 지원하도록 Active Directory 도메인 서비스 schema를 확장하기 위해 추가됩니다. 스키마를 확장하기 전에 스키마 마스터 역할이 보관된 도메인 컨트롤러의 시스템 상태 백업을 수행해야 합니다. 
