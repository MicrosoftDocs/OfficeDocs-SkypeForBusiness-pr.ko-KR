...
ms.locfileid: "58579872"
---
# <a name="start-services"></a>서비스 시작
 
배포된 서버 역할에서 서비스를 시작하려면  4단계: 서비스 시작 **에서 실행을 클릭합니다.** 로컬 Administrators 그룹의 구성원 또는 이에 상응하는 구성원으로 로그온해야 합니다. 
  
> [!NOTE]
> Start **Services가** 실행된 경우 다시 실행 을 클릭하여 명령을 다시 **실행할 수 있습니다.** 
