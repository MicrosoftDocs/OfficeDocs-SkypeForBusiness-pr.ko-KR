...
1. 비즈니스용 Skype 서버 관리 셸을 시작하려면 **시작,** **모든** 프로그램, 비즈니스용 **Skype를** 클릭한 다음 비즈니스용 Skype 서버 관리 셸을 **클릭합니다.**
