...
중앙 관리 서버 저장소를 이동하는 자세한 내용은 cmdlet 참조의 [Move-CsManagementServer를](/powershell/module/skype/move-csmanagementserver?view=skype-ps) Windows PowerShell 참조합니다.
