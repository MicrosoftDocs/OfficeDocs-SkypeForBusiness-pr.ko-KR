...
**SBA(Survivable Branch Appliance)** 노드에는 이 분기 사이트의 SBA(Survivable Branch Appliance)가 나열됩니다. 다음 작업을 수행할 수 있습니다.
  
- **새 SBA(Survivable Branch Appliance)**. 이 사이트에 **새 Survivable Branch Appliance** 를 추가하는 데 사용하는 새 Survivable Branch Appliance 정의 마법사를 시작합니다.
    
Survivable Branch Appliance 옵션 외에 다음과 같은 일반적인 작업을 수행할 수 있습니다.
