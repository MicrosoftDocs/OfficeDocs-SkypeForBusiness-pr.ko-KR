...
ms.locfileid: "62417091"
---
# <a name="edge-servers-scope-node"></a>에지 서버 범위 노드
 
**에지 풀** 노드에 토폴로지의 에지 풀이 나열됩니다. 다음 작업을 수행할 수 있습니다.
  
- **새 에지 풀**. 토폴로지에 새 에지 풀을 추가하는 데 사용하는 **새 에지 풀 정의** 마법사를 시작합니다.
    
에지 풀 옵션 외에 다음과 같은 일반적인 작업을 수행할 수 있습니다.
