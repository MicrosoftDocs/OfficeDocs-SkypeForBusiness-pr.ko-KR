...
지원에 대한 SQL Server 내용은 지원 가능성 설명서에서 [데이터베이스](https://technet.microsoft.com/library/e05d0032-bbea-4e61-987d-d07b1c045fd5.aspx) 소프트웨어 및 클러스터링 지원을 참조하십시오. 백 엔드 데이터베이스에 대한 SQL Server 설정하는 자세한 내용은 배포 [](https://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx) 설명서에서 SQL Server 구성을 참조하십시오.
