...
ms.locfileid: "36197377"
---
# <a name="sql-instances-scope-node"></a>SQL 인스턴스 범위 노드
 
**Sql 저장소** 노드는 토폴로지에 sql Server 데이터베이스를 나열 합니다. 다음 작업을 수행할 수 있습니다.
  
- **새 SQL 저장소**. 토폴로지에 새 SQL Server 데이터베이스를 추가 하는 데 사용 하는 **새 Sql 저장소 정의** 마법사를 시작 합니다.
    
SQL Server 데이터베이스 옵션 외에도 다음과 같은 일반적인 작업을 수행할 수 있습니다.
