...
> [!NOTE]
> **이 a/v 회의 풀과 연결할 프런트** 엔드 풀 선택 창이 표시 되지 않으면 프런트 엔드 풀을 사용 하 여 a/v 회의 서버를 collocated 기능에서 회의를 추가 하도록 선택 하지 않은 것입니다. ** **프런트 엔드 풀 속성의 기능 섹션입니다.
