---
title: 비즈니스용 Skype 서버 에지 네트워크 계획 도구
ms.reviewer: null
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
대부분의 에지 구성 요소는 경계 네트워크에 배포됩니다. 다음 구성 요소는 경계 네트워크의 에지 토폴로지로 구성됩니다. 설명된 경우를 제외하고 구성 요소는 비즈니스용 Skype 서버 [2015](../../plan-your-deployment/edge-server-deployments/scenarios.md)의 에지 서버 시나리오에 포함하며 경계 네트워크에 있습니다. 에지 구성 요소는 다음과 같습니다.
