...
비즈니스용 Skype 서버 2015에 대한 액세스 권한을 부여하기 위해 다음을 실행합니다.
...
- **CsViewOnlyAdministrator:** 구성원은 서버 정보의 배포 및 구성을 볼 수 있습니다. 이 멤버 자격을 사용하면 구성원이 비즈니스용 Skype 서버 2015를 실행하는 서버의 상태 모니터링을 할 수 있습니다.
