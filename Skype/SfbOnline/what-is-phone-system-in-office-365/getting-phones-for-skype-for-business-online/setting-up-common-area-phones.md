...
일반적으로 CAP(공용 영역 전화)는 많은 사람들이 사용할 수 있는 로비 또는 다른 영역과 같은 영역에 배치됩니다. 예를 들어 수신 영역 전화, 도어 전화 또는 회의실 전화, CAP는 사용자 대신 디바이스로 설정되고 네트워크에 자동으로 로그인됩니다. 아래 단계에서는 이러한 유형의 휴대폰을 조직에 배포할 수 있도록 전화 요금제가 있는 전화 시스템 계정을 설정하는 데 도움이 됩니다.
...
- 휴대폰에서 펌웨어를 업데이트합니다(이 항목에서 지원되는 펌웨어 [참조).](getting-phones-for-skype-for-business-online.md)  다음을 수행하여 휴대폰에서 펌웨어를 확인할 수 있습니다.
  ...
  - **LPE(Lync Phone Edition)** 휴대폰: 시작 화면에서 **메뉴**  >  **시스템 정보로** 이동하세요.

    펌웨어 업데이트는 비즈니스용 Skype 서비스에서 관리됩니다. 비즈니스용 Skype 인증 휴대폰의 펌웨어는 비즈니스용 Skype 업데이트 서버에 업로드됩니다. 기본적으로 모든 휴대폰에서 디바이스 업데이트가 활성화됩니다.
...
2. 이제 **체크** 아웃 페이지에서 지금 > 전화 구입을  >   클릭합니다.  
...
라이선스에 대한 자세한 내용은 비즈니스용 Skype 및 Microsoft Teams 추가 기능 [라이선스 를 참조하세요.](../../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)
...
6. 여전히 있는 경우 이 사용자에게 라이선스를 할당합니다. 동일한 페이지에서 제품 **라이선스를 확장하려면 를 클릭합니다.** 다음을 설정합니다.
   ...
   - 그런 다음 국내 통화  계획 또는 국내 및 국제 통화 계획을 **선택해야 합니다.**
     ...
     > [!Note]
     > 비즈니스용 Skype 계획 2는 공용 지역 전화 **라이선스에 포함되어** 있습니다.
...
![비즈니스용 Skype 관리 센터를 사용하여 사용자에게 전화 번호 할당 비즈니스용 Skype 로고를 보여주는 아이콘 ](../../images/sfb-logo-30x30.png) 

1. 관리 센터에서 >   >  **비즈니스용 Skype** 센터 .
2. 비즈니스용 **Skype 관리 센터**  >   **음성**  >  **전화 번호 에서**
...
궁금한 경우 다른 통신사 및 "포트"를 사용하여 휴대폰번호를 찍거나 Microsoft 365 또는 Office 365로 이전할 수도 있습니다. 참조, [Teams로 전화 번호를 전송합니다.](/microsoftteams/phone-number-calling-plans/transfer-phone-numbers-to-teams)

### <a name="step-4---setting-up-your-phone"></a>4단계 - 휴대폰 설정

**휴대폰에서 모드 설정**

공용 영역 전화 모드가 켜져 있어야 하는 휴대폰 또는 **휴대폰입니다.** 해당 작업을 확인하여 해당 작업을 확인할 수 있습니다.
...
- 다음 단계를 수행하여 Polycom VVX에 공통 영역 전화 모드를 사용하도록 설정합니다.
    ...
    2. 그런 다음 **설정으로 이동하고** **비즈니스용 Skype 설정** 옵션에서 공통 영역 전화 **를 선택합니다.**
    3. 예를 **클릭하여** 설정을 저장합니다.
...
> [!NOTE]
> CAP 프로비전 사이트는 CAP 계정의 암호를 임의 암호로 재설정합니다. CAP가 참조하는 계정은 AAD(Azure Active Directory) 계정입니다. AAD에서만 계정을 만든 경우 프로세스가 간단합니다. AAD에 On-Premises Active Directory를 동기화하고 타사 IDP 또는 ADFS를 사용하는 경우 CAP 프로비전이 실패합니다. 이 경우 CAP 프로비전이 작동하려면 Microsoft 365 또는 Office 365/Azure Active Directory **계정만(예:** 도메인이 onmicrosoft.com 계정)을 사용해야 합니다.


### <a name="related-topics"></a>관련 항목

- 비즈니스용 Skype Online 휴대폰 배포에서 사용 가능한 휴대폰에 [대해 자세히 알아보자.](deploying-skype-for-business-online-phones.md)
