...
***
![숫자 5](../images/sfbcallout5.png)<br/>**회의록** 차트의 대화형 차트 데이터를 사용 하 여 사용 추세를 파악 하 고 오디오/비디오를 사용 하 여 전화를 구성 하는 사용자가 사용 하는 시간 (분)을 확인 하 고 오디오 회의 공급자를 통해 Microsoft와 다이얼 인 및 전화 걸기를 할 수 있습니다. 참여 한 회의 중에 사용 되는 **오디오/비디오** 의 총 시간 (분)을 보여 줍니다.
***
