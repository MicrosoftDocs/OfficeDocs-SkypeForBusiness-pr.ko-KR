...
- 이러한 설정에 대한 새 정책을 만들하려면 다음을 실행합니다.
   ...
   ```
   [New-CsMobilityPolicy](https://technet.microsoft.com/library/mt779150.aspx) cmdlet을 참조합니다.
...
- 조직의 모든 사용자에게 만든 새 정책을 부여하기 위해 다음을 실행합니다.
   ...
   ```
   [Grant-CsMobilityPolicy](https://technet.microsoft.com/library/mt779149.aspx) cmdlet을 참조합니다.
    
  정책을 이미 만든 경우 [Set-CsMobilityPolicy](https://technet.microsoft.com/library/mt779147.aspx) cmdlet을 사용하여 기존 정책을 변경한 다음[Grant-CsMobilityPolicy](https://technet.microsoft.com/library/mt779149.aspx) cmdlet을 사용하여 사용자에게 설정을 적용할 수 있습니다.
