...
ms.locfileid: "44220698"
---
# <a name="what-is-address-validation"></a>주소 유효성 검사 란?

통화 계획을 설정할 때 각 사용자에 게 전화 번호와 긴급 주소를 할당 해야 합니다.
  
거리 또는 도심 주소를 확인 하는 것은 정확 하 고 서식이 올바르게 지정 되었는지 확인 하는 것과 관련이 있습니다. 구/군/시의 잘못 된 이름 등 부분적으로 올바른 긴급 주소를 입력 해도 여전히 유효성 검사가 성공 하 게 될 수 있습니다. 유효성 검사 프로세스는 지정 된 주소의 모든 부분을 사용 하 여 통화를 적절 한 응급 서비스 센터로 라우팅할 수 있는 충분 한 정보가 있는지 확인 합니다. 그렇다면 확인 된 것으로 반환 되 고 전화 번호에 할당 될 수 있습니다.
