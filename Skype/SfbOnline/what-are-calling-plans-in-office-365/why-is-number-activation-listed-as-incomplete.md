...
---
# <a name="why-is-number-activation-listed-as-incomplete"></a>숫자 활성화가 불완전한 것으로 나열되는 이유는 무엇입니까?

주소 유효성 검사는 통화 요금제 설정의 중요한 부분입니다. 어떤 이유로 전화 번호가 활성화되지 않은 경우  주소 유효성 검사로 인해 불완전한 것으로 나열된 경우 서비스 요청을 만들고 제출해야 합니다. 이 작업을 하는 방식은 조직의 크기에 따라 다를 수 있습니다.
...
5. 문제 **식별 페이지에서** 다음을 선택하고 입력합니다.
   ...
   - **문제 세부 정보:** 유효성을 검사할 주소에 대한 세부 정보를 입력합니다.
     ...
     > [!IMPORTANT]
     > **전화 번호를 할당할 때 긴급 주소의 유효성을 검사하려는 통화 요금제가 제공된 국가/지역을 입력합니다.**
