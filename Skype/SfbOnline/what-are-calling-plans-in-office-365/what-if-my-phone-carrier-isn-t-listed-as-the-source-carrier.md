...
통신 회사 이름이 나열 되지 않는 것을 확인 하는 경우에는 약간의 혼란을 갖습니다. 대부분의 경우 서비스 공급자 또는 통신 회사는 다른 서비스 공급자 또는 통신 회사에서 소유 하 고 있는 전화 번호를가지고 있는 것입니다. 현재 서비스 공급자가 타사 서비스 공급자와 함께 작동할 수 있기 때문에 나열 된 서비스 공급자 또는 캐리어가 현재 서비스 공급자와 다를 수 있습니다. 
