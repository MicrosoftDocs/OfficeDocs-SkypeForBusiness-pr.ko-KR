...
---
# <a name="submitting-a-service-request-for-local-number-porting"></a>로컬 번호 포팅을 위한 서비스 요청 제출

999개가 넘는 전화 번호(사용자 또는 무료 또는 무료 서비스 번호)를 비즈니스용 Skype Online으로 전송해야 하는 경우 조직의 전화 번호 관리를 [참조하세요.](/microsoftteams/manage-phone-numbers-for-your-organization)
