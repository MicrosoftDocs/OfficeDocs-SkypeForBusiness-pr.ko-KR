...
---
# <a name="why-has-number-activation-failed"></a>번호 활성화에 실패한 이유는 무엇입니까?
주소 유효성 검사는 통화 요금제 설정의 중요한 부분입니다. 어떤 이유로 주소 유효성 검사로 인해 전화 번호가 활성화되지 않은 경우 서비스 요청을 만들어야 합니다. 이 작업을 하는 방식은 조직의 크기에 따라 다를 수 있습니다.
