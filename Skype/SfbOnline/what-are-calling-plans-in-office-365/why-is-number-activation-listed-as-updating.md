...
ms.locfileid: "58596112"
---
# <a name="why-is-number-activation-listed-as-updating"></a>번호 정품 인증이 업데이트로 나열되는 이유는 무엇입니까?

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]?

주소 유효성 검사는 통화 계획을 설정하는 중요한 부분입니다. 어떤 이유로 전화 번호가 활성화되지 않은 경우  주소 유효성 검사로 인해 업데이트로 나열된 경우 서비스 요청을 만들고 제출해야 합니다. 이 작업을 하는 방식은 조직의 크기를 기반으로 합니다.
