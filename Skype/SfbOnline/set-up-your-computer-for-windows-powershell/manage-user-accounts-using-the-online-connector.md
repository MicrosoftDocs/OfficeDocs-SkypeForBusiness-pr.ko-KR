...
- [온라인에서 특정 사용자에 대한 비즈니스용 Skype 반환](manage-user-accounts-using-the-online-connector.md#BKSpecificUser)

- [온라인에서 특정 사용자에 대한 특정 비즈니스용 Skype 반환](manage-user-accounts-using-the-online-connector.md#BKSpecificUsers)

- [온라인에서 필터링된 사용자 비즈니스용 Skype 반환](manage-user-accounts-using-the-online-connector.md#BKListofUsers)
