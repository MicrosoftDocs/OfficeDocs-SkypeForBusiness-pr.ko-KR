...
- [비즈니스용 Skype Online에서 테넌트에 연결하는 기능을 사용하지 않도록 설정했습니다.](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKAbilityConnect)
...
각 관리자는 비즈니스용 Skype Online 테넌트에 최대 3개의 동시 연결을 허용할 수 있습니다. 단일 테넌트는 20개 이상의 동시 연결을 사용할 수 없습니다. 예를 들어 관리자 6명은 각각 3개의 열려 있는 세션을 사용할 수 있습니다. 7번째 관리자는 두 개 이상의 연결을 열고(총 21개의 동시 연결로 인해) 실패합니다. 다음 오류 메시지와 함께 이 시도는 실패합니다.
