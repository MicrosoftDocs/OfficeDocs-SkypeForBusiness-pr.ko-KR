---
title: Exchange 통합 메시징 및 호스팅 보이스 메일 관리
ms.reviewer: ''
ms.author: tonysmit
author: tonysmit
manager: serdars
...
ms.locfileid: "37642617"
---
# <a name="manage-exchange-unified-messaging-and-hosted-voicemail"></a>Exchange 통합 메시징 및 호스팅 보이스 메일 관리
