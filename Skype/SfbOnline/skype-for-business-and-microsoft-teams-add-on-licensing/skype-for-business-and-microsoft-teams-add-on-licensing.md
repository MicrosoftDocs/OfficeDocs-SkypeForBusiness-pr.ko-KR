...
추가 기능 라이선스는 특정 비즈니스용 Skype 기능에 대한 라이선스입니다. 일부 회사는 특정 기능만 경쟁력 있는 가격으로 구매할 수 있는 유연성을 원합니다. 기능을 추가하려면 기능을 사용할 각 사용자마다 하나의 추가 기능 라이선스를 구입하세요.

비즈니스용 Skype 라이선스는 최대 유연성을 제공하도록 디자인됩니다. 예를 들어 기본 비즈니스용 Skype 기능을 사용한 후 오디오 회의 또는 Office 365의 전화 시스템과 같은 더 많은 기능을 사용할 준비가 된 경우 추가 기능 라이선스를 구입할 수 있습니다.
...
자세한 비용 정보는 가격을 보고 추가 기능 라이선스를 구입하는 방법 또는 [다음](skype-for-business-and-microsoft-teams-add-on-licensing.md#bkmk_how) 중 하나를 참조하세요.
...
|**전화 시스템** <br/> |PBX는 비즈니스용 전화 시스템입니다. 전화 시스템은 호스팅된 전화 서비스입니다. 이를 통해 복잡하고 값비싼 장비 없이 기존의 혁신적인 PBX 기능을 모두 사용할 수 있습니다. [다음은 전화 시스템으로 얻을 수 있는 것입니다.](/MicrosoftTeams/here-s-what-you-get-with-phone-system)  <br/> 비용은 전화 시스템에 대한 요구 사항을 [참조하세요.](https://products.office.com/skype-for-business/cloud-pbx#requirements)  <br/> |
|**통화 플랜** <br/> |다른 비즈니스용 Skype 사용자와의 통화는 무료이지만 사용자가 비즈니스 외부의 전화 번호로 전화를 걸 수 있도록 하려는 경우 통화 [요금제가 제공됩니다.](/MicrosoftTeams/calling-plans-for-office-365) 국내 통화 요금제와 국내 및 국제 통화 플랜이 있습니다.  <br/> 비용은 통화 요금제에 대한 요구 사항을 [참조하세요.](https://products.office.com/skype-for-business/pstn-calling-plans#requirements)  <br/> |
...
사용 가능한 추가 기능 라이선스 옵션은 요금제에 따라 다를 수 있습니다. 플랜과 관련된 정보, 기능 및 옵션에 대해서는 다음 주제를 참조하세요.
...
- [Office 365 Premium, 엔터프라이즈용 Microsoft 365 앱 또는 비즈니스용 Skype Online 요금제 2](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/office-365-premium-pro-plus-or-business-online-plan.md)
...
각 비즈니스용 Skype 요금제의 기능 및 비교에 대한 자세한 목록은 비즈니스용 [Skype Online 서비스 설명을 참조하세요.](https://go.microsoft.com/fwlink/?LinkId=730729)

## <a name="how-to-see-prices-and-buy-add-on-licenses"></a>가격을 확인하고 추가 기능 라이선스를 구입하는 방법
<a name="bkmk_how"> </a>

 **Microsoft 365** 요금제 구입 후 Microsoft 365 관리 센터를 통해 가격 및 추가 기능을 구입할 수 있습니다.
...
## <a name="how-do-i-use-my-existing-calling-plans-with-skype-for-business"></a>비즈니스용 Skype에서 기존 통화 요금제는 어떻게 사용하나요?
<a name="bkmk_existing"></a>

기존 통화 플랜을 사용하려는 경우 전화 **시스템** 추가 기능을 구입하고 무료 클라우드 커넥터에서 **[사용](https://technet.microsoft.com/library/mt605227.aspx)**
...
- [](/microsoftteams/set-up-calling-plans) [Office 365용](/MicrosoftTeams/calling-plans-for-office-365) 통화 요금제 및 통화 요금제 설정
