...
2. 명령 Windows PowerShell 프롬프트를 열고 다음 명령을 실행합니다. 
   ...
   ```
시작에 대한 자세한 Windows PowerShell 단일 창에서 모든 [Office 365](https://technet.microsoft.com/library/dn568015.aspx) 서비스에 연결하거나 Windows PowerShell 에 대해 컴퓨터를 [Windows PowerShell.](../set-up-your-computer-for-windows-powershell/set-up-your-computer-for-windows-powershell.md)
