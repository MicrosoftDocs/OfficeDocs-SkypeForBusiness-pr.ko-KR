...
| 설치된 비즈니스용 Skype Online이 잘못된 버전입니다.  <br/>                                                                                                           | 이 문제는 주로 **인증 서비스가 이 프로그램 버전과 호환되지 않을 수 있습니다**라는 내용의 오류 메시지와 관련이 있습니다.  <br/> 사용자에게 Office 365 포털에서 비즈니스용 Skype Online을 제거했다가 다시 설치하도록 요청합니다.  <br/>                                                                                                                                                                                                                                                    |
...
3. 파일 탐색기의 주소 표시줄에 다음을 입력합니다. **C: \\Documents and Settings\\UserName\\Application Data\\Microsoft\\Crypto\\RSA**. 여기에서 ***UserName***은 Windows 로그인 이름입니다.
