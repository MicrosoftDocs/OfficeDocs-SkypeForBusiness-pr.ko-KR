...
|사용자가 동기화 되 고 온라인으로 홈  <br/> |비즈니스용 Skype Server 온-프레미스 배포에서 만들어졌으며 Office 365와 동기화 된 하이브리드 사용자의 수입니다.  <br/> 비즈니스용 Skype 하이브리드 연결을 설정 하려면 비즈니스용 [Skype 서버와 비즈니스용 Skype Online 간 하이브리드 연결 배포](https://technet.microsoft.com/en-us/library/jj204669.aspx)를 참조 하세요.  <br/> |
