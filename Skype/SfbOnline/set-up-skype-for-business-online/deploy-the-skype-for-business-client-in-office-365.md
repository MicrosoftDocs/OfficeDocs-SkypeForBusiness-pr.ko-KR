 ...
 **엔터프라이즈 고객용 Microsoft 365 앱:** 앱이 E3 계획과 같은 Microsoft 365 앱이 포함 된 Office 365 계획을 사용 하는 경우 비즈니스용 Skype 앱은 사용자가 Word, Excel, PowerPoint 등을 다운로드 하 고 설치 하는 동시에 설치 됩니다. 이는 또한 모든 Office를 제거 하지 않는 한 비즈니스용 Skype를 제거할 수 없음을 의미 합니다.
...
- **[Office 배포 도구](https://go.microsoft.com/fwlink/p/?LinkID=626065)** 를 사용 하 여 엔터프라이즈 용 Microsoft 365 앱 또는 비즈니스용 Skype 앱을 로컬 네트워크에 다운로드 합니다. 그런 다음 Office 배포 도구를 사용 하 여 앱을 사용자에 게 배포 합니다. Office 배포 도구를 사용 하면 언어 및 버전 (32 비트 또는 64 비트)과 같은 배포의 특정 측면을 제어할 수 있습니다.
    
- Microsoft Endpoint Configuration Manager와 같은 기존 소프트웨어 배포 도구 및 프로세스를 사용 하 여 office 용 Microsoft 365 앱을 배포 하거나 비즈니스용 Skype 앱을 사용자에 게 배포할 수 있습니다. [Office 배포 도구](https://go.microsoft.com/fwlink/p/?LinkID=626065) 또는 Microsoft 365 관리 센터에서 다운로드 한 소프트웨어를 사용 하 여 기존 도구 및 프로세스를 사용할 수 있습니다.
...
비즈니스용 Skype 앱을 배포 하는 경우 엔터프라이즈 용 Microsoft 365 앱 배포의 일부로 [Configuration Manager를 사용 하 여 엔터프라이즈 용 microsoft 365 앱 관리](https://docs.microsoft.com/configmgr/sum/deploy-use/manage-office-365-proplus-updates)를 참조 하세요.
...
- [엔터프라이즈 용 Microsoft 365 앱 업데이트 프로세스 개요](https://technet.microsoft.com/library/dn761709.aspx)
    
- [Microsoft 365 for enterprise 앱에 대 한 업데이트를 관리 하는 방법 선택](https://technet.microsoft.com/library/dn761707.aspx)
    
- [Microsoft 365 for enterprise 앱에 대 한 업데이트 설정 구성](https://technet.microsoft.com/library/dn761708.aspx)
...
Office 배포 도구 또는 그룹 정책을 사용 하 여 업데이트 채널을 구성 하 여 기능 업데이트를 받을 빈도를 제어할 수 있습니다. 월 단위 채널은 월간 업데이트 기능을 제공 하는 반면, 반기 채널은 6 개월 마다 기능을 업데이트할 수 있도록 합니다. 채널에 대 한 자세한 내용은 [엔터프라이즈 용 Microsoft 365 앱 업데이트 채널 개요](https://support.office.com/article/9ccf0f13-28ff-4975-9bd2-7e4ea2fefef4)를 참조 하세요.
