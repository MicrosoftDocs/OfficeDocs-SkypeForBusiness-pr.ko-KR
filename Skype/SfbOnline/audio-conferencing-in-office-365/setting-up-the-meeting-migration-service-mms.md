...
MMS (모임 마이그레이션 서비스)는 다음과 같은 시나리오에서 사용자의 기존 모임을 업데이트 하는 서비스입니다.
...
이러한 상황에서는 최종 사용자가 [모임 마이그레이션 도구](https://www.microsoft.com/download/details.aspx?id=51659) 를 사용 하 여 자신의 모임을 대신 마이그레이션할 수 있습니다.
