...
|![SCOM 아이콘](../SfbServer/media/3a7601cb-dd2f-4606-8a3b-07c7abdc091a.png)|[SCOM 관리 팩을 사용하여 비즈니스용 Skype 서버 2019 관리](tools/scom-management-pack-use-2019.md) <br/> |비즈니스용 Skype 서버 2019 관리 팩을 사용하여 잠재적인 문제를 사전 예방적으로 식별하고 해결할 수 있습니다. 이러한 방식으로 비즈니스용 Skype 서버 2019 관리 팩은 System Center Operations Manager의 기능을 확장합니다.  <br/> |
