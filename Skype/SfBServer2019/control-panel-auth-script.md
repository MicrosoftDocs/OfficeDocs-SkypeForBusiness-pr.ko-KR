...
```
## <a name="configure-macp-application-in-adfs-farm"></a>ADFS 팜에서 MACP 응용 프로그램 구성

이 스크립트는 새 제어판에 대한 설정의 일부로 비즈니스용 Skype 서버 2019 최신 누적 업데이트를 설치한 후 실행해야 합니다.
...
```
## <a name="configure-oauth-for-macp"></a>MACP용 OAuth 구성
