...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="ce66f-103">비즈니스용 Skype 서버 2019 제어판 인증 스크립트</span><span class="sxs-lookup"><span data-stu-id="ce66f-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="ce66f-104">다음은 MACP(최신 관리 제어판)에 대한 인증 관련 도우미 스크립트입니다.</span><span class="sxs-lookup"><span data-stu-id="ce66f-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="ce66f-105">Microsoft 365 또는 Office 365를 통해 MACP 인증 구성</span><span class="sxs-lookup"><span data-stu-id="ce66f-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="ce66f-106">이 스크립트는 새 제어판에 대한 설정의 일부로 비즈니스용 Skype 서버 2019 누적 업데이트 1 이상을 설치한 후 실행해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="ce66f-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="ce66f-107">ADFS 팜에서 MACP 응용 프로그램 구성</span><span class="sxs-lookup"><span data-stu-id="ce66f-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="ce66f-108">이 스크립트는 새 제어판에 대한 설정의 일부로 비즈니스용 Skype 서버 2019 최신 누적 업데이트를 설치한 후 실행해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="ce66f-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="ce66f-109">MACP용 OAuth 구성</span><span class="sxs-lookup"><span data-stu-id="ce66f-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="ce66f-110">이 스크립트는 새 제어판에 대한 설정의 일부로 비즈니스용 Skype 서버 2019 최신 누적 업데이트를 설치한 후 실행해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="ce66f-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
