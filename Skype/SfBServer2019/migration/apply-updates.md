...
마이그레이션을 시작 하기 전에 환경에 업데이트를 적용 해야 합니다. 최신 정보는의 **비즈니스용 Skype 다운로드 및 업데이트** 를 참조 하세요 [https://go.microsoft.com/fwlink/p/?linkid=232630](https://go.microsoft.com/fwlink/p/?linkid=232630).
