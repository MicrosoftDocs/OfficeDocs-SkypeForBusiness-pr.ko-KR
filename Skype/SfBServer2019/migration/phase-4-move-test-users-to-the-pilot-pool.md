...
다음 두 가지 방법 (비즈니스용 Skype 서버 제어판 및 비즈니스용 Skype 서버 관리 셸)을 사용 하 여 단일 사용자 또는 사용자 그룹을 새로운 Microsoft 비즈니스용 Skype Server 2019 배포로 이동할 수 있습니다. 이 섹션의 항목에서는 파일럿 배포 중에 완료 해야 하는 작업에 대해 설명 하 고 파일럿 배포에서 프로덕션 수준의 배포로 비즈니스용 Skype Server 2019 배포를 이동 하기 전에
...
- [여러 사용자를 시험 운용 풀로 이동](move-multiple-users-to-the-pilot-pool.md)
