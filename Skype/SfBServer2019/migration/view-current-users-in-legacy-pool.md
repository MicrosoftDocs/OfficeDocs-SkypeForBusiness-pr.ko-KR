...
### <a name="to-see-the-list-of-users-in-the-legacy-pool"></a>레거시 풀의 사용자 목록을 보려면 다음을 참조 하세요.

1. RTCUniversalServerAdmins 그룹의 구성원 이거나 CsAdministrator 또는 CsUserAdministrator 관리 역할의 구성원 인 계정을 사용 하 여 레거시 프런트 엔드 서버에 로그온 합니다.
