...
2. 이전 버전의 비즈니스용 Skype 서버에서 클라이언트 버전 필터링을 사용 하 여 최신 업데이트가 설치 된 클라이언트만을 허용 합니다.
    
## <a name="see-also"></a>참고 항목

[Lync 2013의 새로운 설정 및 변경 됨](https://technet.microsoft.com/en-us/library/jj205204(v=ocs.15).aspx) 
 
[Lync 2013의 클라이언트 상호 운용성](https://technet.microsoft.com/en-us/library/jj204672(v=ocs.15).aspx)
