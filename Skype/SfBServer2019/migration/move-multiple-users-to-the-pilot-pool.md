...
[비즈니스용 Skype 서버 2019 관리 셸을 사용하여 여러 사용자를 이동](#sectionSection1)
  
[비즈니스용 Skype 서버 2019 관리 셸을 사용하여 모든 사용자를 동시에 이동](#sectionSection2)
...
3. 비즈니스용 Skype 서버 2019 풀로 이동하려는 두 사용자를 선택합니다. 이 예에서는 사용자 Chen Yang과 Claus Hansen을 이동하겠습니다.
...
5. 드롭다운 목록에서 비즈니스용 Skype 서버 2019 풀을 선택합니다.
...
7. 사용자의 등록자 **풀** 열에 이제 사용자가 성공적으로 이동된 비즈니스용 Skype 서버 2019 풀이 포함되어 있는지 확인해야 합니다. 
    
## <a name="to-move-multiple-users-by-using-the-skype-for-business-server-2019-management-shell"></a>비즈니스용 Skype 서버 2019 관리 셸을 사용하여 여러 사용자를 이동
<a name="sectionSection1"> </a>

1. 비즈니스용 Skype 서버 2019 관리 셸을 열 수 있습니다. 
    
2. 명령줄에 다음을 입력하고 **User1** 및 **User2를** 이동하려는 특정 사용자  이름으로 바꾸고 pool_FQDN 풀의 이름으로 대체합니다. 이 예에서는 Hao Chen과 Katie Jordan을 이동하겠습니다. 
...
4. 등록자 **풀** ID는 이제 이전 단계에서  pool_FQDN 지정한 풀을 지정합니다. ID는 이제 사용자가 이전 단계에서 pool_FQDN으로 지정한 풀을 가리킵니다.이 ID가 있으면 사용자가 성공적으로 이동된 것입니다. 단계를 반복하여 **User2가** 이동된 것을 확인할 수 있습니다. 
    
     ![PowerShell Get-UsUser -Identity cmdlet 출력](../media/Migration_LyncServer_from_LyncServer2010_showuser.jpg)
  
## <a name="to-move-all-users-at-the-same-time-by-using-the-skype-for-business-server-2019-management-shell"></a>비즈니스용 Skype 서버 2019 관리 셸을 사용하여 모든 사용자를 동시에 이동
<a name="sectionSection2"> </a>

이 예에서는 모든 사용자가 레거시 풀(pool01.contoso.net. 비즈니스용 Skype 서버 2019 관리 셸을 사용하여 모든 사용자를 동시에 비즈니스용 Skype 서버 2019 풀(pool02.contoso.net)로 이동합니다.
...
4. 각 **사용자의 등록자** 풀 ID는 이제 이전  단계에서 pool_FQDN 지정한 풀을 포인트로 지정합니다. 이 ID가 있으면 사용자가 성공적으로 이동되었음을 나타냅니다. 
    
5. 또한 비즈니스용 Skype 서버 2019 제어판에서 사용자 목록을 보고 등록자 풀 값이 이제 비즈니스용 Skype 서버 2019 풀을 포인트로 하는지 확인할 수 있습니다.
