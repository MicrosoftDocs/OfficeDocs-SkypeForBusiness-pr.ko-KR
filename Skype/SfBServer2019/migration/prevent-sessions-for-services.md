...
레거시 설치 제어판을 사용 하 여 특정 컴퓨터에서 실행 되는 모든 레거시 서비스에 대해 새 세션을 차단 하거나 특정 레거시 서비스에 대해 새 세션을 방지할 수 있습니다.
  
## <a name="to-prevent-new-sessions-for-services-on-a-computer"></a>컴퓨터에서 서비스에 대 한 새 세션을 방지 하려면

1. RTCUniversalServerAdmins 그룹의 구성원 이거나이에 해당 하는 사용자 권한이 있는 사용자 계정 또는 CsServerAdministrator 또는 CsAdministrator 역할에 할당 된 경우 비즈니스용 Skype 서버 2019을 배포한 네트워크에 있는 컴퓨터에 로그온 합니다.
    
2. 비즈니스용 Skype 제어판을 엽니다.
