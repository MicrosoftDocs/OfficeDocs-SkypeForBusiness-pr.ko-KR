...
1. [1 단계: 마이그레이션 계획](phase-1-plan-your-migration.md)
...
7. [7 단계: 마이그레이션 후 작업 완료](phase-7-complete-post-migration-tasks.md)
    
8. [8 단계: 레거시 풀 서비스 해제](phase-8-decommission-legacy-pools.md)
