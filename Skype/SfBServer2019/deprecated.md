...
SQL 2019와 함께 미러링을 배포할 비즈니스용 Skype 서버 없습니다. 고가용성 및 재해 복구를 제공하기 위한 다른 옵션은 여전히 지원됩니다. 이 중에서 선택해야 합니다. 옵션을 검토할 수 있는 내용은 [Plan for high availability and disaster recovery in 비즈니스용 Skype 서버](../SfbServer/plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md) 참조하세요.
