...
ms.collection: ''
description: 조직의 사용자 수를 비즈니스용 Skype 서버 계획을 수립하고 해당 활동이 생성하는 서버 부하를 계획할 수 있도록 조직을 계획하고 배포하는 방법을 이해합니다.
ms.openlocfilehash: 61c6fc38df65782ce7c11fbeed1c60039a06cf6a
ms.sourcegitcommit: efd56988b22189dface73c156f6f8738f273fa61
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 09/30/2021
ms.locfileid: "60011892"
---
...
|**서버 역할**|**지원되는 최대 사용자 수**|
|:-----|:-----|
|16개의 프런트 엔드 서버와 백 엔드 서버가 있는 프런트 엔드 풀 또는 고가용성을 위해 항상 SQL 있는 백 엔드 서버 쌍.   |동시에 로그인한 고유 사용자 106,000명과 모바일이 아닌 인스턴스를 나타내는 50%의 MPOP(Multiple Points of Presence) 및 총 210,000개 끝점에 대해 Mobility을 사용하도록 설정된 사용자의 40%를 제공합니다.   |
|A/V 회의   |프런트 엔드 풀에서 제공하는 A/V 회의 서비스는 최대 회의 크기가 250명인 풀의 회의를 지원하며, 한에 하나의 대규모 회의만 실행됩니다.  <br/> **참고:** 또한 대규모 회의를 호스팅하기 위해 프런트 엔드 서버가 2대인 별도의 프런트 엔드 풀을 배포하여 250~1,000명 사이의 대규모 회의를 지원할 수 있습니다. 자세한 내용은 [Plan for large meetings in 비즈니스용 Skype 서버.](../../SfbServer/plan-your-deployment/conferencing/large-meetings.md)  |
|에지 서버 1개   |동시 원격 사용자 18,000명   |
|Director 1개   |동시 원격 사용자 18,000명   |
...
|:-----|:-----|:-----|:-----|
|Intel Xeon E5-2673 v3 듀얼 프로세서, 6코어, 2.4GHz 이상(하이퍼스레딩을 사용하지 않도록 설정) **및** 64GB 메모리와 듀얼 포트 네트워크 어댑터 카드 1개   |1500   |64   |49   |
|Intel Xeon E5-2673 v3 듀얼 프로세서, 6코어, 2.4GHz 이상(64GB 메모리 및 듀얼 포트 네트워크 어댑터 카드 1개).   |2000   |88   |66   |
...
|**서버 하드웨어**|**최대 통화 수**|
|:-----|:-----|
|Intel Xeon E5-2673 v3 듀얼 프로세서, 6코어, 2.4GHz 이상(64GB 메모리 및 2GB 네트워크 어댑터 카드 사용).   |200   |
...
|하드웨어 구성 요소|권장|
|:-----|:-----|
|CPU   |Intel Xeon E5-2673 v3 듀얼 프로세서, 6코어, 2.4GHz 이상.   |
|메모리   |48GB   |
