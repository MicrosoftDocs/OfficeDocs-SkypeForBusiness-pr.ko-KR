...
# <a name="call-park-application-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 통화 공원 응용 프로그램 cmdlet
...
통화 대기 응용 프로그램을 사용 하면 사용자가 전화를 걸고 다른 전화기에서 해당 통화를 검색할 수 있습니다. 이러한 cmdlet을 사용 하 여 통화 공원 orbits 및 통화 공원 응용 프로그램에 대 한 설정을 구성할 수 있습니다.

<div>

## <a name="call-park-application-cmdlets"></a>통화 공원 응용 프로그램 Cmdlet

다음 cmdlet을 사용 하 여 통화 공원 응용 프로그램을 관리할 수 있습니다.
