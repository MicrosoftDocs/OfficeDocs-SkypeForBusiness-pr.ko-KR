...
# <a name="providing-lync-server-2013-users-voice-mail-on-hosted-exchange-um"></a>호스팅된 Exchange UM에서 Lync Server 2013 사용자 음성 메일 제공
...
이 섹션에서는 호스팅된 Exchange UM (통합 메시징) 서비스에서 음성 메일로 온-프레미스 Lync Server 2013 배포에 사용자를 제공 하는 과정을 안내 합니다.
