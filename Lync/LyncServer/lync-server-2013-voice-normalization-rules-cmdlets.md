...
---
# <a name="voice-normalization-rules-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 음성 정규화 규칙 cmdlet
...
음성 정규화 규칙은 전화 걸기 요구 사항 (예: 외부 회선에 액세스 하기 위해 9로 전화 걸기)을 Microsoft Lync Server 2013에서 사용 하는 E. 164 개의 전화 번호 형식으로 변환 하는 데 사용 됩니다.

<div>

## <a name="voice-normalization-rules-cmdlets"></a>음성 정규화 규칙 Cmdlet

다음 cmdlet를 사용하여 음성 정규화 규칙을 관리할 수 있습니다.
