...
---
# <a name="create-a-user-policy-for-persistent-chat-in-lync-server-2013"></a>Lync Server 2013의 영구 채팅에 대 한 사용자 정책 만들기
...
Lync Server 제어판 **에서는 사용자에**게 할당할 수 있는 사용자 정책을 정의 합니다.
...
5.  **새 영구적 채팅 정책**에서 다음을 수행합니다.
      ...
      - **설명**에 사용자 정책에 대 한 세부 정보를 입력 합니다 (예: 특정 사용자에 대 한 영구 채팅 정책).
    
      - 사용자 정책을 통해 제어 되지 않는 모든 사용자에 대해 영구 채팅을 제어 하려면 **영구 채팅 사용** 확인란을 선택 하거나 선택을 취소 합니다.
