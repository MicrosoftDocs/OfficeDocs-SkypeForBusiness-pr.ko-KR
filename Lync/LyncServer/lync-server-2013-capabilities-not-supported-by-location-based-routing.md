...
Location-Based 라우팅은 다음과 같은 유형의 상호 작용에 적용 되지 않습니다. Location-Based 라우팅은 이러한 기능을 사용 하 여 Lync 끝점이 PSTN 끝점과 상호 작용 하는 경우 적용 되지 않습니다.
...
다음 목록에 있는 상호 작용 유형에 Location-Based 라우팅 규칙을 적용 하려면 회의에 Location-Based 라우팅을 사용 하도록 설정 해야 합니다.
...
회의에 대 한 Location-Based 라우팅을 사용 하도록 설정 하려면 [Lync Server 2013에서 회의에 대 한 위치 기반 라우팅을](lync-server-2013-location-based-routing-for-conferencing.md)참조 하십시오.
