...
## <a name="to-modify-the-alternate-media-ip-address-of-a-trunk"></a>트렁크의 대체 미디어 IP 주소를 수정하려면
...
## <a name="to-modify-the-alternate-bypassid-of-a-trunk"></a>트렁크의 대체 바이패스 ID를 수정하려면
