...
# <a name="conferencing-policy-settings-reference-for-lync-server-2013"></a>Lync Server 2013에 대 한 회의 정책 설정 참조
...
회의 정책 설정의 최신 목록은 해당 [설정-CsClientPolicy](https://docs.microsoft.com/powershell/module/skype/Set-CsClientPolicy) cmdlet에 대 한 도움말 항목을 참조 하십시오.
