...
# <a name="enabling-and-disabling-users-for-lync-server-2013"></a>Lync Server 2013에 대 한 사용자 설정 및 해제
...
Lync Server 2013에서 Active Directory 사용자를 사용 하도록 설정 하거나, 임시로 사용 하지 않도록 설정 하거나 제거할 수 있습니다.
