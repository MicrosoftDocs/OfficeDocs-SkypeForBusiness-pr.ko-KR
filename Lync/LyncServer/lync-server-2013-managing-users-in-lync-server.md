...
# <a name="managing-users-in-lync-server-2013"></a>Lync Server 2013에서 사용자 관리
...
Lync server 2013 제어판 및 Lync Server 2013 관리 셸을 사용 하 여 Lync 서버 2013에서 사용자 계정을 관리할 수 있습니다. 이 섹션의 절차에서는 사용자 계정의 계정 정보를 확인하고 설정을 구성하는 방법을 안내합니다.
