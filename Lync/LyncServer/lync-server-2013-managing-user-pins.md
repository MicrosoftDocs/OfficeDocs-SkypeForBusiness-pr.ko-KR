...
description: 'Lync Server 2013: 사용자 Pin을 관리 합니다.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48556674"
---
# <a name="managing-user-pins-in-lync-server-2013"></a>Lync Server 2013에서 사용자 Pin 관리
...
다음 절차에 따라 Lync Server 2013 제어판의 **사용자** 섹션에서 사용자의 전화 접속 회의 pin을 관리 합니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 사용자 PIN 정보 보기](lync-server-2013-view-user-pin-information.md)
