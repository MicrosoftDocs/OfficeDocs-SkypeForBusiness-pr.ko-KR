...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 클라이언트 버전 정책 규칙 보기](lync-server-2013-view-client-version-policy-rules.md)

  - [Lync Server 2013에서 새 클라이언트 버전 정책 규칙 만들기 또는 수정](lync-server-2013-create-or-modify-a-new-client-version-policy-rule.md)

  - [Lync Server 2013에서 기존 클라이언트 버전 정책 규칙 삭제](lync-server-2013-delete-an-existing-client-version-policy-rule.md)
