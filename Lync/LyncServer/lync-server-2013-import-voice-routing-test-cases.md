...
4.  **동작** 메뉴에서 **테스트 사례 가져오기를**클릭 합니다.

5.  가져올 테스트 사례 파일 (vtest)을 찾은 다음 **열기**를 클릭 합니다.

6.  **커밋**을 클릭한 후 **모두 커밋**을 클릭합니다.
    
    <div>
    

    > [!NOTE]  
    > Vtest 파일을 가져올 때마다 <STRONG>모두 커밋</STRONG> 명령을 실행 하 여 테스트 사례를 게시 해야 합니다. 자세한 내용은 작업 설명서의 <A href="lync-server-2013-publish-pending-changes-to-the-voice-routing-configuration.md">Lync Server 2013에서 음성 라우팅 구성에 보류 중인 변경 내용 게시</A> 를 참조 하십시오.
