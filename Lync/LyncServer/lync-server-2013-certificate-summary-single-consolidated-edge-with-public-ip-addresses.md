...
# <a name="certificate-summary---single-consolidated-edge-with-public-ip-addresses-in-lync-server-2013"></a>Lync Server 2013의 인증서 요약 - 공용 IP 주소의 단일 통합 에지
...
## <a name="certificates-required-for-single-consolidated-edge-with-public-ip-addresses"></a>공용 IP 주소를 사용 하 여 통합 된 단일 Edge에 필요한 인증서
