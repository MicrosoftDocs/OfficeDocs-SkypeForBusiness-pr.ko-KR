...
새 범주를 만들려면 배포 설명서의 [Lync Server 2013에서 범주 구성을](lync-server-2013-configure-categories.md) 참조 하세요. 영구 채팅 관리자는 Lync Server 제어판 또는 Windows PowerShell cmdlet을 사용 하 여 범주를 만들 수 있습니다.
