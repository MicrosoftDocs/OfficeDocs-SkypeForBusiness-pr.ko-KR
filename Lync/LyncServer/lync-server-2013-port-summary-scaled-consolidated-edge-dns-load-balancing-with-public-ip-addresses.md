...
# <a name="port-summary---scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses-in-lync-server-2013"></a>Lync Server 2013의 포트 요약 - 조정된 통합 에지, 공용 IP 주소의 DNS 부하 분산
...
**확장 된 통합 된 Edge의 엔터프라이즈 경계 네트워크, 공용 IP 주소를 통한 DNS 로드 균형 조정**
...
### <a name="firewall-summary-for-scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses-external-interface--node-1-and-node-2-example"></a>확장 된 통합 된 가장자리, 공용 IP 주소를 사용한 DNS 부하 분산에 대 한 방화벽 요약: 외부 인터페이스-노드 1 및 노드 2 (예제)
...
### <a name="firewall-summary-for-scaled-consolidated-edge-dns-load-balancing-with-public-ip-addresses-internal-interface--node-1-and-node-2-example"></a>확장 된 통합 된 가장자리, 공용 IP 주소가 있는 DNS 로드 균형 조정에 대 한 방화벽 요약: 내부 인터페이스-노드 1 및 노드 2 (예제)
