...
> [!NOTE]  
> XMPP 게이트웨이 마이그레이션을 시작 하려면 Lync Server 2013 XMPP 게이트웨이를 배포 하 고 Lync Server 2013 XMPP 게이트웨이에 대 한 사용자를 사용 하도록 설정 하는 액세스 정책을 구성 해야 합니다. 이 단계를 수행 하기 전에 모든 사용자가 Lync Server 2013 배포로 이동 해야 합니다. 자세한 내용은 <A href="configure-xmpp-gateway-on-lync-server-2013_1.md">Lync Server 2013에서 XMPP 게이트웨이 구성을</A>참조 하세요.
