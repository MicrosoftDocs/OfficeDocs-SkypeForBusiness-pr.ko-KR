...
---
# <a name="team-calling-with-location-based-routing-in-lync-server-2013"></a>Lync Server 2013에서 Location-Based 라우팅을 사용 하 여 팀 호출
...
Lync Server 2013는 Location-Based 라우팅을 통한 팀 호출을 지원 합니다.
