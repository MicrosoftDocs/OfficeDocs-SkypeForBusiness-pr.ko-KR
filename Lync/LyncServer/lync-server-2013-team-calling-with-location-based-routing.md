...
# <a name="team-calling-with-location-based-routing-in-lync-server-2013"></a>Lync Server 2013에서 위치 기반 라우팅을 통한 팀 호출
...
Lync Server 2013는 위치 기반 라우팅을 사용 하 여 팀 통화를 지원 합니다.
