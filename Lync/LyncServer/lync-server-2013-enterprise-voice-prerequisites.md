...
# <a name="enterprise-voice-prerequisites-for-lync-server-2013"></a>Lync Server 2013에 대한 Enterprise Voice 필수 구성 요소
...
엔터프라이즈 음성을 구축할 때 최상의 환경을 위해 IT 인프라, 네트워크 및 시스템이이 섹션의 항목에서 설명 하는 전제 조건을 충족 하는지 확인 하세요.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013의 엔터프라이즈 음성에 대 한 보안 및 구성 선행 조건](lync-server-2013-security-and-configuration-prerequisites-for-enterprise-voice.md)
