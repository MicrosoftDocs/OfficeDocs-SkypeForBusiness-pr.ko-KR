...
6.  Lync Server에서 데이터베이스에 연결 하는 데 사용할 IP 주소의 경우 다음 그림과 같이 **사용 하도록** 설정 되어 있는지 확인 합니다 ****.
    ...
    ![올바른 IP에 대해 예/y e s로 설정] (images/Dn776290.7f818b91-0793-4594-8932-90447270fad9(OCS.15).jpg "올바른 IP에 대해 예/y e s로 설정")
...
9.  Sql server 구성 관리자의 왼쪽 창에서 sql server **서비스** 를 선택 하 여 sql server 인스턴스를 다시 시작 합니다. 그런 다음 오른쪽 창에서 **SQL \<Server 인스턴스\> 이름을** 마우스 오른쪽 단추로 클릭 하 고 다음 그림과 같이 **다시 시작**을 선택 합니다.
    ...
    ![인스턴스의 SQL Server 서비스를 다시 설정 합니다.] (images/Dn776290.a965c8cf-f769-4b52-bb38-c48a438cf491(OCS.15).jpg "인스턴스의 SQL Server 서비스를 다시 설정 합니다.")
...
4.  다음 그림과 같이 **별칭 이름**, **포트 번호**, **프로토콜**, **서버**를 입력 합니다.
    ...
    새 ![별칭 만들기](images/Dn776290.03653588-aecf-4fdd-b58a-95f5b372d478(OCS.15).jpg "새로운 별칭을 만듭니다") .
...
2.  **시작**을 선택 하 고 다음 그림과 같이 **서버 관리자**를 선택 합니다.
    ...
    서버 ![관리자](images/Dn776290.3e4bd8ad-2a65-4a05-af40-c8dd3583bc8f(OCS.15).jpg "열기")
...
5.  도메인을 마우스 오른쪽 단추로 클릭 하 고 다음 그림과 같이 **새 별칭 (CNAME) ...** 을 선택 합니다.
    ...
    새 별칭 cname을(images/Dn776290.abe66cca-b53c-427a-9094-1a59dc6840ca(OCS.15).jpg "만들기 위한 옵션을 선택") 하 ![는 옵션을 선택 합니다].

6.  다음 그림과 같이 **별칭 이름과** **SQL Server의 FQDN**을 입력 합니다.
    
    ![새 별칭 CNAME 대화 상자를 채웁니다.] (images/Dn776290.dd0ebd2d-3407-4459-8bd9-2b389a7bc440(OCS.15).jpg "새 별칭 CNAME 대화 상자를 채웁니다.")
...
2.  다음 그림과 같이 **netstat-a-f**를 입력 하 고 올바른 포트를 사용 하 여 SQL Server가 실행 중인지 확인 합니다.
    ...
    ![Netstat를 사용 하 여 포트를 확인 합니다.] (images/Dn776290.4ff3a1b2-c5eb-4496-8be7-374c351fa027(OCS.15).jpg "Netstat를 사용 하 여 포트를 확인 합니다.")
