...
# <a name="registrar-and-director-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 등록자 및 디렉터 cmdlet
...
등록 기관 및 디렉터는 로그온 요청을 인증 하 고 사용자 상태 및 사용 가능성에 대 한 정보를 유지 관리 하는 데 사용 됩니다. 레지스트라 및 디렉터 cmdlet을 사용 하 여 이러한 서버의 구성 설정을 관리할 수 있습니다.

<div>

## <a name="registrar-and-director-cmdlets"></a>등록자 및 디렉터 Cmdlet

다음은 등록 기관 및 디렉터 관리와 직접 관련 된 cmdlet의 목록입니다.
