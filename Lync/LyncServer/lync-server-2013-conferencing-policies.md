...
---
# <a name="conferencing-policies-in-lync-server-2013"></a>Lync Server 2013의 회의 정책
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 회의 정책 정보 보기](lync-server-2013-view-conferencing-policy-information.md)

  - [Lync Server 2013에서 회의 정책 만들기 또는 수정](lync-server-2013-create-or-modify-a-conferencing-policy.md)

  - [Lync Server 2013에서 기존 회의 정책 삭제](lync-server-2013-delete-an-existing-conferencing-policy.md)
