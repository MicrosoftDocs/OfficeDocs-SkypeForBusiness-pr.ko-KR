...
# <a name="planning-for-lync-server-2013"></a>Lync Server 2013에 대 한 계획
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 Exchange Server 통합 계획](lync-server-2013-planning-for-exchange-server-integration.md)
