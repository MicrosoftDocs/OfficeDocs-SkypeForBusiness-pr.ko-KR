...
2.  New-CsExUmContact cmdlet을 실행하여 배포에 필요한 연락처 개체를 만듭니다. 예를 들어 다음을 실행하여 AA 및 SA 연락처 개체를 만듭니다.
    ...
    이러한 예는 다음 매개 변수를 설정합니다.
      ...
      - **Nm-server-w15-short** 은 연락처 개체의 SIP 주소를 지정 합니다. Active Directory 도메인 서비스에서 사용자 또는 연락처 개체를 구성 하는 데 사용 되지 않은 주소 여야 합니다. 이 값은 앞의 예제와 같이 "sip\<:*sip 주소*\>" 형식 이어야 합니다.
