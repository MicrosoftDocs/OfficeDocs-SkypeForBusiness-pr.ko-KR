...
# <a name="create-response-group-workflows-in-lync-server-2013"></a>Lync Server 2013에서 응답 그룹 워크플로 만들기
...
응답 그룹 구성 도구를 사용 하 여 워크플로를 만듭니다. Lync Server 제어판의 응답 그룹 페이지에서 응답 그룹 구성 도구에 액세스할 수 있습니다.
