...
엔터프라이즈 음성은 서비스 품질 (QoS)에 동의 하지 않고 PSTN (공개 교환 전화 네트워크)에 전화를 거는 데 사용할 수 있는 설정을 제공 합니다. Lync Server 관리 셸에서 사용할 수 있는 cmdlet을 통해 이러한 설정을 구성할 수 있습니다.

<div>

## <a name="pstn-connectivity-cmdlets"></a>PSTN 연결 Cmdlet

다음 cmdlet을 사용 하 여 PSTN 연결의 다양 한 측면을 구성할 수 있습니다.
