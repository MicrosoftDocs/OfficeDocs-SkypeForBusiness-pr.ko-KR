...
---
# <a name="determining-your-infrastructure-requirements-for-lync-server-2013"></a>Lync Server 2013에 대 한 인프라 요구 사항 확인
...
Lync Server를 배포 하기 전에 이러한 요구 사항을 충족 하는 방법을 계획할 수 있도록 배포에 대 한 인프라 요구 사항을 파악 하 고 이해 해야 합니다.

<div>

## <a name="in-this-section"></a>이 섹션의 내용

  - [Lync Server 2013에 대 한 시스템 요구 사항 확인](lync-server-2013-determining-your-system-requirements.md)
