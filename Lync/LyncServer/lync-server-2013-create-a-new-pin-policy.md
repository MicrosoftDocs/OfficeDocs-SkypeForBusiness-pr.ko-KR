...
---
# <a name="create-a-new-pin-policy-in-lync-server-2013"></a>Lync Server 2013에서 새 PIN 정책 만들기
...
**Pin 정책** 페이지를 사용 하 여 IP 전화와 함께 Lync 2013에 연결 하는 사용자에 게 pin (개인 식별 번호) 인증을 제공할 수 있습니다. PIN 인증을 사용하려면 웹 서비스 설정에서 **PIN 인증 사용**이 선택되어 있는지 확인합니다. 자세한 내용은 [Modify 기존 웹 서비스 구성 설정에서 Lync Server 2013](lync-server-2013-modify-existing-web-service-configuration-settings.md)를 참조 하세요.
