...
---
# <a name="user-management-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 사용자 관리 cmdlet
...
<!-- end list -->
  ...
  - [Get-Csuser서비스 정책](https://docs.microsoft.com/powershell/module/skype/Get-CsUserServicesPolicy)
