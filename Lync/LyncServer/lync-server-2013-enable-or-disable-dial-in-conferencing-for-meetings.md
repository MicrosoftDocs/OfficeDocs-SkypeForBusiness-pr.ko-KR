...
# <a name="enable-or-disable-dial-in-conferencing-for-meetings-in-lync-server-2013"></a>Lync Server 2013에서 모임에 대 한 전화 접속 회의 사용 또는 사용 안 함
...
다음 절차에서는 사용자가 전화 접속을 사용 하 여 모임에 참가할 수 있도록 하는 방법을 설명 합니다.

<div>

## <a name="to-enable-or-disable-dial-in-conferencing"></a>전화 접속 회의를 사용 하거나 사용 하지 않으려면
