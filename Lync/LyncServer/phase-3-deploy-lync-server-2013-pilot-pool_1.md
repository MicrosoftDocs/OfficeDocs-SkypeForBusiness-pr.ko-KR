...
_**마지막으로 수정 된 항목:** 2012-08-28_

이 섹션에서는 Lync Server 2013의 파일럿 배포를 배포 하는 데 필요한 단계와 두 가지 풀이 동시에 공존할 수 있도록 몇 가지 주요 유효성 검사 단계에 대해 설명 합니다.

<div>

## <a name="in-this-section"></a>이 섹션의 내용

  - [Lync Server 2013에 대 한 Active Directory 준비](prepare-active-directory-for-lync-server-2013.md)
  ...
  - [레거시 풀과 파일럿 풀 공존 성 확인](verify-pilot-pool-coexistence-with-legacy-pool_1.md)
