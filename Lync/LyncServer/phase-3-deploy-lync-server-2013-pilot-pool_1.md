...
_**마지막으로 수정한 주제:** 2012-08-28_

이 섹션에서는 Lync Server 2013의 파일럿 배포를 배포 하는 데 필요한 단계와 두 개의 풀을 공존할 수 있도록 몇 가지 주요 유효성 검사 단계에 대해 설명 합니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [레거시 풀로 파일럿 풀 동시 사용 확인](verify-pilot-pool-coexistence-with-legacy-pool_1.md)
