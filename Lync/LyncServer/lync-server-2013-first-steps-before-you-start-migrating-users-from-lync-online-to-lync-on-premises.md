...
Lync Online 사용자를 온-프레미스 환경으로 이동 하기 전에 다음 사항을 모두 충족 하는지 확인 합니다.
  ...
  - Lync Online 테 넌 트가 원격 PowerShell 액세스를 사용 하도록 구성 되어 있어야 합니다.
    ...
    이 작업을 수행 하려면 먼저 다음에 액세스할 수 있는 Windows PowerShell 용 Lync Online 모듈을 설치 [http://go.microsoft.com/fwlink/p/?LinkId=391911](http://go.microsoft.com/fwlink/p/?linkid=391911)합니다.
