...
# <a name="managing-call-management-features-in-lync-server-2013"></a>Lync Server 2013의 통화 관리 기능 관리
...
_**마지막으로 수정 된 항목:** 2012-12-18_

Enterprise Voice 통화 관리 기능은 수신 전화를 라우팅하고 받는 방법을 제어합니다. Lync Server 2013에서는 다음과 같은 통화 관리 기능을 제공 합니다.

  - **통화 대기:** 음성 사용자가 통화를 일시적으로 대기 했다가 같은 전화나 다른 전화기에서 선택할 수 있습니다.

  - **그룹 픽업:** 사용자가 통화 픽업 그룹 번호를 사용 하 여 다른 사용자에 게 신호음 울림 통화를 선택할 수 있습니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 할당 되지 않은 번호에 대 한 통화 관리](lync-server-2013-managing-calls-to-unassigned-numbers.md)
