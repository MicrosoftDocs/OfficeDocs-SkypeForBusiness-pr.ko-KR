...
# <a name="services-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 서비스 cmdlet
...
Microsoft Lync Server 2013와 함께 제공 되는 서버 역할 및 서비스 cmdlet을 사용 하면 Lync Server 2013 배포의 일부로 설치 된 다양 한 구성 요소에 대 한 정보를 반환할 수 있습니다. 또한 이러한 cmdlet을 통해 Lync Server 서비스를 보다 쉽게 중지 하 고 시작할 수 있습니다.

<div>

## <a name="services-cmdlets"></a>서비스 Cmdlet
