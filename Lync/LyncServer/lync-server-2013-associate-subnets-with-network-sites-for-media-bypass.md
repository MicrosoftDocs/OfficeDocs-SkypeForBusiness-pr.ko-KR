...
미디어 바이패스에서 서브넷을 네트워크 사이트에 연결하기 위한 특수한 요구 사항은 없습니다. 토폴로지의 서브넷과 네트워크 사이트 간의 연결을 만들려면 [Lync Server 2013에서 서브넷과 네트워크 사이트를 연결](lync-server-2013-associate-a-subnet-with-a-network-site.md)하는 절차를 수행 합니다.
...
대역폭 정책 프로필을 구성 하는 절차는 [Lync Server 2013에서 대역폭 정책 프로필 만들기](lync-server-2013-create-bandwidth-policy-profiles.md)를 참조 하십시오.
