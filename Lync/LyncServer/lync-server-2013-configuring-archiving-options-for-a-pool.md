...
---
# <a name="configuring-archiving-options-for-a-pool-in-lync-server-2013"></a>Lync Server 2013의 풀에 대 한 보관 옵션 구성
...
> [!NOTE]  
> 보관을 사용하도록 설정하기 전에 보관 구성에서 모든 해당 옵션을 지정해야 합니다. 자세한 내용은 배포 설명서에서 <A href="lync-server-2013-configuring-archiving-options.md">Lync Server 2013의 보관 옵션 구성을</A> 참조 하십시오.
...
## <a name="to-configure-archiving-options-at-the-pool-level"></a>풀 수준에서 보관 옵션을 구성하려면
