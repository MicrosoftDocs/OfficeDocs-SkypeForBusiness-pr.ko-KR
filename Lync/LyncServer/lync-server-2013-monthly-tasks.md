...
description: 'Lync Server 2013: 월별 작업입니다.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48548054"
---
# <a name="monthly-tasks-in-lync-server-2013"></a>Lync Server 2013의 월별 작업
...
다음 작업은 매달 수행 해야 합니다.
  ...
  - [Lync Server 2013에서 음성 규칙, 경로 및 정책 테스트](lync-server-2013-test-voice-rules-routes-and-policies.md)

  - [Lync Server 2013에서 웹 앱 액세스 테스트](lync-server-2013-test-web-app-access.md)

  - [Lync Server 2013에서 익명 웹 앱 액세스 테스트](lync-server-2013-test-anonymous-web-app-access.md)

  - [Lync Server 2013에서 모바일 사용자 액세스 테스트](lync-server-2013-test-mobile-user-access.md)
  ...
  - [Lync Server 2013의 용량 검토](lync-server-2013-capacity-review.md)

  - [Lync Server 2013의 재해 복구 테스트](lync-server-2013-disaster-recovery-test.md)
