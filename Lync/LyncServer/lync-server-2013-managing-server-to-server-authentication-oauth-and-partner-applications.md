...
Lync Server 2013에서는 세 가지 서버 간 인증 시나리오를 지원 합니다. Lync Server 2013를 사용 하 여 다음을 수행할 수 있습니다.
  ...
  - Microsoft Exchange 및 Microsoft Lync Server 간, 또는 Microsoft Lync Server와 Microsoft SharePoint 간에 서버 간 365 인증을 구성 합니다.

  - 크로스-프레미스 환경 (즉, 온-프레미스 서버와 Microsoft 365 구성 요소 간의 서버 간 인증)에서 서버 간 인증을 구성 합니다.
...
Microsoft 365 버전의 Lync Server가 해당 Exchange와 통신 하려면 먼저 Lync Server 2013에서 인증 서버 로부터 보안 토큰을 받아야 합니다. 그러면 Lync Server는이 보안 토큰을 사용 하 여 Exchange에 자신을 식별 합니다. Lync Server 2013와 통신 하려면 Microsoft 365 버전의 Exchange에서 동일한 프로세스를 거쳐야 합니다.
