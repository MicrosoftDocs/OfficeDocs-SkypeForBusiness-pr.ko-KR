...
---
# <a name="planning-for-extensible-messaging-and-presence-protocol-xmpp-federation-in-lync-server-2013"></a>Lync Server 2013의 XMPP (extensible messaging and 거점 protocol) 페더레이션 계획
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013의 인증서 요약-XMPP (Extensible messaging and 현재 상태 프로토콜) 페더레이션](lync-server-2013-certificate-summary-extensible-messaging-and-presence-protocol-xmpp-federation.md)

  - [포트 요약-Lync Server 2013의 XMPP (확장 가능한 메시징 및 현재 상태 프로토콜) 페더레이션](lync-server-2013-port-summary-extensible-messaging-and-presence-protocol-xmpp-federation.md)

  - [Lync Server 2013의 DNS 요약-XMPP (확장 가능한 메시징 및 현재 상태 프로토콜) 페더레이션](lync-server-2013-dns-summary-extensible-messaging-and-presence-protocol-xmpp-federation.md)
