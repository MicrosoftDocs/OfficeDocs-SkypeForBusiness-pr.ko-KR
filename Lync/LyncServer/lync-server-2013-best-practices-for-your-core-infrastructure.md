...
Lync Server 2013 배포의 서버가 가동 중지 시간을 일으킬 수 있는 우발적 이거나 고의적 피해 로부터 보호 하려면 다음과 같은 예방 조치를 취해야 합니다.
  ...
  - 보안 업데이트를 사용하여 서버를 최신 상태로 유지합니다. Microsoft Security Notification Service를 구독하면 Microsoft 제품의 보안 게시판 릴리스에 대한 알림을 즉각적으로 받을 수 있습니다. 구독 하려면에서 Microsoft 기술 보안 알림 웹 사이트로 이동 [https://go.microsoft.com/fwlink/p/?LinkId=145202](https://go.microsoft.com/fwlink/p/?linkid=145202) 합니다.
