...
# <a name="setting-up-edge-servers-in-lync-server-2013"></a>Lync Server 2013에서 에지 서버 설정
...
Edge 서버를 설정 하는 데 필요한 기본 작업은 하드웨어 부하 분산 된 Edge 서버의 풀에 부하 분산 장치 배포와 추가 단계가 필요 하다는 점을 제외 하 고 단일 Edge 서버 또는 부하 분산 된 Edge 서버를 설치 하는 것과 동일 합니다. 여러 Edge 서버에서 설정 복제
