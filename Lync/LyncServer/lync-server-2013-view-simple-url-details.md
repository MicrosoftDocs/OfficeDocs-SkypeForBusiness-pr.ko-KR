...
# <a name="view-simple-url-details-in-lync-server-2013"></a>Lync Server 2013에서 간단한 URL 세부 정보 보기
...
Lync Server 2013 제어판을 사용 하 여 Lync Server 2013 환경에 대 한 간단한 URL 세부 정보를 볼 수 있습니다. 간단한 Url을 통해 사용자가 모임에 쉽게 참가할 수 있으며 관리자가 관리 도구를 쉽게 사용할 수 있습니다. 자세한 내용은 [Lync Server 2013의 간단한 Url 계획](lync-server-2013-planning-for-simple-urls.md)을 참조 하세요.

<div>

## <a name="to-view-simple-url-details"></a>간단한 URL 세부 정보를 보려면
...
3.  왼쪽 탐색 모음에서 **토폴로지** 를 클릭 한 다음 **간단한 URL**을 클릭 합니다.

4.  **간단한 URL** 페이지에서 필요한 경우 열 머리글을 클릭 하 여 목록을 정렬 합니다.

5.  간단한 URL 세부 정보를 보려는 이름을 선택한 다음 **속성**을 클릭 합니다.

6.  세부 정보 보기를 마쳤으면 **닫기를**클릭 합니다.
