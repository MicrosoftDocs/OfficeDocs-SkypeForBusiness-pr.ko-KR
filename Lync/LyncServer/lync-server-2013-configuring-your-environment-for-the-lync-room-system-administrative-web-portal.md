...
4.  이름 LRSFullAccessAdminGroup를 사용 하 여 Active Directory 보안 그룹을 만듭니다.
    ...
    (images/Dn436325.5d432819-a2e2-452c-bc2a-5d4ee79d8c33(OCS.15).png "보안 그룹 역할이 있는 관리자 그룹의") ![보안 그룹 역할 목록이 있는 관리자 그룹 목록]  
    
     

5.  LRSFullAccessAdminGroup를 LRSSupportAdminGroup의 구성원으로 추가 합니다.
    
    ![LRSSupportAdminGroup 속성 멤버 페이지](images/Dn436325.91a4a28a-cacf-4ef6-aac1-915ec41c9648(OCS.15).png "LRSSupportAdminGroup 속성 멤버 페이지")  
    
     

6.  이름 LRSSupport를 사용 하 여 SIP 활성화 된 Active Directory 사용자를 만듭니다. 이 사용자를 LRSSupportAdminGroup에 추가 합니다.
    
    ![LRSSupportAdminGroup 속성 멤버 페이지](images/Dn436325.7638055d-22ac-4909-914d-1966f5623909(OCS.15).png "LRSSupportAdminGroup 속성 멤버 페이지")  
