...
통화 대기 응용 프로그램을 배포 하는 모든 프런트 엔드 서버 및 Standard Edition 서버에는 windows Server 2008 R2를 실행 하는 서버 또는 Windows server 2012 또는 Windows Server 2012 r 2를 실행 하는 서버에 대 한 Microsoft Media Foundation이 설치 되어 있어야 합니다. Windows Server 2008 R2의 경우 windows Media 형식 런타임이 Windows 데스크톱 환경의 일부로 설치 됩니다. Windows Media 형식 런타임 또는 Microsoft Media Foundation은 통화가 대기 하는 음악을 재생 하는 Windows media 오디오 (.wma) 파일에 필요 합니다.
