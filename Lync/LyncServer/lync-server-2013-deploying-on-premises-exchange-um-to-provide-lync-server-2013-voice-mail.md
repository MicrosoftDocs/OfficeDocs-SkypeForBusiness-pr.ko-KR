...
# <a name="deploying-on-premises-exchange-um-to-provide-lync-server-2013-voice-mail"></a>Lync Server 2013 음성 메일을 제공하도록 온-프레미스 Exchange UM 배포
...
조직에 Microsoft Exchange Server를 배포 하거나 배포 하려는 경우 Exchange UM (통합 메시징) 기능을 사용 하 여 엔터프라이즈 음성 사용자에 게 음성 메일을 제공할 수 있습니다.
