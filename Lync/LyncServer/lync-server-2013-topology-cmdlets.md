...
# <a name="topology-cmdlets-jn-lync-server-2013"></a>토폴로지 cmdlet jn Lync Server 2013
...
Microsoft Lync Server 2013에 포함 된 대부분의 토폴로지 cmdlet은 설치 및 토폴로지 작성기에서 사용 하도록 디자인 되었습니다. 따라서 관리자가 직접 호출 하는 데는 많은 토폴로지 cmdlet이 있습니다. 그러나 관리자가 이러한 cmdlet을 사용 해야 하는 경우도 있습니다. 예를 들어 새 Kerberos 계정을 만든 후에는 [Enable-CsTopology](https://technet.microsoft.com/en-us/library/Gg398398(v=OCS.15)) cmdlet을 실행 하 여 변경 내용이 적용 되도록 해야 합니다. 또한 관리자는 [CsTopology](https://technet.microsoft.com/en-us/library/Gg398127(v=OCS.15)) 및 [테스트-cscomputer](https://technet.microsoft.com/en-us/library/Gg398162(v=OCS.15)) 와 같은 cmdlet을 실행 하 여 Lync Server 2013가 올바르게 설치 되었고 예상 대로 작동 하는지 확인할 수 있습니다.

<div>

## <a name="topology-cmdlets"></a>토폴로지 Cmdlet

다음은 Lync 서버 토폴로지를 직접 관리 하는 cmdlet 목록입니다.
