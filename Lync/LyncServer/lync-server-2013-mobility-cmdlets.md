...
description: 'Lync Server 2013: 모바일 기능 cmdlet'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48565914"
---
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 모바일 기능 cmdlet
...
Mobility cmdlet은 Lync Server 2010 용 누적 업데이트에서 추가 된 모바일 기능을 관리 하기 위해 도입 되었습니다 2011. 이러한 cmdlet을 사용하여 Mobility Service 구성 및 사용자 정책과 같은 모바일 기능의 설정을 관리할 수 있습니다.

<div>

## <a name="mobility-cmdlets"></a>모바일 기능 cmdlet

모바일 기능을 구성 하는 cmdlet을 사용 하면 Lync Server 관리 셸에서 명령을 실행 하거나 여러 이동성 설정을 구성 및 테스트 하기 위해 스크립트를 작성할 수 있습니다.
