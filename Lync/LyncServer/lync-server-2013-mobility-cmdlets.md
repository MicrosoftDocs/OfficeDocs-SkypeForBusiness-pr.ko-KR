...
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 모바일 cmdlet
...
모바일 cmdlet은 Lync Server 2010의 누적 업데이트에 추가 된 이동성 기능을 관리 하기 위해 도입 되었습니다 (2011 년 11 월). 이러한 cmdlet을 사용 하 여 모바일 서비스 구성 및 사용자 정책 등의 이동성 기능에 대 한 설정을 관리할 수 있습니다.

<div>

## <a name="mobility-cmdlets"></a>Mobility Cmdlet

이동성 기능을 구성 하는 cmdlet을 사용 하면 Lync Server 관리 셸에서 명령을 실행 하거나, 스크립트를 작성 하 여 다양 한 이동성 설정을 구성 하 고 테스트할 수 있습니다.
