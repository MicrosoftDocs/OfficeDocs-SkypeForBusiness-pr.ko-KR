...
# <a name="tblsystemrevision-in-lync-server-2013"></a>Lync Server 2013의 tblSystemRevision
...
tblSystemRevision 여러 관리자 클라이언트 간에 일관성을 얻기 위해 Tblsystemrevision 테이블에 사용 되는 수정 번호를 포함 합니다.
