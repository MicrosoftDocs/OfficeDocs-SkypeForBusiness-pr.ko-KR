...
description: Lync Server 2013:에 지 서버를 시작 합니다.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48541884"
---
# <a name="start-edge-servers-in-lync-server-2013"></a>Lync Server 2013에서에 지 서버 시작
...
## <a name="to-start-the-services"></a>서비스를 시작하려면
