...
Lync Server 2013, 영구 채팅 서버 서비스는 장애 복구용으로 *스트레치 된 풀* 구성을 사용 합니다. 스트레치 된 풀은 두 개의 실제 데이터 센터로 분산 되지만 단일 논리적 Lync 서버 사이트 내에 있는 컴퓨터가 있는 풀입니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 기본 미러와 로그 전달 보조 데이터베이스 간의 SQL Server 로그 전달 설정](lync-server-2013-set-up-log-shipping-secondary-database.md)
