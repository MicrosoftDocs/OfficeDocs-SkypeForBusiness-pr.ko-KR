...
---
# <a name="phase-3-deploy-lync-server-2013-pilot-pool"></a>3 단계: Lync Server 2013 파일럿 풀 배포
...
이 섹션에서는 Lync Server 2013의 파일럿 풀을 배포 하는 데 필요한 단계에 대해 설명 합니다. Lync Server 2013의 배포를 위해서는 토폴로지 작성기를 사용 하 여 배포 하려는 토폴로지 및 구성 요소를 정의 하 고, Lync Server 2013 구성 요소를 배포 하기 위한 환경을 준비 하 고, 첫 번째 프런트 엔드 서버에 토폴로지 디자인을 게시 한 다음, 배포 구성 요소에 대해 Lync Server 2013 소프트웨어를 설치 및 구성 해야 합니다. 완료 되 면 Lync Server 2013 파일럿 풀 배포가 기존 Lync Server 2010 풀과 함께 사용 됩니다.
