...
# <a name="deploying-call-management-features-in-lync-server-2013"></a>Lync Server 2013에서 통화 관리 기능 배포
...
기업 음성 통화 관리 기능은 수신 전화를 라우팅하거나 응답 하는 방법을 제어 합니다. Lync Server 2013는 다음과 같은 통화 관리 기능을 제공 합니다.
  ...
  - **그룹 픽업:** 사용자가 통화 픽업 그룹 번호로 전화를 걸어 픽업 그룹에 할당 된 다른 사용자의 통화에 대 한 응답을 받을 수 있도록 합니다.
