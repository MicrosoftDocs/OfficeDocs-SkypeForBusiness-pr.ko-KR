...
보관을 위한 시스템 플랫폼과 인프라를 설정한 후에는 토폴로지 작성기를 사용 하 여 토폴로지에 보관을 추가한 다음 토폴로지를 게시 해야 합니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 보관 데이터베이스를 추가 하도록 업데이트 된 토폴로지 게시](lync-server-2013-publishing-the-updated-topology-to-add-archiving-databases.md)
