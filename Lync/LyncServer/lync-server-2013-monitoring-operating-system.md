...
이러한 관리 팩은 중요 한 이벤트 및 성능 지표에 대 한 검색, 경고 및 자동 응답을 통해 문제 해결 시간을 줄이고 Windows Server 운영 체제를 실행 하는 시스템의 전반적인 가용성과 성능을 향상 시킵니다.
...
Windows 안정성 및 성능 모니터는 성능 로그 및 경고, 시스템 모니터 및 서버 성능 관리자와 같은 이전의 독립 실행형 도구를 함께 사용 하는 경우에도 다음과 같은 Windows Server 2008 및 Windows Server 2008 R2의 몇 가지 새로운 기능을 제공 합니다.
