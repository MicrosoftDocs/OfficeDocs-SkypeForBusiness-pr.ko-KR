...
# <a name="remove-a-message"></a><span data-ttu-id="af1bc-102">메시지 제거</span><span class="sxs-lookup"><span data-stu-id="af1bc-102">Remove a message</span></span>
...
<span data-ttu-id="af1bc-103">_**마지막으로 수정 된 항목:** 2012-04-04_</span><span class="sxs-lookup"><span data-stu-id="af1bc-103">_**Topic Last Modified:** 2012-04-04_</span></span>

<span data-ttu-id="af1bc-104">메시지를 제거하려면</span><span class="sxs-lookup"><span data-stu-id="af1bc-104">To remove a message</span></span>
