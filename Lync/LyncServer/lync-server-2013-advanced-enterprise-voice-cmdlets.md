...
description: 'Lync Server 2013: 고급 Enterprise Voice cmdlet'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561944"
---
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013의 고급 Enterprise Voice cmdlet
...
조직에서 Enterprise Voice를 구현 하는 경우 사용자 환경 및 조직의 효율성을 향상 시킬 수 있는 추가 기능 및 응용 프로그램을 구현 하는 옵션도 제공 됩니다. 이러한 기능에는 통화 허용 제어, 향상 된 9-1-1 (E9-1-1) 긴급 통화 및 미디어 구성 설정이 포함 됩니다.

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>고급 Enterprise Voice Cmdlet

다음 목록에는 Enterprise Voice 배포의 고급 기능을 관리 하는 데 사용할 수 있는 cmdlet이 포함 되어 있습니다.
