...
description: 'Lync Server 2013: 온라인 모임 추가 기능 사용자 지정'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561104"
---
# <a name="customizing-the-online-meeting-add-in-in-lync-server-2013"></a>Lync Server 2013에서 온라인 모임 추가 기능 사용자 지정
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 Outlook 사용 목록 업데이트](lync-server-2013-updating-the-outlook-enable-list.md)
