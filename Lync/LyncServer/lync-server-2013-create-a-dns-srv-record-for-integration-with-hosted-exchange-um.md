...
9.  **이 서비스를 제공**하는 호스트를 클릭 한 다음 신뢰할 수 있는 외부 클라이언트에 대해 lync server 2013 시스템에 대 한 액세스를 제공 하는 lync server 2013에 지 풀의 FQDN (정규화 된 도메인 이름)을 입력 합니다.
    ...
    > [!NOTE]
    > 이 도메인은 Exchange Online 설정에서 허용되는 신뢰할 수 있는 도메인으로도 설정되어야 합니다. 자세한 내용은 허용 도메인 만들기를 참조 하십시오 <A href="http://go.microsoft.com/fwlink/p/?linkid=229762">http://go.microsoft.com/fwlink/p/?linkId=229762</A>.
