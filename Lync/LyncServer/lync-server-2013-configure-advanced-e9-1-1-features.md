...
# <a name="configure-advanced-e9-1-1-features-in-lync-server-2013"></a>Lync Server 2013에서 고급 E9-1-1 기능 구성
...
Lync Server 2013에는 E9 배포를 사용자 지정 하는 데 사용할 수 있는 다음과 같은 기능이 포함 되어 있습니다.

  - SNMP 응용 프로그램에 위치 정보 서버를 연결 하는 웹 서비스 인터페이스.

  - 보조 위치 원본 데이터베이스에 연결 하는 웹 서비스 인터페이스
