...
# <a name="msmqprocessing-table-in-lync-server-2013"></a>Lync Server 2013의 MSMQProcessing 테이블
...
MSMQProcessing 테이블은 내부용 으로만 사용 됩니다. 이 표는 Microsoft Lync Server 2013에서 도입 되었습니다.
