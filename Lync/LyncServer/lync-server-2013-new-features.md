...
Lync Server 2013에는 기존 기능에 대 한 주요 향상 기능을 비롯 하 여 여러 가지 새로운 기능이 도입 되었습니다. 이 섹션에서는 이러한 새로운 기능과 향상 된 기능에 대해 간략하게 소개 합니다.

Lync Server 2013의 새로운 기능에 대 한 논의는이 섹션의 항목 들 간에 그룹화 되어 있습니다.
