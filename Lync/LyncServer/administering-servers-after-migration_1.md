...
일반적으로 관리 하려는 서버 버전에 해당 하는 관리 도구를 사용 해야 합니다. Lync Server 2013 및 Office Communications Server 2007 R2 관리 도구는 같은 컴퓨터에 설치할 수 없습니다. 또한 Lync Server 2013 제어판은 각 서버에 자동으로 설치 되지 않습니다. Lync Server 2013 제어판을 설치 하려면 배포 설명서의 [Lync server 2013 관리 도구 설치](lync-server-2013-install-lync-server-administrative-tools.md) 항목에 있는 절차를 따릅니다.
