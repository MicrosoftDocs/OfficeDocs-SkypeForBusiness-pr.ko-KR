...
> [!TIP]  
> 샘플 스크립트를 포함 하 여 Lync Server 관리 셸을 사용 하 여 응답 그룹을 만드는 방법에 대 한 자세한 내용은에서 <A href="https://go.microsoft.com/fwlink/p/?linkid=204108">https://go.microsoft.com/fwlink/p/?linkId=204108</A>"Lync Server 관리 셸을 사용 하 여 첫 번째 응답 그룹 만들기"를 참조 하세요.
