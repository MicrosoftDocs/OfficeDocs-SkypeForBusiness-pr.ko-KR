...
---
# <a name="client-system-requirements-for-lync-server-2013"></a>Lync Server 2013에 대 한 클라이언트 시스템 요구 사항
...
_**마지막으로 수정 된 항목:** 2012-11-06_

이 섹션에서는 Lync 2013 클라이언트의 하드웨어 및 소프트웨어 요구 사항에 대해 설명 합니다.
