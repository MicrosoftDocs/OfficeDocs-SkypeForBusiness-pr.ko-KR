...
# <a name="lync-server-2013-best-practices-analyzer"></a>Lync Server 2013 모범 사례 분석기
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013의 모범 사례 분석기 개요](lync-server-2013-overview-of-best-practices-analyzer.md)
