...
이 cmdlet을 실행할 수 있는 사람은 누구 인가요? 기본적으로 다음 그룹의 구성원은 Get-CsManagementStoreReplicationStatus cmdlet을 로컬로 실행할 권한이 있습니다 (RTCUniversalUserAdmins, RTCUniversalServerAdmins).
