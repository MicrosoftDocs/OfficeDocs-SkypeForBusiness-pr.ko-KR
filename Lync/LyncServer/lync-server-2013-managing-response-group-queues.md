...
description: 'Lync Server 2013: 응답 그룹 큐 관리'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
큐는 에이전트가 통화에 응답할 때까지 응답 그룹에 통화를 대기 시킵니다. 큐를 관리할 때는 큐에 하나 이상의 에이전트 그룹을 할당 하 고, 오버플로 작업을 수행 하기 전에 큐에서 보유할 수 있는 통화 수 및 시간 초과 작업을 수행 하기 전에 에이전트에서 대기 하는 시간을 지정 하는 큐 설정을 지정할 수 있습니다. 응답 그룹 응용 프로그램이 사용 가능한 에이전트를 검색할 때 목록에 나열 된 순서 대로 에이전트 그룹을 검색 합니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 응답 그룹 큐 삭제](lync-server-2013-delete-a-response-group-queue.md)
