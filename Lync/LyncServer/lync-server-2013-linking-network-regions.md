...
# <a name="linking-network-regions-in-lync-server-2013"></a>Lync Server 2013에서 네트워크 지역 연결
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 네트워크 지역 링크 정보 보기](lync-server-2013-viewing-network-region-link-information.md)
