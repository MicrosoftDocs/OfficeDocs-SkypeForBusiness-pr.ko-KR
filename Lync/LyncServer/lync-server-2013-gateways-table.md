...
# <a name="gateways-table-in-lync-server-2013"></a>Lync Server 2013의 게이트웨이 테이블
...
_**마지막으로 수정 된 항목:** 2010-11-05_

게이트웨이 테이블이 지원 테이블입니다. 각 레코드는 데이터베이스의 레코드를 포함 하는 공중 전화망 (PSTN) 통화와 관련 된 하나의 게이트웨이에 대 한 정보를 저장 합니다.
...
<td><p>int</p></td>
<td><p>Primary</p></td>
<td><p>이 게이트웨이를 식별 하는 고유 번호입니다.</p></td>
</tr>
<tr class="even">
