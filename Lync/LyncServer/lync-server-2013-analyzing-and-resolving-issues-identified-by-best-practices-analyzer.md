...
---
# <a name="analyzing-and-resolving-issues-identified-by-best-practices-analyzer-in-lync-server-2013"></a>Lync Server 2013의 모범 사례 분석기에서 식별 한 문제 분석 및 해결
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013의 환경 테스트 관련 문제](lync-server-2013-issues-with-the-environment-test.md)

  - [Lync Server 2013의 토폴로지 테스트 관련 문제](lync-server-2013-issues-with-the-topology-test.md)
