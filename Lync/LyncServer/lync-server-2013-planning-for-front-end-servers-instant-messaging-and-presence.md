...
# <a name="planning-for-front-end-servers-instant-messaging-and-presence-in-lync-server-2013"></a>Lync Server 2013의 프런트 엔드 서버, 메신저 및 현재 상태 계획
...
프런트 엔드 서버는 Lync Server의 기능을 많이 제공 하며 모든 Lync Server 배포에 포함 됩니다. 인스턴트 메시지 (IM) 및 현재 상태는 Lync Server의 핵심 기능이 며 모든 Lync Server 설치에서 자동으로 배포 되 고 사용 하도록 설정 됩니다. 다음 섹션에서는 프런트 엔드 서버, 메신저 대화 및 현재 상태에 대 한 자세한 정보를 제공 합니다.
