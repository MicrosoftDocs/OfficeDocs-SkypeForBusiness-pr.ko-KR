...
기존 다이얼 플랜에 대 한 정보를 보려면 다음 절차의 단계를 수행 합니다. 새 다이얼 플랜을 만들려는 경우 [Lync Server 2013에서 다이얼 플랜 만들기](lync-server-2013-create-a-dial-plan.md)를 참조 하세요.
...
4.  **다이얼 플랜** 페이지에서 다이얼 플랜 이름을 두 번 클릭 합니다.
    ...
    > [!NOTE]  
    > 한 번에 하나의 다이얼 플랜에 대 한 정보를 볼 수 있습니다.
