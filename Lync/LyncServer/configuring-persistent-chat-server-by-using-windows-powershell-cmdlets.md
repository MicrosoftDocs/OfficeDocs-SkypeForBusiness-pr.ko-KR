...
# <a name="configuring-persistent-chat-server-by-using-windows-powershell-cmdlets"></a>Windows PowerShell cmdlet으로 영구 채팅 서버 구성
...
다음 Windows PowerShell cmdlet을 사용 하 여 Lync Server 2013, 영구 채팅 서버 내에서 관리를 구성 합니다.
