...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013의 모범 사례 분석기에 대 한 그룹 구성원 자격 및 사용자 권한 요구 사항](lync-server-2013-group-memberships-and-user-rights-requirements-for-best-practices-analyzer.md)

  - [Lync Server 2013에서 모범 사례 분석기를 실행 하기 위한 요구 사항](lync-server-2013-requirements-for-running-best-practices-analyzer.md)
