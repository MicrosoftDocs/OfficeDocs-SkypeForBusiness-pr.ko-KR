...
description: 'Lync Server 2013: 외부 사용자 액세스 정책 다시 설정 또는 삭제'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
---
# <a name="resetting-or-deleting-external-user-access-policies-in-lync-server-2013"></a>Lync Server 2013에서 외부 사용자 액세스 정책 다시 설정 또는 삭제
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 외부 사용자 액세스에 대 한 사이트 또는 사용자 정책 삭제](lync-server-2013-delete-a-site-or-user-policy-for-external-user-access.md)

  - [Lync Server 2013에서 외부 사용자 액세스에 대 한 전역 정책 다시 설정](lync-server-2013-reset-the-global-policy-for-external-user-access.md)
