...
# <a name="managing-high-availability-and-disaster-recovery-in-lync-server-2013"></a>Lync Server 2013에서 고가용성 및 재해 복구 관리
...
다음 항목에서는 영구 채팅 서버에 대 한 고가용성, 재해 복구, 장애 조치 (failover) 및 장애 조치 (failover)를 구성 하는 방법을 설명 합니다.
