...
Microsoft Lync Server 2013는 Exchange UM (통합 메시징)과 함께 작동 하 여 호스트 된 음성 메일에 대 한 자동 전화 교환 및 구독자 액세스를 구현 합니다. 이러한 기능은 Lync Server 관리 셸에서 cmdlet을 통해 관리할 수 있습니다.
