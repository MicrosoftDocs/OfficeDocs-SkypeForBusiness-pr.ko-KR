...
고가용성 Enterprise Voice 서비스에 대해 분기 사이트 복구를 제공 하려는 경우 다음 세 가지 옵션을 사용할 수 있습니다.

  - Survivable Branch Appliance

  - Sba (survivable 분기 서버

  - 분기 사이트의 전체 Lync Server 배포
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에 대 한 분기 사이트 복구 요구 사항](lync-server-2013-branch-site-resiliency-requirements.md)
