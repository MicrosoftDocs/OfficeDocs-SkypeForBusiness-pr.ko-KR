...
description: 'Lync Server 2013: 클라이언트 버전 구성 설정'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48574664"
---
# <a name="client-version-configuration-settings-in-lync-server-2013"></a>Lync Server 2013의 클라이언트 버전 구성 설정
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 클라이언트 버전 구성 설정의 기존 컬렉션 삭제](lync-server-2013-delete-an-existing-collection-of-client-version-configuration-settings.md)
