...
매주 IIS (인터넷 정보 서비스) 로그 및 성능에 대 한 검토를 수행 합니다. IIS 로그 및 성능을 모니터링 하는 방법에 대 한 자세한 내용은 [Windows Server 2003 IIS (인터넷 정보 서비스) 이벤트 로깅 개요](https://go.microsoft.com/fwlink/?linkid=36077)를 참조 하세요. 검토에는 다음이 포함 되어야 합니다.
...
이 도구에 대 한 설명서는 [Lync Server 2013 Resource Kit Tools 설명서](https://go.microsoft.com/fwlink/?linkid=623245)에서 제공 됩니다.
