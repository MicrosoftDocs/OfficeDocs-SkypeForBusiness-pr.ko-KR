...
_**마지막으로 수정한 주제:** 2016-04-12_

Microsoft Lync Server 2013에는 관리자가 명령줄에서 Lync Server 2013을 관리할 수 있는 700 cmdlet이 제공 됩니다. Lync 서버 cmdlet은 일반적으로 Lync Server 관리 셸에서 사용 됩니다. Lync server 관리 셸을 사용 하는 한 가지 방법은 Lync Server 서비스 또는 서버 역할을 실행 하는 컴퓨터에 로그온 하 고, **시작**, **모든 프로그램**, **Microsoft lync server 2013**을 차례로 클릭 한 다음 **Lync server Management shell**을 클릭 하는 것입니다. 관리 셸이 열려 있는 후 다음과 같은 명령을 입력 하 여 명령줄에서 직접 cmdlet에 대 한 도움말을 검색할 수 있습니다.
...
Lync Server 관리에 사용할 수 있는 전체 cmdlet 목록을 검색 하려면 Lync Server Management Shell 명령 프롬프트에서 다음을 입력 합니다.

    Get-Command * -Module Lync -CommandType cmdlet

Lync Server 관리 셸을 사용 하는 방법에 대 한 자세한 내용은의 [http://go.microsoft.com/fwlink/p/?linkId=203150](http://go.microsoft.com/fwlink/p/?linkid=203150)Lync Server Windows PowerShell 블로그를 참조 하세요.

<div>

## <a name="lync-server-2013-cmdlets"></a>Lync Server 2013 Cmdlet

다음은 Lync Server 2013와 함께 제공 되는 cmdlet의 목록입니다.

  - [추가-CsSlaDelegates](https://technet.microsoft.com/en-us/library/Mt703199(v=OCS.15))
  ...
  - [-CsUserData on 변환](https://technet.microsoft.com/en-us/library/JJ205337(v=OCS.15))
  ...
  - [-CsUser 사용 안 함](https://technet.microsoft.com/en-us/library/Gg398747(v=OCS.15))
  ...
  - [사용-CsUser](https://technet.microsoft.com/en-us/library/Gg398711(v=OCS.15))
  ...
  - [다운로드-CsAnnouncement](https://technet.microsoft.com/en-us/library/Gg398937(v=OCS.15))
  ...
  - [Get-Csuser서비스 정책](https://technet.microsoft.com/en-us/library/JJ204838(v=OCS.15))
  ...
  - [부여-CsClientVersionPolicy](https://technet.microsoft.com/en-us/library/Gg412903(v=OCS.15))
  ...
  - [부여-CsMobilityPolicy](https://technet.microsoft.com/en-us/library/Hh690038(v=OCS.15))
  ...
  - [부여-Csuser서비스 정책](https://technet.microsoft.com/en-us/library/JJ205388(v=OCS.15))
  ...
  - [가져오기-CsAnnouncementFile](https://technet.microsoft.com/en-us/library/Gg398472(v=OCS.15))
  ...
  - [가져오기-CsLegacyConferenceDirectory](https://technet.microsoft.com/en-us/library/Gg398418(v=OCS.15))

  - [가져오기-CsLegacyConfiguration](https://technet.microsoft.com/en-us/library/Gg412923(v=OCS.15))
  ...
  - [가져오기-CsUserData](https://technet.microsoft.com/en-us/library/JJ205373(v=OCS.15))
  ...
  - [CsUcsRollback-호출](https://technet.microsoft.com/en-us/library/JJ204661(v=OCS.15))

  - [잠금-CsClientPin](https://technet.microsoft.com/en-us/library/Gg398650(v=OCS.15))

  - [병합-CsLegacyTopology](https://technet.microsoft.com/en-us/library/Gg425870(v=OCS.15))
  ...
  - [이동-CsLegacyUser](https://technet.microsoft.com/en-us/library/Gg413025(v=OCS.15))
  ...
  - [CsUser 이동](https://technet.microsoft.com/en-us/library/Gg398528(v=OCS.15))
  ...
  - [새 CsAnnouncement](https://technet.microsoft.com/en-us/library/Gg398522(v=OCS.15))
  ...
  - [새로운 CsCallParkOrbit](https://technet.microsoft.com/en-us/library/Gg398936(v=OCS.15))
  ...
  - [새-CsClientPolicyEntry](https://technet.microsoft.com/en-us/library/Gg399046(v=OCS.15))

  - [새-CsClientVersionConfiguration](https://technet.microsoft.com/en-us/library/Gg399029(v=OCS.15))
  ...
  - [새로운 CsCpsConfiguration](https://technet.microsoft.com/en-us/library/Gg412919(v=OCS.15))
  ...
  - [신규-CsMcxConfiguration](https://technet.microsoft.com/en-us/library/Hh690035(v=OCS.15))
  ...
  - [새로운 CsPushNotificationConfiguration](https://technet.microsoft.com/en-us/library/Hh690027(v=OCS.15))
  ...
  - [새로운 CsWebLink](https://technet.microsoft.com/en-us/library/Hh690053(v=OCS.15))
  ...
  - [CsAnnouncement 제거](https://technet.microsoft.com/en-us/library/Gg412766(v=OCS.15))
  ...
  - [제거-CsAutodiscoverConfiguration](https://technet.microsoft.com/en-us/library/Hh690054(v=OCS.15))
  ...
  - [제거-CsCallParkOrbit](https://technet.microsoft.com/en-us/library/Gg412901(v=OCS.15))
  ...
  - [-CsClientVersionConfiguration 제거](https://technet.microsoft.com/en-us/library/Gg425925(v=OCS.15))
  ...
  - [제거-CsCpsConfiguration](https://technet.microsoft.com/en-us/library/Gg398358(v=OCS.15))
  ...
  - [-CsManagementConnection 제거](https://technet.microsoft.com/en-us/library/Gg425803(v=OCS.15))

  - [제거-CsMcxConfiguration](https://technet.microsoft.com/en-us/library/Hh690026(v=OCS.15))
  ...
  - [제거-CsPushNotificationConfiguration](https://technet.microsoft.com/en-us/library/Hh690028(v=OCS.15))
  ...
  - [제거-CsSlaConfiguration](https://technet.microsoft.com/en-us/library/Mt703201(v=OCS.15))

  - [제거-CsSlaDelegates](https://technet.microsoft.com/en-us/library/Mt703203(v=OCS.15))
  ...
  - [제거-CsUnassignedNumber](https://technet.microsoft.com/en-us/library/Gg398209(v=OCS.15))
  ...
  - [-Csuser서비스 정책 제거](https://technet.microsoft.com/en-us/library/JJ204629(v=OCS.15))
  ...
  - [집합-CsAnnouncement](https://technet.microsoft.com/en-us/library/Gg425752(v=OCS.15))
  ...
  - [Set CsDialPlan 플랜](https://technet.microsoft.com/en-us/library/Gg398644(v=OCS.15)) Set CsDialPlan 플랜
  ...
  - [테스트-CsMcxConference](https://technet.microsoft.com/en-us/library/Hh690045(v=OCS.15))

  - [테스트-CsMcxP2PIM](https://technet.microsoft.com/en-us/library/Hh690020(v=OCS.15))

  - [테스트-CsMcxPushNotification](https://technet.microsoft.com/en-us/library/Hh690043(v=OCS.15))
