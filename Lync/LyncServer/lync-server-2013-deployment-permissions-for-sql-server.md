...
<td><p><span data-ttu-id="9c88a-121">RTCUniversalServerReadOnly 그룹 구성원이어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="9c88a-121">Must be a member of the RTCUniversalServerReadOnly group</span></span></p></td>
