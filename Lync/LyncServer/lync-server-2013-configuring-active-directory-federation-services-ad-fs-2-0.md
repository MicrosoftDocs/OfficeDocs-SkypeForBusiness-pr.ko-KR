...
> [!NOTE]  
> AD FS 2.0을 설치할 때 Windows Server Manager를 사용 하 여 Active Directory Federation Services 역할을 추가 하지 마세요. 대신,에서 Active Directory Federation Services 2.0 RTW 패키지를 다운로드 하 여 설치 <A href="https://go.microsoft.com/fwlink/p/?linkid=313375">https://go.microsoft.com/fwlink/p/?LinkId=313375</A> 합니다.
...
3.  Windows PowerShell 명령줄에서 다음 명령을 실행 합니다.
    ...
    ```
4.  다음 명령을 실행 하 여 배포와 관련 된 서버 이름을 교체 하 여 수동 인증을 사용 하도록 설정 되는 Lync Server 2013에 대 한 누적 업데이트를 사용 하 여 각 Lync Server 2013에 대 한 상호 관계를 설정 합니다 2013.
    ```powershell
