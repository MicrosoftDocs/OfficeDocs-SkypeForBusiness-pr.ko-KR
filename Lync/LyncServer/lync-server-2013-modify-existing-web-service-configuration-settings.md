...
# <a name="modify-existing-web-service-configuration-settings-in-lync-server-2013"></a>Lync Server 2013에서 기존 웹 서비스 구성 설정 수정
...
5.  **웹 서비스 설정 편집**의 **windows 통합 인증**에서 **협상**, **windows 통합 인증**또는 **없음**중 하나를 선택 합니다.
