...
Lync Server 클라이언트는 비상 통화의 일부로 PIDF-로 데이터를 포함 하며,이 데이터는 E9-1-1 서비스 공급자가 해당 PSAP를 확인 하 고 해당 전화를 올바른 ESQK와 함께 해당 PSAP로 라우팅하는 데 사용 되며,이는 PSAP 발송자가 해당 통화를 가져올 수 있도록 합니다. 발신자의 위치입니다.
