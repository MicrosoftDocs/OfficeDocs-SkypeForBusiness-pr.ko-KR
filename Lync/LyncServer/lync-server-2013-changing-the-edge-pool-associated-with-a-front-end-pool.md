...
---
# <a name="changing-the-edge-pool-associated-with-a-front-end-pool-in-lync-server-2013"></a>Lync Server 2013의 프런트 엔드 풀과 연결 된에 지 풀 변경
...
## <a name="changing-the-edge-pool-associated-with-a-front-end-pool"></a>프런트 엔드 풀과 연결된 에지 풀 변경
