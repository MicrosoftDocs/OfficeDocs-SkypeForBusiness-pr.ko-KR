...
Lync Server 2013를 배포 하 고 작동 하기 전에 스키마를 확장 한 다음 개체를 만들고 구성 하 여 Active Directory 도메인 서비스를 준비 해야 합니다. 스키마 확장에서는 Lync Server에 필요한 Active Directory 클래스 및 특성을 추가 합니다.

이 섹션의 항목에서는 Lync Server 배포를 위해 AD DS를 준비 하는 방법과 설정 및 OU (조직 구성 단위) 권한을 할당 하는 방법에 대해 설명 합니다. Lync Server에 필요한 스키마 변경 사항에 대 한 자세한 내용은 [Lync server 2013에서 사용 되는 Active Directory 스키마 확장, 클래스 및 특성](lync-server-2013-active-directory-schema-extensions-classes-and-attributes-used-by-lync-server.md)을 참조 하세요.
