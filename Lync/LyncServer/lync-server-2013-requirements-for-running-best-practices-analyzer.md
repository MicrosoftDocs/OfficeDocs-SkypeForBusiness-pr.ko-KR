...
Lync server 2013, 모범 사례 분석기를 사용 하 여 Lync Server 2013 환경을 검사할 수 있습니다. 이전 환경을 검사 하는 데 사용할 수 없지만 이전 버전의 도구를 사용 하 여 해당 환경을 검색할 수는 있습니다. 모범 사례 분석기의 Lync Server 2010 및 Office Communications Server 2007 R2 버전을 다운로드 하 고 사용 하는 방법에 대 한 자세한 내용은 "Lync Server 2010, Best [http://go.microsoft.com/fwlink/p/?linkId=210536](http://go.microsoft.com/fwlink/p/?linkid=256358) practices analyzer" 및 "office communications server 2007 And Office communications server 2007 r 2에 대 [http://go.microsoft.com/fwlink/p/?linkId=256358](http://go.microsoft.com/fwlink/p/?linkid=210651)한 모범 사례 분석기"를 참조 하세요.
