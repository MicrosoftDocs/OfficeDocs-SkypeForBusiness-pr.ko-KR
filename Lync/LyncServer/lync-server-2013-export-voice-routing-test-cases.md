...
테스트 사례를 통해 조직에서 음성 경로를 테스트할 수 있습니다. 전화를 걸고 사용할 다이얼 플랜 및 음성 정책의 이러한 항목을 정의한 다음 Lync Server에서 해당 조건이 제공 되 면 주어진 번호를 PSTN 네트워크로 성공적으로 라우팅할 수 있는지 확인할 수 있습니다.
