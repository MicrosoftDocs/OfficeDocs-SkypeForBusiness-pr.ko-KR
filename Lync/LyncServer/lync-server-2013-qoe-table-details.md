...
이 섹션에서는 각 체감 품질 (환경 품질) 데이터베이스 스키마 테이블의 열에 대해 자세히 설명 합니다.
  ...
  - [Lync Server 2013의 PurgeSettings 테이블 (체감 품질)](lync-server-2013-purgesettings-table-qoe.md)
  ...
  - [Lync Server 2013의 UserAgentDef 테이블 (체감 품질)](lync-server-2013-useragentdef-table-qoe.md)
