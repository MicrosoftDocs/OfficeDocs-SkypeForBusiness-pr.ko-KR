...
# <a name="perimeter-network-voip-components-for-lync-server-2013"></a>Lync Server 2013에 대한 경계 네트워크 VoIP 구성 요소
...
개인 또는 컨퍼런스 통화에 통합 커뮤니케이션 클라이언트를 사용 하는 외부 발신자는 Edge 서버에서 동료와 음성 통신을 진행 합니다.

Edge 서버에서 액세스에 지 서비스는 조직의 방화벽 외부에 있는 Lync 사용자의 통화에 대 한 SIP 신호를 제공 합니다. A/V Edge 서비스는 NAT와 방화벽의 미디어 이동을 사용 하도록 설정 합니다. 회사 방화벽 외부에서 통합 커뮤니케이션 (UC) 클라이언트를 사용 하는 발신자는 개인 및 전화 회의 둘 다에 대 한 A/V에 지 서비스에 의존 합니다.
