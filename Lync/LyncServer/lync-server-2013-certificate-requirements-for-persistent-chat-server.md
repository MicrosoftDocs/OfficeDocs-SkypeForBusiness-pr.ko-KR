...
# <a name="certificate-requirements-for-persistent-chat-server-in-lync-server-2013"></a>Lync Server 2013의 영구 채팅 서버에 대한 인증서 요구 사항
...
영구 채팅 서버를 설치 하려면 파일 업로드/다운로드를 위해 영구 채팅 웹 서비스를 실행 하는 각 서버에 대해 Lync Server 2013 내부 서버에서 사용 하는 것과 동일한 CA에서 발급 한 인증서가 있어야 합니다. 영구 채팅 설치를 시작 하기 전에 특히 외부 CA를 사용 하는 경우 필요한 인증서가 있는지 확인 합니다.
