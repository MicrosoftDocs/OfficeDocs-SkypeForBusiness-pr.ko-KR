...
description: Lync Server 2013:에 지 배포를 확인 합니다.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48564504"
---
# <a name="verifying-your-edge-deployment-in-lync-server-2013"></a>Lync Server 2013에서에 지 배포 확인
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - [Lync Server 2013에서 외부 사용자에 대 한 연결 확인](lync-server-2013-verify-connectivity-for-external-users.md)
