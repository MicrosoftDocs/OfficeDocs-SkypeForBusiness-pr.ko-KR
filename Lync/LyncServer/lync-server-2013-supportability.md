...
# <a name="supportability-for-lync-server-2013"></a>Lync Server 2013에 대한 지원 가능성
...
_**마지막으로 수정한 주제:** 2012-04-23_

Microsoft Lync Server 2013 통신 소프트웨어는 소규모, 중급 또는 대규모 조직의 요구를 충족 하도록 설계 된 토폴로지를 지원 하며 성능, 고가용성 및 확장성에 대 한 요구 사항이 달라 집니다.
