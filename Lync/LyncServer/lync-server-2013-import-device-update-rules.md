...
장치 업데이트 규칙은 Windows PowerShell 및 **가져오기-CsDeviceUpdate** cmdlet을 사용 해야만 가져올 수 있습니다. 이 cmdlet은 Lync Server 2013 관리 셸 또는 Windows PowerShell의 원격 세션에서 실행할 수 있습니다.
...
## <a name="to-import-device-update-rules-to-a-single-web-server"></a>단일 웹 서버로 장치 업데이트 규칙을 가져오려면
...
자세한 내용은 [가져오기-CsDeviceUpdate](https://docs.microsoft.com/powershell/module/skype/Import-CsDeviceUpdate) cmdlet에 대 한 도움말 항목을 참조 하십시오.
