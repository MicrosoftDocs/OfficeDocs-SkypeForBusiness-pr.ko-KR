...
_**마지막으로 수정 된 항목:** 2014-08-27_

클라이언트 및 장치에 대 한 소프트웨어 지원 2013 배포에는 지원 되는 운영 체제, 인프라 소프트웨어 및 기타 추가 소프트웨어를 통해 클라이언트 및 장치 기능을 지 원하는 데 필요 합니다.
...
## <a name="in-this-section"></a>이 섹션의 내용
  ...
  - <span></span>  
    [Lync Server 2013의 공용 인스턴트 메신저 연결 지원](lync-server-2013-support-for-public-instant-messenger-connectivity.md)

  - <span></span>  
    [Lync에서 사용자 사진이 표시 되는 방식](how-user-photos-are-displayed-in-lync.md)
