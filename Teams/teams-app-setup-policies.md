...
관리자는 앱 설치 정책을 사용 하 여 다음을 수행할 수 있습니다.

- 팀을 사용자 지정 하 여 사용자에 게 가장 중요 한 앱을 강조 표시 합니다. 고정할 앱을 선택 하 고 표시 되는 순서를 설정 합니다. 앱을 고정 하면 조직의 사용자에 게 제공 되는 앱을 비롯 하 여 조직에서 사용 하는 응용 프로그램 (예를 들어 조직의 개발자에 의해)이 필요 합니다.
- 사용자가 앱을 팀에 고정할 수 있는지 여부를 제어 합니다.
...
Microsoft 팀 관리 센터에서 앱 설치 정책을 관리할 수 있습니다. 전역 (조직 차원의 기본) 정책을 사용 하거나 사용자 지정 정책을 만들어 사용자에 게 할당할 수 있습니다. 사용자 지정 정책을 만들고 할당 하지 않으면 조직의 사용자가 자동으로 전역 정책을 받습니다. 이러한 정책을 관리 하려면 전역 관리자 또는 팀 서비스 관리자 여야 합니다.
...
6. 사용자를 위해 앱을 설치 하려면 **(미리 보기에서)** 다음을 수행 합니다.

    1. **설치 된 앱**에서 **앱 추가**를 클릭 합니다.
    2. **설치 된 앱 추가** 창에서 팀을 시작할 때 자동으로 설치 하려는 앱을 검색 합니다. 앱 사용 권한 정책을 기준으로 앱을 필터링 할 수도 있습니다. 앱 목록을 선택한 후 **추가**를 클릭 합니다.

        ![설치 된 앱 추가 창을 보여 주는 스크린샷](media/app-setup-policies-add-installed-apps.png)

7. 앱을 고정 하려면 다음을 수행 합니다.

    1. **고정 된 앱**에서 **앱 추가**를 클릭 합니다.
    2. 고정 된 **앱 추가** 창에서 추가 하려는 앱을 검색 한 다음 **추가**를 클릭 합니다. 앱 사용 권한 정책을 기준으로 앱을 필터링 할 수도 있습니다. 고정할 앱 목록을 선택 했으면 **추가**를 클릭 합니다.

         ![고정 된 앱 추가 창을 보여 주는 스크린샷](media/app-setup-policies-add-apps.png)

    3. 팀에 표시할 순서 대로 앱을 정렬 한 다음 **저장**을 클릭 합니다.
...
#### <a name="how-many-pinned-apps-can-be-added-to-a-policy"></a>정책에 추가할 수 있는 고정 된 앱은 몇 개입니까?
