...
앱을 고정하면 조직의 사용자가 가장 필요로 하는 앱을 강조 표시할 수 있습니다. 고정은 Teams의 모든 유형의 앱(코어 앱, Microsoft 제공 앱, 타사 앱, 조직 내에서 개발된 사용자 지정 앱)에서 작동합니다. 사용자에게 앱이 허용된 경우 앱 설정 정책을 통해 앱을 고정해도 설치됩니다. 앱 설정 정책을 사용하여 다음 작업을 수행할 수 있습니다.
...
최종 사용자는 [앱 사용 권한 정책](teams-app-permission-policies.md)에서 허용하는 경우 및 해당 테넌트에서 앱 자체가 허용되는 경우 스스로 앱을 설치할 수 있습니다.

앱을 설치하기 위한 앱 설정 정책을 만들려면 다음 단계를 수행합니다.
...
:::image type="content" source="media/install-apps-in-meeting.png" alt-text="앱 정책을 설치합니다.":::
...
Microsoft Teams 관리 센터를 사용하여 글로벌(조직 전체 기본값) 정책 및 사용자가 만든 사용자 지정 정책을 포함하여 정책을 편집할 수 있습니다.
...
Teams 모바일 클라이언트를 사용하면 활동, 채팅, Teams와 같은 코어 Teams 앱을 볼 수 있으며 Microsoft에서 제공하는 앱을 고정할 수 있습니다.
...
관리자 핀이 항상 우선적으로 적용됩니다. **사용자 고정** 옵션이 켜져 있으면 사용자가 고정한 앱을 관리자가 고정된 앱 아래에 유지합니다. **사용자 고정** 옵션을 해제하면 사용자는 기존 핀을 잃게 되고, 관리자가 고정한 앱만 앱 바에 표시됩니다.
