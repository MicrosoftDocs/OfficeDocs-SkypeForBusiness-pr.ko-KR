...
앱을 고정하면 조직의 사용자가 가장 필요로 하는 앱을 강조 표시할 수 있습니다. 고정은 Teams의 모든 유형의 앱(핵심 앱, Microsoft 제공 앱, 타사 앱 및 조직 내에서 개발된 사용자 지정)에서 작동합니다. 사용자에게 앱이 허용된 경우 앱 설정 정책을 통해 앱을 고정해도 설치됩니다. 앱 설정 정책을 사용하여 다음 작업을 수행할 수 있습니다.
...
최종 사용자는 [앱 사용 권한 정책에서 앱을](teams-app-permission-policies.md) 허용하고 Teams 관리자가 앱을 허용하는 경우 앱을 직접 설치할 수 있습니다. 대신 사용자 또는 조직에 대해 앱이 차단된 경우 최종 사용자는 [관리자 승인을 요청할](user-requests-approve-apps.md) 수 있습니다.
...
교육용 Teams에서는 통화 앱을 사용할 수 없습니다. 앱 설정 정책에서 새 사용자 지정 정책을 만들면 앱 목록에 통화 앱이 표시됩니다. 그러나 이 앱은 Teams 클라이언트에 고정되어 있지 않으며 교육용 Teams 사용자는 Teams에서 통화 앱을 볼 수 없습니다.
...
Teams 모바일 클라이언트를 사용하면 사용자에게 활동, 채팅 및 Teams와 같은 핵심 Teams 앱이 표시되며 Microsoft에서 제공하는 앱 중 일부를 고정할 수 있습니다.

#### <a name="order-of-apps-pinned-through-a-policy"></a>정책을 통해 고정된 앱의 순서
