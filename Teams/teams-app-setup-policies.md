...
- 사용자를 대신하여 앱을 **설치합니다(미리 보기 상태).** 사용자가 Teams를 시작할 때 기본적으로 설치되는 앱을 선택할 수 있습니다. 할당된 앱 사용 권한 정책이 [](teams-app-permission-policies.md) 허용하는 경우 사용자가 앱을 직접 설치할 수 있습니다.
...
- **FirstLineWorker:** 이 정책은 일선 작업자에 대한 것입니다. 조직의 일선 작업자에게 할당할 수 있습니다. 만드는 사용자 지정 정책과 마찬가지로 설정이 활성화될 수 있도록 사용자에게 정책을 할당해야 합니다. 자세한 내용은 이 문서의 사용자에 대한 사용자 지정 앱 설정 정책 할당 섹션으로 이동하세요. [](#assign-a-custom-app-setup-policy-to-users)
