...
이 문서에서는 Teams 앱을 개발에서 배포로 검색하는 방법에 대한 전체 지침을 제공합니다. 이 지침은 앱의 Teams 측면을 중점적으로 설명하며 관리자와 IT를 위한 것입니다. Teams 앱 개발에 대한 자세한 내용은 Teams 개발자 <a href="https://docs.microsoft.com/microsoftteams/platform" target="_blank">설명서를 참조하세요.</a>
...
앱이 프로덕션에서 사용할 준비가 되면 개발자는 앱 패키지를 생성해야 합니다. App <a href="https://docs.microsoft.com/microsoftteams/platform/get-started/get-started-app-studio" target="_blank">Studio를</a> 사용할 수 있습니다. 파일이 .zip 형식으로 전송됩니다.
...
1. 사용자 지정 앱 또는 전체 앱 **설정과의** 상호 작용 허용을 턴합니다. 이 작업을 위해:
