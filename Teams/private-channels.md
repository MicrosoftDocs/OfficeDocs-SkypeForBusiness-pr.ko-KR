...
기본적으로 팀 소유자 또는 팀 구성원은 비공개 채널을 만들 수 있습니다. 게스트는 만들 수 없습니다. 비공개 채널을 만드는 기능을 팀 수준 및 조직 수준에서 관리할 수 있습니다. 정책을 [사용하여](teams-policies.md) 개인 채널을 만들 수 있는 조직의 사용자를 제어합니다. 정책을 설정하면 팀 소유자는 구성원이 팀의 설정 탭에서 비공개 채널을 만들  수 있는 기능을 해제하거나 설정할 수 있습니다.
