...
Microsoft Teams에서 최대 10,000명 참석자가 Teams 모임에 참가할 수 있습니다. 주 모임이 최대 허용 인원에 도달하면, 추가 참석자는 보기 전용 환경을 통해 참가합니다.

먼저 모임에 참가한 참석자 중 모임의 최대 허용 인원 까지는 모든 기능을 포함한 Teams 모임 환경이 제공됩니다. 즉, 음성 및 비디오 공유, 공유 비디오 시청, 모임의 채팅 참여가 가능합니다.

주 모임이 최대 허용 인원에 도달한 후 참가한 참석자에게는 보기 전용 환경이 제공됩니다.

참석자가 참가할 수 있도록 Android 및 iOS 모바일용 지원사항을 모두 제공합니다.

> [!Note]
> 현재 모임에서 채팅 및 전화를 이용할 수 있는 최대 사용 인원은 WW에서는 300명, GCC, GCC High 및 DoD에서는 250명입니다.

E3/E5/A3/A5 SKU가 있는 모든 이끌이는 기본값으로 보기 전용 환경을 사용할 수 없도록 설정되어 있습니다. 추가 구성 또는 설정이 필요하지 않습니다.

## <a name="disable-teams-view-only-experience"></a>Teams 보기 전용 환경 사용 불가로 설정

관리자는 PowerShell을 통해 보기 전용 환경을 사용하지 않도록 설정할 수 있습니다.

```PowerShell
Set-CsTeamsMeetingPolicy -Identity Global -StreamingAttendeeMode Disabled
```

향후에는 관리자가 Teams 관리 센터에서 보기 전용 환경을 사용하지 않도록 설정할 수도 있습니다.
...
- 관리자가 Teams 보기 전용 환경을 사용하지 않도록 설정.
- 참석자는 대기실을 지나칠 수 있는 권한이 없습니다.

주 모임의 최대 허용 인원에 도달하면, 모임 최대 허용 인원에 도달했고 새 참석자는 보기 전용으로 참여할 것이라는 배너가 모임 이끌이와 발표자에게 표시됩니다.
...
공석이 있는 경우 사용자는 항상 주 모임에 참가합니다. 주 모임이 최대 허용 인원에 도달하고 한명 이상의 참석자가 주 모임을 떠나는 경우 주 모임에 수용 가능 인원이 생깁니다. 모임이 다시 최대 허용 인원에 도달할 때까지 모임에 참가(또는 재참가)하는 참석자는 주 모임에 참가합니다. 보기 전용 환경을 사용 중인 참석자는 주 모임으로 자동으로 승격되지 못하며 현재 주 모임으로 수동으로 승격될 수 없습니다.

발표자/참석자 역할이 설정되지 않은 경우 주 모임의 공석은 선착순으로 채워집니다. 모임이 최대 허용 인원에 도달하면 다른 모든 사용자는 보기 전용 환경을 통해 참가합니다.

## <a name="impact-to-meeting-presenters"></a>모임 발표자에게 미치는 영향

모임 발표자에 대한 제한 사항:

- 보기 전용 참석자에 대한 정보는 제공하지 않습니다. 보기 전용 참석자에 대해 E-discovery를 지원하지 않습니다.
- 사용자는 보기 전용 참석자를 볼 수 없습니다.
- 모임에서 보기 전용 참석자를 제거할 수 없습니다.

> [!Note]
> 참석자 수는 보기 전용 방의 인원을 제외하고 모임에 있는 사람만 반영합니다. 따라서 발표자는 보기 전용 환경의 참석 인원을 정확히 알 수 없습니다.
...
- 공유 데스크톱 기능을 사용하여 공유되고 있는 콘텐츠 보기

보기 전용 참석자는 모임에서 다음과 같은 옵션을 경험할 수 없습니다.

- 참석자가 설정된 로비 정책 또는 옵션에 따라 대기실을 지나칠 수 있는 권한이 없는 경우 모임에 참가
- 오디오 회의를 사용하여 보기 전용 공간에 참가
- Microsoft Teams Room System 또는 CVI(Cloud Video Interop) 서비스를 사용하여 보기 전용 공간에 참가
- 오디오 또는 비디오 공유
- 모임 채팅을 보거나 참여하기
- 참가자가 현재 발표자가 아닌 경우 모임 참가자의 비디오 피드 보기
- 기본 공유 PowerPoint 기능 또는 개별 응용 프로그램 공유(데스크톱 공유 외)를 사용하여 공유된 PowerPoint 파일 보기
