        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Teams 시작하기</h3>
                        <p>채팅 및 모임에서 팀 및 채널 사용에 이르기까지 사용자는 이 세션이 끝나면 Teams를 자신 있게 사용할 수 있는 기본을 배우게 될 것입니다.</p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Teams를 한 단계 업그레이드하는 방법을 알아봅니다.</h3>
                        <p>일상 업무에서 Teams를 최적화하고 구성하는 독창적인 방법을 이해합니다.</p>
                        <p><i>대상 그룹: 최종 사용자</i></p>
                    </div>
                </div>
            </div>
