---
title: '& 모임에 대한 Teams 정책 기반 녹음/녹화 소개'
author: cabailey
ms.author: cabailey
manager: laurawi
ms.date: 05/11/2020
...
description: '& 모임에 대한 Teams 정책 기반 녹음/녹화에 대해 알아보기'
f1.keywords:
- CSH
ms.custom:
- Adopt
...
정책 기반 녹음/녹화를 사용하면 Microsoft Teams를 채택하여 관련 회사 또는 규정 정책에 따라 후속 처리 및 보존을 위해 통화 및 온라인 모임을 자동으로 기록하고 캡처해야 하는 경우 관리 정책을 사용하여 전화 및 모임을 규정할 수 있습니다.

Teams 커뮤니케이션을 구성, 관리, 기록, 저장 및 분석하기 위한 엔드 투 엔드 솔루션을 제공하는 데 필요한 플랫폼 기능, 사용자 환경 및 관리 인터페이스를 포함하여 타사 기록 솔루션의 통합을 지원하도록 Teams가 향상되었습니다. 향상된 기능에는 다음을 제공하는 통신 플랫폼 API 및 기록을 위한 이벤트가 포함됩니다.
...
규정 준수 기록 솔루션 통합 기능은 [준수 기록 및 Microsoft Teams 세션에서](https://myignite.microsoft.com/archives/IG19-VCE40) Ignite 2019에서도 검토되었습니다.
...
> ![무엇과 이유를 기록하는 상호 작용을 보여 주는 스크린샷.](media/recording-taxonomy.png "이미지는 기록 범주를 보여 줍니다.")

각 범주에는 녹음이 시작되는 방법, 기록되는 내용, 녹음이 저장되는 위치, 알림을 받는 사람, 액세스를 제어하는 사람 및 보존 처리 방법에 대한 다양한 요구 사항이 수반됩니다.

| 유형                   | 편의성(일반 팀 기록) | 조직 - 규제(규정 준수 기록) |
| ---------------------- | ------------------ | --------------- |
| 초기자              | 사용자               | 관리(시스템)  |
| 대상                 | 통화당/모임 | 사용자별        |
| 스토리지 소유자          | 사용자               | 규정 준수      |
...
Teams는 모임 및 라이브 이벤트의 [편리](./cloud-recording.md) 하고 기능적인 녹화를 위한 다양한 기능을 제공합니다. 조직 녹음/녹화는 Teams를 채택하는 조직이 관련 회사 또는 규정 정책에 따라 후속 처리 및 보존을 위해 통화 및 온라인 모임을 자동으로 기록하고 캡처해야 하는 경우 관리 정책을 통해 규정하도록 Teams를 채택하는 것을 의미합니다. 이 정책에 따라 사용자는 Teams와의 디지털 상호 작용이 기록되고 있지만 녹음을 사용하지 않도록 설정할 수 없으며 상호 작용이 완료되면 녹음/녹화에 액세스할 수 없습니다. 기록은 eDiscovery, 법적 보존 및 기타 회사 보존 사용에 대한 규정 준수 및 법률 담당자가 사용할 수 있는 조직 보관 파일의 일부가 됩니다.
...
<td>기록된 사용자</td>
<td><ul>
<li><p>녹음이 진행 중일 때 알림을 받습니다.</p></li>
...
<li><p>Teams 통화 및 모임과 관련된 녹음/녹화 관련 문제를 모니터링하고 해결합니다.</p></li>
<li><p>사용량, 품질 및 안정성에 대한 운영 분석을 통해 내부 규정 준수 책임자를 지원합니다.</p></li>
</ul></td>
</tr>
<tr class="odd">
<td>규정 준수 책임자</td>
...
<li><p>통신 관련 메타데이터 또는 상호 작용 콘텐츠에 따라 상호 작용을 검색합니다. 일반적인 예는 다음과 같습니다.</p>
<ul>
<li><p><strong>메타 데이터</strong> - 참가자, 시간, 방향, 전화 번호, 원본 번호, 사용자 지정 비즈니스 데이터</p></li>
<li><p><strong>콘텐츠</strong> – 전사, 감정, 발음, 관련 상호 작용</p></li>
</ul></li>
...
> [!div class="mx-imgBorder"]
> ![팀 사용자 지정 앱 설정을 보여 주는 스크린샷](media/hp-compliance-recording-for-teams-calling-and-meetings.jpg "이미지는 Teams 모임 또는 통화를 보내고 받을 때의 흐름을 보여줍니다.")
...
레코더는 [Microsoft 통신 플랫폼을 사용하고 Microsoft](/graph/cloud-communications-concept-overview) Graph에 애플리케이션으로 등록하는 확장 가능한 Azure 기반 서비스(봇)로 빌드됩니다. 레코더는 Teams 통화 및 모임 [통신 플랫폼 API](/graph/api/resources/communications-api-overview) 와의 직접 상호 작용을 제공하고 미디어 수집을 위한 엔드포인트를 제공합니다.

봇을 구성하고, 앱 인스턴스를 만들고, 규정 준수 정책을 할당하는 방법을 보여 주는 [샘플 규정 준수 레코더 애플리케이션을 사용할 수 있습니다](https://github.com/microsoftgraph/microsoft-graph-comms-samples/tree/a3943bafd73ce0df780c0e1ac3428e3de13a101f/Samples/BetaSamples/LocalMediaSamples/ComplianceRecordingBot) . 또한 이 샘플에는 [들어오는 통화](https://github.com/microsoftgraph/microsoft-graph-comms-samples/blob/a3943bafd73ce0df780c0e1ac3428e3de13a101f/Samples/BetaSamples/LocalMediaSamples/ComplianceRecordingBot/FrontEnd/Http/Controllers/PlatformCallController.cs#L199-L244) 라우팅 처리, [기록 상태 변경](https://github.com/microsoftgraph/microsoft-graph-comms-samples/blob/a3943bafd73ce0df780c0e1ac3428e3de13a101f/Samples/BetaSamples/LocalMediaSamples/ComplianceRecordingBot/FrontEnd/Bot/CallHandler.cs#L135-L138) 및 [기록 중인 사용자 제거](https://github.com/microsoftgraph/microsoft-graph-comms-samples/blob/a3943bafd73ce0df780c0e1ac3428e3de13a101f/Samples/BetaSamples/LocalMediaSamples/ComplianceRecordingBot/FrontEnd/Bot/CallHandler.cs#L121-L126)와 같은 특정 상호 작용을 기록하기 위한 API 사용 예제도 있습니다.
특정 API에 대한 그래프 설명서는 [updateRecordingStatus](/graph/api/call-updaterecordingstatus?tabs=http) 및 [incomingContext](/graph/api/resources/incomingcontext)에 대해 여기에서 찾을 수 있습니다.
...
파트너는 규정 준수 기록 통합의 모든 요구 사항이 지원되도록 인증 솔루션을 제출하기 전에 Microsoft Microsoft Graph 통신 API 및 SDK의 최소 필수 릴리스 버전을 확인해야 합니다.

규정 준수 기록 시나리오에 기본적인 두 가지 특정 요구 사항은 다음과 같습니다.

- 레코더 봇은 Azure에 배포해야 합니다.

- 레코더 봇은 Azure의 Windows VM에서 실행되어야 합니다.
...
IT 관리자는 규정 준수 기록 정책을 만들고 할당하여 기록할 사용자와 각 사용자에 사용할 레코더를 결정할 수 있습니다. 레코더는 통신 상호 작용이 발생할 때 이러한 정책의 구성에 따라 대화에 참여하도록 자동으로 초대됩니다. 규정 준수 기록 정책은 [Microsoft PowerShell](./teams-powershell-overview.md)을 사용하여 관리되며 각 조직의 테넌트, 사용자별 및 보안 그룹 수준에서 적용할 수 있습니다. [Microsoft 모임 정책](./meeting-policies-overview.md), [통화 정책](./teams-calling-policy.md) 및 [그룹 정책에](./assign-policies-users-and-groups.md#assign-a-policy-to-a-group) 대한 자세한 내용을 확인할 수 있습니다.

1. 테넌트에서 애플리케이션 인스턴스를 만듭니다.
...
3. 사용자에게 규정 준수 기록 정책을 할당합니다.
   ...
   [Grant-CsTeamsComplianceRecordingPolicy를 참조하세요](/powershell/module/skype/grant-csteamscompliancerecordingpolicy).
...
알림에 대한 지원은 Teams 클라이언트 환경을 사용하여 사용하도록 설정됩니다. 환경은 시각적 개체 또는 오디오일 수 있습니다.
...
> [!NOTE]
> 규정 준수 기록은 회의 모드 통화 큐에서 지원되지 않습니다. 전송 모드 통화 큐를 사용하세요.
> 사용자가 인터넷 중단을 경험하고 SBA를 사용하여 PSTN 호출을 만들고 수신하는 경우 규정 준수 기록이 작동하지 않습니다.

## <a name="compliance-recording-for-teams-certification-programs"></a>Teams 인증 프로그램에 대한 규정 준수 기록

파트너가 CCaaS 솔루션을 개발하고 Teams와 통합할 수 있도록 공개적으로 사용할 수 있는 API를 게시하는 것 외에도 Microsoft Teams 인증 프로그램에 대한 규정 준수 기록을 개발하여 고객에게 각 참여 파트너의 솔루션이 테스트되고 확인되어 Microsoft 솔루션에서 기대하는 품질, 호환성 및 안정성을 제공합니다.  
...
|더버 (미국) |[https://www.dubber.net/call-recording/](https://www.dubber.net/call-recording/) |
