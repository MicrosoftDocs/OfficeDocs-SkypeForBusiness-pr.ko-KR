...
이 문서에서는 오디오 및 비디오와 관련된 모임 정책 설정을 설명합니다. 여기에는 다음이 포함되었습니다.
...
- [PTZ(점 기울기 확대/축소) 카메라용 FECC(Far End Camera Control)](#far-end-camera-control-fecc-for-point-tilt-zoom-ptz-cameras)
...
이는 이끌이별 및 사용자별 정책의 조합입니다. 비디오는 중요한 모임 구성 요소입니다. 일부 조직에서는 관리자가 비디오 사용 사용자 모임에 대해 더 많은 제어권을 필요로 할 수 있습니다. 이 설정은 사용자가 호스트하는 일대일 모임과 사용자가 시작한 그룹 통화에서 비디오를 설정할 수 있는지 여부를 제어합니다. Teams 모바일 클라이언트에서 이 설정은 사용자가 모임에서 사진과 비디오를 공유할 수 있는지 여부를 제어합니다.
...
Daniela가 호스트한 모임에서 비디오를 켜도록 허용합니다. Daniela는 모임에 참가하여 비디오를 켤 수 있습니다. 아만다의 정책은 비디오를 허용하지 않도록 설정되어 있기 때문에 아만다는 다니엘라의 회의에서 비디오를 켤 수 없습니다. Amanda는 모임의 다른 참가자가 공유한 비디오를 볼 수 있습니다.
...
|이끌이: **꺼짐**||**IP 비디오** 설정은 이끌이에 대해 꺼져 있기 때문에 우선적으로 적용됩니다. 이제 누구도 이 정책이 할당된 사용자가 이끄는 모임에서 비디오를 켤 수 없습니다.|

### <a name="manage-audiovideo-for-meeting-participants"></a>모임 참가자용 오디오/비디오 관리

|수행하려는 작업...|가능한 정책 설정|
|---|---|
|모임 참가자의 오디오 및 비디오 비활성화|IP 오디오 모드: **사용 안 함**<br> IP 비디오 모드: **사용 안 함**<br>IP 비디오: 해당 내용|
|모임 참가자에 대해 수신 비디오 및 오디오만 사용하도록 설정|IP 오디오 모드: **발신 및 수신 오디오 사용**<br> IP 비디오 모드: **발신 및 수신 비디오 사용**<br>IP 비디오: **끄기**|
|모임 참가자에 대해 비디오 비활성화(참가자는 오디오만 사용)|IP 오디오 모드: **발신 및 수신 오디오 활성화**<br> IP 비디오 모드: **사용 안 함**<br>IP 비디오: 해당 내용
...
|**BlurOnly**|**배경 흐림만**|사용자에게 비디오 배경을 흐리게 하는 옵션이 있습니다.|
