...
> [!NOTE]
> 팀 소유자를 추가할 때 팀이 관리 센터에 만들어지거나 새 또는 기존 Teams 팀이 추가되는 경우를 제외하고 팀 소유자도 구성원으로 Microsoft 365 있습니다.
...
조직 구조와 일치하는 Teams를 만들 수 있습니다. Teams는 사기를 북돋우고, 팀 관련 검토를 하고, 직원 온보딩 프로세스를 명확하게 하며, 인력 계획을 토론하고, 다양한 인력 전체의 가시성을 향상하려는 리더에게 최적화되어 있습니다.  
