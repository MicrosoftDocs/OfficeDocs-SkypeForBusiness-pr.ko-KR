...
목록의 템플릿은 사용자에 대한 일반적인 정보 추적 시나리오에 맞게 조정됩니다. 각 서식 파일은 목록 보기 및 세부 정보 보기 수준 모두에 미리 정의된 목록 구조, 양식 레이아웃 및 서식 옵션이 제공되어 사용자가 빠르게 시작할 수 있도록 합니다. 템플릿을 선택하면 일부 샘플 데이터와 함께 목록의 모양을 미리 볼 수 있습니다. 다음은 조직의 팀이 목록에서 미리 정의한 서식 파일을 사용하는 방법에 대한 몇 가지 예입니다.

- 문제를 추적하고 문제 추적기 템플릿을 사용하여 문제를 해결합니다.
- 이벤트 iterary 템플릿을 사용하여 모든 이벤트 세부 정보를 구성합니다.
- 환자 템플릿을 사용하여 의료 조직에서 의료 팀이 진료를 모니터링하고 조정하기 위한 환자 요구 및 상태를 기록합니다.
