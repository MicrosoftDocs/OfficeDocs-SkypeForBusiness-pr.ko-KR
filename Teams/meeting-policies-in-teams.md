...
-메모-사용자가 오디오 회의 라이선스를 사용 하도록 설정 하거나 사용자가 오디오 회의를 허용 하는 경우 모임 세부 정보 단추가 availiable 됩니다. 모임 세부 정보는 availiable 되지 않습니다.
...
- [Kps (미디어 비트 전송률)](#media-bit-rate-kps)
