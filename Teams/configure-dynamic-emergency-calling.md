...
>[!Note]
>또한 서브넷은 LIS에서 정의할 수 있으며 응급 위치와 연결될 수 있습니다.  LIS 서브넷은 클라이언트에 할당된 서브넷 IP 범위와 일치하는 네트워크 ID로 정의해야 합니다. 예를 들어 10.10.10.150/25의 클라이언트 IP/마스크에 대한 네트워크 ID는 **10.10.10.128입니다.** 자세한 내용은 [TCP/IP](https://docs.microsoft.com/troubleshoot/windows-client/networking/tcpip-addressing-and-subnetting)주소 및 하위 내기 기본 이해를 참조하세요.
