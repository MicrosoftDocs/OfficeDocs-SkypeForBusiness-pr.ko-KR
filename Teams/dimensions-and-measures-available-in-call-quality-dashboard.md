...
| 첫 번째 사용자 수|숫자로 | 고유 하거나 고유한 첫 번째 끝점 사용자의 수입니다. 이 측정값에 대해 최대 0.2% 오류가 발생 했습니다. 자세한 내용은 아래 참고를 참조 하세요.| 
| 두 번째 사용자 수|숫자로|고유 하거나 고유한 두 번째 끝점 사용자의 수입니다. 이 측정값에 대해 최대 0.2% 오류가 발생 했습니다. 자세한 내용은 아래 참고를 참조 하세요.|
