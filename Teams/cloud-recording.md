...
<sup>1</sup> 2020년 8월 20일을 기점으로 A1 사용자가 모임 녹음 파일에 대한 액세스가 21일 후에 만료됩니다. 자세한 내용은 [Stream에 Microsoft Teams 모임 녹화 업로드를 참조하세요.](https://docs.microsoft.com/stream/portal-upload-teams-meeting-recording)
...
Microsoft Stream은 적격 Microsoft 365 및 Office 365 구독의 일부로 또는 독립 실행형 서비스로 사용할 수 있습니다.  자세한 내용은 [Stream 라이선싱 개요](https://docs.microsoft.com/stream/license-overview)를 참조하세요.  Microsoft Stream은 이제 Microsoft 365 Business, Microsoft 365 Business Standard 및 Microsoft 365 Business Basic에 포함됩니다.

사용자가 Microsoft Stream에 액세스할 수 있도록 [Microsoft 365 또는 Office 365의](https://support.office.com/article/Assign-licenses-to-users-in-Office-365-for-business-997596B5-4173-4627-B915-36ABAC6786DC) 사용자에게 라이선스를 할당하는 방법에 대해 자세히 알아보습니다. Microsoft Stream에 대한 블록 등록 에 정의된 사용자에 대해 [Microsoft Stream이](https://docs.microsoft.com/stream/disable-user-organization)차단되지 않도록 합니다.
...
1시간 녹음/녹화 크기는 400MB입니다. 녹음/녹화된 파일에 대한 필요한 용량을 알고 있어야 하며 Microsoft Stream에서 충분한 저장소를 사용할 수 있는지 확인합니다.  [구독에](https://docs.microsoft.com/stream/license-overview) 포함된 기본 저장소 및 추가 저장소를 구입하는 방법을 이해하려면 Microsoft Stream 라이선스 개요를 참조하세요.
