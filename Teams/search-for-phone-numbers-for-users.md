...
2. 왼쪽 탐색 영역에서 **Voice** > **전화 numbersGet** >  **새 숫자를** 선택합니다.
  
    > [!IMPORTANT]
    > Teams 관리 센터의 왼쪽 탐색 영역에서 **음성** 옵션을 보려면 먼저 **하나 이상의 Enterprise E5 또는 E3 라이선스**, **전화 시스템** 추가 기능 라이선스 또는 **오디오 회의** 추가 기능 라이선스를 하나 이상 구입해야 합니다.  
