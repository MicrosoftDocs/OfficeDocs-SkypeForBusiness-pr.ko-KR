...
> [!NOTE]
> 기본적으로 게스트 액세스 기능은 꺼져있습니다. 따라서 게스트가 팀에 참여하려면 관리자가 Teams에서 게스트 액세스를 설정해야 합니다. 이 작업을 수행 하려면 [팀에서 게스트와 공동 작업](https://docs.microsoft.com/microsoft-365/solutions/collaborate-as-team)을 참조 하세요. 
