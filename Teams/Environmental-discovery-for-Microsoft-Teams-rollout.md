...
---
<a name="environmental-discovery-for-a-microsoft-teams-rollout"></a>Microsoft Teams 롤아웃을 위한 환경 검색
===================================================

검색은 Microsoft Teams로의 여정을 계획할 때 취하는 첫 번째 주요 단계 중 하나입니다.

환경의 세부 검색을 수행하여 현재 상태를 더 잘 이해하고, Teams 롤아웃 실행을 차단할 수 있는 모든 어려움이나 더 많은 어려움을 드러내야 합니다.

## <a name="discovery-questionnaire"></a>검색 설문지

아래 샘플 설문지에서는 조직이 Teams에서 통화 요금제 기능을 사용하여 오디오 회의 및 전화 시스템을 성공적으로 출시할 준비가 됐는지 확인하는 질문 집합을 설명합니다.

기존 공동 작업 인프라 및 Microsoft 365 또는 Office 365 조직, 네트워킹, 엔드포인트, 운영 및 채택 및 준비와 관련된 모든 문제는 환경 검색 설문지의 일부로 포함됩니다.

설문지가 여러 섹션으로 나뉘어 여러 주요 영역에서 Teams 배포에 대한 조직의 준비를 확인할 수 있습니다. 프로젝트 팀과 의하면 요청된 정보를 최대한 세부 정보로 제공하여 계획 활동을 용이하게 할 수 있습니다.
...
이 설문지로 작업할 때 활성 Microsoft 365 또는 Office 365 조직이 있는 것이 좋습니다. 아직 Microsoft 365 또는 Office 365 조직을 활성화하거나 구성하지 않은 경우 [비즈니스용 Microsoft 365](https://support.office.com/article/plan-your-setup-of-office-365-for-business-eb926624-018b-4486-bf11-5fba6ee4d645)설정 계획을 참조합니다.

다음 표를 사용하여 Microsoft 365 또는 Office 365 조직에 대한 정보를 캡처합니다.

> | 질문 | 답변 | 설명 |
> |---|---|---|
> | 프로덕션 Microsoft 365 참고<br/>또는 Office 365 조직 이름 및 ID<br/>를 선택해야 합니다. 더 많은 것이 있는 경우<br/>연결된 두 개 이상의 테넌트<br/>조직에서 모든 신원을 메모합니다. | 테넌트 이름: <br/>테넌트 ID:| |
> | 테넌트가 배포된 지역은 무엇입니까?| | |
> | 이러한 Microsoft 365 또는 <br/>Office 365 테넌트. 다중텐트인가 <br/>또는 전용인가요? | <input type="checkbox"> 다중텐트<br/> <input type="checkbox"> 전용 | |
...
> | Skype에서 사용할 수 있는 라이선스 수준 <br/>Business Online 사용자가신가요? | <input type="checkbox"> E1/G1 <br/> <input type="checkbox"> E2/G2 <br/> <input type="checkbox"> E3/G3 <br/> <input type="checkbox"> E4/G4 E5 | 사용자 수 <br/>각 SKU에 대해: |
...
> | 페더러드 ID를 사용하는 경우 <br/>페더러리 인프라가 있나요? | <input type="checkbox"> Windows 2008 R2 AD FS <br/> <input type="checkbox"> Windows 2012 AD FS <br/> <input type="checkbox"> Windows 2012 R2 AD FS <br/> <input type="checkbox"> Windows 2016 AD FS <br/> <input type="checkbox"> 타사 페더러리 <br/>&nbsp;&nbsp; &nbsp; 게이트웨이(세부 정보 참고) <br/>&nbsp;&nbsp; &nbsp; 를 선택해야 합니다. | |
> | 현재 활성 Microsoft 365를 유지 관리하는 경우<br/>또는 Office 365 테넌트가 <br/>테넌트와 연결된 대상 사용자 | <input type="checkbox"> N/A – Microsoft 365 또는 없음<br/>&nbsp;&nbsp; &nbsp; Office 365 테넌트가 있는 경우 <br/> <input type="checkbox"> 아니요, 사용자의 SMTP/SIP <br/>&nbsp;&nbsp; &nbsp; 도메인이 연결되지 않습니다. <br/>&nbsp;&nbsp; &nbsp; 테넌트가 있는 경우 <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 또는 Office 365<br/> <input type="checkbox"> 예, 사용자의 SMTP/SIP <br/>&nbsp;&nbsp; &nbsp; 도메인이 연결됩니다. <br/>&nbsp;&nbsp; &nbsp; 기존 테넌트가 있는 경우 <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 또는 Office 365 | |
...
> | 비즈니스용 Skype가 배포된가요? <br/>On-premises 및 hybrid deployments의 경우 <br/>버전 및 CU(누적 업데이트)를 적어 두는 경우 <br/>세부 정보를 입력합니다. | <input type="checkbox"> 예, Microsoft 365 또는 <br/>&nbsp;&nbsp; &nbsp; Office 365 <br/> <input type="checkbox"> 예, 하이브리드(있는 경우) <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 또는 <br/>&nbsp;&nbsp; &nbsp; Office 365) <br/> <input type="checkbox"> 예, 프레미스 <br/> <input type="checkbox"> 예, 온라인, 전용 <br/>&nbsp;&nbsp; &nbsp; (Microsoft) <br/> <input type="checkbox"> 예, 호스트, 전용 <br/>&nbsp;&nbsp; &nbsp; (타사) <br/> <input type="checkbox"> 예, 호스트, 공유 <br/>&nbsp;&nbsp; &nbsp; (타사) <br/> <input type="checkbox"> 아니요, 기타 | |
> | Exchange가 배포됐나요? <br/>On-premises 및 hybrid deployments의 경우 <br/>메모에 버전 및 CU 세부 정보를 메모합니다. <br/>열을 열 수 있습니다. | <input type="checkbox"> 예, Microsoft 365 <br/> <input type="checkbox"> 예, 하이브리드(있는 경우) <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 또는 <br/>&nbsp;&nbsp; &nbsp; Office 365) <br/> <input type="checkbox"> 예, 프레미스 <br/> <input type="checkbox"> 예, 온라인, 전용 <br/>&nbsp;&nbsp; &nbsp; (Microsoft) <br/> <input type="checkbox"> 예, 호스트, 전용 <br/>&nbsp;&nbsp; &nbsp; (타사) <br/> <input type="checkbox"> 예, 호스트, 공유 <br/>&nbsp;&nbsp; &nbsp; (타사) <br/> <input type="checkbox"> 아니요, 기타 | |
...
> | 다른 타사 플랫폼이 배포된 경우 <br/>오늘 사용 중이신가요? 이 경우 <br/>다음 플랫폼 및 <br/>주석 열. | <input type="checkbox"> Cisco WebEx <br/> <input type="checkbox"> Slack <br/> <input type="checkbox"> 기타( <br/>&nbsp;&nbsp; &nbsp; 주석 열입니다.) | 사용자 수: <br/>세부 정보:|
...
> | 직접 라우팅을 지원하는 [SBC가](https://docs.microsoft.com/microsoftteams/direct-routing-plan#supported-session-border-controllers-sbcs) 배포된 경우 <br/>이 이니셔티브 범위에 있는 사무실의 경우 예인 경우<br/>메모 열의 세부 정보를 메모합니다.| <input type="checkbox"> 예 <br/> <input type="checkbox"> 아니요 ||
...
> | 질문 | 답변 | 설명 |
> |---|---|---|
> | Skype에서 사용할 수 있는 사용자 유형 <br/>비즈니스용 Online? | <input type="checkbox"> 조직의 모든 사용자 <br/> <input type="checkbox"> 특정 사용자/사용자 그룹 <br/>&nbsp;&nbsp; &nbsp; (설명 열에서 지정합니다.) | |
> | 현재 어떤 부호 및 기능 <br/>현재 사용 중이신가요? | <input type="checkbox"> 메신저 및 현재 상태(IM/P)<br/> <input type="checkbox"> 회의 <br/> <input type="checkbox"> 페더ation <br/> <input type="checkbox"> 모임 녹음/녹화 <br/> <input type="checkbox"> Microsoft 오디오 회의 <br/> <input type="checkbox"> 타사 오디오 회의(참고)<br/>&nbsp;&nbsp; &nbsp; 설명 열의 세부 정보)를 참조합니다. <br/> <input type="checkbox"> 통화 계획(이전의 PSTN 통화) <br/> <input type="checkbox"> 조직 자동 참석자 <br/> <input type="checkbox"> 호출 큐 | |
...
> | 사용 방법 또는 사용 계획 <br/>전화 시스템(이전의 클라우드 PBX)을 <br/>PSTN? <br/>적용되는 모든 옵션을 선택합니다. | <input type="checkbox"> 통화 계획(이전의 PSTN 통화) <br/> <input type="checkbox"> 프레미스 PSTN 연결 <br/>&nbsp;&nbsp; &nbsp; (기존 Skype를 <br/>&nbsp;&nbsp; &nbsp; Business 2015 또는 Lync Server <br/>&nbsp;&nbsp; &nbsp; 2013 배포) <br/> <input type="checkbox"> 프레미스 PSTN 연결 <br/>&nbsp;&nbsp; &nbsp; (클라우드 커넥터 사용) | |
...
> | 질문 | 답변 | 설명 |
> |---|---|---|
> | Lync 또는 비즈니스용 Skype 버전 <br/> 현재는 배포되어 있나요? | <input type="checkbox"> Lync Server 2010 <br/> <input type="checkbox"> Lync Server 2013 <br/> <input type="checkbox"> 비즈니스용 Skype Server 2015 <br/> <input type="checkbox"> 비즈니스용 Skype Server 2019 <br/><input type="checkbox"> 비즈니스용 Skype 클라우드 커넥터 <br/>&nbsp;&nbsp; &nbsp; 버전 | |
> | 비즈니스용 Skype Online과의 하이브리드가 구성되어 있나요? | <input type="checkbox"> 예 <br/> <input type="checkbox"> 아니요 | |
> | 이 환경이 제3자에 의해 호스트되고 관리되는가 <br/>파티? 예인 경우 <br/>주석 열. | <input type="checkbox"> 예 <br/> <input type="checkbox"> 아니요 | |
> | 현재 사용 중인 모달 및 기능 <br/>오늘인가요? | <input type="checkbox"> 메신저 및 현재 상태(IM/P) <br/> <input type="checkbox"> 회의 <br/> <input type="checkbox"> 페더ation <br/> <input type="checkbox"> 모임 녹음/녹화 <br/> <input type="checkbox"> 영구 채팅/그룹 채팅 <br/> <input type="checkbox"> Microsoft 오디오 회의 <br/>&nbsp;(이전의 회의 전화 &nbsp; &nbsp; 접속) <br/>&nbsp;&nbsp; &nbsp; 온-프레미스 Lync Server 또는 <br/>&nbsp;&nbsp; &nbsp; 비즈니스용 Skype 배포 <br/> <input type="checkbox"> 타사 오디오 회의 <br/>&nbsp;&nbsp; &nbsp; (메모의 세부 정보 참고 <br/>&nbsp;&nbsp; &nbsp; 열)을 열에 추가합니다. <br/> <input type="checkbox"> Enterprise Voice 사용 <br/>&nbsp; &nbsp; &nbsp;PSTN 연결 <br/> <input type="checkbox"> 다음을 통해 플랜(이전의 PSTN 통화) <br/>&nbsp;&nbsp; &nbsp; 비즈니스용 Skype Online과 하이브리드 | |
...
> | Lync 또는 비즈니스용 Skype Edge가 있는 경우 <br/>두 개 이상의 데이터 센터에 배포된 경우 <br/>예인 경우 메모 열의 세부 정보를 메모합니다. | <input type="checkbox"> 예 <br/> <input type="checkbox"> 아니요 | |
> | Edge 역할이 현재 제공하는 서비스를 선택합니다. | <input type="checkbox"> 외부 사용자 액세스(회사 사용자) <br/> <input type="checkbox"> 원격 사용자 액세스(익명) <br/>&nbsp;&nbsp; &nbsp; 외부 모임 참가자) <br/> <input type="checkbox"> 페더ation <br/> <input type="checkbox"> 미디어 릴레이 | |
...
다음 표를 사용하여 조직의 네트워킹 세부 정보 및 사용자가 Microsoft 365 및 Office 365 서비스에 연결되는 방식(또는)을 캡처합니다.

> | 질문 | 답변 | 설명 |
> |---|---|---|
> | 마이그레이션 범위에 있는 사용자를 어떻게(또는 어떻게) 마이그레이션할 수 있습니다. <br/>사무실에 있는 경우 Teams에 액세스하나요? <br/>적용되는 모든 옵션을 선택합니다. | <input type="checkbox"> 라우팅된 NAT 연결 <br/> <input type="checkbox"> 프록시 서버 <br/> <input type="checkbox"> 공용 Wi-Fi <br/> <input type="checkbox"> 관리되는(공용이 아닌) Wi-Fi <br/> <input type="checkbox"> ExpressRoute <br/>&nbsp;&nbsp; &nbsp; (Microsoft 피어링) ||
...
> | VPN을 사용하는 경우 Teams 트래픽을 제외할 수 있습니다. <br/>Microsoft 365 및 Office 365 서비스에 직접 액세스하기 위한 VPN이 있나요? | <input type="checkbox"> 예 <br/> <input type="checkbox"> 아니요 | |
...
> | 지역 내의 모든 위치가 인터넷을 통해 <br/>또는 전체 지역에 대해 중앙 집중식으로 인터넷을 내보나요? | <input type="checkbox"> 인터넷에 대한 국가별 액세스 <br/> <input type="checkbox"> 다음에 대한 중앙 집중식 액세스 <br/>&nbsp;&nbsp; &nbsp; 인터넷 | |
...
> | 질문 | 답변 | 설명 |
> |---|---|---|
> | Lync Server의 운영 모델 <br/>비즈니스용 Skype Server, Microsoft 365 배포, <br/>또는 지금 Office 365 배포를 사용하나요? | | |
> | 현재 지원 정렬을 간략하게 설명할 수 있습니다. <br/>Lync Server, 비즈니스용 Skype Server, Microsoft 365, <br/>또는 Office 365? | | |
...
> | Lync Server, Skype for를 모니터링하는 방법 <br/>Business Server, Microsoft 365 배포 또는 <br/>Office 365 배포 | | |
