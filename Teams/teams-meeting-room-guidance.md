...
# <a name="enhanced-microsoft-teams-room"></a>[향상된 Microsoft Teams 방](#tab/emtr)

## <a name="enhanced-microsoft-teams-room"></a>향상된 Microsoft Teams 방
...
## <a name="what-is-an-enhanced-microsoft-teams-room"></a>향상된 방은 Microsoft Teams 무엇입니까?
...
## <a name="when-should-you-deploy-this-room-type"></a>이 룸 형식은 언제 배포해야 하나요?
...
### <a name="what-is-this-space-used-for"></a>이 공간은 어떤 데 사용하나요?
...
### <a name="how-is-this-space-laid-out"></a>이 공간은 어떻게 계획하나요?
...
### <a name="how-do-the-front-of-room-displays-work"></a>방 전면 표시가 어떻게 작동하나요? 
...
## <a name="enhanced-microsoft-teams-room-design-guidance"></a>향상된 Microsoft Teams 방 디자인 지침

이 섹션은 처음부터 방을 구축하는 것을 다루기 위한 것입니다. 

### <a name="room-layout"></a>방 레이아웃 
...
### <a name="infrastructure-power"></a>인프라 파워
...
### <a name="floor-treatments"></a>바닥 처리
...
#### <a name="speaker-placement"></a>발표자 배치

사용되는 디바이스 또는 디바이스의 인증된 범위 내의 모든 회의실 참가자에 대한 적용 범위를 제공하려면 발표자가 배치해야 합니다.

### <a name="front-of-room-display"></a>방 전면 디스플레이
...
#### <a name="display-functions"></a>표시 함수
...
### <a name="microsoft-teams-room-console-and-compute"></a>Microsoft Teams 콘솔 및 계산
