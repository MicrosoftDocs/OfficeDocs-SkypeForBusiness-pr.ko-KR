---
title: Microsoft Teams 게스트 액세스 설정 또는 해제
ms.author: mikeplum
...
2. **UsersGuest** >  **액세스를** 선택합니다.

3. **Teams 게스트 액세스 허용** 을 **켜** 기로 설정합니다.

    ![게스트 액세스 스위치를 켜기로 설정하도록 허용합니다.](media/guest-access-setting.png)

4. **통화**, **모임** 및 **메시징** 에서 게스트에 대해 허용하려는 항목에 따라 각 기능에 대해 **켜****기 또는 끄** 기를 선택합니다.

      - **개인 전화 걸기** – 게스트가 피어 투 피어 전화를 걸 수 있도록 허용하려면 이를 **켬** 으로 설정합니다.
      - **IP 비디오** - 게스트가 통화 및 모임에서 비디오를 사용할 수 **있도록 하려면 이** 설정을 켭니다.
      ...
      - **대화의 밈** - 게스트가 대화 **에서** 밈을 사용할 수 있도록 이 설정을 켭니다.
      - **대화의 스티커 – 게스트가 대화에서** 스티커를 사용할 수 있도록 이 설정을 **켜** 십시오.
      - **메시지에 대한 몰입형 리더** - 게스트가 [Teams 몰입형 리더](https://support.microsoft.com/topic/a700c0d0-bc53-4696-a94d-4fbc86ac7a9a)를 사용할 수 있도록 이 설정을 **켜** 십시오.

    ![Teams 게스트 권한 설정입니다.](media/manage-guest-access-image1.png)
