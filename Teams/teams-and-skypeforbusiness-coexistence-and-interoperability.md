...
비즈니스용 Skype 환경, 외부 (연합) 통신, PSTN 음성 서비스 및 음성 응용 프로그램, Office 통합, USB 장치용 HID 컨트롤, Skype에서 다른 여러 통합이 계속 처리 되는 것을 방지 하려면 비즈니스를 위한 것 이며 **아일랜드** 모드의 팀에서는 사용할 수 없습니다. 전화 시스템은 **아일랜드** 모드의 팀에서 지원 되지 않습니다. 이 모드에서는 유일한 엔터프라이즈 음성 클라이언트만 비즈니스용 Skype입니다.

> [!Important]
> **아일랜드** 모드에서는 페더레이션 사용자 (조직 외부의 사용자)의 모든 메시지와 통화가 비즈니스용 Skype로 배달 됩니다. **팀 전용** 모드로 업그레이드 한 후 조직 외부의 모든 메시지와 통화가 팀에 게 전달 됩니다.

> [!Tip]
> 비즈니스용 Skype Online 고객 추천 경로는 기본 **제도** 모드를 시작 하 여 조직의 팀에서 채도를 채택 하 고 **팀 전용** 모드로 빠르게 전환 하는 것입니다. 온-프레미스 및 하이브리드 고객 특히 복잡 한 경우 **팀 공동 작업 모드를 사용 하** 여 비즈니스용 Skype를 **아일랜드** 모드 대신 시작 점으로 배포 하는 것이 좋을 수 있으며,이를 통해 비즈니스용 skype에 대 한 진행이 가능 합니다. ** **조직에서 팀을 채택할 준비가 되었을 때 팀 공동 작업 및 모임 모드 (모임 먼저), 해당 하는 경우 **팀 전용** 모드로 전환 합니다.
...
온-프레미스 또는 하이브리드 비즈니스 서버의 비즈니스용 Skype를 사용 하는 조직은 사용자의 통신에 대 한 상호 운용성 및 예측 가능성을 제공 하려는 경우이 모드를 **아일랜드** 모드 대신 고려해 야 합니다. 팀으로 업그레이드 하기 위한 예측 가능한 시간 표시 막대를 보유 하 고 있습니다 ( **아일랜드** 모드의 채택 채도에 의존 하지 않는 것이 반대).
