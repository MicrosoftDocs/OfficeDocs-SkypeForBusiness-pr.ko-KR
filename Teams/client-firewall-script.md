---
title: 샘플 스크립트 - Microsoft Teams PowerShell 스크립트
author: dstrome
ms.author: dstrome
manager: serdars
audience: Admin
...
description: 방화벽을 통해 연결될 수 있도록 Windows Teams 샘플 스크립트를 Windows 있습니다.
f1.keywords:
- NOCSH
appliesto:
- Microsoft Teams
...
ms.locfileid: "62893765"
---
# <a name="sample-script---microsoft-teams-firewall-powershell-script"></a>샘플 스크립트 - Microsoft Teams PowerShell 스크립트
