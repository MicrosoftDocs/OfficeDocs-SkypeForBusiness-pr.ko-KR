...
게스트 액세스는 모든 Microsoft 365 비즈니스 표준, Microsoft 365 Enterprise 및 Microsoft 365 교육 구독에 포함 됩니다. Microsoft 365 라이선스가 추가로 필요 하지 않습니다. Teams에서는 추가할 수 있는 게스트 수를 제한하지 않습니다. 그러나 테넌트에 추가 할 수 있는 총 방문자 수는 Azure AD의 유료 기능에 따라 제한될 수 있습니다. 자세한 내용은 [Azure AD B2B 공동 작업 라이선스](https://docs.microsoft.com/azure/active-directory/b2b/licensing-guidance)를 참조하세요.
