...
>[!IMPORTANT]
>**긴급 주소:** 전화 주소와 연결된 번호는 운영자가 관리합니다. 관리 센터에서 긴급 주소를 Teams 운영자는 해당 긴급 주소에 전화 번호를 할당합니다. 긴급 주소 및 할당된 전화 번호를 변경하기 위해 운영자에게 문의하세요.
...
2. **전용 모드에 Teams 합니다.** 조직이 Teams 모드인지 확인하려면 Teams 관리 센터에서 업그레이드 에서 조직 전체 **설정으로 > Teams 합니다.** 사용자가 사용자 전용 모드에 Teams 확인하려면 사용자로  이동하고 사용자 계정을 선택합니다. 계정 **탭의** Teams  업그레이드에서 공존 모드가 'Teams'로 설정되어 있는지 확인
