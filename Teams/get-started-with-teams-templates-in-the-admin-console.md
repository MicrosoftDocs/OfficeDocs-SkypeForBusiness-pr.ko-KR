...
> [!NOTE]
> 개인 채널 및 민감도 레이블은 현재 Teams 템플릿에서 지원되지 않습니다. 개인 채널 만들기는 템플릿 정의에 포함되지 않습니다. 템플릿 흐름에서 팀  만들기의 민감도 레이블 옵션은 팀에 적용되지 않습니다.
...
| ------------------ | -------------- | ----------------------------------------------------- |
| Office 365 채택 |`com.microsoft.teams.template.AdoptOffice365`|  채널 <ul><li>일반</li> <li>공지 사항</li> <li>챔피언 코너</li> <li>팀 양식</li></ul> 앱: <ul><li>Wiki</li>  <li>일정</li> |
...
|인시던트 응답 조정| `com.microsoft.teams.template.CoordinateIncidentResponse`|채널 <ul><li>일반<li>공지 사항</li><li>물류</li><li>계획</li><li>복구</li><li>긴급</li></ul> 앱: <ul><li>Wiki</li><li>Excel</li><li>OneNote</li><li>SharePoint</li><li>Planner</li></ul>|
...
|소매 - 관리자 공동 작업| `retailManagerCollaboration` |채널 <ul><li>일반<li>작업</li><li>학습</li></ul> 앱: <ul><li>Wiki</li><li>Planner</li></ul>|
||||
