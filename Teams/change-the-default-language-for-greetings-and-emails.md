...
- **개별 사용자의 음성 메일 인사말 및 보이스 메일 메시지에 대 한 언어 변경** 사용자의 기본 설정 lanaguage를 변경 하 여 해당 Outlook 사서함으로 전송 되는 음성 메일 인사말 및 보이스 메일 메시지의 언어를 변경할 수 있습니다. 지침은 [Microsoft 365 또는 Office 365의 언어 및 지역 설정을 설정 하는 방법] ()을 참조 하세요 https://docs.microsoft.com/office365/troubleshoot/access-management/set-language-and-region) . 
    
    > [!NOTE]
    > [비즈니스에 대 한 Microsoft 365에서 표시 언어 및 표준 시간대 변경](https://support.office.com/en-us/article/change-your-display-language-and-time-zone-in-microsoft-365-for-business-6f238bff-5252-441e-b32b-655d5d85d15b?ui=en-US&rs=en-US&ad=US) 에 나와 있는 지침에 따라 로그인 한 후 해당 설정을 통해 사용자의 인사말을 변경할 수 있습니다.
...
- **보이스 메일 메시지의 언어를 변경 하 시겠습니까?** 비즈니스용 Skype for [https://mysettings.lync.com/voicemail](https://mysettings.lync.com/voicemail) **Prompt 언어**아래에서 새 언어를 선택 합니다. Microsoft 팀의 경우-사용자가 [팀 데스크톱 클라이언트 설정](https://support.office.com/article/manage-your-call-settings-in-teams-456cb611-3477-496f-b31a-6ab752a7595f) 에서 보이스 메일 인사말을 변경할 수 있습니다.
...
- [비즈니스용 Skype 서버에서 온-프레미스 PSTN 연결을 사용 하 여 Microsoft 365 또는 Office 365의 전화 시스템 계획](https://go.microsoft.com/fwlink/?LinkId=717947)
