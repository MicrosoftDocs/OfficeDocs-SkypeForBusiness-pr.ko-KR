...
새 사용자의 경우 기본 회의 유료 전화 번호는 사용자가 오디오 회의 서비스를 사용할 수 있는 경우 사용자의 Office 365 프로필에 설정 된 국가를 기준으로 지정 됩니다. 사용자의 국가와 일치 하는 유료 전화 번호가 있는 경우 해당 번호는 사용자의 기본 유료 번호로 자동으로 할당 됩니다. 전화 회의 브리지의 기본 유료 번호로 정의 된 번호가 사용자의 기본 유료 번호로 할당 되지 않는 경우에 사용 됩니다.  
