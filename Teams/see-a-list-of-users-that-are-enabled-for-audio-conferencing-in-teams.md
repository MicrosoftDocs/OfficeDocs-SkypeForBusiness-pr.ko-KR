...
조직에서 오디오 회의를 위해 Microsoft 팀 사용자를 설정한 후에는 사용 하도록 설정 된 사용자 목록을 볼 수 있습니다. 
...
- Microsoft 팀 관리 센터의 왼쪽 탐색 창에서 **사용자**를 클릭 합니다.


## <a name="what-else-should-i-know"></a>알아야 할 기타 사항

- 사용 하도록 설정 된 사용자 목록을 볼 때 목록에서 사용자를 선택 하 여 해당 사용자에 대 한 오디오 회의 설정을 편집할 수 있습니다.
    
- 단일 사용자를 선택 하면 사용자에 게 할당 된 기본 전화 번호와 기타 관련 오디오 회의 설정을 볼 수 있습니다.    
