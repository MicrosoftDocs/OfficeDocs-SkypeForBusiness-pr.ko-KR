...
조직에서 팀 이름을 지정하고 분류하는 방법, 게스트를 팀 구성원으로 추가할 수 있는지, 누가 팀을 만들 수 있는지에 대한 엄격한 제어를 구현해야 할 수 있습니다. Azure AD(Azure Active Directory 레이블)를 사용하여 이러한 영역을 구성할 수 있습니다. 
...
|<img src="media/audio_conferencing_image9.png" alt= "An icon depicting the next steps"/>|다음 단계|<ul><li>팀 만들기, 이름, 분류 및 게스트 액세스에 대한 조직의 요구 사항을 문서화합니다.</li><li>이러한 요구 사항을 롤아웃의 일부로 구현할 Teams 계획합니다.</li><li>정책을 통신하고 게시하여 Teams 사용자가 예상할 수 있는 동작에 대해 알릴 수 있습니다.</li></ul>|
...
> 
> [!NOTE]
> 그룹 및 팀 만들기를 제한하면 많은 Microsoft 365 Office 365 서비스를 위해 그룹을 만들어야 하기 때문에 사용자의 생산성이 저하될 수 있습니다. 자세한 내용은 에지의 거버넌스 [계획을](/microsoft-365/solutions/manage-creation-of-groups) Teams.
...
- [민감도 레이블을 사용하여 Microsoft Teams 그룹 및 Microsoft 365 사이트의 콘텐츠를 SharePoint 수 있습니다.](/microsoft-365/compliance/sensitivity-labels-teams-groups-sites)
...
| ![다음 단계를 묘사하는 아이콘](media/audio_conferencing_image9.png)<br/>다음 단계|<ul><li>팀 만료, 데이터 보존 및 보관에 대한 조직의 요구 사항을 문서화합니다.</li><li>이러한 요구 사항을 롤아웃의 일부로 구현할 Teams 계획합니다.</li><li>정책을 통신하고 게시하여 Teams 사용자가 예상할 수 있는 동작에 대해 알릴 수 있습니다.</li></ul>|
...
|보존 정책 |보안 Teams 규정 준수 센터에 보존 정책을 설정하여 특정 기간 동안 & 삭제합니다. **참고**: 이 기능을 사용하려면 E3 Microsoft 365 또는 Office 365 Enterprise 라이선스가 필요합니다. |아니요 |TBD |
|보관 및 복원 |팀이 더 이상 활성화되지 않지만 참조를 위해 유지하거나 향후 다시 활성화하려는 경우 팀을 보관합니다. |아니요 |TBD |

> [!Note]
> 그룹 만료는 Azure AD Premium 기능입니다. 이 기능을 사용하려면 테넌트에 설정 및 영향을 받는 그룹의 구성원을 구성하는 Azure AD Premium 및 라이선스에 대한 구독이 있어야 합니다.

#### <a name="additional-information"></a>추가 정보

이러한 설정을 구현하는 방법에 대한 기술 지침은 다음을 참조하세요.

- [그룹 Microsoft 365 설정합니다](/azure/active-directory/users-groups-roles/groups-lifecycle).

- [보존 정책을 Teams 설정합니다](retention-policies.md).
...
> [!NOTE]
> 미리 계획을 세우기 위해 필요한 라이선스에 [대해 자세히 알아보아야 합니다](https://azure.microsoft.com/pricing/details/active-directory/).
...
| ![다음 단계를 묘사하는 아이콘](media/audio_conferencing_image9.png)<br/>다음 단계|<ul><li>테넌트 및 사용자 수준에서 Teams 제한하기 위한 조직의 요구 사항을 문서화합니다.</li><li>특정 요구 사항을 롤아웃의 일부로 구현할 Teams 계획합니다.</li><li>정책을 통신하고 게시하여 Teams 사용자가 예상할 수 있는 동작에 대해 알릴 수 있습니다.</li></ul>|
...
- [공유 채널의 Microsoft Teams](shared-channels.md)
...
또한 채널에 대한 중재를 설정하고 특정 사용자에게 중재자 기능을 제공하여 채널 게시물을 만들고 응답할 수 있는 사용자를 제어할 수 있습니다. 자세한 [내용은](manage-channel-moderation-in-teams.md) 채널 설정 및 관리 Microsoft Teams 참조하세요.

## <a name="security-and-compliance"></a>보안 및 규정 준수

Teams 보안 및 규정 준수 기능의 고급 보안 및 Microsoft 365 Office 365 감사 및 보고, 규정 준수 콘텐츠 검색, 전자 검색, 법적 보존 및 보존 정책을 지원합니다.

> [!Important]
> 조직에 규정 준수 및 보안 요구 사항이 있는 경우 보안 및 규정 준수에 대한 개요 문서에서 이 [항목에 대해](security-compliance-overview.md) 제공된 심층적인 콘텐츠를 Microsoft Teams.
