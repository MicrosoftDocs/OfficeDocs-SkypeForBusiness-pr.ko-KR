...
ms.locfileid: "60012572"
---
# <a name="plan-for-office-365-government---dod-deployments"></a>계획 Office 365 Government - DoD 배포

이 지침은 미국 연방 정부 기관 또는 Office 365 정부 규정 및 요구 사항에 따라 데이터를 처리하는 기타 엔터티에서 배포를 구동하는 IT Office 365 Government – DoD를 사용하는 것이 이러한 요구 사항을 충족하는 데 적합한 경우를 위한 것입니다.

> [!NOTE]
> 조직에서 이미 Office 365 Government – DoD 자격 요구 사항을 충족하고 프로그램에 적용되고 수락된 경우 1단계와 2단계를 건너뛰고 3단계로 바로 이동하면 됩니다.

## <a name="step-1-determine-whether-your-organization-needs-office-365-government---dod-and-meets-eligibility-requirements"></a>1단계. 조직에서 요구하는 Office 365 Government - DoD 및 자격 요구 사항을 충족하는지 확인합니다. 

Office 365 Government - DoD 환경은 클라우드 서비스에 대한 미국 정부 요구 사항을 준수합니다. 조직의 기능 및 기능을 Office 365 뿐만 아니라 조직에서는 다음과 같은 기능의 이점을 Office 365 Government DoD:

- 조직의 고객 콘텐츠는 Microsoft의 상용 서비스에서 고객 콘텐츠와 논리적으로 Office 365 있습니다.
...
자격 요건을 포함하여 Office 365 Government 계획에서 미국 정부 고객을 위한 [](https://products.office.com/government/compare-office-365-government-plans)DoD Office 365 Government 자세한 정보를 찾을 [수 있습니다.](https://products.office.com/government/compare-office-365-government-plans#EligibilityRequirements)

미국 [Office 365](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government) 서비스 설명은 미국 내 규정 준수 요구 사항을 충족하는 데 중심이 있는 플랫폼의 이점을 설명합니다.
...
## <a name="step-2-apply-for-office-365-government---dod"></a>2단계. 신청 Office 365 Government - DoD

이 서비스가 조직에 적합한지 확인한 후 이 서비스에 대한 신청 [프로세스를 시작합니다.](https://products.office.com/government/eligibility-validation)


## <a name="step-3-understand-office-365-government---dod-default-security-settings"></a>3단계. 기본 Office 365 Government - DoD 기본 보안 설정을 이해합니다.
...
정부 클라우드 고객의 요구 사항을 수용하기 위해 Teams Office 365 Government - DoD 및 Teams 계획에 Enterprise 있습니다. 사용할 수 있는 기능을 보기 위해 다음 표를 참조합니다.
