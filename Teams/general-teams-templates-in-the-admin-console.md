...
## <a name="adopt-officd-365"></a>Officd 365 채택

챔피언 커뮤니티 출시를 전파 하 고 새로운 기술로 동료를 지원 해 보세요.

| 기본 서식 파일 형식 | 이 기본 서식 파일에 포함 된 속성 |
| ------------------ |----------------------------------------------------- |
| Office 365 도입 |  채널 <ul><li>일반</li> <li>알림에서</li> <li>챔피언 모서리</li> <li>팀 양식</li></ul> 들 <ul><li>키</li>  <li>일정</li> |li><li>기술 개발</li><li>대출 처리</li><li>고객 불만</li><li>보너스</li><li>재미 있는 내용</li><li>규정 준수</li></ul>|
|||
