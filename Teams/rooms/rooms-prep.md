...
- Active Directory 또는 Azure AD(Azure Active Directory) 인스턴스 및 Microsoft Exchange 및 Microsoft Teams.
...
Microsoft Teams 룸 암호는 "sfb"로 설정됩니다. 암호는 관리자 모드 또는 AutoUnattend.xml 파일을 통해 로컬로 변경할 수 있습니다(ADK의 Windows 시스템 이미지 관리자를 사용하여 xml 파일을 변경합니다.
...
보안 문서에서 관리자 계정에 대한 [Microsoft Teams 룸 수](security.md) 있습니다.
