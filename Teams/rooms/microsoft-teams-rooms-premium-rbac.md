---
title: Microsoft Teams 룸 프리미엄 서비스를 사용하는 역할 기반 액세스 제어
author: dstrome
ms.author: dstrome
manager: serdars
ms.reviewer: altsou
...
- **관리 서비스 관리자**: Microsoft Teams 룸 프리미엄 서비스 포털에 대한 모든 권한이 있습니다.
...
1. Microsoft Teams 룸 관리 서비스 포털의 왼쪽 탐색에서 **설정** > **역할** 로 이동합니다.
2. **역할 만들기** 를 선택합니다.
