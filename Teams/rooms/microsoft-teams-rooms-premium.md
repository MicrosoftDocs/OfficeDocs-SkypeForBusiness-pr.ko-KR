---
title: Microsoft Teams 룸 관리되는 서비스
author: dstrome
ms.author: dstrome
manager: serdars
ms.reviewer: ''
...
Microsoft Teams 룸 관리되는 서비스는 클라우드 기반 IT 관리 및 모니터링 서비스로 Microsoft Teams 룸 디바이스 및 주변 장치를 최신으로 유지하고 사전 예방적으로 모니터링하여 훌륭한 사용자 환경에 최적화된 환경을 지원합니다.
...
다음은 관리되는 서비스에서 제공하는 Microsoft Teams 룸 개요입니다.
...
다음은 위의 기능을 지원하기 위해 Microsoft Teams 룸 관리 서비스가 제공하는 중요한 기능의 요약입니다.

|기능  |설명  |
|---------|---------|
|**인벤토리 관리**   |룸 디바이스, 주변 장치, 제품 및 모델을 나열하는 대량 내보내기 옵션을 사용하여 룸 인벤토리 추적         |
|**방 등록**   |룸 디바이스를 자체 등록하여 관리되는 서비스에 Microsoft Teams 룸 쉽게 온보더링할 수 있습니다.          |
...
서비스 Microsoft Teams 룸 유지 관리 서비스의 경우 등록된 회의실은 지원되는 Microsoft Teams 룸 있어야 합니다. 필요한 모든 URL 및 [IP](/office365/enterprise/urls-and-ip-address-ranges) 주소 범위가 Office 365 회의실 디바이스에서 완전히 허용되고 도달할 수 있는 환경을 준비해야 합니다. [](requirements.md#hardware-requirements) 자세한 내용은 [설명서에서](rooms-prep.md) 환경 준비를 Microsoft Teams 룸 참조하세요.
...
|**지원되는 언어**    |영어         |
|**포털을 통한 가용성 지원**   | 24X7      |
|**관리되는 Microsoft Teams 룸 SOC에 대한 초기 응답 시간**   |  4시간       |
|**고객 비활성의 경우 티켓 자동 폐쇄**    |고객 시작 티켓: 영업일 3일<br>시스템 시작 티켓: 영업일 15일</li>   </ul>      |
|**광범위한 Microsoft 지원으로 리디렉션**   |관리되는 서비스의 범위를 벗어날 때 다른 Microsoft 제품에 Microsoft Teams 룸 관련 문제는 적절한 지원 팀으로 연결됩니다.         |
|**OEM(원래 장비 제조업체) 지원으로 리디렉션**    |관리 Microsoft Teams 룸 SOC는 문제를 이해하고 해당하는 경우 OEM과의 지원을 조정하는 데 도움이 됩니다. 경우에 따라 OEM에 직접 참여할 책임이 있을 수 있습니다.         |

또한 관리되는 Microsoft Teams 룸 SOC가 조직의 IT 작업을 지원하며 최종 사용자를 위한 지원 센터 서비스를 대체하지는 않습니다.

관리되는 서비스 지원 범위에 대한 Microsoft Teams 룸 자세한 내용은 지원 포함 및 제외 를 [참조합니다.](#support-inclusions-and-exclusions)
...
|---------|---------|---------|
|**서비스 구성**   |         |         |
|앱 설정, Microsoft Teams 룸 Windows 네트워크 Microsoft Teams 룸, 자사 소프트웨어 설정 및 권장되는 전원 설정 및 구성을 포함하여 구성에 대한 조사 및 지침입니다.     |모든 타사 소프트웨어 구성 및 조사는 Microsoft Teams 앱에 직접 Microsoft Teams 없습니다. 또한 첫 번째 파티 창 외부 또는 룸 앱 설정 외부의 구성이 필요한 모든 OEM Microsoft Teams 구성합니다.         |타사 표준 지원 채널         |
|**룸 계정 설정**    |         |         |
...
관리 Microsoft Teams 룸 서비스는 디바이스를 모니터링하고, 디바이스 데이터를 수집하며, Microsoft가 원격으로 룸 디바이스에 액세스하고 관리할 수 있도록 합니다. 관리 Microsoft Teams 룸 서비스는 모임의 라이브 콘텐츠에 액세스하지 않습니다.
