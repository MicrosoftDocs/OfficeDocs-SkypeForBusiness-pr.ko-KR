...
description: 이 문서에서는 차세대 룸 시스템인 Microsoft Teams 룸 배포하기 위한 Skype 설명하고 있습니다.
ms.openlocfilehash: eb1bacc0d96cf48f174980bd7bee9ea476f545f1
ms.sourcegitcommit: a894e9397050e09bfaab02e700e943a3bbeb1302
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 03/15/2022
ms.locfileid: "63504085"
---
# <a name="plan-microsoft-teams-rooms"></a>계획 Microsoft Teams 룸

이 문서에서는 전체 모임 및 회의실 전략의 일부로 전체 Microsoft Teams 룸 계획, 배달 및 운영에 대한 종단 간 접근 방식을 소개합니다.
...
Microsoft Teams 룸 큰 회의실까지 모든 크기의 모임에 HD 비디오, 오디오 및 콘텐츠 공유를 제공하는 완벽한 모임 환경을 제공합니다.

![사용자가 배경에 Teams 룸 본체를 탭합니다.](../media/room-systems-image1.jpg "사용자가 배경에 Teams 룸 본체를 탭합니다.")
 [Microsoft Teams 룸](https://support.office.com/article/Skype-Room-Systems-version-2-help-e667f40e-5aab-40c1-bd68-611fe0002ba2) 도움말은 배포의 일부로 가치를 추가하는 방법에 대해 Microsoft Teams 룸 자세한 정보를 찾을 수 있는 좋은 리소스입니다.
...
이러한 구성 요소를 여러 공급업체에서 미리 설치한 번들로 조달하거나 이 문서에 설명된 요구 사항을 따라 지원되는 구성 요소를 개별적으로 구입할 [수 있습니다](requirements.md).
...
| &nbsp;   |  &nbsp;   |
|-----------|------------|
|![배포를 결정할 수 있습니다.](../media/audio_conferencing_image7.png) <br/>의사 결정 지점|<ul><li>조직에서 Microsoft Teams 룸 배포하나요? </li><li>시스템 조달 방법 Microsoft Teams 룸?</li></ul> |
| ![활동을 식별합니다.](../media/audio_conferencing_image9.png)<br/>다음 단계 | <ul><li>배포 전반에 걸쳐 주요 활동을 진행할 인원을 식별합니다.</li><li>회의실을 배포할 위치와 회의실 크기에 적합한 주변 장치를 Microsoft Teams 룸(및 설정 계획)를 검토합니다.</li></ul> |
| | |
...
검색의 일부로 방 음향 및 레이아웃을 고려해야 합니다. 예를 들어 방의 의자가 카메라 보기를 차단하지 않는지 검사합니다. 방에 과도한 에코 또는 소음이 없는 공기조화가 없는지, 화면 및 전원이 충분한지 Microsoft Teams 룸. AV(시청각) 팀 또는 파트너가 조언할 수 있도록 고려해야 하는 여러 가지 요인이 있습니다. 
...
|-----------|---------------|---------------|-----------------------|--------------|-------------------------------------|----------------------------------------------------------|
| 런던 본사 | Curie         | 중형        | 612&ndash;                  | 예          | 스피커폰                        | 1 화면, 오디오 및 비디오 및 프레젠테이션<br>PSTN Access |
| 시드니 본사 | 힐          | 대형         | 1216&ndash;                 | 예          | 레거시 AV 장치, 1개 화면 및 카메라 | 2개 화면, 오디오 및 비디오 및 프레젠테이션<br>PSTN Access |
...
룸 유형 및 크기에 따라 시스템 및 주변 장치 유형에 대한 지침은 요구 사항 Microsoft Teams 룸 [참조](requirements.md)하세요. 

선호하는 공급업체에 따라 요구 사항 문서에 제공된 정보를 사용하여 룸 유형 Microsoft Teams 룸 지원되는 주변 장치 구성을 정의하고 배포에 대한 템플릿으로 사용합니다. 
...
요구 사항 문서에 Microsoft Teams 룸 파트너의 수를 획득할 [수 있습니다](requirements.md). 이러한 솔루션 및 조달 옵션에 대한 자세한 내용은 파트너의 웹 사이트를 방문하세요. 
