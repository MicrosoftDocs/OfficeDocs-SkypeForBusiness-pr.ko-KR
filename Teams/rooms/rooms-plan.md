...
|-----------|---------------|---------------|-----------------------|--------------|-------------------------------------|----------------------------------------------------------|
| 런던 사령부 | Curie         | 높음이나        | 6&ndash;12                  | 예          | 폰                        | 1 화면, 오디오 및 비디오 + 프레젠테이션<br>PSTN 액세스 |
| 시드니 사령부 | 지          | 용량의         | 12&ndash;16                 | 예          | 레거시 AV 장치, 1 화면 및 카메라 | 2 개의 화면, 오디오 및 비디오와 프레젠테이션<br>PSTN 액세스 |
