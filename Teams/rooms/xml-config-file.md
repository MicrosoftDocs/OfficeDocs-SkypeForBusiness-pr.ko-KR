...
| \<NoiseSuppressionDefault\>                 | 부울 &#x2777;            | 첫 번째 &#x2776; | 기본적으로 true를 사용하도록 설정합니다. false이면 Microsoft AI 기반 NS(노이즈 억제)만 해제됩니다. HW가 노이즈 억제를 기본 제공하면 Microsoft NS가 켜지면 계단식으로 표시됩니다. 관리자는 OEM 제공 NS만 사용하려는 경우 Microsoft AI 기반 NS를 해제해야 합니다.
