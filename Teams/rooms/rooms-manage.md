...
- **건강** Teams 룸 디바이스에 연결된 주변 장치, 네트워크 연결, 필요한 서비스에 로그인 상태 및 소프트웨어 버전 정보에 대한 자세한 정보를 표시합니다.
...
Teams 룸 디바이스 세부 정보의 **활동** 탭에는 디바이스가 시간이 지남에 따라 참가한 모든 모임에 대한 개략적이고 자세한 정보가 표시됩니다. **활동** 탭에서 모임이 열린 시간, 모임에 참석한 참가자 수, 모임 중 오디오 품질을 확인할 수 있습니다.
