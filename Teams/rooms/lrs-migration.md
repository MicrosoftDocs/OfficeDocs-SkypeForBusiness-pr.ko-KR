...
SMART LRS 고객의 경우 Crestron 하드웨어 거래 프로그램 외에도 SMART는 Microsoft Teams Rooms로 업그레이드할 수 있는 솔루션을 제공하기 위해 작업 중입니다. 이 업그레이드는 SMART Technologies Inc.에서 제품 지원에 따라 고객에게 제공됩니다. 여기에 대한 자세한 내용은 여기를 [참조하세요.](https://support.smarttech.com/docs/hardware/room-systems-skype/srs-skype-v2/en/about/default.cshtml)


## <a name="what-should-you-do"></a>어떻게 해야 하나요?

위에서 언급한 업그레이드 옵션을 사용하여 TLS 1.0/1.1 사용 안 되기 전에 Lync Room System 디바이스를 Microsoft Teams Room로 업데이트하는 것이 좋습니다. 또한 기존 디바이스를 Microsoft Teams Rooms에 대해 인증된 새 디바이스로 바꾸는 것이 고려될 수도 있습니다. 자세한 [내용은 회의실](https://aka.ms/roomdevices) 디바이스를 참조하고 [Microsoft Teams Room 요구 사항도 살펴보기 바랍니다.](/skypeforbusiness/plan-your-deployment/clients-and-devices/requirements)  


> [!NOTE]
> Microsoft Teams Rooms 소프트웨어는 앱 버전 4.0.64.0을 사용하여 2018년 12월 14일 현재 TLS 1.2 프로토콜을 지원합니다. 온라인 프레미스 고객의 경우 Microsoft Teams Rooms의 TLS 1.2를 통해 통신하려면 비즈니스용 Skype for Business Server 2015 누적 업데이트 9(CU9) 또는 비즈니스용 Skype 서버 2019 누적 업데이트 1(CU1)이 필요합니다. 클라이언트 변경 내용이 전달 및 이후 규정 준수로 비즈니스용 Skype Online 고객에게 영향을 주지 않습니다.