...
<br><br>**참고:** 정부 기관용 Teams(GCC, GCC High, DoD)의 경우, 제한은 여전히 250입니다. 정부 클라우드 제한이 250에서 300으로 늘어나면 이 문서를 업데이트 할 예정입니다. Teams 모임 제한에 대한 최신 정보는 [제한 및 사양](limits-specifications-teams.md)을(를) 참조하시기 바랍니다.
