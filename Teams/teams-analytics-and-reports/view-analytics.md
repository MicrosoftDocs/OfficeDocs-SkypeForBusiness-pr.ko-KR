...
- **팀별 분석** 은 사용자에게 특정 팀에 대한 사용 현황 데이터를 보여 주는 보다 세분화된 보기를 제공합니다.
- **채널별 분석** 은 사용자에게 특정 채널에 대한 사용 현황 데이터를 보여 주는 더욱 세분화된 보기를 제공합니다.

사용자는 이러한 보기를 필터링하여 지정된 기간 동안 데이터를 볼 수 있습니다.

## <a name="view-cross-team-analytics"></a>팀 간 분석 보기

1. Teams 팀 목록의 맨 아래에 있는 참가 또는 팀 만들기 옆에 **있는 팀 관리를** **클릭합니다**.
2. 분석 **탭을** 클릭합니다.
...
1. Teams 원하는 팀으로 이동하고 추가 옵션(**...)** 을 클릭한 다음 팀 관리를 **클릭합니다**.
2. 분석 **탭을** 클릭합니다.
4. 날짜 범위를 선택하여 팀에 대한 사용 현황 데이터를 보여 줍니다.  
    ...
    |항목 |설명  |
    |--------|-------------|
    |**요약**   |다음을 포함한 팀 활동 요약:<ul><li>**사용자**: 지정된 기간에 있는 총 사용자 수입니다. 여기에는 팀 소유자, 팀 구성원 및 게스트가 포함됩니다.</li> <li>**게시물**: 지정된 기간 동안 팀 채팅에 게시된 새 메시지의 수입니다.</li><li>**응답**: 지정된 기간 동안 팀 채팅의 응답 수입니다.</li> <li>**앱**: 팀에 추가된 앱 수입니다.</li><li>**모임**: 팀 수준에서 Teams 모임의 수입니다.</li> </ul> |
...
1. Teams 원하는 채널로 이동하고 추가 **옵션(...)** 을 클릭한 다음 채널 관리를 **클릭합니다**.
2. 분석 **탭을** 클릭합니다.
...
> [!TIP]
> 팀당 분석 보기에서 드롭다운 목록 상자에서 채널을 선택하여 채널당 분석을 [볼 수 있습니다](#view-per-team-analytics).
