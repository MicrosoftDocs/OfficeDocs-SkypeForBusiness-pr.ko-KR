...
3. **초대 미리** 보기를 클릭 하 여 모임 초대의 미리 보기를 표시 합니다.
4. 모두 마쳤으면 **저장**을 클릭 합니다.
5. 변경 내용이 전파 되는 시간을 기다립니다. 그런 다음 팀 회의 일정을 계획 하 여 모임 초대의 모양을 확인할 수 있습니다.  
...
환경에서 사용할 포트 범위를 확실히 알 수 없는 경우 다음 설정을 사용 하는 것이 좋은 출발점입니다. 자세한 내용은 [Microsoft 팀에서 QoS (서비스 품질) 구현을](QoS-in-Teams.md)참조 하세요. 이는 필요한 DSCP 표식 및 제안 된 적절 한 미디어 포트 범위를 팀과 Express에서 모두 사용 하는 것입니다.
