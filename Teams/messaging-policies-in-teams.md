...
- **대화에서 스티커를 사용. 이 기능을 설정하면 다른 사용자와의 채팅 대화에 스티커를 포함할 수 있습니다.
...
- **채팅 권한 역할** 이 설정을 사용하여 사용자의 감독된 채팅 역할을 정의합니다.  감독 채팅 [에 대해 자세히 알아보면 됩니다.](supervise-chats-edu.md)
...
- [Teams의 사용자 및 그룹에 정책 할당](assign-policies-users-and-groups.md)
