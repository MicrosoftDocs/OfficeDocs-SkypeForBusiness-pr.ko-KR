...
[Teams에 포함된](#policy-packages-included-in-teams) 정책 패키지를 사용하거나 사용자 지정 정책 패키지를 만들 [수 있습니다.](#custom-policy-packages)
...
**사용자 지정 정책 패키지는 GCC(Government Community Cloud)에 대해 아직 사용할 수 없습니다.**
