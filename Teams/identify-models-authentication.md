...
MFA는 Microsoft 365 또는 Office 365 포함된 모든 Microsoft Teams. 최소한 서비스 관리자와 같은 관리자 역할이 할당된 [](/microsoft-365/admin/add-users/about-admin-roles?view=o365-worldwide)해당 계정에 대해 MFA가 Teams 것이 좋습니다.
