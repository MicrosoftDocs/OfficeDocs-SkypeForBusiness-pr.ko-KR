...
> [!NOTE]
> Q&A는 모임 용량을 지난 참석자만 볼 수 없습니다.

관리자가 Q&A를 사용하도록 설정하면 [이끌이 역할이](https://aka.ms/GetQnA) 있는 사용자는 모임을 만들거나 업데이트할 때 Q&A를 켤 수 있습니다. Teams 및 Outlook 모임 옵션을 통해 이끌이는 이전에 추가된 모임에서 Q&A를 제거하여 참석자가 이 기능을 사용하지 못하도록 할 수도 있습니다.
...
3. 선택한 Q&탭이 열려 있는 상태에서 줄임표를 클릭하고 "제거"를 클릭합니다. 이렇게 하면 Teams 앱 스토어를 통해 추가된 Q&A 환경이 제거됩니다.
...
그거에요! 이제 모임 옵션으로 구동되는 Q&A 환경이 하나뿐입니다. Q&Teams 앱 스토어를 통해 추가된 앱이 제거됩니다.
