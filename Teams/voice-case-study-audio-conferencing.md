---
title: 'Teams Contoso 사례 연구: 오디오 회의'
author: CarolynRowe
ms.author: crowe
manager: serdars
ms.date: 06/17/2020
...
오디오 회의의 경우 Contoso는 외부뿐만 아니라 조직 내에서 잘 알려진 전화 번호를 사용했습니다. Contoso는 가능한 한 이러한 숫자를 유지 관리하기를 원하기 때문에 오디오 회의 브리지에 전용 및 공유 전화 번호를 할당하는 정보를 검토했습니다. 

Contoso는 조사에 따라 다음과 같은 결정을 내렸다. 

- 오디오 회의 호출을 정기적으로 호스트하는 인구의 세그먼트만 오디오 회의 라이선스를 받게 됩니다. 
