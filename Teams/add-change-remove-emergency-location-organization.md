...
[PSTN 연결 옵션](pstn-connectivity.md)&mdash;에 관계없이 Microsoft 통화 플랜, 운영자 연결, Teams Phone Mobile 또는 직접 라우팅&mdash;긴급 위치를 전화 번호와 연결할 수 있습니다.
...
긴급 위치를 할당하려면 사용자, 전화 번호 및 긴급 위치가 모두 동일한 국가에 있어야 합니다. 자세한 내용은 [사용자의 긴급 위치 할당 또는 변경을 참조하세요](assign-change-emergency-location-user.md).
...
5. 주소를 찾을 수 없고 주소를 수동으로 편집하려는 경우 **주소 편집을 수동으로** 켭니다.
6. **저장** 을 클릭합니다.
...
> [!NOTE]
> 주소의 유효성이 검사되지 않은 경우에만 위치의 주소 정보를 변경할 수 있습니다. 주소의 유효성이 이미 검사되었으며 주소를 변경해야 하는 경우 위치를 삭제한 다음 올바른 주소로 새 위치를 만듭니다.
