...
**앱 권한 정책은** 사용자가 사용할 수 있는 앱을 제어하는 데 사용됩니다. 관리자는 사용자가 앱 스토어에서 설치하는 특정 앱을 허용하거나 차단할 Teams 있습니다. [앱 권한 정책은](teams-app-permission-policies.md) 관리 센터를 통해 Microsoft Teams 관리됩니다.
