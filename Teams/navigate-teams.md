...
audience: admin
ms.reviewer: ''
description: 이 문서에서는 Kaizala 사용자가 Microsoft Teams 탐색하는 방법을 설명합니다.
f1.keywords: ''
...
## <a name="moving-your-kaizala-groups-to-microsoft-teams"></a>Kaizala 그룹을 Microsoft Teams 이동
...
![Teams 채널의 구역 관리자 및 매장 동료 인터페이스](media/kaizala-to-teams-image27.png)
...
팀 구성원에게 중요한 뉴스 또는 작업을 알리는 공지 사항을 만듭니다.
   ...
   ![Teams 알림](media/kaizala-to-teams-image9.png)
...
## <a name="getting-work-done-in-teams"></a>Teams 작업 완료
...
![Teams 앱 템플릿 검사 목록](media/checklisttemplatecompose.gif)
...
### <a name="jobs-in-teams"></a>Teams 작업
...
### <a name="announcements-in-teams"></a>Teams 공지 사항
...
### <a name="quiz-in-teams"></a>Teams 퀴즈
...
### <a name="training-in-teams"></a>Teams 교육
...
![Teams 보기에서 학습 만들기](media/training-app-template-compose-view.gif)
...
## <a name="moving-kaizala-custom-solutions-to-microsoft-teams"></a>Kaizala 사용자 지정 솔루션을 Microsoft Teams 이동

![Kaizala Teams 이동](media/kaizala-to-teams-image1.png)
...
## <a name="kaizala-management-portal-to-teams-admin-center"></a>Teams 관리 센터로 Kaizala 관리 포털
...
### <a name="to-move-a-kaizala-group-to-teams"></a>Kaizala 그룹을 Teams 이동하려면
...
## <a name="kaizala-tenant-data-export"></a>테넌트 데이터 내보내기 Kaizala
