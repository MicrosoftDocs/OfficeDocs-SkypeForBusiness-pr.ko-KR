...
-   둘째로, Office 365에 정의 된 기존 그룹이 없는 고객의 경우 Microsoft 365 관리 센터, 팀 웹 또는 데스크톱 클라이언트를 사용 하 여 만들 수 있습니다. 앞에서 설명한 대로 팀 클라이언트를 사용 하 여 향후 모든 구성원을 Office 365 그룹에 대해 관리 합니다. 팀 멤버 자격은 Microsoft 365 그룹에 대 한 구성원 자격이 정의 되므로 이러한 변경을 위해 사용자를 준비 해야 합니다.
