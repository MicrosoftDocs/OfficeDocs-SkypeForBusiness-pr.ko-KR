...
f1keywords: ''
description: 신용 카드, 직불 카드 또는 청구서 청구를 통해 Teams 스토어에서 타사 앱을 구입하는 방법을 알아봅니다.
appliesto:
- Microsoft Teams
...
> [!NOTE]
> 전역 관리자가 다른 전역 관리자가 구매한 구독을 관리하려는 경우 동일한 청구 계정에 있어야 합니다. Microsoft 365 관리 센터 앱을 선택하여 구매한 구독에 대한 다른 전역 관리자 액세스 권한을 부여할 수 있습니다. 여기에서 **청구 프로필** >  보기로 이동하여 **청구 계정** > **할당 역할** > **다른 전역 관리자를 추가합니다**.
