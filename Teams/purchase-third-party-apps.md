...
> [!IMPORTANT]
> 사용자가 앱 스토어를 통해 앱을 구매하지 Teams 차단하려는 경우 앱을 차단해야 합니다. 앱을 차단하는 방법에 대한 자세한 [](app-policies.md) 내용은 앱 정책 관리를 참조하거나 [org-level에서](manage-apps.md#allow-and-block-apps)앱을 차단하는 방법을 참조하세요.
...
3. 앱을 찾으면 구매를  클릭하여 앱  세부 정보 페이지의 계획 및 가격 책정 탭으로 이동합니다. 앱에 대한 SaaS 제품 계획 및 가격 정보를 검토합니다. 자세한 정보가 필요한 경우  자세한 내용을 선택하여 [AppSource의](https://appsource.microsoft.com/)앱 페이지로 이동합니다.
...
6. 청구 계정 및 판매 주소가 올바른지 확인합니다. 아직 없는 경우 추가 를 선택하여 새 추가를 **추가합니다.** 청구 계정에 대한 자세한 내용은 청구 계정 [이해 를 참조하세요.](/microsoft-365/commerce/manage-billing-accounts)
