...
**Teams 외부에서 솔루션 구매 및 설정** Microsoft의 신뢰할 수 있는 비디오 제공 파트너를 활용하여 비디오 제공 확장에 대한 전문가의 도움을 받으세요. Teams에서 비디오 배달 공급자를 사용하도록 설정하려면 먼저 Teams 외부 및 별도 SDN/eCDN 솔루션을 구입하여 설정해야 합니다.
