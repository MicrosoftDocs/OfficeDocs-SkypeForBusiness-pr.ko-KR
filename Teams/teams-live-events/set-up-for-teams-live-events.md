...
- enabler-strategic
description: 네트워크를 설정하고, 라이선스를 할당하고, 라이브 이벤트 기능 및 일정을 사용하도록 설정하고, 비디오 배포 솔루션을 포함하여 Teams에서 라이브 이벤트를 설정합니다.
appliesto:
- Microsoft Teams
...
1. Microsoft Teams 관리 센터의 왼쪽 탐색에서 모임 라이브 이벤트  >  **정책으로 이동하세요.**
2. 다음 옵션 중 하나를 선택합니다.
...
**Teams 외부에서 솔루션 구매 및 설정** Microsoft의 신뢰할 수 있는 비디오 제공 파트너를 활용하여 비디오 제공 확장에 대한 전문가의 도움을 받으세요. Teams와 함께 사용할 비디오 배달 공급자를 사용하도록 설정하려면 먼저 Teams 외부에서 SDN/eCDN 솔루션을 구입하고 설정해야 합니다.
...
- 네트워크 최적화의 업계 표준인 **Riverbed는** 가속 솔루션을 Microsoft Teams 및 Stream으로 확장하고 있습니다.  이제 Microsoft 365 고객은 Teams 및 Stream을 비롯한 365 트래픽을 다른 선도적인 엔터프라이즈 SaaS 서비스와 함께 자신 있게 가속화하여 어디서나 인력 생산성을 향상할 수 있습니다. Teams 및 Stream 가속은 Riverbed의 세계적 수준의 지원 및 지속적인 투자를 보장하는 모든 보장과 함께 사용할 수 있는 수월한 설정을 통해 사용할 수 있습니다.
