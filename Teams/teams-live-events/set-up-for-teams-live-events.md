...
description: 네트워크 설정, 라이선스 할당, 라이브 이벤트 기능 사용, 예약, 동영상 배포 솔루션을 비롯 한 팀에서 실시간 이벤트를 설정 합니다.
appliesto:
- Microsoft Teams
...
사용자가 외부 앱 또는 장치에서 생성 된 이벤트를 예약 하려면 다음 단계를 수행 해야 합니다.
...
**Teams 외부에서 솔루션 구매 및 설정** Microsoft의 신뢰할 수 있는 비디오 제공 파트너를 활용하여 비디오 제공 확장에 대한 전문가의 도움을 받으세요. 팀에서 비디오 제공 공급자를 사용 하도록 설정 하기 전에 팀과 별도로 SDN/eCDN 솔루션을 구입 하 여 설정 해야 합니다.
...
- 네트워크 최적화의 업계 표준인 Microsoft 팀 및 스트림으로의 가속 **솔루션을 확장** 하는 것입니다.  이제 Microsoft 365 고객이 다양 한 주요 엔터프라이즈 SaaS 서비스와 함께 팀과 스트리밍을 비롯 한 365 트래픽을 더욱 빠르게 가속화 하 여 어디서 나 직원 생산성을 높일 수 있습니다. 팀 및 스트림 가속은 Riverbed의 세계 수업 지원 및 지속적인 투자에 대 한 모든 보장을 통해 제공 되는 간편 설정을 통해 사용할 수 있습니다.
...
- [팀 라이브 이벤트 란?](what-are-teams-live-events.md)
