...
* 조직당 하나의 계층 구조 파일만 적용할 수 있습니다. 그러나 하나의 CSV 파일 내에 노드의 고유한 계층으로 조직의 여러 부분을 함께 포함할 수 있습니다. 예를 들어 Contoso Pharmaceuticals에는 약국 루트 노드와 소매 루트 노드가 있습니다. 두 루트 노드에는 여러 행의 후원 행이 있으며 둘 사이에는 겹치지 않습니다.
