---
title: 비즈니스용 Skype Online에서 Microsoft Teams
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
audience: admin
ms.reviewer: landerl
description: 비즈니스용 Skype Online 배포에서 Microsoft Teams 조직을 업그레이드하는 방법을 알아봅니다.
...
ms.locfileid: "64846557"
---
# <a name="upgrade-from-skype-for-business-online-to-teams"></a>비즈니스용 Skype Online에서 Teams
...
비즈니스용 Skype Online을 완전히 배포하고 사용자를 비즈니스용 Skype Teams 업그레이드하려는 경우 이 문서의 지침을 따릅니다. 사용자에게 적절한 공존 및 업그레이드 모드를 할당하여 조직에서 선택한 업그레이드 경험에 따라 사용자를 선택적으로 또는 올인할 수 있습니다.
...
## <a name="upgrade-all-users-to-teams-at-one-time"></a>모든 사용자를 한 번에 Teams 업그레이드

모든 사용자를 한 번에 Teams 업그레이드하려면 다음 단계를 수행합니다.
...
2. **공존 모드** 에서 **비즈니스용 Skype 사용자에게 Teams 업그레이드를 사용할 수 있음을 알리기** 스위치를 켜기로 변경 **합니다**.
...
Microsoft Teams 관리 센터를 사용하는 경우 최대 20명의 사용자에 대해 TeamsUpgradePolicy를 한 번에 구성할 수 있습니다.
1. Microsoft Teams 관리 센터에서 **사용자를** 선택하고 업그레이드해야 하는 최대 20명의 사용자에 대한 확인란을 찾아서 다중 선택합니다. 
2. listview의 왼쪽 위 모서리에서 **설정 편집** 을 선택합니다. 
3. 오른쪽의 **[설정 편집**] 창에서 **Teams 업그레이드** 에서 **비즈니스용 Skype 사용자** 스위치를 **켜** 기로 변경합니다. 참고: 공존 모드의 값이 "조직 전체 설정 사용"인 경우 이 스위치가 표시되지 않으므로 먼저 이러한 사용자의 공존 모드를 조직의 기본값으로 명시적으로 설정해야 합니다.

또는 PowerShell을 사용하여 사용자 그룹에 대한 알림을 한 번에 사용하도록 설정하는 것이 더 쉬울 수 있습니다. 

### <a name="step-3-set-the-coexistence-mode-for-users-to-teams-only"></a>3단계: 사용자의 공존 모드를 Teams 전용으로 설정

Teams 유일한 애플리케이션으로 사용하도록 현재 웨이브의 사용자를 업그레이드할 준비가 되면 사용자가 Teams 전용으로 공존 모드를 설정합니다.

Microsoft Teams 관리 센터를 사용하는 경우 최대 20명의 사용자에 대해 TeamsUpgradePolicy를 한 번에 구성할 수 있습니다.
1. Microsoft Teams 관리 센터에서 **사용자를** 선택한 다음 최대 20명의 사용자에 대한 확인란을 선택합니다.
2. listview의 왼쪽 위 모서리에서 **설정 편집** 을 선택합니다.
3. 오른쪽의 **[설정 편집**] 창의 **Teams 업그레이드** 섹션에서 공존 모드를 드롭다운 목록에서 **만 Teams** 설정합니다.

또는 PowerShell을 사용하여 사용자 그룹을 한 번에 업그레이드하는 것이 더 쉬울 수 있습니다. 
...
- 비즈니스용 Skype 온-프레미스 또는 Cloud Connector Edition을 통해 온-프레미스 음성 기능을 사용하는 비즈니스용 Skype Online의 사용자입니다. 사용자의 Teams 업그레이드는 TeamsOnly 사용자에게 PSTN 기능이 있는지 확인하기 위해 사용자를 직접 라우팅으로 마이그레이션하는 데 조정되어야 합니다.  자세한 내용은 [온-프레미스 음성이 있는 비즈니스용 Skype Online을 참조하세요](upgrade-to-teams-on-prem-pstn-considerations.md#from-skype-for-business-online-with-on-premises-voice).
