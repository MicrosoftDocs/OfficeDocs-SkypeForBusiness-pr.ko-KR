---
title: Microsoft Graph 사용하여 빌드된 중소기업을 위한 팀 템플릿
author: LanaChin
...
description: Microsoft Graph 빌드된 Microsoft Teams 미리 정의된 템플릿을 사용하여 중소기업을 위한 팀을 빠르고 쉽게 만들 수 있습니다.
...
ms.locfileid: "65646307"
---
# <a name="team-templates-built-in-microsoft-graph-for-small-and-medium-businesses"></a>중소기업용 Microsoft Graph 빌드된 팀 템플릿

Microsoft Teams의 팀 템플릿을 사용하면 설정, 채널 및 사전 설치된 앱의 미리 정의된 팀 구조를 제공하여 팀을 빠르고 쉽게 만들 수 있습니다.

중소기업의 경우 템플릿은 조직 전체에 Teams 신속하게 배포하는 데 도움이 되므로 특히 강력할 수 있습니다. 템플릿을 사용하면 사용자가 Teams 효과적으로 사용하는 방법을 파악할 수 있습니다. 이 문서는 조직 전체에서 여러 팀을 계획, 배포 및 관리할 책임이 있는 경우에 적합합니다.
...
일반적으로 팀 템플릿에 대한 자세한 내용은 [Microsoft Graph 사용하여 팀 템플릿을 사용한 시작](get-started-with-teams-templates.md) 참조하세요.
...
| 서식 파일 유형  | TemplateId | 이 템플릿과 함께 제공되는 속성 |
| :------------------ | :-------------- | :----------------------------------------------------- | 
| SMB - <br>임원 팀 | `https://graph.microsoft.com/beta/`<br>` teamsTemplates('SmallBusinessExecutive')` | 채널 <ul><li>일반\*</li><li>개인 \*</li></ul> 앱<ul><li>OneNote(**비공개** 채널에 고정)</li> <li>Planner( **프라이빗** 채널에 고정됨) </li></ul><br>팀 속성 <ul><li>비공개로 설정된 팀 표시 유형</li></ul> | 
...
| 서식 파일 유형 | TemplateId | 이 템플릿과 함께 제공되는 속성 |
|:------------------ | :-------------- | :----------------------------------------------------- | 
| SMB - <br>재무  | `https://graph.microsoft.com/beta/`<br>` teamsTemplates('SmallBusinessFinance')`| 채널 <ul><li>일반\*</li><li>개인 \*</li></ul><br> 앱<ul><li>OneNote(**비공개** 채널에 고정)</li> <li>Planner( **프라이빗** 채널에 고정됨) </li> </ul><br>팀 속성 <ul><li>비공개로 설정된 팀 표시 유형</li></ul> | 
