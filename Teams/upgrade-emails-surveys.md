...
## <a name="sample-emails"></a>예제 전자 메일

<a name="step-1-email"></a>

### <a name="stakeholder-email-for-step-1"></a>이해 관계자 전자 메일 (1 단계)
...
[1 단계로 돌아가기](upgrade-basic.md#step-1)

<a name="step-4-email"></a>

### <a name="notify-users-email-for-step-4"></a>4 단계에 대해 사용자에 게 전자 메일 알림
...
[4 단계로 돌아가기](upgrade-basic.md#step-4)

<a name="step-6-email"></a>

### <a name="remind-users-email-for-step-6"></a>사용자에 게 전자 메일 미리 알림 6 단계

제목 줄: 미리 알림: 팀으로 업그레이드 하기 위해 준비해 보세요.
...
[6 단계로 돌아가기](upgrade-basic.md#step-6)

<a name="step-7-email"></a>

### <a name="welcome-users-email-from-the-executive-sponsor-for-step-7"></a>책임자의 7 단계에 대 한 사용자의 전자 메일 시작
...
[7 단계로 돌아가기](upgrade-basic.md#step-7)

<a name="step-9-email"></a>

### <a name="check-in-email-for-step-9"></a>9 단계의 체크 인 전자 메일
...
[9 단계로 돌아가기](upgrade-basic.md#step-9)

<a name="step-10-email"></a>

### <a name="email-to-ask-users-to-give-teams-and-channels-a-try-for-step-10"></a>사용자에 게 팀과 채널을 제공 하도록 요청 하는 전자 메일 10 단계
...
[10 단계로 돌아가기](upgrade-basic.md#step-10)
...
팀에서 다음 활동을 수행할 수 있는 숙련 된 시간과 자세한 정보를 알고 싶은 활동이 한 개 이상 있는지 여부를 나타냅니다.

| &nbsp; | 매우 숙련 | 약간 숙련 | 숙련 되지 않음 | 자세한 정보 | 해당 없음 | 불확실/익숙하지 않음 | | | | |
|---|---|---|---|---|---|---|---|---|---|---|
| 팀과 메신저 대화를 사용 하 여 다른 사용자와 채팅 | | | | | | | | | | |
| 온라인 모임에 팀 사용 | | | | | | | | | | |
| 공동 작업 (팀 및 채널)에 팀 사용 | | | | | | | | | | |
| 모바일 장치에서 팀 사용 | | | | | | | | | | |

| **Microsoft 팀을 사용 하는 것을 막는 경우** | **적용 되는 모두 선택** |
|---|---|
| 본 적이 없는 경우 | &#9744; |
| 컴퓨터에 설치 되어 있지 않습니다. | &#9744; |
| 나의 혜택 또는 사용자가 작업 하는 사람에 대해 이해할 수 없습니다. | &#9744; |
| 필요에 따라 평가할 시간이 없었습니다. | &#9744; |
| 통신 및 공동 작업에 대 한 요구 사항을 충족 하는 다른 응용 프로그램을 이미 사용 하 고 있습니다. | &#9744; |
| 사용 하기 전에 교육이 필요 합니다. | &#9744; |
| 이를 사용 하려고 했지만 기술 문제나 나쁜 경험이 있는 경우 | &#9744; |
| 지원 센터에서 내 질문에 대해 도울 수 없음 | &#9744; |
| 현재는 사용 하지 않음 | &#9744; |
| 기타 (지정 해 주십시오) | &#9744; |
