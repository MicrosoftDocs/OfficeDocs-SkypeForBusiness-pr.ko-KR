...
<td><a href="/office365/enterprise/client-connectivity">Microsoft 데이터 센터에 가장 효율적인 라우팅을 수행</a>합니다. 로컬 또는 지역 송신 지점을 사용하여 Microsoft 네트워크에 최대한 효율적으로 연결할 수 있는 위치를 식별합니다.</td>
</tr>
<tr class="odd">
<td>침입 탐지 및 예방 지침</td>
