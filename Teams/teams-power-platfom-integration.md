...
Microsoft Power Platform은 사용자가 로우 코드 도구를 사용하여 개발을 가속화하여 Power BI 데이터를 분석 **하고, Power Apps** 사용하여 사용자 지정 앱을 빌드  **하고, Power Automate** 자동화 **하고, 그** Power Virtual Agents 지능형 봇을 만들 수 있도록 지원합니다. 원격 및 하이브리드 작업으로의 전환으로 Microsoft Teams 전 세계 사람들이 계속 만들고, 공동 작업하고, 통신할 수 있도록 지원했습니다. 매일 7,500만 명 이상의 활성 사용자를 통해 Teams 작업을 완료하는 방법을 알 수 있습니다.

:::image type="content" source="media/teams-power-platform-integration.png" alt-text="Microsoft Power Platform과 Teams 요약된 이미지입니다.":::

Microsoft Power Platform    **은 Teams 작업 Power BI 보고서, Teams 탭 또는 개인 앱으로 만든 앱을 Power Apps 메시지에서 Power Automate 흐름을 트리거하거나 적응형 카드를 사용하여 만든 봇을 추가할 수 있는 다양한 통합 기능을 제공합니다. Power Virtual Agents** Teams 다른 구성원이 상호 작용할 수 있도록 할 수 있습니다.
...
- 새 기본 데이터 플랫폼(Microsoft Dataver Microsoft 365 Teams se for Power Apps)  또는 연결선을 통해 다른 데이터 원본에 저장된 비즈니스 데이터에 연결하여 통합된 Power Apps 기반 앱을 만들고 공유합니다.
...
새 기능은 선택된 구독에 Microsoft 365 있습니다.
