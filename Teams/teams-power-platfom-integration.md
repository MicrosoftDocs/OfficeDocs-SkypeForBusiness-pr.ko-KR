...
Microsoft Power Platform은 사용자가 로우 코드 도구를 사용하여 개발을 가속화하여 Power BI 데이터를 분석 **하고, Power Apps** 사용하여 사용자 지정 앱을 빌드  **하고, Power Automate** 사용하여 프로세스를 자동화 **하고, 그** Power Virtual Agents 지능형 봇을 만들 수 있도록 지원합니다. 원격 및 하이브리드 작업으로의 전환으로 Microsoft Teams 전 세계의 사람들이 계속 만들고, 공동 작업하고, 통신할 수 있습니다. 매일 7,500만명이 넘는 활성 사용자를 Teams 작업을 완료하는 방식입니다.

:::image type="content" source="media/teams-power-platform-integration.png" alt-text="Microsoft Power Platform과 Teams 요약된 이미지입니다.":::

Microsoft Power Platform은 Teams 작업 Power BI 보고서를 탭 또는 개인 앱으로 Teams **Power Apps** 앱에 추가하고,  **모든 메시지에서 Power Automate 흐름을 트리거하거나 적응형 카드를 사용하여 만든 봇을 추가할 수 있는 다양한 통합 기능을 제공합니다. Power Virtual Agents** Teams 다른 구성원이 상호 작용할 수 있도록 할 수 있습니다.
...
- 앱과 서비스 간에 자동화된 워크플로를 만들어 파일을 동기화하고, 알림을 받고, 데이터 **수집** 등 다양한 작업을 Power Automate.
- 가이드 및 코드가 없는 그래픽 인터페이스를 사용하여 봇을 빌드하여 Power Virtual Agents 내에서 디지털  도우미를 Teams 동료가 채팅할 수 있도록 합니다.

앱, 봇 및 워크플로를 만드는 새로운 기능은 관계형 데이터 저장소, 풍부한 데이터 Teams, 엔터프라이즈급 거버넌스 및 원 클릭 솔루션 배포를 제공하는 Teams 데이터버스[](/powerapps/teams/overview-data-platform)용 데이터 Teams 새로운 기본 제공 데이터 플랫폼을 통해 지원됩니다. 데이터 Teams [Microsoft Dataverse를 통해 구축됩니다](/powerapps/maker/common-data-service/data-platform-intro). 데이터버스를 사용하여 Teams Teams 업계에서 일반적인 시나리오를 선보이는 Teams 바로 사용할 수 있는 사용자 지정 Teams 설치할 수 있습니다. 조직의 브랜디드 및 요구 사항에 맞게 이러한 사용자 지정 솔루션을 사용자 지정하고 확장할 수 있습니다.
