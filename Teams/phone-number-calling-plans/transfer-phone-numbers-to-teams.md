---
title: Microsoft Teams 전화 번호 전송
author: SerdarSoysal
ms.author: serdars
manager: serdars
...
description: 포팅 마법사를 사용하여 현재 서비스 공급자에서 Microsoft Teams 전화 번호를 전송하는 방법을 알아봅니다.
...
ms.locfileid: "66103255"
---
# <a name="transfer-phone-numbers-to-microsoft-teams"></a>Microsoft Teams 전화 번호 전송

Microsoft Teams 관리 센터의 포팅 마법사를 사용하여 현재 서비스 공급자에서 Teams 전화 번호를 전송합니다. 전화 번호를 Teams 이식하면 Microsoft가 서비스 공급자가 되어 해당 전화 번호에 대한 요금을 청구합니다.

시작하기 전에 [포트 순서](port-order-overview.md)의 정보를 검토하는 것이 좋습니다. 전화 접속 회의 브리지, 자동 전화 교환 또는 기타 서비스 번호, 무료 전화 번호 또는 Teams 전송해야 하는 999명 이상의 사용자(구독자) 전화 번호가 있는 경우 조직에서 올바른 양식을 다운로드하여 보내도록 [전화 번호 관리를](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) 참조하세요.
...
## <a name="create-a-port-order-and-transfer-your-phone-numbers-to-teams"></a>포트 주문을 만들고 전화 번호를 Teams
...
1. Microsoft Teams 관리 센터의 왼쪽 탐색에서 **Voice** > **전화 숫자** 로 이동합니다. **숫자를** 클릭한 다음 **포트** 를 클릭하여 포팅 마법사를 시작합니다.
2. **시작** 페이지에서 정보를 검토한 다음 준비가 되면 **다음** 을 클릭합니다.
3. **위치 및 숫자 유형 선택** 페이지에서 다음을 지정하고 **다음** 을 클릭합니다.

    - **국가 또는 지역**: 숫자를 가져오는 국가 또는 지역입니다.
    - **전화 숫자 유형**: 지리적 또는 무료 번호와 같은 숫자 유형입니다.
...
4. **계정 정보 추가** 페이지에서 다음을 완료한 다음 다음 **을 클릭합니다.**
    ...
    - **주문 세부 정보**: 
        - **주문 이름**: 주문 이름
        - **알림 이메일**: 주문 알림을 받을 이메일 주소입니다. 여러 전자 메일 주소를 입력하는 경우 각각을 세미콜론으로 구분합니다.
...
6. **주문 완료** 페이지에서 **서명된 권한 부여 업로드** 클릭하여 서명된 LOA(승인서)의 스캔한 복사본을 업로드합니다.
    ...
    4. 서명된 LOA를 스캔한 다음 서명 **된 권한 부여 업로드** 클릭하여 업로드합니다.
...
포트 순서의 상태를 보려면 Microsoft Teams 관리 센터의 왼쪽 탐색에서 > **음성** > **포트 주문** 으로 이동한 다음 **주문 기록을** 클릭합니다. 각 포트 순서 상태는 **상태** 열에 나열됩니다. 자세한 내용은 [포트 주문의 상태를 참조하세요.](port-order-status.md)
