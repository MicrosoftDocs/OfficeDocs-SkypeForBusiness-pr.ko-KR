...
## <a name="manually-submit-a-port-order-request"></a>수동으로 포트 주문 요청 제출

Microsoft 365 관리 센터에서 서비스 요청을 만들거나, 완성 된 승인 (LOA) 양식을 해당 지역의 PSTN 서비스 데스크에 직접 보내어 포트 순서를 수동으로 제출할 수 있습니다.

### <a name="submit-a-service-request-in-the-microsoft-365-admin-center"></a>Microsoft 365 관리 센터에서 서비스 요청 제출

1. Microsoft 365 관리 센터의 왼쪽 탐색 창에서**새 서비스 요청** **지원** > 으로 이동 합니다.  **지원** 목록이 표시 되지 않으면 왼쪽 탐색 모음에서 **탐색 사용자 지정** 으로 이동 하 여 추가한 다음 **지원** 확인란을 선택 합니다.
...
3. **고객 지원** 창에서 다음을 수행 합니다.
    ...
    2. **첨부** **파일에서 파일 추가**를 클릭 한 다음 완료 된 [LOA](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md#letters-of-authorization-loas-for-transferring-numbers)를 업로드 합니다.
    3. **대화 상대**를 클릭 합니다.

### <a name="send-your-letter-of-authorization-directly-to-the-pstn-service-desk"></a>권한 부여의 문자를 PSTN 서비스 데스크에 직접 전송

국가 또는 지역에 대 한 [LOA](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md#letters-of-authorization-loas-for-transferring-numbers) 를 다운로드 하 고 양식을 작성 한 다음 해당 지역의 [PSTN 서비스 데스크](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md) 에 보냅니다.

- 미국에서 [요청을 보냅니다](mailto:ptn@microsoft.com).
