...
---
# <a name="adobe-acrobat-as-a-default-pdf-viewer-in-microsoft-teams"></a>Microsoft Teams의 기본 PDF 뷰어인 Adobe Acrobat

> [!NOTE]
> Microsoft Teams의 기본 PDF 환경인 Adobe Acrobat은 현재 공개 미리 보기에서만 사용할 수 있습니다. 이 기능을 사용하려면 관리자는 테넌트에 [대해 공개 미리 보기를 사용하도록 설정하고](public-preview-doc-updates.md#enable-public-preview) 최종 사용자가 Teams 클라이언트 버전을 공개 미리 보기로 변경해야 합니다.

관리자는 Adobe Acrobat을 Microsoft Teams에서 PDF 파일을 보고 편집하는 기본 앱으로 설정할 수 있습니다. 최종 사용자는 Adobe Acrobat 구독 또는 Adobe ID 없이 PDF 파일을 보고, 검색하고, 주석을 달고, 주석을 달 수 있습니다.

## <a name="set-up-adobe-acrobat-app"></a>Adobe Acrobat 앱 설정

앱을 설정하기 전에 테넌트에서 앱을 사용할 수 있도록 허용하고, Adobe Acrobat 앱을 특별히 허용했는지, 앱 사용 권한 정책에서 허용하는지 확인합니다. Adobe Acrobat을 PDF 파일의 기본 앱으로 설정하려면 다음 단계를 수행합니다.

1. Teams 관리 센터에 로그인하고 **Teams 앱****[관리](https://admin.teams.microsoft.com/policies/manage-apps)** 앱  >  으로 이동합니다.

1. Adobe Acrobat 앱을 검색하여 선택합니다.
...
모든 사용자가 Adobe Acrobat 앱을 할당하고 사용할 수 있도록 하려면 다음 단계를 수행합니다.
...
저장을 선택하면 Teams는 ADOBE Acrobat 앱을 PDF 파일의 기본 파일 처리기로 사용합니다.

일부 개인 또는 그룹에 대해 Adobe Acrobat 앱을 선택적으로 허용하려는 경우 [사용자 지정 앱 사용 권한 정책을](teams-app-permission-policies.md) 할당할 수 있습니다.
...
* Adobe Acrobat 앱을 차단하는 경우 설치 정책에서 제거합니다. 그러면 최종 사용자 환경이 네이티브 PDF 파일 뷰어를 사용하여 되돌아갑니다.
* Teams 데스크톱 클라이언트에서 Adobe Acrobat 앱에 로그인하는 동안 문제가 발생하는 경우 브라우저에서 Teams를 사용하여 로그인합니다.
