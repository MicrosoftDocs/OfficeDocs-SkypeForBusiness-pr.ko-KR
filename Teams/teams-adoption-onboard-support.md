...
- [알려진 문제 및 문제 해결](https://aka.ms/TeamsKnownIssues)
- [Microsoft Teams 교육](https://docs.microsoft.com/microsoftteams/training-microsoft-teams-landing-page)

![다음 단계를 나타내는 아이콘: Microsoft Teams 채택 ](media/teams-adoption-next-icon.png) [3단계:](teams-adoption-phase3-enable.md)크기 조정.
