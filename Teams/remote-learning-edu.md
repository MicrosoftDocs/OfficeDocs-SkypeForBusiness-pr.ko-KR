...
>
> - [**Teams에서 교육하는 데 가장 중요한 첫 단계**](https://support.office.com/article/microsoft-teams-5aa4431a-8a3c-4aa5-87a6-b6401abea114)에 대한 방법 지침을 포함하는 교사용으로 작성된 문서 모음입니다.
...
온라인 학습은 교실에서 학습하는 것과 같이 개인적, 참여적 그리고 사회적으로 연결될 수 있습니다. 학생과 교사는 계속해서 대화를 통해 서로에게 도움을 줄 수 있으며 라이브 모임에서 실제로 모임에 참여하는 것처럼 느낄 수 있습니다. 교사는 과제를 사용하여 학생의 일과 진행 상황을 추적할 수 있습니다. 아무도 연락받고 있지 않다고 생각할 필요가 없습니다. 온라인으로 학습하는 많은 학생이 더 많이 발언할 수 있고 교실에서 교사 및 친구들과 더욱 연결되어 있다고 느낍니다. 교실에서와 마찬가지로 교사는 Teams의 앱 및 기능을 사용하여 가장 적합한 방식으로 지원할 수 있습니다.

Microsoft Teams는 대화, 콘텐츠, 과제, 앱을 한 곳으로 가져오는 디지털 허브로, 교사에게 생생한 학습 환경을 만들어 줍니다. 단일 환경에서 공동 작업 교실을 만들고, 전문 학습 커뮤니티에 연결하고, 동료와 연결할 수 있습니다.

Teams 내에서 교사는 신속하게 학생들과 함께 대화하고 파일 및 웹 사이트를 공유하고 OneNote 수업용 전자 필기장을 만들고 과제를 배포하고 등급을 지정할 수 있습니다. 기본으로 제공되는 OneNote 수업용 전자 필기장 및 엔드투엔드 과제 관리를 통해 교사는 대화형 수업을 구성하고 효과적이고 적시에 피드백을 제공할 수 있습니다. 학교 관리자와 직원은 발표 및 주제별 대화에 직원 Teams를 사용하여 최신 정보를 얻고 공동으로 작업할 수 있습니다. 교육자는 전문 학습 커뮤니티를 사용하여 교육용 자료를 공유할 수 있습니다.
