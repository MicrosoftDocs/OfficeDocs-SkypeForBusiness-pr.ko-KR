...
관리 Teams 관리 센터에서 또는 PowerShell을 사용하여 Microsoft 365 라이선스를 관리합니다. 라이선스를 관리하려면 전역 관리자 또는 사용자 관리 관리자가 되어야 합니다.
...
Teams 사용자 수준 라이선스는 관리 센터 사용자 관리 인터페이스를 통해 Microsoft 365 직접 관리됩니다. 관리자는 새 사용자 계정을 만들 때 또는 기존 계정이 있는 사용자에게 라이선스를 할당할 수 있습니다. 

> [!IMPORTANT]
> 관리자는 라이선스를 관리하기 위해 전역 관리자 또는 사용자 관리 관리자 권한이 Microsoft Teams 있어야 합니다.
관리 Microsoft 365 관리 센터를 사용하여 Teams 사용자 또는 소규모 사용자 집합에 대한 라이선스를 관리합니다. 라이선스 페이지에서 Teams(최대 20명 사용자) 또는 활성 사용자 페이지에서 라이선스를 **관리할 수** 있습니다.  선택한 방법은 특정 사용자에 대한 제품 라이선스를 관리하거나 특정 제품에 대한 사용자 라이선스를 관리할지 여부에 따라 결정됩니다.
