...
ms.locfileid: "65016650"
---
# <a name="change-the-phone-numbers-on-your-audio-conferencing-bridge"></a>오디오 회의 브리지에서 전화 번호 변경

**오디오 회의** 라이선스를 구입하면 Microsoft에서 조직에 대한 오디오 회의 브리지를 호스팅합니다. 오디오 회의 브리지는 모임 이끌이와 참가자가 전화를 사용하여 Skype for Business 참가하거나 모임을 Microsoft Teams 데 사용할 수 있도록 여러 위치에서 전화 접속 전화 번호를 제공합니다.
...
3. **편집** 페이지의 **할당** 대상에서 드롭다운을 확장한 다음 **Conference** **bridgeApply** > 를 선택합니다.
...
1. 왼쪽 탐색 창에서 **MeetingsConference** >  브리지로 이동합니다.
...
```
 ...
 자세한 내용은 [Microsoft Teams 초대에 포함된 전화 번호 설정 또는 Skype for Business](set-the-phone-numbers-included-on-invites-in-teams.md) [Online의 초대에 포함된 전화 번호 설정을](/SkypeForBusiness/audio-conferencing-in-office-365/set-the-phone-numbers-included-on-invites) 참조하세요.
...
Windows PowerShell 사용하여 사용자와 사용자가 수행할 수 있는 작업 또는 허용되지 않는 작업을 관리할 수 있습니다. Windows PowerShell 일상적인 작업을 간소화할 수 있는 단일 관리 지점을 사용하여 Microsoft 365 또는 Office 365 관리하고 Skype for Business Online을 관리하는 데 도움이 될 수 있습니다. Windows PowerShell 시작하려면 다음 항목을 참조하세요.
...
- [Windows PowerShell 사용하여 Skype for Business Online 관리](/SkypeForBusiness/set-up-your-computer-for-windows-powershell/set-up-your-computer-for-windows-powershell)

- [Windows PowerShell 사용하여 일반적인 Skype for Business Online 관리 작업 수행](/SkypeForBusiness/set-up-your-computer-for-windows-powershell/set-up-your-computer-for-windows-powershell)
