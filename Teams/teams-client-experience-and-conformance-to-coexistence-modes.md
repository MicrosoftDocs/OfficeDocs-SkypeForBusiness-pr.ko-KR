...
> [!NOTE]
> 이 페이지에서는 사용자가 비즈니스용 Skype 공존 모드 (SfBOnly, SfBWithTeamsCollab, SfBWithTeamsCollabAndMeetings)에 있는 경우 팀 클라이언트의 동작에서 최근에 발표 된 중요 한 변경 사항에 대해 설명 합니다.
...
**참고:**
<sup></sup> 이번에는 SfBwithTeamsCollab 및 SfBOnly가 동일 하 게 작동 하지만 팀에서 채널 및 파일 기능을 사용 하지 않도록 설정 하는 것도 SfBOnly 모드입니다. 중간에는 앱 사용 권한 정책을 사용 하 여 채널을 숨길 수 있습니다.
