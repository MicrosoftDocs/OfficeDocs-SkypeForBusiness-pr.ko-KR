...
|:-----|:-----|
|Microsoft Teams 관리 센터에 나열되지 않은 새 사용자 또는 서비스 전화 번호를 가져옵니다.|뉴질랜드에서는 Microsoft Teams 관리 센터를 사용하여 조직의 전화 번호를 받을 수 있습니다. 양식을 다운로드하여 새 전화 번호 요청을 제출하고 [TNS 서비스 데스크에 문의하여 지침을 확인할 수도 있습니다](contact-tns-service-desk.md).<br/><br/>[뉴질랜드에 대한 새로운 전화 번호 요청(mi-nz)](https://download.microsoft.com/download/4/a/a/4aa04212-a13d-46bf-b09e-1efbcbb2e622/new-phone-number-request-for-new-zealand-(v1.0)-(mi-NZ).pdf). <br/><br/> 전화 번호를 할당하려면 먼저 고객 알고 양식을 다운로드하여 전체 양식을 작성하고 [TNS Service Desk에 문의하여 지침을](contact-tns-service-desk.md) 확인해야 합니다.<br/><br/>새로운 주문은이 시장에 채우기 위해 2 ~ 3 주가 걸릴 수 있습니다.  |
