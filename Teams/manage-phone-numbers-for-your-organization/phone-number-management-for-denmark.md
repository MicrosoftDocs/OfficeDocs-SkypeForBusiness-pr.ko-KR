...
ms.locfileid: "48324224"
---
# <a name="phone-number-management-for-denmark"></a>덴마크어 용 전화 번호 관리

이 표를 사용 하 여 Microsoft 팀의 덴마크어에서 전화 번호를 받고 관리 하는 방법에 대 한 정보를 찾습니다. 
  
자세한 내용은 [조직의 전화 번호 관리](manage-phone-numbers-for-your-organization.md)를 참조 하세요.
  
|**실행할 작업**|**올바른 양식을 다운로드 하 여 저희에 게 보내기**|
|:-----|:-----|
|Microsoft 팀 관리 센터에 나열 되지 않은 새 사용자 및 서비스 전화 번호를 가져옵니다.   <br/> |이 양식을 다운로드 합니다. <br/>  [덴마크어 (v. 5.0)에 대 한 새 전화 번호 요청 (da-진한)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-denmark-(v.5.0)-(da-dk).pdf?raw=true) <br/>  <br/>기입 하 여 보내 [주십시오](mailto:ptneu@microsoft.com).
|전화 번호를 귀하에 게 전송 하세요.  <br/> | 이 양식을 다운로드 합니다. <br/>[덴마크 (모든 번호)의 인증 문자 (LOA) (v. a 5.0) (da-진한)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-denmark-(all-numbers)-(v.5.0)-(da-dk).pdf?raw=true) <br/> <br/>기입 하 여 보내 [주십시오](mailto:ptneu@microsoft.com). <br/> |
