...
|:-----|:-----|
|Microsoft 팀 관리 센터에 나열 되지 않은 새 사용자 또는 서비스 전화 번호를 가져옵니다.   <br/> |이 양식을 다운로드 합니다. <br/>  [스웨덴 (v. 5.0)에 대 한 새 전화 번호 요청 (sv-se)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-sweden-(v.5.0)-(sv-se).pdf?raw=true) <br/>  <br/>기입 하 여 보내 [주십시오](mailto:ptneu@microsoft.com).|
