...
2. 왼쪽 창에서 **음성** 을 선택한 다음 **전화 번호를** 선택합니다.

3. 페이지의 오른쪽 위 모서리에서 **작업을** 클릭한 다음 **전화 번호 지원 가져오기** 를 선택합니다. [전화 번호 서비스 센터로](https://pstnsd.powerappsportals.com/) 전송됩니다.
