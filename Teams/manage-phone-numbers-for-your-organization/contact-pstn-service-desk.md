...
모든 정보를 받은 후에는 귀하의 요청에 적용 되는 다음 전자 메일 주소 중 하나에 요청을 보냅니다.
- **번호 포팅**
    - **미국 또는 캐나다 내**에서 전화 번호를 포팅 하려면 [ptn@microsoft.com에서 전자 메일을 보내 주시기 바랍니다](mailto:ptn@microsoft.com).
    - **미국 또는 캐나다 이외의**지역에서 전화 번호를 포팅 [ptneu@microsoft.com에서 전자 메일을 보내 주십시오](mailto:ptneu@microsoft.com).
