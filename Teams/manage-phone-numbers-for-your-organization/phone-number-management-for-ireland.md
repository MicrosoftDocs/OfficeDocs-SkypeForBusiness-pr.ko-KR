...
|:-----|:-----|
|관리 센터에 나열되지 않은 새 사용자 또는 서비스 Microsoft Teams 수 있습니다. <br/> |아일랜드에서는 관리 센터를 사용하여 조직에 대한 전화 번호를 Microsoft Teams 수 없습니다. 새 전화 번호 요청을 제출해야 합니다. <br/><br/>이 양식을 다운로드합니다.<br/>아일랜드에 대한 새 전화 번호 [요청(v.5.0) (en-us)](https://download.microsoft.com/download/9/e/5/9e5634d7-ce23-489f-b867-6f5120645fb1/new-phone-number-request-for-ireland-(v.5.0)-(en-us).pdf) <br/><br/> 작성하고 [지침은 PTSN 서비스 데스크에 문의하세요.](contact-pstn-service-desk.md)  <br/> |
