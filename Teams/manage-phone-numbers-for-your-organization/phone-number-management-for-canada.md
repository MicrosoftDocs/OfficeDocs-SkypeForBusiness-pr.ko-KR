...
|한 번의 Microsoft 365 Office 365 전송합니다.  <br/>               | 전송하려는 사용자(구독자) 전화 번호 목록에 대한 지침은 [PTSN에](contact-pstn-service-desk.md) 문의하세요. PIN을 설정하기 위해 여기를 [클릭하세요.](../phone-number-calling-plans/port-order-overview.md#can-i-port-out-my-numbers-from-teams-to-a-different-phone-service-provider-or-carrier)  <br/> |
