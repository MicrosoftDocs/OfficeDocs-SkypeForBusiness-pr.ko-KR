...
- Calling Plans
- seo-marvel-apr2020
description: 조직의 Microsoft Teams에 대한 사용자(구독자) 및 서비스(무료 전화 번호) 및 서비스(무료) 전화 번호를 구하고 관리하는 방법에 대해 자세히 알아보고 있습니다.
ms.openlocfilehash: 7b7bbc7dae1aff2b582853c3deaf0d1861f20361
ms.sourcegitcommit: 01087be29daa3abce7d3b03a55ba5ef8db4ca161
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 03/23/2021
ms.locfileid: "51101174"
---
...
- Microsoft Teams 관리 센터에서 새 사용자 전화 [번호를 받고 있습니다.](../getting-phone-numbers-for-your-users.md#get-new-phone-numbers-for-your-users)
- Microsoft Teams 관리 센터에서 새 서비스 전화 [번호를 받고 있습니다.](../getting-service-phone-numbers.md#get-new-service-numbers)
...
- Microsoft Teams 관리 센터에 나열되지 않은 새 전화 번호에 대한 요청 양식을 사용하세요.
...
각 국가 또는 지역에는 서로 다른 지침, 다양한 유형의 전화 번호(지리적/비지리 전화 번호 및 서비스(전화/무료)) 및 Microsoft Teams에서 사용할 수 있도록 전화 번호를 구하기 위한 규칙/규정이 있습니다.

Microsoft Teams 관리 센터를 사용하여 새 사용자(구독자) 또는 서비스(무료) 전화 번호를 받을 수 없는 경우도 있습니다. 또는 특정 전화  번호(정식 요청) 또는  특정 지역 코드가 필요할 수 있습니다.

그렇다면 올바른 PDF LOA 양식(국가 또는 지역 및 전화 번호 유형)을 다운로드하여 다시 보내야 합니다. 서비스 데스크에서 요청 처리를 시작할 것입니다.

### <a name="letters-of-authorization-loas-to-transferport-existing-phone-numbers-from-another-service-provider-to-microsoft-teams"></a>다른 서비스 공급자에서 Microsoft Teams로 기존 전화 번호를 전송/포트하는 LOAS(인증 편지)

기존 전화 번호를 전송/포트해야 하는 경우 다른 서비스 공급자의 기존 번호를 Microsoft Teams로 요청하고 전송할 수 있는 권한을 부여하는 LOA(승인 서신)를 다운로드, 작성 및 보내야 합니다.
...
- Toll-Free 번호입니다.
- 전송/포트에 필요한 999개 이상의 사용자 전화 번호는 로컬 번호 포터링 마법사를 사용하여 Microsoft Teams 관리 센터에 액세스할 수 없습니다.
