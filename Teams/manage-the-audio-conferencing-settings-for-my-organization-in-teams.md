...
### <a name="to-assign-a-license-for-a-user"></a>사용자에 대한 라이선스를 할당하는 경우
...
### <a name="enable-or-disable-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 Microsoft Teams 사용하지 않도록 설정
...
### <a name="enable-or-disable-using-windows-powershell"></a>Windows PowerShell
...
### <a name="reset-the-meeting-conference-id-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 모임 Microsoft Teams 다시 설정
...
### <a name="reset-a-conference-organizers-pin-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 회의 이끌이의 PIN Microsoft Teams 재설정
...
### <a name="send-an-email-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 Microsoft Teams 보내기
...
### <a name="set-invite-phone-numbers-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 초대 Microsoft Teams 설정
...
### <a name="set-the-meeting-experience-when-callers-join-a-meeting-using-the-microsoft-teams-admin-center"></a>관리자 센터를 사용하여 발신자들이 모임에 참가할 Microsoft Teams 설정
...
### <a name="set-the-pin-length-for-meetings"></a>모임에 대한 PIN 길이 설정
...
### <a name="enable-or-disable-email-from-being-sent-to-audio-users"></a>오디오 사용자에게 전자 메일이 전송되지 않도록 설정하거나 사용하지 않도록 설정
...
### <a name="see-primary-and-secondary-languages-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 기본 및 보조 Microsoft Teams 참조
...
## <a name="see-audio-conferencing-dial-in-numbers-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 오디오 회의 전화 접속 Microsoft Teams 참조
