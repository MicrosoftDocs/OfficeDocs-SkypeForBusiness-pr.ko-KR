...
description: 게스트, 페더레이션된 사용자 및 익명 사용자에 대해 Microsoft Teams의 앱이 작동하는 방식을 알아봅니다.
...
ms.locfileid: "68494631"
---
# <a name="use-teams-apps-as-an-external-attendees-or-guest"></a>Teams 앱을 외부 참석자 또는 게스트로 사용

Teams 앱을 사용하면 조직 외부 사용자와의 공동 작업을 수행할 수 있습니다. 관리자는 Teams 채팅, 모임 및 채널에 액세스하여 조직의 사용자와 공동 작업할 수 있는 사용자를 제어합니다. 자세한 내용은 [외부 참석자와의 공동 작업을 허용하는 방법과](manage-external-access.md) [Teams에서 게스트가 수행할 수 있는 작업을 참조하세요](guest-access.md). 이 문서에서는 조직 외부의 사용자가 앱을 사용하는 데 중점을 둡니다.

다음 유형의 사용자가 Teams 채팅 또는 모임에 참석할 수 있으며, 사용자가 허용하는 경우 Teams에서 앱을 사용할 수 있습니다.
...
* 모임 채팅에 봇이 설치되면 해당 채팅에 있는 다른 조직의 사람들과 사전에 통신할 수 있으며, 이러한 사용자는 봇과 통신할 수 있습니다.
* 호스팅 조직의 데이터 정책이 적용됩니다.
* 해당 사용자 조직에서 공유하는 타사 앱의 데이터 공유 사례가 적용됩니다.

## <a name="anonymous-users"></a>익명 사용자

### <a name="install-update-and-delete-apps-for-anonymous-users"></a>익명 사용자용 앱 설치, 업데이트 및 삭제
...
### <a name="disallow-anonymous-users-to-use-apps-in-meetings"></a>익명 사용자가 모임에서 앱을 사용하도록 허용 안 함

기본적으로 익명 사용자는 모임에서 기존 앱과 상호 작용할 수 있습니다. 익명 사용자가 앱과 상호 작용하는 것을 허용하지 않습니다.

1. Teams 관리 센터에 로그인하고 모임 **[모임 설정](https://admin.teams.microsoft.com/meetings/settings)****에 액세스합니다** > .

1. **참가자** 아래에서 **익명 사용자가 모임의 앱과 상호 작용할 수 있는** 토글을 **해제** 로 변경합니다.
...
* [게스트 및 외부 참가자와의 공동 작업을 허용하는 방법](manage-external-access.md)
* [게스트가 Teams에서 수행할 수 있는 작업](guest-access.md)
