...
Microsoft는 이 문서에 나열된 디코더와 인코더를 제외한 모든 디코더와 인코더를 지원합니다.
...
레거시 운영 체제의 경우 하드웨어 가속을 위해 다음 Device_ids만 사용하도록 설정됩니다.
