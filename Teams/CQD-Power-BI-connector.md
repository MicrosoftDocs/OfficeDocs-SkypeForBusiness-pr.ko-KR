...
6. **GCC(Government Community Cloud) 지원 –** GCC 환경의 고객의 경우 Power BI Desktop을 사용할 때 CQD Power BI 커넥터가 작동합니다. CQD Power BI 커넥터는 현재 GCC 고객용 Power BI 서비스와 호환되지 않습니다.
