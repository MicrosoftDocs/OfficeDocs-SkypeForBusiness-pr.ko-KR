...
이 문서에서는 업그레이드한 후에 조직에 대한 Teams 성공적으로 운영하기 위한 요구 사항에 대한 개요를 제공합니다. 조직에서 Teams 제대로 운영하면 조직에 고품질의 신뢰할 수 있는 환경을 제공해야 합니다.
...
<tr><td><img src="media/audio_conferencing_image9.png" alt="An icon depicting the next steps"/><br/>다음 단계</td><td><ul><li>작업 가이드 전체를 검토합니다.</li><li>조직의 목표에 부합하는 운영 전략을 구현하여 워크로드의 품질과 Teams 구현합니다.</li><li>환경 품질 검토 가이드를 검토합니다.</li><li> 운영 전략을 구현하여 경험의 품질 검토를 정기적으로 수행하여 Teams 배포가 최고 성능으로 작동하고 있는지 확인합니다.</li></ul></td></tr>
...
Microsoft Teams 기술을 Microsoft 365 Office 365 허브를 제공합니다. 예제는 다음과 같습니다.
...
[서비스 Microsoft 365 또는 Office 365 확인 방법](https://support.office.com/article/How-to-check-Office-365-service-health-932AD3AD-533C-418A-B938-6E44E8BC33B0)
...
초기 파일럿이 시작된 후 실제 사용량을 측정하기 위한 Teams 중요합니다. 이렇게 하면 조직에서 실제 사용량이 Envision 단계에서 예측한 사용량과 어떻게 일치하는지 파악할 수 있습니다. 이 섹션에서는 Teams 사용에 중점을 두지만, 전체 사용량을 측정하고 평가하기 위한 Microsoft 365 Office 365 해야 합니다.
...
| 사용량 측정 | 드라이브 Teams 단계(배포가 완료된 후)에서 사용량을 측정하고 평가합니다. 필요한 경우 사용 현황 문제를 해결합니다. | Biweekly | |
| (드라이브 값 단계) | | | |
...
NPS(순 프로모터 점수)는 업계 전반의 고객 충성도 메트릭이자 사용자 정서 평가에 사용할 수 있는 좋은 접근 방식입니다. NPS는 다음 두 가지 질문을 통해 계산할 수 있습니다. "동료에게 Teams 추천할 가능성이 Teams?", "왜?" 자유형 질문과 함께 계산할 수 있습니다.
