...
오디오 회의용 라이선스를 구입할 때 할당되는 로컬 전화 접속 번호가 있습니다. 전화 접속 번호는 모임 초대에 포함됩니다. 이러한 로컬 번호는 조직에서만 사용할 수 있습니다. 조직에 할당된 전화와 해당 번호는 오디오 회의에 사용하도록 설정된 해당 조직 내의 사용자가 공유합니다. 따라서 비즈니스용 Skype 또는 Microsoft Teams A 및 다른 사용자 B가 예약한 모임에 동일한 전화 접속 번호가 있습니다.
  
로컬 전화 접속 번호 및 조직이 있는 국가의 국제 전화 접속 번호도 모임 초대에 포함됩니다. 모임 참석자는 초대에 포함된 다른 번호를 사용하는 경우 공유 전화 번호가 됩니다.
  
## <a name="how-many-international-dial-in-numbers-does-audio-conferencing-in-microsoft-365-or-office-365-support"></a>오디오 회의가 지원되는 국제 전화 접속 번호는 Microsoft 365 Office 365 있나요?

현재 국가/지역 목록은 전화 온라인에서 오디오 회의에 대한 Microsoft Teams 전화 숫자를 비즈니스용 Skype [참조하세요.](/SkypeForBusiness/audio-conferencing-in-office-365/phone-numbers-for-audio-conferencing) [](phone-numbers-for-audio-conferencing-in-teams.md)
...
모임 제한에 대한 자세한 내용은 온라인 [비즈니스용 Skype 참조하세요.](/office365/servicedescriptions/skype-for-business-online-service-description/skype-for-business-online-limits#bkmk_Meeting_LyncOnlineLimits)
...
관리자인 사용자가 전자 메일로 [](https://support.office.com/article/eac4d046-1afd-4f1a-85fc-8219c79e1504)오디오 회의 정보 및 PIN을 보내고 업데이트할 수 있는 새 기능을 추가했습니다. 이 설정을 사용하지 않도록 설정하는 방법을 [](enable-or-disable-sending-emails-when-their-settings-change-in-teams.md) 포함하여 자세한 내용은 오디오 회의 설정이 온라인에서 변경될 때 전자 메일 보내기 Microsoft Teams 설정이 변경될 때 전자 메일 보내기 사용 또는 사용 안 을 비즈니스용 Skype [참조하세요.](/SkypeForBusiness/audio-conferencing-in-office-365/enable-or-disable-sending-emails-when-their-settings-change)
...
현재 오디오 회의를 통해 브로드캐스트에 참가할 수 있도록 설정된 사용자에 대한 지원이 Skype 모임 없습니다.
  
## <a name="can-a-user-get-operator-assistance-during-a-meeting"></a>사용자가 모임 중에 운영자 지원을 받을 수 있나요?

아니요, 사용자는 모임 중에 *0을 눌러 운영자 지원 또는 지원을 받을 수 없습니다. 오디오 회의에 문제가 있는 경우 조직의 관리자는 [Microsoft](https://support.office.com/article/Microsoft-support-for-Office-365-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)지원에 문의하여 를 Office 365.
