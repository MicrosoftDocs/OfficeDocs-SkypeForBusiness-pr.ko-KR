...
1. (곧 출시 예정) 맞춤 **앱 아래** 에서 라이선스를 기반으로 맞춤 앱 표시를 끄거나 **끄거나 끄기.** 이 설정이 설정된 경우 사용자는 라이선스에 따라 앱이 고정되는 환경을 얻습니다. 자세한 내용은 라이선스에 [Teams 앱 맞춤을 참조하세요](pin-teams-apps-based-on-license.md).
