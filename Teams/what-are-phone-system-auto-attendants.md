...
전화 시스템은 외부 및 내부 발신자가 조직의 사용자 또는 부서에 게 전화를 걸고 배치 하거나 전송할 수 있도록 하는 데 사용 되는 자동 전화 교환을 제공 합니다.
...
전화 시스템용 자동 전화 교환을 설정 하려면 [클라우드 자동 전화 교환 설정](create-a-phone-system-auto-attendant.md)으로 이동 합니다.
