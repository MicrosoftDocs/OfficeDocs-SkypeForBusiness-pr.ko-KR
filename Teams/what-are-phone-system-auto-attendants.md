...
자동 전화 연결은 대부분의 경우 시스템의 노드로, 발신자에게 사용자 운영자가 아닌 음성 프롬프트 또는 음성 파일을 일련의 음성 프롬프트 또는 오디오 파일을 제공합니다. 사용자가 자동 전화 접속과 연결된 번호로 전화를 걸면 해당 사용자가 선택한 전화가 사용자에게 리디렉션되거나 조직에서 다른 사람을 찾은 다음 해당 사용자에게 연결할 수 있습니다. DTMF(휴대폰 키패드) 또는 음성 인식을 사용하여 선택 항목을 표현하고 메뉴 시스템과 상호 작용할 수 있습니다. 사용자가 선택한 선택은 통화를 다른 자동 전화 걸기 또는 통화 큐로 리디렉션할 수도 있습니다.
  
전화 시스템에 대한 자동 전화 번호를 설정하기 위해 클라우드 자동 전화 회의 [설정으로 이동 합니다.](create-a-phone-system-auto-attendant.md)
  
클라우드 자동 지원에는 다음과 같은 기능이 있습니다.
...
- 자동 전화 번호에 전화 번호를 할당할 때 엄격하게 말하면 해당 자동 전화 연결과 연결된 리소스 계정에 전화 번호를 할당하는 것입니다. 이렇게 하면 두 개 이상의 전화 번호로 자동 전화 접속에 액세스할 수 있습니다. 대부분의 경우 리소스 계정은 비용 없는 전화 시스템 가상 사용자 라이선스를 사용하게 됩니다. 이 라이선스는 조직 수준에서 전화 번호에 전화 시스템 기능을 제공하며, 자동 전화 회의 및 통화 큐를 만들 수 있습니다.
...
이름으로 전화 걸기 기능은 디렉터리 검색으로도 알려진 자동 전화 접속 기능입니다. 이를 통해 자동 전화 회의에 전화를 걸면 음성(음성 인식) 또는 DTMF(전화 키패드) 응답을 사용하여 전체 또는 부분 이름을 입력하여 회사 디렉터리를 검색하고, 해당 사람을 찾은 다음, 통화를 전송할 수 있습니다. 전화기를 사용하여 전화를 걸고 싶은 사용자는 전화 번호가 필요하거나 통화 요금제가 할당되어 있지 않지만 온라인 사용자인 경우 전화 시스템 라이선스가 있어야 합니다. Enterprise Voice 비즈니스용 **Skype Server** 사용자가 사용할 수 있도록 설정되어 있어야 합니다. 이름별로 전화를 걸면 여러 국가 또는 지역에서 다국적 조직에 호스트된 Microsoft Teams 사용자에게 전화를 찾아 전송할 수도 있습니다. 관련 구성이 필요한 경우 자동 전화 접속에서 Dial by Name을 명시적으로 사용하도록 설정해야 합니다.
...
자동 전화 연결에 음성 인식을 사용하도록 설정할 수 있지만 DTMF(휴대폰 키패드 항목)는 사용할 수 없습니다. 자동 전화 회의에서 음성 인식을 사용하도록 설정되어 있는 경우에도 휴대폰 키패드 항목을 사용할 수 있습니다.
...
이러한 옵션은 메뉴 프롬프트가 재생될 때 자동 전화 걸기에서 발신자에 표시됩니다. 예: "판매를 위해 1을 누르고 서비스에 대해 2를 누르기. 운영자에게 말하기 위해, 아무 때나 0을 누르면 됩니다."
