...
ms.locfileid: "58600983"
---
# <a name="toll-free-dialing-restrictions-in-kenya"></a>케냐의 무료 전화 걸기 제한
...
|전화 걸기 형식  <br/> | 0 800 7XX XXX <br/> |
|국가/지역 ISO 코드  <br/> |KE  <br/> |
|섬/지역 커버  <br/> |해당 사항 없음  <br/> |
|적용되지 않는 섬/지역  <br/> |해당 사항 없음  <br/> |
|유선/고정된 선 가용성  <br/> |부분. 주석을 참조합니다.  <br/> |
|모바일 네트워크 가용성  <br/> |부분. 주석을 참조합니다.  <br/> |
|주석, 제한 사항 및 액세스 문제  <br/> |네트워크 액세스 수정: Safaricom 및 Airtel. 모바일 네트워크 액세스: Safaricom, Airtel 및 Orange입니다.  <br/> |
