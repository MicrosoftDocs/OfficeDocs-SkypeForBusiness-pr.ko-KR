...
ms.locfileid: "41693713"
---
# <a name="toll-free-dialing-restrictions-in-uruguay"></a>우루과이의 무료 전화 걸기 제한
...
|전화 걸기 형식  <br/> |0004 019 XXXX  <br/> |
|국가/지역 ISO 코드  <br/> |UY  <br/> |
|덮여 있는 섬/지역  <br/> |해당 사항 없음  <br/> |
|섬/지역은 적용되지 않습니다.  <br/> |해당 사항 없음  <br/> |
|유선/고정 선 가용성  <br/> |예( Claro 제외).  <br/> |
|모바일 네트워크 가용성  <br/> |부분. 설명을 참조합니다.  <br/> |
|주석, 제한 사항 및 액세스 문제  <br/> |모바일 액세스: Airtime 요금이 청구됩니다. 모바일 액세스: Ancel 및 Movistar에서 사용할 수 있습니다.  <br/> |
