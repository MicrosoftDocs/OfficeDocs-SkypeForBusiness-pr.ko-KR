...
- Calling Plans
- seo-marvel-mar2020
description: 사용 가능성, 유선/고정 회선, 모바일 네트워크 가용성, 제한을 포함 하 여 터키의 무료 전화 번호를 사용 하는 방법에 대해 알아봅니다.
ms.openlocfilehash: 0d69feb1b5a4496fef479260ebaa0f96febac6a3
ms.sourcegitcommit: cddaacf1e8dbcdfd3f94deee7057c89cee0e5699
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 04/03/2020
ms.locfileid: "43139727"
---
# <a name="toll-free-dialing-restrictions-in-turkey"></a>터키의 무료 전화 걸기 제한
...
|전화 걸기 형식  <br/> |00 800 XXXX XXXXX-XXXXX-XXXXX-XXXXX-XXXXX  <br/> |
|국가/지역 ISO 코드  <br/> |비교한  <br/> |
|섬/지역 포함  <br/> |해당 사항 없음  <br/> |
|섬/지역 포함 안 함  <br/> |해당 사항 없음  <br/> |
|유선/고정 회선 가용성  <br/> | 예 (수퍼 온라인을 제외한). <br/> |
