...
- Calling Plans
- seo-marvel-mar2020
description: 일본에서 무료 전화 번호(가용성, 유선/고정 유선 및 모바일 네트워크 가용성, 제한 사항)에 대해 자세히 알아보고
ms.openlocfilehash: 6413f93bfe655ed52ccea187b69024e4bed1a556
ms.sourcegitcommit: cddaacf1e8dbcdfd3f94deee7057c89cee0e5699
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 04/03/2020
ms.locfileid: "43140357"
---
# <a name="toll-free-dialing-restrictions-in-japan"></a>일본에서 무료 전화 걸기 제한
...
|전화 걸기 형식  <br/> |00531 XX XXXX  <br/> |
|국가/지역 ISO 코드  <br/> |JP  <br/> |
|덮여 있는 섬/지역  <br/> |해당 사항 없음  <br/> |
|섬/지역은 적용되지 않습니다.  <br/> |해당 사항 없음  <br/> |
|유선/고정 선 가용성  <br/> |예  <br/> |
|모바일 네트워크 가용성  <br/> |부분. 설명을 참조합니다.  <br/> |
|주석, 제한 사항 및 액세스 문제  <br/> |모바일 네트워크 액세스: NTT Docomo, Au(KDD) 및 Softbank.  <br/> |
