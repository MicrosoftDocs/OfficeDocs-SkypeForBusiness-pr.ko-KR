...
---
# <a name="toll-free-dialing-restrictions-in-philippines"></a>필리핀에서 무료 전화 걸기 제한
...
|유선/고정 회선 가용성  <br/> | PLDT 에서만. <br/> |
|모바일 네트워크 가용성  <br/> |부분적 이지만 premium 요금입니다. 메모를 참조 하세요.  <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> |Sun 셀룰러 및 스마트 모바일 네트워크에서 사용할 수 있습니다.  <br/> |
