...
- Calling Plans
- seo-marvel-mar2020
description: 가용성, 유선/고정 선 및 모바일 네트워크 가용성 및 제한 사항을 포함하여 필리핀의 무료 전화 번호에 대해 자세히 배워야 합니다.
ms.openlocfilehash: 4d38c75a002733fda1874a7aba3a5a1d08a85ba0
ms.sourcegitcommit: cddaacf1e8dbcdfd3f94deee7057c89cee0e5699
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 04/03/2020
ms.locfileid: "43139757"
---
# <a name="toll-free-dialing-restrictions-in-philippines"></a>필리핀의 무료 전화 걸기 제한
...
|유선/고정 선 가용성  <br/> | PLDT에서만. <br/> |
|모바일 네트워크 가용성  <br/> |부분적이지만 프리미엄 요금입니다. 설명을 참조합니다.  <br/> |
|주석, 제한 사항 및 액세스 문제  <br/> |Sun Cellular 및 스마트 모바일 네트워크에서 사용할 수 있습니다.  <br/> |
