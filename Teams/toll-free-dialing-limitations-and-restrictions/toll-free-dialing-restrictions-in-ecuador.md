...
---
# <a name="toll-free-dialing-restrictions-in-ecuador"></a>에쿠아도르 무료 전화 걸기 제한
...
|국가/지역 ISO 코드  <br/> |EC  <br/> |
|섬/지역 포함  <br/> |해당 없음  <br/> |
|섬/지역 포함 안 함  <br/> | (Etapa)에서 액세스할 권한이 없습니다. <br/> |
|유선/고정 회선 가용성  <br/> | Pacifictel 에서만 가능 합니다. <br/> |
|모바일 네트워크 가용성  <br/> |아니요  <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> | Pacifictel 네트워크 에서만 액세스할 <br/> |
