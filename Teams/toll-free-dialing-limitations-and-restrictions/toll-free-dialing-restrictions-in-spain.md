...
---
# <a name="toll-free-dialing-restrictions-in-spain"></a>스페인에서 무료 전화 걸기 제한
...
|국가/지역 ISO 코드  <br/> |디자인이  <br/> |
|섬/지역 포함  <br/> |Balearic 섬 및 카나리아 섬  <br/> |
|섬/지역 포함 안 함  <br/> |해당 없음  <br/> |
|유선/고정 회선 가용성  <br/> |'  <br/> |
|모바일 네트워크 가용성  <br/> |'. 프리미엄 요금으로 이용할 수 있습니다.  <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> |다른 outpulses를 사용 하 여 모바일 id를 제공 합니다.  <br/> |
