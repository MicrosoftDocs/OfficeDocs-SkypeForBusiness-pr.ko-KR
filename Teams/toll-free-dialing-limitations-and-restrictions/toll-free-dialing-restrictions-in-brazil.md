...
---
# <a name="toll-free-dialing-restrictions-in-brazil"></a>브라질의 무료 전화 걸기 제한
...
|국가/지역 ISO 코드  <br/> |B  <br/> |
|섬/지역 포함  <br/> |해당 없음  <br/> |
|섬/지역 포함 안 함  <br/> |해당 없음  <br/> |
|유선/고정 회선 가용성  <br/> |'  <br/> |
|모바일 네트워크 가용성  <br/> |부분적 이지만 premium 요금입니다. 메모를 참조 하세요.  <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> |모바일 액세스: 방송 시간이 부과 되지 않습니다.  <br/> |
