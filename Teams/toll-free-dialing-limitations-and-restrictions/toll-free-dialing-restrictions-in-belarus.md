...
ms.locfileid: "37571643"
---
# <a name="toll-free-dialing-restrictions-in-belarus"></a>벨로루시의 무료 전화 걸기 제한
...
|전화 걸기 형식  <br/> |8 820 XXXX XXXX  <br/> |
|국가/지역 ISO 코드  <br/> |여  <br/> |
|섬/지역 포함  <br/> |해당 없음  <br/> |
|섬/지역 포함 안 함  <br/> |해당 없음  <br/> |
|유선/고정 회선 가용성  <br/> |'  <br/> |
|모바일 네트워크 가용성  <br/> |'  <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> |Velcom, MTS, Life의 모바일 네트워크 액세스  <br/> |
