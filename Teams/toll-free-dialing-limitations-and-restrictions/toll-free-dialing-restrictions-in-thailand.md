...
|국가/지역 ISO 코드  <br/> |TH  <br/> |
|덮여 있는 섬/지역  <br/> |해당 사항 없음  <br/> |
|섬/지역은 적용되지 않습니다.  <br/> |해당 사항 없음  <br/> |
|유선/고정 선 가용성  <br/> |예  <br/> |
|모바일 네트워크 가용성  <br/> |예. 설명을 참조합니다.  <br/> |
|주석, 제한 사항 및 액세스 문제  <br/> |모바일 액세스: 로밍어를 제외하고는 Airtime 요금이 부과되지 않습니다. 이 경우 로밍은 현지 항공 시간으로 청구됩니다. 모바일 액세스: 모든 모바일 네트워크에서 액세스할 수 있습니다.  <br/> |
