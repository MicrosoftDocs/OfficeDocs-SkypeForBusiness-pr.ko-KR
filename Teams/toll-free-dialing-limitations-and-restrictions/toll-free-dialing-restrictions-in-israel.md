...
|전화 걸기 형식  <br/> | 1-80-9XX-XXXX <br/>  1-80-92X-XXXX <br/> |
|국가/지역 ISO 코드  <br/> |IL  <br/> |
|섬/지역 포함  <br/> |해당 없음  <br/> |
|섬/지역 포함 안 함  <br/> | 팔레스타인 자치 지역에서 접근할 권한이 없습니다. <br/> |
|유선/고정 회선 가용성  <br/> |예  <br/> |
|모바일 네트워크 가용성  <br/> | Partial. 메모를 참조 하세요. <br/> |
|메모, 제한 사항 및 액세스 문제  <br/> |모바일 액세스: Paltel &amp; jawal/Watania 모바일 네트워크에서 액세스할 권한이 없습니다.  <br/> |
