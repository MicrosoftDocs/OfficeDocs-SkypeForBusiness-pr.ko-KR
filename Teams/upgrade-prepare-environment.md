...
---
# <a name="prepare-your-environment-for-upgrading-to-teams"></a>Teams로 업그레이드하기 위한 환경 준비
...
조직에서 Teams 업그레이드를 성공적으로 진행하려면 현재 비즈니스용 Skype 환경과 네트워크 준비의 유효성을 검사하는 것이 중요합니다. 현재 환경을 준비하면 Teams에서 사용자 환경의 품질을 개선하는 것 외에도 고품질의 사용자 환경을 보장하는 데 도움이 됩니다. 개별 단계를 계획하는 데 시간이 걸린 경우 배포를 가속화하고 중요한 작업 항목을 건너뛴 경우를 보장할 수 있습니다.
