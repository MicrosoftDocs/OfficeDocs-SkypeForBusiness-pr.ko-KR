...
#### <a name="view-the-conference-id-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 Microsoft Teams ID 보기
...
#### <a name="view-the-conference-id-using-windows-powershell"></a>회의 ID를 사용하여 Windows PowerShell
...
#### <a name="reset-the-conference-id-using-the-microsoft-teams-admin-center"></a>관리 센터를 사용하여 Microsoft Teams 다시 설정
...
#### <a name="reset-the-conference-id-using-windows-powershell"></a>전화 회의 ID를 사용하여 Windows PowerShell
