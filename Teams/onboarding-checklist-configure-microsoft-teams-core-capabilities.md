...
| 5mb  | 선택 사항: 게스트 액세스 구성 | 팀에서 게스트 액세스를 사용 하 여 조직 외부 사용자와 팀 및 채널에 대 한 액세스 권한을 부여 하 여 공동 작업을 수행 합니다. 게스트 액세스는 팀의 테 넌 트 수준 설정입니다. 이 기능은 기본적으로 해제 되어 있습니다. <br/>조직에서 해당 기능을 사용할 계획인 경우 게스트 액세스를 사용 하도록 설정 하 고 테 넌 트 전체 게스트 설정을 구성 합니다. | | [Microsoft Teams의 게스트 액세스](guest-access.md) |
