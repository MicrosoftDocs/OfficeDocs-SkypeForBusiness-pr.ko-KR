...
| 2  | 테넌트에 Teams 활성화되어 있는지 확인합니다. | Teams 기본적으로 설정되어 있습니다. 서비스 **&** 추가 기능 페이지를 Microsoft 365 관리 센터에서 조직에 Teams 활성화되어 있는지 확인하고 필요한 경우 사용하도록 설정합니다. | | [Microsoft Teams 또는 Microsoft 365 Office 365](office-365-set-up.md) |
...
| 10 | 선택 사항: PowerShell을 사용하여 관리 Teams | 관리 센터가 아닌 PowerShell cmdlet을 사용하여 Microsoft 365 설정 관리 및 Teams 수 있습니다. | | [Microsoft Teams PowerShell](/powershell/module/teams/?view=teams-ps) |