...
개인 지점 교환 (PBX)은 비즈니스 내의 전화 시스템입니다. 휴대폰 시스템을 사용 하면 PBX 기능을 사용할 수 있지만 복잡 하 고 저렴 한 장비가 제공 되지 않습니다. 

전화 시스템을 사용 하면 기존 온-프레미스 PBX 시스템을 클라우드 환경에 긴밀 하 게 통합 된 Microsoft 365 또는 Office 365에서 제공 하는 기능 집합으로 바꿀 수 있습니다. 기능에 대 한 자세한 내용은 [다음은 전화 시스템에서 얻을 수 있는 내용](here-s-what-you-get-with-phone-system.md)입니다.

## <a name="phone-system-technology"></a>전화 시스템 기술

전화 시스템은 Microsoft 팀과 비즈니스용 Skype Online을 사용 하 여 클라우드에서 통화 제어 및 PBX 기능을 사용할 수 있도록 합니다. 
...
- Microsoft 통화 요금제 (국내 또는 국내 및 국제)를 구매 합니다. Microsoft 호출 계획은 PSTN 통신 회사로 서 Microsoft를 사용 하는 클라우드 솔루션입니다. 자세한 내용은 [전화 시스템 및 통화 계획](calling-plan-landing-page.md)을 참조 하세요.
