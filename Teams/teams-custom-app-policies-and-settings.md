...
관리자 및 팀 소유자는 팀에서 사용자 지정 앱을 추가할 수 있는지 여부를 제어할 수 있습니다. 이 **설정은 사용자** 지정 앱 정책과 함께 구성원이 사용자 지정 앱을 업로드하도록 허용하여 특정 팀에 사용자 지정 앱을 추가할 수 있는 사용자를 결정합니다.
...
3. 사용자 **지정 앱에서** 사용자 지정 앱과의 상호 작용 허용을 켜 **거나 해제합니다**.
