...
| 어떤 Teams 설정을 적용해야 하나요? | Teams 설정을 사용하여 전자 메일 통합, 클라우드 저장소 옵션, 조직 탭, 회의실 장치 설정 및 검색 범위와 같은 기능에 맞게 Teams를 설정할 수 있습니다. 이러한 설정을 변경하면 해당 설정은 조직의 모든 팀에 적용됩니다.<p>[Teams 설정](enable-features-office-365.md#teams-settings)  |
