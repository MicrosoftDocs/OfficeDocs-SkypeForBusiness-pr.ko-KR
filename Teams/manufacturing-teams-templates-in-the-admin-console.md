...
---
# <a name="use-teams-manufacturing-templates-in-the-admin-center"></a>관리 센터에서 Teams 제조 템플릿 사용

Teams 서식 파일을 사용하면 설정, 채널 및 미리 설치된 앱의 미리 정의된 서식 파일을 제공하여 빠르고 쉽게 팀을 만들 수 있습니다.

Teams 템플릿에는 제조 요구 사항을 중심으로 설계된 팀 구조에 대한 미리 작성된 정의가 있습니다. Teams 서식 파일을 확장하여 특정 조직 요구에 맞는 팀을 만들 수도 있습니다.
...
제조 공장 팀과의 통신, 리소스 액세스 및 공장 운영을 중앙 집중화합니다. 정책 및 절차 문서, 교육 비디오, 안전 알림, 교대 근무 인계 프로세스를 포함합니다.
