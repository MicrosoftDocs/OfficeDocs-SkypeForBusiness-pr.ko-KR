...
사용 하지 않는 팀 수를 설정 하려면 관리자가 [Microsoft 365 또는 Office 365 그룹 만료 정책을](https://docs.microsoft.com/office365/admin/create-groups/office-365-groups-expiration-policy) 사용 하 여 사용 하지 않는 팀을 자동으로 정리 하면 됩니다. 팀은 그룹에 의해 지원 되므로 그룹 만료 정책도 팀에 자동으로 적용 됩니다.
