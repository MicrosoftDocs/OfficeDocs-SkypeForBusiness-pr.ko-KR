...
# <a name="perform-your-upgrade-to-teams"></a>팀으로 업그레이드 수행

비즈니스용 Skype의 현재 배포에 따라 업그레이드 여행 선택:

- [비즈니스용 Skype Online에서 팀으로 업그레이드](https://aka.ms/SkypeToTeams-UpgradeOnline)
- [비즈니스용 Skype에서 팀에 하이브리드 업그레이드](https://aka.ms/SkypeToTeams-UpgradeHybrid)
- [비즈니스용 Skype 온-프레미스에서 팀으로 업그레이드](https://aka.ms/SkypeToTeams-UpgradeOnPrem)
