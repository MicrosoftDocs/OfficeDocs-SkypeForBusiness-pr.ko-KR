...
ms.locfileid: "58725477"
---
# <a name="view-microsoft-teams-utilization-in-power-bi-using-cqd-data"></a>CQD Microsoft Teams 사용하여 Power BI 사용률 보기

2020년 3월에 [CQD에](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/CQD-Power-BI-query-templates.zip?raw=true)대한 다운로드 가능한 Teams 쿼리 템플릿에 Power BI 사용률 보고서를 추가했습니다. 

이 Teams 사용률 보고서를 통해 사용자가 CQD(통화 품질 대시보드) 데이터에 액세스하여 Microsoft Teams 방법(및 양)을 Teams 수 있습니다. 이러한 보고서는 관리자와 비즈니스 리더가 이 데이터에 대해 빠르게 이동할 수 있는 중앙 집중식 위치입니다.

Teams 사용률 Power BI 보고서는 통화 수 요약 및 오디오 **[](#call-count-summary-report)** 분 요약의 두 가지 기본 **[보고서로 구성됩니다.](#audio-minutes-summary-report)** 사용자가 [](#daily-usage)아래 설명에 설명된 드릴다운 [](#user-list) 보고서를 활용할 때 일일 사용량, [지역](#regional-audio-details)오디오 세부 [정보,](#conference-details) 회의 세부 정보 및 사용자 목록 보고서가 재생됩니다.
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report1.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report9.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report10.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report11.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report12.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report13.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report14.png)
  
  1.  차트 아래의 표에는 해당 시간의 메트릭이 표시됩니다. 열 헤더로 정렬할 수 있습니다. 그러나 문제가 있는 영역을 찾는 데 관심이 있습니다.  
    ![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report15.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report24.png)

![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report25.png)
  

아래 표에서 잠재적인 문제 해결 노력을 지원하기 위해 회의 참가자뿐만 아니라 패킷 손실 및 지터까지 모든 관련 정보를 볼 수 있습니다.

![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report26.png)
...
1.  호출 개수 요약 페이지에서 표를 통해 특정 지역으로 드릴스루합니다.
  ![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report16.png)

2.  필요한 지역 추가 정보가 필요한 행을 선택합니다.
  ![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report17.png)

3.  데이터 추세는 내부 네트워크에서 사용되는 상당한 수의 분을 보여 주며 회의는 P2P 사용을 훨씬 능가합니다.
  ![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report18.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report19.png)
...
![스크린샷: Teams 사용률 보고서입니다.](media/CQD-teams-utilization-report20.png)
