...
> [!NOTE]
> CQD에 업로드 하는 보고 레이블은 *고객 데이터* 또는 *개인 데이터로*간주 되는 정보를 포함 하 여 Microsoft 365 또는 Office 365에 대 한 계약에 따라 *지원 데이터로* 처리 됩니다. Microsoft에 제공 하지 않을 데이터는 지원 *데이터로*포함 하지 마세요 .이 정보는 지원에 대 한 microsoft 엔지니어가 볼 수 있습니다.
