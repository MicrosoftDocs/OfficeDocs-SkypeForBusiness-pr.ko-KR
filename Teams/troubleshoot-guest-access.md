...
라이선싱 오류가 표시되면 [Azure Active Directory B2B 라이선싱 지침](https://docs.microsoft.com/azure/active-directory/b2b/licensing-guidance)을 읽고 조직의 게스트 액세스에 대한 요구 사항을 충족하는 라이선싱 요구 사항을 결정해야 합니다.
