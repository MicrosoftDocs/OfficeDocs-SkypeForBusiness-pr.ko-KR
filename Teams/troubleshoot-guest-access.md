...
- 문제를 알고 있는지 확인하려면 조직의 지원 Teams [를 참조합니다.](/MicrosoftTeams/troubleshoot/teams-welcome)
...
> [!NOTE]
> Teams 게스트가 다른 (리소스) 테넌트에서 게스트로 로그인하고 사용할 수 Teams 게스트의 홈 테넌트에서 사용하도록 설정해야 합니다.
