...
Microsoft 팀의 칭찬 앱은 사용자에 게 조직이 나 강의실 구성원에 게 감사를 표시 하는 데 도움이 됩니다. 선택할 수 있는 배지 설정 및 사용자 지정 옵션을 사용 하 여 칭찬에서 사용자가 수행 하는 다양 한 작업을 교육 하는 데 도움이 되도록 디자인 되었습니다. 자세한 내용은 [사용자에 게 칭찬 보내기를](https://support.microsoft.com/office/send-praise-to-people-50f26b47-565f-40fe-8642-5ca2a5ed261e)참고 하세요.

관리자는 Microsoft 팀 관리 센터에서 조직에 사용할 수 있는 배지를 제어할 수 있습니다. 왼쪽 탐색 창에서 팀 앱으로 이동 하 **> 앱을 관리** 합니다. 앱 목록에서 **칭찬** 를 클릭 한 다음 **설정을** 선택 합니다.  여기서는 기본 및 기본 제공 배지 집합을 사용 하도록 설정 하 고 사용자 지정 배지를 만들 수 있습니다.
...
**사용자 지정 배지 만들기를** 선택 합니다. 여기서는 측면 패널에서 사용자 지정 배지를 디자인할 수 있습니다. 최대 25 명의 사용자 지정 배지를 만들 수 있습니다. 
