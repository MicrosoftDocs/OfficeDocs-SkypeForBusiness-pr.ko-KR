...
긴급 서비스 호출은 Microsoft 365 또는 Office 365의 통화 계획과 기존 전화 서비스와 다르게 작동합니다. 이러한 차이점을 이해하고 Microsoft 365 또는 Office 365의 통화 계획으로 모든 사용자에게 전달하는 것이 중요합니다. 긴급 서비스 호출의 차이점을 읽고 이해한 것을 인정하고 동의하며 Microsoft 365 또는 Office 365의 통화 요금제로 각 사용자에게 이 공지를 제공할 것입니다.
  
응급 서비스 호출 기능의 차이점은 다음과 같습니다. (i) 비즈니스용 Skype 및 Teams는 응급 서비스 호출을 하는 발신자의 실제 위치를 알 수 없습니다. 잘못된 응급 서비스 콜 센터 및/또는 응급 서비스로 라우팅되는 호출이 잘못된 위치로 라우팅될 수 있습니다. (ii) 사용자의 Teams 클라이언트가 오프라인 상태이거나 사용자의 디바이스가 네트워크 정전 또는 정전과 같은 이유로 인터넷에 액세스할 수 없는 경우 Microsoft 365 또는 Office 365의 전화 시스템을 통한 긴급 서비스 호출은 지원되지 않습니다. (iii) Microsoft 365 또는 Office 365의 통화 요금제는 인터넷 연결을 사용할 수 있는 전 세계 어디에서나 사용할 수 있습니다. 통화가 해당 국가/지역의 적절한 콜 센터로 라우팅되지 않을 수 있기 때문에 사용자는 본국/지역 외부 위치에서 응급 서비스 호출을 하지 말아야 합니다.
