...
응급 서비스 호출은 기존 전화 서비스와는 다른 Microsoft 365 Office 365 요금제와 다르게 작동합니다. 이러한 차이점을 이해하고 모든 사용자에게 전화 요금제로 Microsoft 365 Office 365. 귀하는 긴급 서비스 호출의 차이점을 읽고 이해한 것을 인정하고 동의하며, 이 통지를 각 사용자에게 전화 요금제 또는 Microsoft 365 Office 365.
