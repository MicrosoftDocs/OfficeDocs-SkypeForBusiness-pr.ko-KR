...
description: 라이브 대화형 워크샵은 30일 만에 Microsoft Teams 실행하도록 디자인되었습니다.
f1.keywords:
- CSH
...
<div id="main" class="v2">
    <div class="container">
        <p>Microsoft Teams는 중간 규모 조직(500-5000명)을 시작하고 30일만에 Microsoft Teams 수 있도록 설계된 일련의 라이브 대화형 워크샵인 <strong>30</strong>에서 초대할 수 있습니다. 시간 테스트 지침 및 모범 사례를 알아보고 질문과 대답을 Teams 참여하세요. 워크샵 참가자는 전문가와 함께 오픈 마이크 사무실 시간에 대한 Teams 수 있습니다.
           <p>뛰어들 준비가 되신가요? 프로젝트 팀의 모든 구성원이 <i>30</i>개 세션에서 시작 Teams 시작하는 것이 권장됩니다. 아래 세션 제목을 클릭하여 등록합니다.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>최종 사용자 준비</h3>
                    <p>사용자를 준비하고, 챔피언을 구성하고, 사용자 수락을 주요 구성 요소로 사용할 수 있도록 하는 전략과 리소스를 Teams 있습니다.</p><p><i>대상: 소유자 채택 및 변경</i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>최적화 및 확장</h3>
                    <p>서비스 성능을 최적화하고, 기능을 확장하고, Teams 사용자를 온보더링하는 계획을 디자인합니다.</p>
                    <p><i>대상: 비즈니스 스폰서, IT 관리자, 채택 및 변경 소유자</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>Teams 회담</h3>
                    <p>주제 전문가가 용이하게 진행하는 이 온라인 대화형 워크샵은 가장 인기 있는 몇 가지 시나리오에 대한 모범 사례와 실용적인 지침을 배울 수 있는 고유한 기회를 Teams. Chalk Talks는 기본 롤아웃을 완료했다고 Teams 가정합니다.</p>
