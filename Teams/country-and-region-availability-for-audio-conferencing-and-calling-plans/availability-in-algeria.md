...
여기에는 비즈니스용 Skype 용 Office 365 서비스와 알제리에서 사용할 수 있는 Microsoft 팀이 나와 있습니다.
...
|오디오 회의에 대 한 전화 번호가 자동으로 할당 되나요?  <br/> | 아니요 |
...
|**기능**|**세부적인**|
|:-----|:-----|
|유료 전화 번호를 받을 수 있는 대/주 도시는 무엇 인가요?   | 비 지역. 전화 번호가 특정 도시 또는 위치에 연결 되어 있지 않습니다. <br/> |
|유료 전화 번호를 사용 하 고 계십니까?  <br/> |지리적이 지 않음 ([요청 시](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)) <br/> |
