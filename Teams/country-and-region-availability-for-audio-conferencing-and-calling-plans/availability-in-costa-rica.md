...
다음은 Costa rica에서 Microsoft 365 Office 365 및 비즈니스용 Skype Microsoft Teams 서비스입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |전화 숫자는 특정 도시 또는 위치에 연결되지 않습니다.  <br/> 전용 전화 번호를 원하는 경우 [비즈니스용 Skype 및 Microsoft Teams의 서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요.  <br/> |
