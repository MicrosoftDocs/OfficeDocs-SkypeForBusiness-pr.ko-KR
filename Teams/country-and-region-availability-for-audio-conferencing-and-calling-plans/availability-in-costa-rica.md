...
- Phone System
- Calling Plans
description: 다음은 비즈니스용 Skype용 Microsoft 365 및 Office 365 서비스 및 Costa Rica에 사용할 수 있는 Microsoft Teams입니다.
...
[다른 국가 또는 지역을](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)찾거나 오디오 회의 및 통화 계획에 대한 국가 및 지역 가용성에 대해 자세히 알아보실 수 있습니다. 오디오 회의 및 통화 계획.

다음은 비즈니스용 Skype용 Microsoft 365 및 Office 365 서비스 및 Costa Rica에 사용할 수 있는 Microsoft Teams입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |전화 번호는 특정 도시 또는 위치에 연결되지 않습니다.  <br/> 전용 전화 번호를 원하는 경우 [비즈니스용 Skype 및 Microsoft Teams의 서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요.  <br/> |
