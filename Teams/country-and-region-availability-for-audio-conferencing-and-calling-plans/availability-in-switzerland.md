...
ms.locfileid: "41852365"
---
# <a name="availability-in-switzerland"></a>스위스의 가용성

> [!NOTE]
> 스위스의 **서비스** 번호를 사용 하 여 회의, 자동 전화 교환 및 통화 대기열에 사용할 수 있지만, 통화 요금제를 사용할 수 없기 때문에 스위스에서는 **사용자** 번호를 가져올 수 없습니다.
...
다음은 비즈니스용 Skype 및 스위스에서 사용할 수 있는 Microsoft 팀을 위한 Office 365 서비스입니다.
...
|오디오 회의에 대 한 전화 번호가 자동으로 할당 되나요?  <br/> |예, 다음을 수행 합니다. <br/><ul><li> Zurich</ul>전용 전화 번호를 원할 경우 [비즈니스용 Skype 및 Microsoft 팀에 대 한 서비스 전화 번호 가져오기를](/microsoftteams/getting-service-phone-numbers)참조 하세요.  <br/> |
...
|**기능**|**세부적인**|
|:-----|:-----|
|유료 전화 번호를 받을 수 있는 대/주 도시는 무엇 인가요?  <br/> |Zurich  <br/> |
