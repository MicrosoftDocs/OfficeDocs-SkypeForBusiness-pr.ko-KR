...
---
# <a name="availability-in-italy"></a>이탈리아의 사용 가능 여부
...
다음은 비즈니스용 Skype에 대 한 Microsoft 365 및 Office 365 서비스와 이탈리아에서 사용할 수 있는 Microsoft 팀입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우:<br/><ul><li> Milan</ul>전용 전화 번호를 원할 경우 [서비스 전화 번호 가져오기를](/microsoftteams/getting-service-phone-numbers)참조 하세요.  <br/> |
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |Milan  <br/> |
