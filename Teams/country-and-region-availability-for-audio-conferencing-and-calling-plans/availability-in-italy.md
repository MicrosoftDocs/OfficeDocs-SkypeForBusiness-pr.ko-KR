...
ms.locfileid: "67271023"
---
# <a name="availability-in-italy"></a>이탈리아의 가용성
...
다음은 이탈리아에서 사용할 수 있는 비즈니스용 Skype 및 Microsoft Teams용 Microsoft 365 및 Office 365 서비스입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우:<br/><ul><li> 밀라노</ul>전용 전화 번호를 원하는 경우 [서비스 전화 번호 가져오기를 참조하세요](../getting-service-phone-numbers.md).  <br/> |
...
|:-----|:-----|
|통화 플랜을 구매할 수 있나요?  |예          |   
|통화 플랜에 사용할 수 있는 시간(분)입니다.    |월당 5가지 플랜 옵션을 사용할 수 있습니다. <ul><li>종량제 통화 플랜 </li><li> 120분 국내 통화 플랜 </li><li> 240분 국내 통화 플랜 </li><li> 1200분 국내 통화 플랜 </li><li> 국제 통화 플랜: 국내 1200분 또는 국제 통화 600분(해당 월 중 첫 번째 통화)</li></ul> [IT(관세 투명성)](https://www.microsoft.com/download/details.aspx?id=102426)<br>[관세 투명성(EN)](https://www.microsoft.com/download/details.aspx?id=102426) |
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |밀라노  <br/> |
|유료 번호를 사용할 수 있나요?  <br/> |예  <br/> |
|무료 번호를 사용할 수 있나요?  <br/> |예  <br/> |

 오디오 회의, 자동 전화 교환 및 통화 큐에 대한 통행료 및 무료 전화 번호를 받으려면 [서비스 전화 번호 가져오기](../getting-service-phone-numbers.md)를 참조하세요.
