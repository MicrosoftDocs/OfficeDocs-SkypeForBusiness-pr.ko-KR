...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우:<br/><ul><li>Vienna </ul>전용 전화 번호를 원할 경우 [서비스 전화 번호 가져오기를](/microsoftteams/getting-service-phone-numbers)참조 하세요.  <br/> |
...
|프리미엄 번호로 아웃 바운드 통화를 할 수 있습니까?  <br/> | 예 <br/> |
