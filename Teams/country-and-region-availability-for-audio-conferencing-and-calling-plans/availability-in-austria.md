...
다음은 비즈니스용 Skype용 Microsoft 365 및 Office 365 서비스 및 오스트리아에서 사용할 수 있는 Microsoft Teams입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우:<br/><ul><li>비엔나 </ul>전용 전화 번호를 사용하려는 경우 서비스 전화 번호 보기 [를 참조합니다.](../getting-service-phone-numbers.md)  <br/> |
...
|프리미엄 번호로 아웃바운드 호출을 할 수 있나요?  <br/> | 예 <br/> |
