...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> | 지리적이 아닌. 전화 번호는 특정 도시 또는 위치에 연결되지 않습니다. <br/>  전용 전화 번호를 원하는 경우 [비즈니스용 Skype 및 Microsoft Teams의 서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요.  <br/> |
|전화 번호 기능을 사용하는 전화 걸기 기능  <br/> | 예, 중국에서 서비스를 구입한 고객을 제외합니다. 중국에서 서비스를 구매하는 고객에게는 전화 접속 기능이 비활성화됩니다.   <br/> |
