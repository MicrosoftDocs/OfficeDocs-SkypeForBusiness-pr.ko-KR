...
다음은 스웨덴에서 사용할 수 있는 비즈니스용 Skype 및 Microsoft Teams용 Microsoft 365 및 Office 365 서비스입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우: <br/><ul><li> 스톡홀름</ul>전용 전화 번호를 원하는 경우 [서비스 전화 번호 가져오기를 참조하세요](../getting-service-phone-numbers.md).  <br/> |
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |<ul><li>예테보리 <li>  헬싱보리 <li>  셰 핑 <li>  말 뫼 <li>  오레브로 주 <li>  스톡홀름 <li>  웁살라 <li>  바스테라스 주 </ul> |
