...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우: <br/><ul><li> 스톡홀름</ul>전용 전화 번호를 사용하려는 경우 서비스 전화 번호 보기 [를 참조합니다.](../getting-service-phone-numbers.md)  <br/> |
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |<ul><li>Gothenburg <li>  Helsingborg <li>  링크 연결 <li>  말컹 <li>  Orebro <li>  스톡홀름 <li>  Uppsala <li>  Vasteras </ul> |
