...
다음은 Sri Lanka에서 Microsoft 365 Office 365 및 비즈니스용 Skype Microsoft Teams 서비스입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> | 전화 숫자는 특정 도시 또는 위치에 연결되지 않습니다. 전용 전화 번호를 사용하려는 경우 에 대한 서비스 전화 번호 비즈니스용 Skype[및](../getting-service-phone-numbers.md)Microsoft Teams.  <br/> |
