...
다음은 비즈니스용 Skype용 Microsoft 365 및 Office 365 서비스 및 Sri Lanka에서 사용할 수 있는 Microsoft Teams입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> | 전화 번호는 특정 도시 또는 위치에 연결되지 않습니다. 전용 전화 번호를 사용하려는 경우 비즈니스용 Skype 및 Microsoft Teams에 대한 서비스 전화 번호[보기를 참조하세요.](../getting-service-phone-numbers.md)  <br/> |
