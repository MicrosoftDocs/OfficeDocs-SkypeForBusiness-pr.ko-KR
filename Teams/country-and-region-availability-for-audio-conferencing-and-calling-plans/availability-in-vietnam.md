...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |<ul><li>하노이(요청[시)](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md)<li>호치민(요청[시)](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md)</ul>  <br/> |
