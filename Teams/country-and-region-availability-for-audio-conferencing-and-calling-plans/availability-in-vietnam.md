...
다음은 베트남에서 사용할 수 있는 비즈니스용 Skype 및 Microsoft Teams용 Microsoft 365 및 Office 365 서비스입니다.
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |<ul><li>하노이(요청[시)](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)<li>호치민(요청[시)](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)</ul>  <br/> |
