...
- LIL_Placement
- seo-marvel-mar2020
description: 오디오 회의, 전화 시스템, 통화 플랜, 통신 크레딧, 수신자 부담 전화 번호 및 무료 전화 번호가 국가 또는 지역에서 제공되는지 알아봅니다.
...
**모든 국가 및 지역에서 스프레드시트를 찾으려는 경우 [클라우드 음성 기능 국가/지역 가용성 스프레드시트를](https://download.microsoft.com/download/d/b/6/db6992c5-ec9a-4b02-8742-59df17dd90a7/country-and-region-availability-(v-19OCT2021)-(en-us).xlsx) 다운로드하여 저장합니다**.

***

Teams 서비스 중 하나를 사용할 수 있는지 확인한 후에는 라이선스를 구입하고 사용자에게 할당하는 데 도움이 되는 [Microsoft Teams 추가 기능 라이선스](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) 를 볼 수 있습니다.
...
## <a name="want-to-learn-more-about-these-services"></a>이러한 서비스에 대해 자세히 알아보고 싶습니다.

### <a name="audio-conferencing"></a>오디오 회의

경우에 따라 조직의 사용자가 전화를 사용하여 모임에 전화해야 하는 경우가 있습니다. Teams에는 이러한 상황에 대한 오디오 회의 기능이 포함되어 있습니다! 사람 모바일 장치 또는 PC에서 Teams 앱을 사용하는 대신 휴대폰을 사용하여 모임에 전화를 걸 수 있습니다. 조직에 대한 오디오 회의를 원한다고 결정한 경우 오디오 모임을 예약/호스트하려는 조직의 각 사용자에 대해 하나의 **오디오** 회의 라이선스를 구입합니다.
  
오디오 회의를 사용하면 사용자가 모임에 전화 접속하는 데 사용할 수 있는 무료 전화 번호와 무료 전화 번호가 있습니다. 다음 국가나 지역의 유료 전화 번호는 사용자가 오디오 회의를 사용할 수 있게 되면 조직에 공유 오디오 회의 번호로 자동 할당됩니다. 추가 도시에서 조직에 전용 통행료 및 무료 번호를 할당할 수 있습니다.

> [!IMPORTANT]
> 오디오 회의에 대한 모든 전화 접속 번호 목록을 포함하는 리소스는 없습니다. 지역 또는 국가/지역에서 사용할 수 있는 전화 접속 전화 번호가 있는지 확인하려면 **Teams 관리 센터** > **음성** > **전화 번호** 로 이동하여 **추가** 를 클릭한 다음 **새 서비스 번호를** 클릭합니다. **국가/지역**, **시/지역** 및 **도시** 목록을 사용하여 검색을 필터링합니다. 무료 서비스 번호를 찾고 있는 경우 **주/지역** 목록에서 **무료를** 선택합니다.
...
오디오 회의에서 "*통화"* 기능은 다른 사용자가 전화 접속 모임에 참가할 수 있도록 하는 데 사용됩니다. 이 문서의 드롭다운 목록을 사용하여 국가/지역을 검색하고 이 기능을 사용할 수 있는지 확인합니다.

> [!CAUTION]
> 일부 무료 전화 번호는 국가 내의 특정 국가 또는 지역 내에서만 작동하기 때문에 무료 또는 무료 전화 번호로 전화 걸기를 할 수 없습니다. 예를 들어 미국 전화를 걸어 브라질의 무료 번호로 전화를 걸면 통화가 브라질 내 또는 브라질 내의 특정 지역에서 시작되지 않았기 때문에 통화가 성공하지 못할 수 있습니다. 무료 전화 번호로 전화 걸기 기능은 전화 걸기 무료 번호의 제한에 따라 크게 달라집니다. 아쉽게도 이 동작을 제어할 수 없으므로 전화 걸기 무료 번호 및 무료 번호 제한에 따라 환경이 달라질 수 있습니다.
  
아래에 나열되지 않은 다른 국가/지역으로 모임에서 전화 걸기는 [커뮤니케이션 크레딧을](../what-are-communications-credits.md) 사용하여 사용할 수 있습니다. 이러한 사용자의 경우 [조직에 대한 통신 크레딧을 설정해야 합니다](../set-up-communications-credits-for-your-organization.md).

### <a name="phone-system"></a>전화 시스템

전화 시스템을 사용하면 자동 전화 교환 및 통화 큐(수신자 또는 무료 번호 포함)를 만들어 조직의 수신 전화에 응답할 수 있습니다. 사용자를 위한 통화 플랜을 추가할 때 Teams를 사용하여 전화 걸기 및 받기, 통화 전송, 음소거 및 음소거 해제와 같은 기본 통화 제어 작업을 처리할 수 있습니다. **전화 시스템** 사용자는 주소록에서 이름을 클릭하면 Teams에서 해당 사용자에게 전화를 걸게 됩니다. 전화를 걸고 받기 위해 **전화 시스템** 사용자는 모바일 장치, 노트북 또는 PC가 있는 헤드셋 또는 Teams와 함께 작동하는 많은 IP 휴대폰 중 하나를 사용합니다.

이러한 일부 위치에서의 유료 전화 번호는 인벤토리 수준에 따라 지정된 시간에 다를 수 있습니다. 개별 사용자의 전화 번호를 가져오는 것 외에도 오디오 회의(회의 브리지용), 자동 전화 교환 및 통화 큐와 같은 서비스에 대한 수신자 또는 무료 전화 번호를 검색하고 획득할 수도 있습니다. 이를 서비스 번호라고 합니다. 전화 번호를 받으려면 [서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요. 그러나 사용자의 경우에는, 통화 플랜을 해당 사용자에게 할당한 후 전화를 걸고 받을 수 있도록 사용자 전화 번호를 할당할 수 있습니다. 해당 전화 번호를 찾으려면 [사용자에 대한 전화 번호 받기](../getting-phone-numbers-for-your-users.md)로 이동합니다. 또한 [사용자에 대한 전화 번호 할당, 변경 또는 제거](../assign-change-or-remove-a-phone-number-for-a-user.md)를 참조할 수도 있습니다.
...
### <a name="microsoft-teams-calling-plans"></a>Microsoft Teams 통화 플랜

전화 시스템과 함께 통화 플랜을 사용하면 사용자가 전화를 걸고 받을 수 있습니다. 먼저 사용자에게 할당할 사용자(구독자) 전화 번호(서비스 번호 아님)를 받고 통화 플랜을 할당합니다. 사용 가능한 통화 플랜에는 **국내**, **국제** 및 **종량제** 의 세 가지 유형이 있습니다. 자세한 내용은 [Microsoft Teams에 대한 통화 플랜](../calling-plans-for-office-365.md) 을 참조하세요.

라이선스 정보에 [대한 Microsoft Teams 추가 기능 라이선스 옵션](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) 도 볼 수 있습니다.
...
개별 사용자의 전화 번호를 가져오는 것 외에도 오디오 회의(회의 브리지용), 자동 전화 교환 및 통화 큐와 같은 서비스에 대한 유료 또는 무료 전화 번호를 검색하고 획득할 수도 있습니다. 이를 서비스 번호라고 합니다.
  
다음은 오디오 회의 및 통화 플랜에 사용할 유료 서비스 번호를 받을 수 있는 수도 및 주요 도시 목록입니다. **Teams 관리 센터를** 사용하여 이러한 위치에서 유료 서비스 번호를 받습니다.
  
무료 또는 무료 서비스 번호를 받으려면 [서비스 전화 번호 가져오기를](../getting-service-phone-numbers.md) 볼 수 있습니다. 다른 공급자로부터 전송하려는 유료 또는 무료 서비스 번호가 이미 있는 경우 [조직의 전화 번호 관리를 참조하세요](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).
...
통신 크레딧을 설정하지 않고 사용자에게 라이선스를 할당하지 않고 통화 플랜 또는 오디오 회의 플랜 또는 국가/지역에 따라 조직의 시간(분)이 부족한 경우 모임에서 전화를 걸거나 전화를 걸 수 없습니다. [통신 크레딧이란?](../what-are-communications-credits.md)에서 권장 자금액을 포함한 자세한 내용을 알아볼 수 있습니다.

## <a name="related-topics"></a>관련 항목

[Microsoft Teams의 서비스 전화 번호 가져오기](../getting-service-phone-numbers.md)
