...
비즈니스용 Skype 또는 Microsoft 팀 서비스 중 하나를 사용할 수 있는지 확인 한 후에는 비즈니스용 [skype 및 Microsoft 팀 추가 기능 라이선스](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) 를 구입 하 여 사용자에 게 라이선스를 할당 하는 데 도움이 될 수 있습니다.

> [!NOTE]
> 
> 사용자에 게 더 많은 전화 번호를 받으려면 [사용자의 전화 번호 가져오기](/microsoftteams/getting-phone-numbers-for-your-users) , 전화 번호 요청 양식, [조직의 전화 번호 관리](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)를 참조 하세요.


## <a name="want-to-learn-more-about-these-services"></a>이러한 서비스에 대 한 자세한 내용을 보 시겠습니까?

### <a name="audio-conferencing"></a>오디오 회의

조직의 사용자가 모임에 전화를 걸 때 휴대폰을 사용 해야 하는 경우가 있습니다. 비즈니스용 Skype 및 Microsoft 팀에는 이러한 상황에 대 한 오디오 회의 기능이 포함 되어 있습니다. 사용자는 모바일 장치 또는 PC에서 비즈니스용 Skype 및 Microsoft 팀 앱을 사용 하는 대신 휴대폰을 사용 하 여 모임에 통화할 수 있습니다. 조직에 오디오 회의를 원하는 경우 오디오 모임을 예약/호스트할 조직의 각 사용자에 대해 하나의 **오디오 회의** 라이선스를 구입 해야 합니다.
  
오디오 회의를 사용 하 여 사용자가 모임에 전화 접속 하는 데 사용할 수 있는 유료 및 무료 전화 번호가 있습니다. 다음 국가 또는 지역의 유료 전화 번호는 오디오 회의를 사용 하도록 설정 된 경우 조직에 공유 오디오 회의 번호로 자동으로 할당 됩니다. 다른 도시에서 전담 유료 및 무료 전화 번호를 조직에 할당할 수 있습니다.

> [!IMPORTANT]
> 오디오 회의에 대 한 모든 전화 접속 번호 목록이 포함 된 리소스가 없습니다. 해당 지역 또는 국가/지역에서 전화 접속 전화 번호를 사용할 수 있는지 확인 하려면 **비즈니스용 Skype 관리 센터** > **음성** > **전화 번호로**이동한 다음 **추가**를 클릭 한 다음 **새 서비스 번호**를 클릭 합니다. **국가/지역**, **시/지역**, **구/군/시** 목록을 사용 하 여 검색을 필터링 합니다. 무료 서비스 번호를 찾고 있는 경우에는 **상태/지역** 목록에서 무료 **통화** 를 선택 합니다.

오디오 회의에 대 한 자세한 내용은 [오디오 회의 일반적인 질문](../audio-conferencing-common-questions.md) 을 참조 하세요.

[오디오 회의에 대 한 가격](https://products.office.com/skype-for-business/audio-conferencing#Requirements) 
  
#### <a name="using-the-call-me-feature-or-when-adding-other-people-to-a-meeting-so-they-can-join-it"></a>전화 걸기 기능 사용 또는 다른 사람을 모임에 추가 하 여 참가할 수 있도록 할 때
오디오 회의에는 "*전화 걸기*" 라는 기능을 사용 하 여 다른 사용자가 전화 접속 모임에 참가할 수 있도록 합니다. 위의 드롭다운 목록을 사용 하 여 국가/지역을 검색 하 고이 기능을 사용할 수 있는지 확인 합니다.

> [!CAUTION]
> 수신자 부담 전화 번호는 특정 국가 또는 국가 내 지역 에서만 작동 하기 때문에 무료 또는 무료 전화 번호로 전화를 걸 수는 없습니다. 예를 들어, 브라질에서 무료 번호로 미국에서 전화를 거는 경우, 브라질 내에서 또는 브라질 내의 특정 지역에서 통화가 시작 되지 않았기 때문에 통화가 제대로 되지 않을 수 있습니다. 무료 전화 번호에 전화를 걸 수 있는 기능은 수신자 부담 전화의 제한 사항에 따라 광범위 하 게 달라 집니다. 불행 하 게도, Office 365 내에서이 동작을 제어할 수 없으며, 그 결과 무료 번호와 수신자 부담 전화의 제한 사항에 따라 사용자의 환경이 다를 수 있습니다. 
  
다른 국가/지역으로 모임에서 전화를 거는 방법 아래에 나열 되어 있지 않은 경우 [Office 365 통신 크레딧을](../what-are-communications-credits.md)사용 하 여 사용할 수 있습니다. 이러한 사용자는 [조직의 통신 크레딧을 설정](../set-up-communications-credits-for-your-organization.md)해야 합니다.
  
### <a name="phone-system"></a>전화 시스템
전화 시스템을 사용 하면 자동 전화 교환 및 통화 대기열 (유료 또는 유료 번호)을 만들어 조직에 대 한 걸려오는 전화에 응답 하 고, 사용자가 비즈니스용 Skype를 사용 하 여 기본 통화 제어 작업을 수행할 수 있도록 하는 전화 플랜을 추가할 수 있습니다. 전화 걸기, 통화 전송, 음소거 및 음소거 해제 등의 통화를 합니다. **전화 시스템** 사용자는 주소록에서 이름을 클릭 하 여 비즈니스용 Skype가 해당 사용자에 게 전화를 걸 수 있습니다. 전화를 걸고 받으려면 **휴대폰 시스템** 사용자가 모바일 장치, 랩톱이 나 PC와 함께 헤드셋 또는 비즈니스용 Skype에서 작동 하는 다 수의 IP 전화기 중 하나를 사용할 수 있습니다.

> 이러한 위치 중 일부의 유료 전화 번호는 재고 수준에 따라 지정 된 시간에 따라 다를 수 있습니다. Office 365의 개별 사용자에 대 한 전화 번호를 가져올 수 있을 뿐만 아니라 오디오 회의 (컨퍼런스 브리지), 자동 전화 교환, 통화 대기열 등의 서비스에 대해 유료 또는 무료 전화 번호를 검색 하 고 받을 수도 있습니다. 이를 서비스 번호 라고 합니다. 전화 번호를 받으려면 [서비스 전화 번호 받기를](/microsoftteams/getting-service-phone-numbers) 참조 하세요. 그러나 사용자에 게 통화 요금제를 할당 한 후에는 전화를 걸거나 받을 수 있도록 사용자의 전화 번호를 할당할 수 있습니다. 해당 전화 번호를 찾으려면 [사용자의 전화 번호 가져오기를](/microsoftteams/getting-phone-numbers-for-your-users)참조 하세요. [사용자의 전화 번호 지정, 변경 또는 제거를](/microsoftteams/assign-change-or-remove-a-phone-number-for-a-user)볼 수도 있습니다. 

[전화 시스템의 가격 책정](https://products.office.com/skype-for-business/phone-system#Requirements)

> [!NOTE]
> 이러한 위치 중 일부의 유료 전화 번호는 재고 수준에 따라 지정 된 시간에 따라 다를 수 있습니다. 
...
Office 365의 개별 사용자에 대 한 전화 번호를 가져올 수 있을 뿐만 아니라 오디오 회의 (컨퍼런스 브리지), 자동 전화 교환, 통화 대기열 등의 서비스에 대해 유료 또는 유료 전화 번호를 검색 하 고 가져올 수도 있습니다. 이를 서비스 번호 라고 합니다.
  
다음은 오디오 회의 및 통화 요금제에서 사용할 유료 서비스 번호를 얻을 수 있는 대문자 및 주요 도시 목록입니다. **비즈니스용 Skype 관리 센터**를 사용 하 여 이러한 위치에서 유료 서비스 번호를 받을 수 있습니다.
  
유료 또는 무료 서비스 번호를 받으려면 [서비스 전화 번호 받기를](/microsoftteams/getting-service-phone-numbers)참조 하세요. 다른 공급자 로부터 전송 하려는 유료 또는 무료 서비스 번호가 이미 있는 경우 [조직의 전화 번호 관리](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)를 참조 하세요.
