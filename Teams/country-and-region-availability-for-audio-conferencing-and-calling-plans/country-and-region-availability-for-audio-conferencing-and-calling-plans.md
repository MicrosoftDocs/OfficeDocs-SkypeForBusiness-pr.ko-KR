...
경우에 따라 조직의 사용자가 전화를 사용하여 모임에 전화해야 하는 경우가 있습니다. 비즈니스용 Skype 및 Microsoft Teams에는 이러한 상황에 대한 오디오 회의 기능이 포함되어 있습니다. 사용자는 모바일 장치 또는 PC에서 비즈니스용 Skype와 Microsoft Teams 앱을 사용하는 대신 전화를 사용하여 모임에 전화를 걸 수 있습니다. 조직에 대해 오디오 회의를 하기로 결정한 경우 오디오 모임을 예약/호스트하려는 조직의 각 사용자에 대해 하나의 **오디오** 회의 라이선스를 구입합니다.
...
전화 시스템을 사용하면 자동 전화 교환 및 통화 큐(수신자 또는 무료 번호 포함)를 만들어 조직의 수신 전화에 응답할 수 있습니다. 사용자에 대한 통화 플랜을 추가하는 경우 비즈니스용 Skype 사용하여 통화 배치 및 수신, 통화 전송, 통화 음소거 및 음소거 해제와 같은 기본 통화 제어 작업을 처리할 수 있습니다. **전화 시스템** 사용자는 주소록에서 이름을 클릭하면 비즈니스용 Skype 해당 사용자에게 전화를 걸게 됩니다. 전화를 걸고 받기 위해 **전화 시스템** 사용자는 모바일 장치, 노트북 또는 PC가 있는 헤드셋 또는 비즈니스용 Skype 작동하는 많은 IP 전화 중 하나를 사용합니다.
