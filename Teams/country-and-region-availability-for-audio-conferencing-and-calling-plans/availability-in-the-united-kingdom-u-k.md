...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우: <br/><ul><li> 런던</ul>전용 전화 번호를 원하는 경우 [비즈니스용 Skype 및 Microsoft Teams의 서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요.  <br/> |
...
|프리미엄 번호로 아웃바운드 호출을 할 수 있나요? <br/> | 부분적으로 지원되는: 공유 비용 번호(44843, 44844, 44845, 44870, 44871, 44872)에 대한 호출은 분당 지불하기 위해 Communications 크레딧을 사용하여 지원됩니다.  449XX에 대한 호출은 지원되지 않습니다. <br/> |
...
|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> |<ul><li>버밍엄 <li>  Bolton <li>  본머스 <li>  Bradford <li>  Brighton <li>  Bristol <li>  Coventry <li>  헐 <li>  리즈 <li>  Leicester <li>  리버풀 <li>  런던 <li>  맨체스터 <li>  Newcastle <li>  Nottingham <li>  Plymouth <li>  Sheffield <li>  Stoke-on-Trent <li>  Teesside(Middlesbrough) </ul> |
