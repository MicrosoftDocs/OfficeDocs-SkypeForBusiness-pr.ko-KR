...
ms.locfileid: "67267833"
---
# <a name="availability-in-croatia"></a>크로아티아의 가용성
...
다음은 크로아티아에서 사용할 수 있는 비즈니스용 Skype 및 Microsoft Teams용 Microsoft 365 및 Office 365 서비스입니다.
...
|전화 번호가 오디오 회의에 자동으로 할당되나요?  <br/> |예, 다음의 경우:<br/><ul><li> 자그레브</ul>전용 전화 번호를 원하는 경우 [비즈니스용 Skype 및 Microsoft Teams의 서비스 전화 번호 받기](../getting-service-phone-numbers.md)를 참조하세요.  <br/> |
...
|아웃바운드 통화를 할 수 있나요?  <br/> | 196개 국가 또는 [지역을 포함합니다.](users-can-make-outbound-calls-to-these-countries-and-regions.md)<br/> |
   
## <a name="toll-and-toll-free-numbers-for-services"></a>서비스를 위한 유료 및 무료 번호

|**기능**|**세부 정보**|
|:-----|:-----|
|유료 번호를 받을 수 있는 수도 및 주요 도시는 어디인가요?  <br/> | <ul><li>Osijek <li>  리예카 <li>  분할 <li>  자다르 <li>  자그레브 </ul> |
