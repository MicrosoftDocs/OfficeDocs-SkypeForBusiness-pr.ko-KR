...
다음은 비즈니스용 Skype 용 Office 365 서비스와 Microsoft 팀에서 사용할 수 있도록 하는 것입니다.
...
|오디오 회의에 대 한 전화 번호가 자동으로 할당 되나요?  <br/> |예, 다음을 수행 합니다.<br/><ul><li> 룩셈부르크</ul> 전용 전화 번호를 원할 경우 [비즈니스용 Skype 및 Microsoft 팀에 대 한 서비스 전화 번호 가져오기를](/microsoftteams/getting-service-phone-numbers)참조 하세요.  <br/> |
...
|**기능**|**세부적인**|
|:-----|:-----|
|유료 전화 번호를 받을 수 있는 대/주 도시는 무엇 인가요?  <br/> |룩셈부르크  <br/> |
