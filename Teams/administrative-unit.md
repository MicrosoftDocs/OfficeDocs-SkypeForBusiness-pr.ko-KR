...
![시나리오를 보여주는 다이어그램입니다.](media/au-diagram.png)
...
![예로 회사 관리 단위를 예로 들 수 있습니다.](media/au-example.png)

글로벌 IT 관리자는 만든 후 해당 관리 단위에 해당하는 디바이스 사용자를 추가할 수 있습니다.

![사용자 미리 보기가 있는 예제 회사입니다.](media/au-example2.png)
