...
| 규정 준수 관리 Teams                                                | 보안 Microsoft 365 보안, Microsoft 365 준수 및 Microsoft Teams 관리 센터를 Windows PowerShell 조직의 Office 365 정책 및 설정을 Microsoft Teams 수 있습니다. | [가이드에서 규정 준수 Teams 관리](https://aka.ms/complianceinteamsinteractiveguide)      |
...
| Teams 전화 시스템 구성: 자동 전화 교환 & 큐 구성                   | 호출 큐를 만들고 배포하는 프로세스를 자동 전화 교환 관리 센터를 사용하여 Microsoft Teams 호출의 일부로 Microsoft Teams 단계입니다.                                                          |  [전화 Teams 시스템 가이드 구성](https://aka.ms/TeamsPhoneInteractiveGuide)             |
| 직접 라우팅 구성: SBC 및 음성 라우팅 연결                 | 기존 Microsoft Teams 전화 시스템 직접 라우팅을 사용하여 기존 전화 통신 인프라와 통합합니다.                                                                                                              | [직접 라우팅 가이드 구성](https://aka.ms/DirectRoutingInteractiveGuide)          |
| 에서 거버넌스 Microsoft Teams                                     | 조직에 대한 Teams 메시징 보존 정책을 만드는 방법과 개별 메시지를 보관, 삭제 및 복원하는 방법을 Teams                                                                                   |  [가이드에서 거버넌스 Microsoft Teams 구성](https://aka.ms/TeamsGovernanceInteractiveGuide)        |
| 모임 구성 및 Microsoft Teams 배포                          | 모임 워크로드를 배포하는 프로세스를 Microsoft Teams.                                                                                                                                       |  [모임 가이드 구성 및 Microsoft Teams 배포](https://aka.ms/TeamsMeetingsInteractiveGuide)          |
| 오디오 회의를 구성합니다Microsoft Teams                            | 오디오 회의의 기능을 Teams 전화 접속 전화 번호를 할당하는 방법에 대해 알아보고 있습니다.                                                                                          |  [가이드에 대한 오디오 회의 Microsoft Teams 구성](https://aka.ms/AudioConferencingInteractiveGuide)      |
