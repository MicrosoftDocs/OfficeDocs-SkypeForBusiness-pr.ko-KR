...
> [!Note]
> 팀이 다른 시스템의 입력(예: School Data Sync)을 사용하여 자동으로 생성되는 경우 입력 데이터가 구성한 이름 정책과 준수하는지 확인 그렇지 않은 경우 팀 만들기에 실패합니다.
...
일반적으로 팀을 만들지 못하게 하는 것이 좋습니다. 모든 사용자가 팀을 만들 수 있는 경우 Teams는 널리 채택될 가능성이 더 높습니다. 교직원, 교사 또는 학생은 Teams를 사용하여 연구 그룹 또는 특수 관심 그룹을 만들 수 있습니다. 이렇게 하면 Teams가 교실 내부 및 외부에서 수락되는 데 도움이 될 수 있습니다.
...
## <a name="how-do-i-automatically-create-a-team-for-each-course-at-the-beginning-of-the-semester-or-quarter"></a>1학기 또는 분기가 시작될 때 각 과정에 대한 팀을 자동으로 만들 수 있나요?
