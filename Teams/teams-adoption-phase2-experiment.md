...
description: 이 문서에서는 채택의 실험 단계를 Microsoft Teams 알아보고 있습니다.
f1.keywords:
- CSH
ms.custom:
- Adopt
...
ms.locfileid: "60745464"
---
# <a name="microsoft-teams-adoption-phase-2---experiment"></a>Microsoft Teams 2단계 - 실험

이제 훌륭한 프로젝트 팀과 조직에 대한 중요한 정보로 무장하고 있으며, 이제 팀을 실험할 준비가 Teams. 긍정적인 관계를 가진 이해 관계자가 이끌고, 조직에 의미 있는 피드백을 제공할 수 있는 충분한 수의 초기 채택자가 있는 그룹 내에서 2~3개 실제 프로젝트를 실험하는 것이 좋습니다. 조직이 크든 작든 이 단계를 완료하여 채팅 및 파일 저장소 기능을 사용하는 것 Teams 공동 작업을 개선할 수 있는 방법을 파악하는 것이 좋습니다.  
