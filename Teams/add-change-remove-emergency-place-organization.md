...
ms.locfileid: "37639568"
---
# <a name="add-change-or-remove-a-place-for-an-emergency-location-in-your-organization"></a>조직의 긴급 위치 추가, 변경 또는 제거

조직의 실제 위치 수에 따라 건물, 바닥, 사무실 위치를 추가 하 여 보다 구체적인 비상 위치를 만들 수 있습니다. 자세한 내용은 [응급 위치, 장소 및 통화 라우팅 이란?](/microsoftteams/what-are-emergency-locations-addresses-and-call-routing) 를 참조 하세요.
