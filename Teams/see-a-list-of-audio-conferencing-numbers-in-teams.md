...
[초대에 포함된 전화 번호 설정을](set-the-phone-numbers-included-on-invites-in-teams.md) 확인하여 단일 사용자의 전화 접속 전화 번호를 변경할 수 있습니다.
...
2. 오디오 회의에 사용할 수 있는 전화 번호를 봅니다.

- 오디오 회의 자동 전화 교환에서 사용할 위치 및 기본 언어를 볼 수도 있습니다.
