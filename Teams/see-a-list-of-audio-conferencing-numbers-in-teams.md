...
Microsoft 팀 사용자를 위해 오디오 회의를 설정할 때 오디오 회의에 사용할 수 있는 전화 번호를 볼 수 있습니다. 이 목록에는 조직에서 사용할 수 있는 모든 오디오 회의 전화 번호가 포함 됩니다.
...
- 오디오 회의 자동 전화 교환에 사용 되는 위치 및 기본 언어를 볼 수도 있습니다.
