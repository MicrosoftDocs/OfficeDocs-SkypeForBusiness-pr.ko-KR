...
---
# <a name="prepare-your-it-staff-for-microsoft-teams"></a>Microsoft Teams를 위한 IT 직원 준비
...
Microsoft 365 또는 Office 365 조직 관리자, 기술 책임자 및 지원 센터는 고품질 사용자 환경을 구동하는 데 책임이 있습니다. 여기에는 네트워크가 Teams를 지원할 준비가 됐는지, 사용자를 위한 Teams를 구성하고, 발생할 수 있는 문제를 효과적으로 해결하고 해결할 수 있는 것이 포함됩니다.
...
| | |
|---|---|
| ![의사 결정 지점을 묘사하는 아이콘](media/audio_conferencing_image7.png) <br/>의사 결정 지점|<ul><li>Teams 배포 및 지원에 관여할 가능성이 있는 모든 지원 직원을 참여시겠습니까?</li><li>업그레이드가 진행될 때 추가 직원을 온보드하기 위한 교육 계획을 개발한 경우</li></ul> |
| ![다음 단계를 묘사하는 아이콘](media/audio_conferencing_image9.png)<br/>다음 단계|<ul><li>IT 직원에게 필요한 정보가 있는지 확인</li><li>새 기능이 릴리스될 때 학습 및 준비 계획을 다시 확인 합니다.</li></ul>|

Teams에 대한 IT 직원을 준비한 후 환경이 모든 요건을 충족하는지 [확인해야 합니다.](upgrade-plan-journey-prerequisites.md)
