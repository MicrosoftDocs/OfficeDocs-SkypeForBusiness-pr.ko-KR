...
2020년 1월의 새: [CQD에 Power BI](https://www.microsoft.com/download/details.aspx?id=102291)쿼리 템플릿을 다운로드합니다. CQD Power BI 분석하고 보고하는 데 사용할 수 있는 사용자 지정 가능한 템플릿입니다.

CQD(통화 품질 대시보드) 보고서의 경우 Teams 데이터를 쿼리하고 보고하는 데 Power BI 경우 CQD Power BI 템플릿을 다운로드합니다. 템플릿을 열면 Power BI CQD 관리자 자격 증명으로 로그인하라는 메시지가 표시됩니다. 이러한 쿼리 템플릿을 사용자 지정하고 라이선스 및 CQD 관리자 권한이 있는 조직의 Power BI 배포할 수 있습니다.

이러한 PBIT 파일을 사용하려면 먼저 다운로드에 포함된 *MicrosoftCallQuality.pqx* Power BI Microsoft [CQD용](CQD-Power-BI-connector.md) 커넥터를 설치해야 [합니다.](https://www.microsoft.com/download/details.aspx?id=102291) 
...
|<strong>(New!)</strong> CQD Teams 사용률 보고서.pbit     | 조직의 사용자가 얼마나 많은 Teams 보여줍니다. 보고 환경을 최대화하기 위해 건물 데이터를 업로드해야 합니다. 자세한 내용은 CQD Power BI 보고서를 사용하여 Microsoft Teams [를 읽습니다.](CQD-teams-utilization-report.md)        |
