...
여기에서는 Graph API를 사용하여 조직의 [Teams](https://docs.microsoft.com/microsoftteams/private-channels) 개인 채널을 관리하는 데 필요한 지침을 찾을 수 있습니다.
...
관리자는 Graph API를 사용하여 팀 소유자를 대신하여 개인 채널을 만들 수 있습니다. 예를 들어 조직에서 개인 채널을 중앙 집중화하려는 경우 이 작업을 원할 수 있습니다.
