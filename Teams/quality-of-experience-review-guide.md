...
![Graph 품질 범주를 제공합니다.](media/qerguide-image-categories.png "조직의 품질 범주: 서비스 관리, 엔드포인트 및 네트워크입니다.")
...
![TCP를 사용하는 오디오 스트림의 백분율을 보여주는 차트입니다.](media/qerguide-image-audiostreamswithtcp.png)
...
![TCP와 UDP를 사용하는 스트림의 볼륨을 보여주는 보고서입니다.](media/qerguide-image-tcpvsudp.png)
...
[Office 365 연결 원칙](/microsoft-365/enterprise/microsoft-365-network-connectivity-principles)
