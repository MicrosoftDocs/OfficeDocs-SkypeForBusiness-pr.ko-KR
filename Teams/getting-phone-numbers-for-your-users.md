...
## <a name="show-phone-numbers-for-your-organization"></a>조직의 전화 번호 표시

![](media/teams-logo-30x30.png) **Microsoft 팀 관리 센터를 사용 하 여** microsoft 팀 로고를 표시 하는 아이콘 

왼쪽 탐색 창에서 **음성** > **전화 번호로** 이동 하 여 위치, 번호 형식, 상태 정보를 비롯 한 조직의 번호를 확인 합니다.
  
## <a name="what-else-do-you-need-to-know-about-users-phone-numbers"></a>사용자의 전화 번호에 대해 알아야 할 기타 사항
