...
관리자는 다음과 같은 몇 가지 방법으로 조직에 새 게스트를 추가할 수 있습니다.
...
- Azure AD(Azure Active Directory) B2B 공동 작업을 통해 조직에 게스트를 추가합니다. 자세한 내용은 [빠른 시작: Azure Portal 디렉터리에 게스트 추가를 확인하세요](/azure/active-directory/external-identities/b2b-quickstart-add-guest-users-portal).
