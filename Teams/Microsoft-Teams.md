...
layout: HubPage
hide_bc: true
title: Microsoft Teams 기술 문서
ms.reviewer: ''
ms.author: kenwith
audience: admin
manager: serdars
author: kenwith
description: Microsoft Teams 기술 문서
ms.topic: hub-page
...
ms.locfileid: "42028279"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Microsoft Teams 기술 문서</h1>
        <P> </p>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Teams에 오신 것을 환영합니다</h3>
                                                <P>Teams 개요를 확인하고 Teams 관리자 또는 IT 전문가에게 필요한 기술 지침 찾아보기</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>비즈니스용 Skype에서 Teams로 업그레이드</h3>
                                                <P>Teams로의 최상의 경로를 탐색하는 데 도움이 되는 지침 및 도구 찾기</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>교육 및 비디오 찾기  </h3>
                                                <P>Teams 교육 받기 - 관리자 및 사용자를 위한 교육</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>포스터: Teams 아키텍처, 전화 통신 솔루션</h3>
                                                <P>Teams의 인쇄용 그림 보기 IT 아키텍처 및 전화 통신 솔루션</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>조직 전체로 Teams 확장</h3>
                                                <P>의료, 일선 직원, 소매, 정부, 교육을 포함한 업계 사용자를 위한 맞춤형 솔루션 찾아보기</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Teams 기술 커뮤니티</h3>
                                            <p>Teams 기술 커뮤니티에 참여하여 질문하기 &amp; 답변 얻기, Teams 블로그 읽기</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>최종 사용자 Teams 도움말</h3>
                                            <p>도움말, 교육 및 최종 사용자를 위한 새로운 콘텐츠로 이동</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <a href="https://docs.microsoft.com/microsoftteams/platform/overview"> <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Teams 개발자 플랫폼</h3>
                                            <p>Microsoft Teams 개발자 플랫폼과 이를 사용하여 유용하고 강력한 앱을 만드는 방법에 대해 알아보기</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
