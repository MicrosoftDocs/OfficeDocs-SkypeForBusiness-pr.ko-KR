...
- <span data-ttu-id="6f25a-110">흐름 X는 온-프레미스 Office 365 클라이언트에서 클라우드의 Office 365 서비스와 통신 하는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-110">Flow X is used by the on-premises Office 365 client to communicate with the Office 365 service in the cloud.</span></span> <span data-ttu-id="6f25a-111">이는 고객 네트워크에서 발생 하며 Office 365의 끝점으로 종료 됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-111">It originates from the customer network, and it terminates as an endpoint in Office 365.</span></span>
...
### <a name="principles"></a><span data-ttu-id="6f25a-174">원칙은</span><span class="sxs-lookup"><span data-stu-id="6f25a-174">Principles</span></span>
...
### <a name="teams-topology"></a><span data-ttu-id="6f25a-187">팀 토폴로지</span><span class="sxs-lookup"><span data-stu-id="6f25a-187">Teams topology</span></span>
...
<span data-ttu-id="6f25a-200">**흐름 설명**:</span><span class="sxs-lookup"><span data-stu-id="6f25a-200">**Flow descriptions**:</span></span>
...
<span data-ttu-id="6f25a-232">[![Microsoft 팀 온라인 통화 흐름 그림 02](media/microsoft-teams-online-call-flows-figure02-thumbnail.png)](media/microsoft-teams-online-call-flows-figure02.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-232">[![Microsoft Teams Online Call Flows Figure 02](media/microsoft-teams-online-call-flows-figure02-thumbnail.png)](media/microsoft-teams-online-call-flows-figure02.png)</span></span>

<span data-ttu-id="6f25a-233">*그림 2-고객 네트워크 내*</span><span class="sxs-lookup"><span data-stu-id="6f25a-233">*Figure 2 - Within customer network*</span></span>

<span data-ttu-id="6f25a-234">7 단계에서 피어 투 피어 미디어 흐름 5가 선택 됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-234">In step 7, peer-to-peer media flow 5 is selected.</span></span>

<span data-ttu-id="6f25a-235">미디어는 양방향입니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-235">Media is bidirectional.</span></span> <span data-ttu-id="6f25a-236">흐름 5의 방향은이 문서의 모든 흐름과 일관성을 유지 하면서 연결 관점에서 통신을 시작 함을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-236">The direction of flow 5 indicates that one side initiates the communication from a connectivity perspective, consistent with all the flows in this document.</span></span> <span data-ttu-id="6f25a-237">이 경우 두 종점이 모두 고객 네트워크 내에 있기 때문에 사용 되는 방향은 중요 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-237">In this case, it doesn't matter which direction is used because both endpoints are within the customer network.</span></span>

<span data-ttu-id="6f25a-238">**외부 사용자에 대 한 고객 네트워크 (팀에서 전송 릴레이가 전달 하는 미디어 릴레이):**</span><span class="sxs-lookup"><span data-stu-id="6f25a-238">**Customer network to external user (media relayed by Teams Transport Relay):**</span></span>

<span data-ttu-id="6f25a-239">[![Microsoft 팀 온라인 통화 흐름 그림 03](media/microsoft-teams-online-call-flows-figure03-thumbnail.png)](media/microsoft-teams-online-call-flows-figure03.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-239">[![Microsoft Teams Online Call Flows Figure 03](media/microsoft-teams-online-call-flows-figure03-thumbnail.png)](media/microsoft-teams-online-call-flows-figure03.png)</span></span>

<span data-ttu-id="6f25a-240">*그림 3-외부 사용자에 대 한 고객 네트워크 (팀에서 전송 릴레이가 전달 하는 미디어 릴레이)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-240">*Figure 3 - Customer network to external user (media relayed by Teams Transport Relay)*</span></span>
...
- <span data-ttu-id="6f25a-251">미디어는 양방향입니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-251">Media is bidirectional.</span></span> <span data-ttu-id="6f25a-252">흐름 2에서 원격 모바일 사용자에 대 한 방향은 연결 관점에서 통신을 시작 한다는 것을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-252">The direction of flow 2 to remote mobile user indicates that one side initiates the communication from a connectivity perspective.</span></span>

<span data-ttu-id="6f25a-253">**내부 사용자에 대 한 VPN 사용자 (팀에서 전송 하는 미디어 릴레이)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-253">**VPN user to internal user (media relayed by Teams Transport Relay)**</span></span>

<span data-ttu-id="6f25a-254">[![Microsoft 팀 온라인 통화 흐름 그림 05](media/microsoft-teams-online-call-flows-figure05-thumbnail.png)](media/microsoft-teams-online-call-flows-figure05.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-254">[![Microsoft Teams Online Call Flows Figure 05](media/microsoft-teams-online-call-flows-figure05-thumbnail.png)](media/microsoft-teams-online-call-flows-figure05.png)</span></span>

<span data-ttu-id="6f25a-255">*그림 5-내부 사용자에 대 한 VPN 사용자 (팀에서 전송 하는 미디어 릴레이)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-255">*Figure 5 - VPN user to internal user (media relayed by Teams Transport Relay)*</span></span>

<span data-ttu-id="6f25a-256">VPN을 고객 네트워크로 보내는 신호는 흐름 2를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-256">Signaling between the VPN to the customer network is using flow 2'.</span></span> <span data-ttu-id="6f25a-257">고객 네트워크와 Office 365 간의 신호는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-257">Signaling between the customer network and Office 365 is using flow 4.</span></span> <span data-ttu-id="6f25a-258">그러나 미디어는 VPN을 우회 하 고 Office 365에서 팀 미디어 릴레이와 흐름 3 및 4를 사용 하 여 라우팅합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-258">However, media bypasses the VPN and is routed using flows 3 and 4 through Teams media relay in Office 365.</span></span>

<span data-ttu-id="6f25a-259">**내부 사용자에 대 한 VPN 사용자 (직접 미디어)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-259">**VPN user to internal user (direct media)**</span></span>

<span data-ttu-id="6f25a-260">[![Microsoft 팀 온라인 통화 흐름 그림 06](media/microsoft-teams-online-call-flows-figure06-thumbnail.png)](media/microsoft-teams-online-call-flows-figure06.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-260">[![Microsoft Teams Online Call Flows Figure 06](media/microsoft-teams-online-call-flows-figure06-thumbnail.png)](media/microsoft-teams-online-call-flows-figure06.png)</span></span>

<span data-ttu-id="6f25a-261">*그림 6-내부 사용자에 대 한 VPN 사용자 (직접 미디어)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-261">*Figure 6 - VPN user to internal user (direct media)*</span></span>
...
#### <a name="use-case-teams-to-pstn-through-office-365-trunk"></a><span data-ttu-id="6f25a-274">사용 사례: Office 365 트렁크를 통해 PSTN에 대 한 팀</span><span class="sxs-lookup"><span data-stu-id="6f25a-274">Use Case: Teams to PSTN through Office 365 Trunk</span></span>
...
<span data-ttu-id="6f25a-288">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-288">Note that:</span></span>

- <span data-ttu-id="6f25a-289">팀 클라이언트는 비즈니스용 Skype 모임에 참가할 수 없으며 비즈니스용 Skype 클라이언트가 팀 모임에 참가할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-289">Teams clients cannot join Skype for Business meetings, and Skype for Business clients cannot join Teams meetings.</span></span>

- <span data-ttu-id="6f25a-290">PSTN 사용자가 선택적으로 "전화 접속"을 하거나 "전화를 걸기" 하는 것은 모임의 이끌이 PSTN 통화 및/또는 회의 프로 비전에 따라 달라 집니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-290">A PSTN user optionally "Dials IN" or is "Dialed OUT", depending on the meeting's organizer PSTN Calling and/or conferencing provisioning.</span></span>

- <span data-ttu-id="6f25a-291">게스트 사용자 또는 고객 사용자는 엄격한 규칙이 있는 FW/NAT를 사용 하 여 보호 되는 게스트 개인 네트워크에서 참가할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-291">A guest user or a customer user may join from a guest private network, which is protected using FW/NAT with strict rules.</span></span>

<span data-ttu-id="6f25a-292">[![Microsoft 팀 온라인 통화 흐름 그림 09](media/microsoft-teams-online-call-flows-figure09-thumbnail.png)](media/microsoft-teams-online-call-flows-figure09.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-292">[![Microsoft Teams Online Call Flows Figure 09](media/microsoft-teams-online-call-flows-figure09-thumbnail.png)](media/microsoft-teams-online-call-flows-figure09.png)</span></span>

<span data-ttu-id="6f25a-293">*그림 9-팀 모임*</span><span class="sxs-lookup"><span data-stu-id="6f25a-293">*Figure 9 - Teams Meeting*</span></span>

#### <a name="use-case-federation-with-skype-for-business-on-premises"></a><span data-ttu-id="6f25a-294">사용 사례: 비즈니스용 Skype를 사용 하 여 온-프레미스 페더레이션</span><span class="sxs-lookup"><span data-stu-id="6f25a-294">Use case: Federation with Skype for Business on premises</span></span>

<span data-ttu-id="6f25a-295">**Office 365의 팀에서 전송 릴레이가 전달 하는 미디어 릴레이**</span><span class="sxs-lookup"><span data-stu-id="6f25a-295">**Media relayed by Teams Transport Relay in Office 365**</span></span>

<span data-ttu-id="6f25a-296">[![Microsoft 팀 온라인 통화 흐름 그림 10](media/microsoft-teams-online-call-flows-figure10-thumbnail.png)](media/microsoft-teams-online-call-flows-figure10.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-296">[![Microsoft Teams Online Call Flows Figure 10](media/microsoft-teams-online-call-flows-figure10-thumbnail.png)](media/microsoft-teams-online-call-flows-figure10.png)</span></span>
...
<span data-ttu-id="6f25a-308">*그림 11-페더레이션된 테 넌 트의 비즈니스용 Skype 미디어 릴레이에서 릴레이 된 미디어*</span><span class="sxs-lookup"><span data-stu-id="6f25a-308">*Figure 11 - Media relayed by Skype for Business Media Relay in federated tenant*</span></span>
...
### <a name="teams-hybrid-topology"></a><span data-ttu-id="6f25a-319">팀 하이브리드 토폴로지</span><span class="sxs-lookup"><span data-stu-id="6f25a-319">Teams hybrid topology</span></span>
...
<span data-ttu-id="6f25a-329">**고객 네트워크 내부의 하이브리드**</span><span class="sxs-lookup"><span data-stu-id="6f25a-329">**Hybrid within the customer network**</span></span>

<span data-ttu-id="6f25a-330">[![Microsoft 팀 온라인 통화 흐름 그림 14](media/microsoft-teams-online-call-flows-figure14-thumbnail.png)](media/microsoft-teams-online-call-flows-figure14.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-330">[![Microsoft Teams Online Call Flows Figure 14](media/microsoft-teams-online-call-flows-figure14-thumbnail.png)](media/microsoft-teams-online-call-flows-figure14.png)</span></span>

<span data-ttu-id="6f25a-331">*그림 14-고객 네트워크 내의 하이브리드*</span><span class="sxs-lookup"><span data-stu-id="6f25a-331">*Figure 14 - Hybrid within customer network*</span></span>

<span data-ttu-id="6f25a-332">Office 365의 게이트웨이에서 팀과 비즈니스용 Skype 간의 신호를 브리지로 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-332">Signaling between Teams and Skype for Business is bridged by a gateway in Office 365.</span></span> <span data-ttu-id="6f25a-333">그러나 미디어는 고객 네트워크 내에서 흐름 5를 사용 하 여 직접 피어 투 피어 피어에서 라우팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-333">However, media is routed directly peer-to-peer within the customer network using flow 5.</span></span>

<span data-ttu-id="6f25a-334">**외부 비즈니스용 Skype 사용자와 하이브리드 고객 네트워크-Office 365에서 릴레이**</span><span class="sxs-lookup"><span data-stu-id="6f25a-334">**Hybrid customer network with external Skype for Business user – relayed by Office 365**</span></span>

<span data-ttu-id="6f25a-335">[![Microsoft 팀 온라인 통화 흐름 그림 15](media/microsoft-teams-online-call-flows-figure15-thumbnail.png)](media/microsoft-teams-online-call-flows-figure15.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-335">[![Microsoft Teams Online Call Flows Figure 15](media/microsoft-teams-online-call-flows-figure15-thumbnail.png)](media/microsoft-teams-online-call-flows-figure15.png)</span></span>

<span data-ttu-id="6f25a-336">*그림 15-외부 비즈니스용 Skype 사용자가 있는 하이브리드 고객 네트워크-Office 365에서 릴레이*</span><span class="sxs-lookup"><span data-stu-id="6f25a-336">*Figure 15 - Hybrid customer network with external Skype for Business user - relayed by Office 365*</span></span>
...
- <span data-ttu-id="6f25a-348">신호는 Office 365의 게이트웨이에서 브리지 됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-348">Signaling is bridged by a gateway in Office 365.</span></span>
...
<span data-ttu-id="6f25a-358">\* 그림 17-전화 시스템 다이렉트 라우팅 토폴로지가 있는 팀</span><span class="sxs-lookup"><span data-stu-id="6f25a-358">\*Figure 17 - Teams with Phone System Direct Routing topology</span></span>
...
- <span data-ttu-id="6f25a-365">**흐름 5b** – 우회 모드의 다이렉트 라우팅 SBC를 사용 하 여 고객 네트워크 내의 팀 사용자 간 미디어 흐름을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-365">**Flow 5B** – Represents a media flow between the Teams user within the customer network with the Direct Routing SBC in bypass mode.</span></span>
- <span data-ttu-id="6f25a-366">**흐름 5c** – PSTN 연결 호출 우회 모드에서 직접 라우팅 sbc와 다른 직접 라우팅 sbc 사이의 미디어 흐름을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-366">**Flow 5C** – Represents a media flow between the Direct Routing SBC to another Direct Routing SBC in a PSTN hairpin call bypass mode.</span></span>

<span data-ttu-id="6f25a-367">**직접적인 라우팅이 있는 내부 사용자 (Office 365의 팀에서 미디어를 릴레이 하는 방법 전송 릴레이)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-367">**Internal user with Direct Routing (media relayed by Teams Transport Relay in Office 365)**</span></span>

<span data-ttu-id="6f25a-368">[![Microsoft 팀 온라인 통화 흐름 그림 18](media/microsoft-teams-online-call-flows-figure18-thumbnail.png)](media/microsoft-teams-online-call-flows-figure18.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-368">[![Microsoft Teams Online Call Flows Figure 18](media/microsoft-teams-online-call-flows-figure18-thumbnail.png)](media/microsoft-teams-online-call-flows-figure18.png)</span></span>

<span data-ttu-id="6f25a-369">*그림 18-직접 라우팅이 있는 내부 사용자 (Office 365의 팀에서 전송 릴레이가 미디어를 릴레이할 때)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-369">*Figure 18 - Internal user with Direct Routing (media relayed by Teams Transport Relay in Office 365)*</span></span>

<span data-ttu-id="6f25a-370">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-370">Note that:</span></span>

- <span data-ttu-id="6f25a-371">SBC에는 Office 365에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-371">The SBC must have a public IP address that is routable from Office 365.</span></span>

- <span data-ttu-id="6f25a-372">SBC에서 Office 365로 신호 및 미디어를 보내고, 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-372">Signaling and media from the SBC to Office 365 and vice versa use flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-373">고객 네트워크 내의 클라이언트에서 Office 365으로 이동 하는 신호 및 미디어를 사용 하는 방법 4.</span><span class="sxs-lookup"><span data-stu-id="6f25a-373">Signaling and media from the client within the customer network to Office 365 use flow 4.</span></span>

<span data-ttu-id="6f25a-374">**직접 라우팅이 있는 원격 사용자 (미디어는 Office 365의 media server (MP)를 통해 라우트 됨)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-374">**Remote user with Direct Routing (media is routed through a media server (MP) in Office 365)**</span></span>

<span data-ttu-id="6f25a-375">[![Microsoft 팀 온라인 통화 흐름 그림 19](media/microsoft-teams-online-call-flows-figure19-thumbnail.png)](media/microsoft-teams-online-call-flows-figure19.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-375">[![Microsoft Teams Online Call Flows Figure 19](media/microsoft-teams-online-call-flows-figure19-thumbnail.png)](media/microsoft-teams-online-call-flows-figure19.png)</span></span>

<span data-ttu-id="6f25a-376">*그림 19-직접 라우팅이 있는 원격 사용자 (미디어는 Office 365의 media server (MP)를 통해 라우트됩니다)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-376">*Figure 19 - Remote user with Direct Routing (media is routed through a media server (MP) in Office 365)*</span></span>

<span data-ttu-id="6f25a-377">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-377">Note that:</span></span>

- <span data-ttu-id="6f25a-378">SBC에는 Office 365에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-378">The SBC must have a public IP address that is routable from Office 365.</span></span>

- <span data-ttu-id="6f25a-379">SBC에서 Office 365로 신호 및 미디어를 보내고, 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-379">Signaling and media from the SBC to Office 365 and vice versa use flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-380">인터넷의 클라이언트에서 Office 365로 신호 및 미디어를 사용 하는 것이 흐름 3</span><span class="sxs-lookup"><span data-stu-id="6f25a-380">Signaling and media from the client on the Internet to Office 365 use flow 3.</span></span>

<span data-ttu-id="6f25a-381">**내부 사용자 직접 라우팅 (미디어 바이패스)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-381">**Internal user Direct Routing (media bypass)**</span></span>

<span data-ttu-id="6f25a-382">[![Microsoft 팀 온라인 통화 흐름 그림 20](media/microsoft-teams-online-call-flows-figure20-thumbnail.png)](media/microsoft-teams-online-call-flows-figure20.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-382">[![Microsoft Teams Online Call Flows Figure 20](media/microsoft-teams-online-call-flows-figure20-thumbnail.png)](media/microsoft-teams-online-call-flows-figure20.png)</span></span>

<span data-ttu-id="6f25a-383">*그림 20-내부 사용자 직접 라우팅 (미디어 바이패스)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-383">*Figure 20 - Internal user Direct Routing (media bypass)*</span></span>

<span data-ttu-id="6f25a-384">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-384">Note that:</span></span>

- <span data-ttu-id="6f25a-385">SBC에는 Office 365에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-385">The SBC must have a public IP address that is routable from Office 365.</span></span>

- <span data-ttu-id="6f25a-386">SBC에서 Office 365로 신호를 보내고 그 반대의 경우 흐름 4 및/또는 흐름 4 '를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-386">Signaling from SBC to Office 365 and vice versa use flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-387">고객 네트워크 내의 클라이언트에서 Office 365으로 전송 되는 신호는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-387">Signaling from client within the customer network to Office 365 use flow 4.</span></span>

- <span data-ttu-id="6f25a-388">고객 네트워크 내의 클라이언트에서 고객 네트워크에 있는 SBC에 대 한 미디어는 flow 5B로 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-388">Media from client within the customer network to SBC within the customer network use flow 5B.</span></span>

<span data-ttu-id="6f25a-389">**직접 라우팅이 있는 원격 사용자 (Office 365의 팀에서 전송 릴레이가 미디어를 우회 하 여 릴레이)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-389">**Remote user with Direct Routing (media bypass relayed by Teams Transport Relay in Office 365)**</span></span>

<span data-ttu-id="6f25a-390">[![Microsoft 팀 온라인 통화 흐름 그림 21](media/microsoft-teams-online-call-flows-figure21-thumbnail.png)](media/microsoft-teams-online-call-flows-figure21.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-390">[![Microsoft Teams Online Call Flows Figure 21](media/microsoft-teams-online-call-flows-figure21-thumbnail.png)](media/microsoft-teams-online-call-flows-figure21.png)</span></span>

<span data-ttu-id="6f25a-391">*그림 21-직접 라우팅이 있는 원격 사용자 (Office 365의 팀에서 미디어를 사용 하 여 릴레이 전송 릴레이가 전달 됩니다.)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-391">*Figure 21 - Remote user with Direct Routing (media bypass relayed by Teams Transport Relay in Office 365)*</span></span>

<span data-ttu-id="6f25a-392">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-392">Note that:</span></span>

- <span data-ttu-id="6f25a-393">SBC에는 Office 365 및 인터넷에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-393">The SBC must have a public IP address that is routable from Office 365 and Internet.</span></span>

- <span data-ttu-id="6f25a-394">SBC에서 Office 365로 신호를 보내고 그 반대의 경우 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-394">Signaling from the SBC to Office 365 and vice versa uses flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-395">인터넷의 클라이언트에서 Office 365로 신호를 보내는 것은 흐름 3을 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-395">Signaling from the client on the Internet to Office 365 uses flow 3.</span></span>

- <span data-ttu-id="6f25a-396">고객 네트워크 내의 SBC에 대 한 인터넷 클라이언트의 미디어는 3 번 및 4 흐름을 사용 하 고, Office 365의 팀 전송 릴레이가 릴레이 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-396">Media from the client on the Internet to the SBC within the customer network uses flows 3 and 4, relayed by Teams Transport Relay in Office 365.</span></span>

<span data-ttu-id="6f25a-397">**원격 사용자 직접 라우팅 (미디어 바이패스 다이렉트)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-397">**Remote user Direct Routing (media bypass direct)**</span></span>

<span data-ttu-id="6f25a-398">[![Microsoft 팀 온라인 통화 흐름 그림 22](media/microsoft-teams-online-call-flows-figure22-thumbnail.png)](media/microsoft-teams-online-call-flows-figure22.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-398">[![Microsoft Teams Online Call Flows Figure 22](media/microsoft-teams-online-call-flows-figure22-thumbnail.png)](media/microsoft-teams-online-call-flows-figure22.png)</span></span>

<span data-ttu-id="6f25a-399">*그림 22-원격 사용자 직접 라우팅 (미디어 바이패스 다이렉트)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-399">*Figure 22 - Remote user Direct Routing (media bypass direct)*</span></span>

<span data-ttu-id="6f25a-400">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-400">Note that:</span></span>

- <span data-ttu-id="6f25a-401">SBC에는 Office 365 및 인터넷에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-401">The SBC must have a public IP address that is routable from Office 365 and the Internet.</span></span>

- <span data-ttu-id="6f25a-402">SBC에서 Office 365로 신호를 보내고 그 반대의 경우 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-402">Signaling from the SBC to Office 365 and vice versa uses flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-403">인터넷의 클라이언트에서 Office 365로 신호를 보내는 것은 흐름 3을 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-403">Signaling from the client on the Internet to Office 365 uses flow 3.</span></span>

- <span data-ttu-id="6f25a-404">고객 네트워크 내의 SBC에 대 한 인터넷 클라이언트의 미디어는 흐름 2를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-404">Media from the client on the Internet to the SBC within the customer network uses flow 2.</span></span>

<span data-ttu-id="6f25a-405">**다이렉트 라우팅 (미디어 바이패스) – PSTN 연결 통화 (착신 통화/전송로 인해)**</span><span class="sxs-lookup"><span data-stu-id="6f25a-405">**Direct Routing (media bypass) – PSTN hairpin call (due to call forward/transfer)**</span></span>

<span data-ttu-id="6f25a-406">[![Microsoft 팀 온라인 통화 흐름 그림 23](media/microsoft-teams-online-call-flows-figure23-thumbnail.png)](media/microsoft-teams-online-call-flows-figure23.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-406">[![Microsoft Teams Online Call Flows Figure 23](media/microsoft-teams-online-call-flows-figure23-thumbnail.png)](media/microsoft-teams-online-call-flows-figure23.png)</span></span>

<span data-ttu-id="6f25a-407">*그림 23-다이렉트 라우팅 (미디어 바이패스)-PSTN 연결 통화 (착신 통화/전송로 인해)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-407">*Figure 23 - Direct Routing (media bypass) - PSTN hairpin call (due to call forward/transfer)*</span></span>

<span data-ttu-id="6f25a-408">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-408">Note that:</span></span>

- <span data-ttu-id="6f25a-409">SBC에는 Office 365에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-409">The SBC must have a public IP address that is routable from Office 365.</span></span>

- <span data-ttu-id="6f25a-410">SBC에서 Office 365로 신호를 보내고 그 반대의 경우 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-410">Signaling from the SBC to Office 365 and vice versa uses flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-411">클라이언트가 PSTN에서 PSTN으로 전화를 hairpinned 후 신호 및 미디어 루프를 벗어났습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-411">The client is out of the signaling and media loop after the call is hairpinned from PSTN to PSTN.</span></span>

- <span data-ttu-id="6f25a-412">고객 네트워크 내의 sbc 인스턴스 A의 미디어를 고객 네트워크 내의 SBC 인스턴스 B (여기서, A 및 B는 같은 인스턴스일 수 있음)에서 흐름 5C를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-412">Media from SBC instance A within the customer network to SBC instance B within the customer network (where, A and B can be the same instance) uses flow 5C.</span></span>

<span data-ttu-id="6f25a-413">**다이렉트 라우팅 (Office 365)-2 개의 테 넌 트를 통해 PSTN 연결 통화**</span><span class="sxs-lookup"><span data-stu-id="6f25a-413">**Direct Routing (media through Office 365) – PSTN hairpin call across two tenants**</span></span>

<span data-ttu-id="6f25a-414">[![Microsoft 팀 온라인 통화 흐름 그림 24](media/microsoft-teams-online-call-flows-figure24-thumbnail.png)](media/microsoft-teams-online-call-flows-figure24.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-414">[![Microsoft Teams Online Call Flows Figure 24](media/microsoft-teams-online-call-flows-figure24-thumbnail.png)](media/microsoft-teams-online-call-flows-figure24.png)</span></span>

<span data-ttu-id="6f25a-415">*그림 24-다이렉트 라우팅 (Office 365)-2 개의 테 넌 트를 통해 PSTN 연결 통화*</span><span class="sxs-lookup"><span data-stu-id="6f25a-415">*Figure 24 - Direct Routing (media through Office 365) – PSTN hairpin call across two tenants*</span></span>

<span data-ttu-id="6f25a-416">다음 사항에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="6f25a-416">Note that:</span></span>

- <span data-ttu-id="6f25a-417">SBC에는 Office 365에서 라우팅할 수 있는 공용 IP 주소가 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-417">The SBC must have a public IP address that is routable from Office 365.</span></span>

- <span data-ttu-id="6f25a-418">SBC에서 Office 365로 신호를 보내고 그 반대의 경우 흐름 4 및/또는 흐름 4를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-418">Signaling from the SBC to Office 365 and vice versa uses flow 4 and/or flow 4'.</span></span>

- <span data-ttu-id="6f25a-419">클라이언트가 PSTN에서 PSTN으로 전화를 hairpinned 후 신호 및 미디어 루프를 벗어났습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-419">The client is out of the signaling and media loop after the call is hairpinned from PSTN to PSTN.</span></span>

- <span data-ttu-id="6f25a-420">고객 네트워크 X의 sbc 인스턴스 B에 있는 SBC 인스턴스 A의 미디어는 Office 365 미디어 서버를 통해 릴레이 되어야 하며 우회 모드를 사용할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-420">Media from SBC instance A within the customer network X to SBC instance B must be relayed through the Office 365 Media Server and can't use bypass mode.</span></span>

## <a name="teams-with-express-route-optimization"></a><span data-ttu-id="6f25a-421">Express 경로 최적화를 사용 하는 팀</span><span class="sxs-lookup"><span data-stu-id="6f25a-421">Teams with Express Route optimization</span></span>

<span data-ttu-id="6f25a-422">[![Microsoft 팀 온라인 통화 흐름 그림 25](media/microsoft-teams-online-call-flows-figure25-thumbnail.png)](media/microsoft-teams-online-call-flows-figure25.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-422">[![Microsoft Teams Online Call Flows Figure 25](media/microsoft-teams-online-call-flows-figure25-thumbnail.png)](media/microsoft-teams-online-call-flows-figure25.png)</span></span>

<span data-ttu-id="6f25a-423">*그림 25-Express 경로 최적화를 사용 하는 팀*</span><span class="sxs-lookup"><span data-stu-id="6f25a-423">*Figure 25 - Teams with Express Route optimization*</span></span>

<span data-ttu-id="6f25a-424">Express 경로를 정당화 및 배포 하는 경우 팀 흐름이 흐름 4에서 흐름 1, 흐름 4 '에서 흐름 1 '으로 다시 라우팅될 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-424">In the case that Express Route is justified and deployed, then Teams flows could be re-routed from flow 4 to flow 1 and from flow 4' to flow 1'.</span></span> <span data-ttu-id="6f25a-425">그러나 팀 응용 프로그램이 흐름 4 및 4를 사용 하 여 인터넷을 통해 다른 Office 365에서 흐르는 종속성이 있습니다. 따라서 이러한 흐름은 차단 되지 않아야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-425">However, the Teams application has a hard dependency on other Office 365 flows over the Internet using flows 4 and 4'; hence these flows must not be blocked.</span></span>

<span data-ttu-id="6f25a-426">비즈니스용 Skype 하이브리드 Edge 트래픽은 인터넷으로 라우팅되며, 외부 사용자와 통신 하 고 다른 테 넌 트와 페더레이션 하기 위해 경로를 표현할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-426">Note that Skype for Business hybrid Edge traffic is routed to the Internet and not to Express Route to communicate with external users and federate with other tenants.</span></span>

<span data-ttu-id="6f25a-427">비대칭 흐름을 방지 하려면 다시 라우팅이 양방향으로 진행 되어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-427">To prevent asymmetrical flows, re-routing must be in both directions.</span></span> <span data-ttu-id="6f25a-428">즉, 고객 네트워크 내의 주소는 최적화에 기반 하 여 인터넷 또는 Express 경로를 통해 라우팅할 수 있지만 두 가지를 모두 사용 하지는 않습니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-428">In other words, an address within the customer network is routable either through Internet or Express Route, based on optimization, but not through both.</span></span>


<span data-ttu-id="6f25a-429">**외부 사용자에 대 한 고객 네트워크 (팀에서 전송 릴레이가 전달 하는 미디어 릴레이):**</span><span class="sxs-lookup"><span data-stu-id="6f25a-429">**Customer network to external user (media relayed by Teams Transport Relay):**</span></span>

<span data-ttu-id="6f25a-430">[![Microsoft 팀 온라인 통화 흐름 그림 26](media/microsoft-teams-online-call-flows-figure26-thumbnail.png)](media/microsoft-teams-online-call-flows-figure26.png)</span><span class="sxs-lookup"><span data-stu-id="6f25a-430">[![Microsoft Teams Online Call Flows Figure 26](media/microsoft-teams-online-call-flows-figure26-thumbnail.png)](media/microsoft-teams-online-call-flows-figure26.png)</span></span>

<span data-ttu-id="6f25a-431">*그림 26-외부 사용자에 대 한 고객 네트워크 (팀에서 전송 릴레이가 전달 하는 미디어 릴레이)*</span><span class="sxs-lookup"><span data-stu-id="6f25a-431">*Figure 26 - Customer network to external user (media relayed by Teams Transport Relay)*</span></span>

<span data-ttu-id="6f25a-432">**상위 수준 단계:**</span><span class="sxs-lookup"><span data-stu-id="6f25a-432">**High Level Steps:**</span></span>

1. <span data-ttu-id="6f25a-433">고객 네트워크 내의 팀 사용자는 flow2를 사용 하 여 URL 도메인 이름 (DNS)을 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-433">Teams User within customer network resolves URL domain name (DNS) using flow2.</span></span>
1. <span data-ttu-id="6f25a-434">고객 네트워크 내의 팀 사용자는 흐름 1을 사용 하 여 팀 전송 릴레이에 미디어 릴레이 포트를 할당 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-434">Teams User within customer network allocates a media Relay port on Teams Transport Relay using flow 1.</span></span>
1. <span data-ttu-id="6f25a-435">고객 네트워크 내의 팀 사용자는 흐름 1을 Office 365로 사용 하 여 "초대"를 얼음 후보로 보냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-435">Teams User within customer network sends "invite" with ICE candidates using flow 1 to Office 365.</span></span>
1. <span data-ttu-id="6f25a-436">Office 365에서는 흐름 3을 사용 하 여 외부 팀 사용자에 게 알림을 보냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-436">Office 365 sends notification to external Teams user using flow 3.</span></span>
1. <span data-ttu-id="6f25a-437">팀 외부 사용자는 흐름 3을 사용 하 여 팀 전송 릴레이에 미디어 릴레이 포트를 할당 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-437">Teams external user allocates a media Relay port on Teams Transport Relay using flow 3.</span></span>
1. <span data-ttu-id="6f25a-438">팀 외부 사용자는 흐름 3을 사용 하 여 "answer" 라는 발송 후보로 전송 되며 흐름 1을 사용 하 여 팀 사용자 A에 게 다시 전달 됩니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-438">Teams external user sends "answer" with ICE candidates using flow 3, which is forwarded back to Teams user A using Flow 1.</span></span>
1. <span data-ttu-id="6f25a-439">팀 사용자 A 및 팀 사용자 B는 ICE connectivity 테스트를 호출 하 고, Office 365의 팀 전송 릴레이가 릴레이할 흐름 1 및 3을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-439">Teams User A and Teams User B invoke ICE connectivity tests and selects flows 1 and 3, which are relayed by Teams Transport Relay in Office 365.</span></span>
1. <span data-ttu-id="6f25a-440">팀 사용자는 흐름 1 및 3을 사용 하 여 Office 365에 원격 분석을 보냅니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-440">Teams Users send telemetry to Office 365 using flows 1 and 3.</span></span>

> [!NOTE]
> <span data-ttu-id="6f25a-441">흐름 4를 요구 하는 다른 마이크로 서비스에서 팀 응용 프로그램의 종속성을 지원 하려면 흐름 4를 사용 하도록 설정 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="6f25a-441">Flow 4 must be enabled to support dependencies of Teams application on other micro-services that mandates flow 4.</span></span>
