...
때로는 Microsoft 팀 사용자가 자신의 오디오 회의 정보를 보내야 할 수 있습니다. 이 작업은 사용자의 속성 아래에서 **전자 메일을 통해 회의 정보 보내기를** 클릭 하 여 수행할 수 있습니다. 이 전자 메일을 보낼 때 다음을 비롯 한 모든 오디오 회의 정보가 포함 됩니다.
