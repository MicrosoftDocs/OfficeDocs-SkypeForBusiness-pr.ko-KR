...
<span data-ttu-id="de469-108">가상화된 환경의 Microsoft Teams는 채팅 및 공동 작업을 지원 합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-108">Microsoft Teams in a virtualized environment supports chat and collaboration.</span></span> <span data-ttu-id="de469-109">또한 Windows Virtual Desktop, Citrix 및 VMware 플랫폼을 사용하여 호출 및 모임 기능도 지원됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-109">And with the Windows Virtual Desktop, Citrix, and VMware platforms, calling and meeting functionality is also supported.</span></span>
...
## <a name="teams-on-vdi-requirements"></a><span data-ttu-id="de469-123">VDI 요구 사항에 대한 Teams</span><span class="sxs-lookup"><span data-stu-id="de469-123">Teams on VDI requirements</span></span>
...
### <a name="citrix-virtual-apps-and-desktops-requirements"></a><span data-ttu-id="de469-142">Citrix Virtual Apps 및 데스크톱 요구 사항</span><span class="sxs-lookup"><span data-stu-id="de469-142">Citrix Virtual Apps and Desktops requirements</span></span>
...
#### <a name="dedicated-persistent-setup"></a><span data-ttu-id="de469-170">전용 영구 설정</span><span class="sxs-lookup"><span data-stu-id="de469-170">Dedicated persistent setup</span></span>
...
2. <span data-ttu-id="de469-231">다음 명령 중 하나를 실행하여 VDI VM에 MSI를 설치합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-231">Install the MSI to the VDI VM by running one of the following commands:</span></span>
    ...
    - <span data-ttu-id="de469-236">컴퓨터당 설치</span><span class="sxs-lookup"><span data-stu-id="de469-236">Per-machine installation</span></span>
...
3. <span data-ttu-id="de469-246">VDI VM에서 MSI를 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-246">Uninstall the MSI from the VDI VM.</span></span> <span data-ttu-id="de469-247">Teams를 제거하는 방법에는 두 가지가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-247">There are two ways to uninstall Teams.</span></span>
    ...
    - <span data-ttu-id="de469-250">명령줄: 다음 명령을 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-250">Command line: Run the following command.</span></span>
      ...
      <span data-ttu-id="de469-251">이 프로세스는 운영 체제 환경에 따라 프로그램 파일(x86) 폴더 또는 프로그램 파일 폴더에서 Teams를 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-251">This process uninstalls Teams from the Program Files (x86) folder or Program Files folder, depending on the operating system environment.</span></span>
...
<span data-ttu-id="de469-274">Teams용 네트워크를 준비하는 방법에 대한 자세한 내용은 Teams에 대한 조직의 네트워크 [준비를 참조합니다.](prepare-network.md)</span><span class="sxs-lookup"><span data-stu-id="de469-274">To learn more about how to prepare your network for Teams, see [Prepare your organization's network for Teams](prepare-network.md).</span></span>
...
## <a name="teams-on-vdi-with-chat-and-collaboration"></a><span data-ttu-id="de469-291">채팅 및 공동 작업을 통해 VDI의 Teams</span><span class="sxs-lookup"><span data-stu-id="de469-291">Teams on VDI with chat and collaboration</span></span>
...
<span data-ttu-id="de469-355">또는 다음을 할 수도 있습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-355">Or, you can also do the following:</span></span>
...
## <a name="control-fallback-mode-in-teams"></a><span data-ttu-id="de469-369">Teams에서 폴백 모드 제어</span><span class="sxs-lookup"><span data-stu-id="de469-369">Control fallback mode in Teams</span></span>
...
- <span data-ttu-id="de469-388">Citrix는 엔드포인트에 정의된 명시적 HTTPX의 사용을 지원하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-388">Citrix doesn't support the use of explicit HTTP proxies defined on an endpoint.</span></span>
...
- <span data-ttu-id="de469-404">비즈니스용 Skype와의 상호 연동성은 음성 통화로 제한됩니다. 비디오 부호가 없는 경우</span><span class="sxs-lookup"><span data-stu-id="de469-404">Interoperability with Skype for Business is limited to audio calls; there is no video modality.</span></span>
- <span data-ttu-id="de469-405">모임 또는 그룹 통화에서는 들어오는 비디오 스트림 하나만 지원됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-405">Only a single incoming video stream is supported in meetings or group calls.</span></span> <span data-ttu-id="de469-406">여러 사용자가 비디오를 보내면 주된 발표자 비디오만 언제든 표시됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-406">When multiple people send video, only the dominant speaker's video is shown at any given time.</span></span>
- <span data-ttu-id="de469-407">수신 및 발신 비디오 스트림 해상도는 720p 해상도로 제한됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-407">Incoming and outgoing video stream resolution is limited to 720p resolution.</span></span> <span data-ttu-id="de469-408">WebRTC 제한 사항입니다.</span><span class="sxs-lookup"><span data-stu-id="de469-408">This is a WebRTC limitation.</span></span>
- <span data-ttu-id="de469-409">들어오는 카메라 또는 화면 공유 스트림에서 하나의 비디오 스트림만 지원됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-409">Only one video stream from an incoming camera or screen share stream is supported.</span></span> <span data-ttu-id="de469-410">들어오는 화면 공유가 있는 경우 주 화자 비디오 대신 화면 공유가 표시됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-410">When there's an incoming screen share, that screen share is shown, instead of the video of the dominant speaker.</span></span>
- <span data-ttu-id="de469-411">장치가 연결이 끊어진 경우 사용자가 선택한 마지막 오디오 장치를 사용하기 위해 Teams가 전환되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-411">Teams doesn't switch to use the last audio device that a user selected, if the device is disconnected, and then reconnected.</span></span>
- <span data-ttu-id="de469-412">나선 화면 공유:</span><span class="sxs-lookup"><span data-stu-id="de469-412">Outgoing screen sharing:</span></span>
    - <span data-ttu-id="de469-413">애플리케이션 공유는 지원되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-413">Application sharing is not supported.</span></span>
- <span data-ttu-id="de469-414">제어권 제공 및 제어권 제공:</span><span class="sxs-lookup"><span data-stu-id="de469-414">Give control and take control:</span></span>
    - <span data-ttu-id="de469-415">화면 공유 또는 응용 프로그램 공유 세션 중에 지원되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-415">Not supported during a screen sharing or application sharing session.</span></span>
    - <span data-ttu-id="de469-416">PowerPoint 공유 세션 중에 지원됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-416">Supported during a PowerPoint sharing session.</span></span>
- <span data-ttu-id="de469-417">Citrix 전용 제한 사항</span><span class="sxs-lookup"><span data-stu-id="de469-417">Citrix-only limitations</span></span>
    - <span data-ttu-id="de469-418">다중 모니터 설정에서 화면 공유를 하는 경우 주 모니터만 공유됩니다.</span><span class="sxs-lookup"><span data-stu-id="de469-418">When screen sharing in a multi-monitor setup, only the main monitor is shared.</span></span>
    - <span data-ttu-id="de469-419">CWA에서 높은 DPI 크기 조정은 지원되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-419">High DPI scaling on CWA is not supported.</span></span>

<span data-ttu-id="de469-420">VDI와 관련이 없는 Teams의 알려진 문제는 조직의 [지원 팀을 참조합니다.](Known-issues.md)</span><span class="sxs-lookup"><span data-stu-id="de469-420">For Teams known issues that aren't related to VDI, see [Support Teams in your organization](Known-issues.md).</span></span>

## <a name="troubleshooting"></a><span data-ttu-id="de469-421">문제 해결</span><span class="sxs-lookup"><span data-stu-id="de469-421">Troubleshooting</span></span>

### <a name="troubleshoot-citrix-components"></a><span data-ttu-id="de469-422">Citrix 구성 요소 문제 해결</span><span class="sxs-lookup"><span data-stu-id="de469-422">Troubleshoot Citrix components</span></span>

#### <a name="teams-crashes-or-the-teams-sign-in-screen-is-blank"></a><span data-ttu-id="de469-423">Teams 충돌 또는 Teams 로그인 화면이 비어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="de469-423">Teams crashes or the Teams sign in screen is blank</span></span>

<span data-ttu-id="de469-424">Citrix VDA 버전 1906 및 1909의 알려진 문제입니다.</span><span class="sxs-lookup"><span data-stu-id="de469-424">This is a known issue with Citrix VDA versions 1906 and 1909.</span></span> <span data-ttu-id="de469-425">이 문제를 해결하기 위해 다음 레지스트리 DWORD 값을 추가하고 204(16진수)로 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-425">To work around this issue, add the following registry DWORD value, and set it to 204 (hexadecimal).</span></span>

<span data-ttu-id="de469-426">HKEY_LOCAL_MACHINE\SOFTWARE\Citrix\CtxHook\AppInit_Dlls\SfrHook\Teams.exe</span><span class="sxs-lookup"><span data-stu-id="de469-426">HKEY_LOCAL_MACHINE\SOFTWARE\Citrix\CtxHook\AppInit_Dlls\SfrHook\Teams.exe</span></span>

<span data-ttu-id="de469-427">그런 다음 VDA를 다시 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="de469-427">Then, restart VDA.</span></span> <span data-ttu-id="de469-428">자세한 내용은 Teams에 대한 HDX 최적화 문제 해결 Citrix 지원 문서를 [참조하세요.](https://support.citrix.com/article/CTX253754)</span><span class="sxs-lookup"><span data-stu-id="de469-428">To learn more, see this Citrix support article, [Troubleshooting HDX optimization for Teams](https://support.citrix.com/article/CTX253754).</span></span>

## <a name="related-topics"></a><span data-ttu-id="de469-429">관련 항목</span><span class="sxs-lookup"><span data-stu-id="de469-429">Related topics</span></span>

- [<span data-ttu-id="de469-430">MSI를 사용하여 Microsoft Teams 설치</span><span class="sxs-lookup"><span data-stu-id="de469-430">Install Microsoft Teams using MSI</span></span>](msi-deployment.md)
- [<span data-ttu-id="de469-431">Teams PowerShell 개요</span><span class="sxs-lookup"><span data-stu-id="de469-431">Teams PowerShell overview</span></span>](teams-powershell-overview.md)
- [<span data-ttu-id="de469-432">Windows 가상 데스크톱에서 Microsoft Teams 사용</span><span class="sxs-lookup"><span data-stu-id="de469-432">Use Microsoft Teams on Windows Virtual desktop</span></span>](https://docs.microsoft.com/azure/virtual-desktop/teams-on-wvd)
