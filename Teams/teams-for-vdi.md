...
- Citrix 환경에서 Teams가 실행되는 동안 사용자가 Virtual Machine에서 연결을 끊는 경우 Teams 업데이트는 사용자가 다시 연결할 때 AV에 대해 최적화되지 않은 상태로 될 수 있습니다. 이 시나리오를 피하기 위해 사용자가 Citrix Virtual Machine에서 연결을 끊기 전에 Teams를 종료하는 것이 좋습니다.
