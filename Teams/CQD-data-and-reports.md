...
### <a name="admin-roles-with-and-without-euii-access"></a><span data-ttu-id="3d46a-149">EUII 액세스를 포함 하거나 사용 하지 않고 관리 역할</span><span class="sxs-lookup"><span data-stu-id="3d46a-149">Admin roles with and without EUII access</span></span>
...
|<span data-ttu-id="3d46a-170">URL</span><span class="sxs-lookup"><span data-stu-id="3d46a-170">URL</span></span>| <span data-ttu-id="3d46a-171">롤링 일 추세의 종료 날짜</span><span class="sxs-lookup"><span data-stu-id="3d46a-171">End date of Rolling Day Trend</span></span>|
|:---|:---|
...
|<span data-ttu-id="3d46a-206">사용자 단위 보고서 집합</span><span class="sxs-lookup"><span data-stu-id="3d46a-206">Per-user report set</span></span>   | <span data-ttu-id="3d46a-207">아니요</span><span class="sxs-lookup"><span data-stu-id="3d46a-207">No</span></span>   | <span data-ttu-id="3d46a-208">예</span><span class="sxs-lookup"><span data-stu-id="3d46a-208">Yes</span></span>   |
...
|<span data-ttu-id="3d46a-231">탭</span><span class="sxs-lookup"><span data-stu-id="3d46a-231">Tab</span></span>  |  |
|---------|---------|
...
<span data-ttu-id="3d46a-252">막대 위로 마우스를 가져가면 실제 숫자 값을 구할 수도 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-252">You can also obtain the actual numerical values by hovering the mouse over a bar.</span></span>
...
- <span data-ttu-id="3d46a-265">유선 내부-유선 내부</span><span class="sxs-lookup"><span data-stu-id="3d46a-265">Wired Inside — Wired Inside</span></span>
...
<span data-ttu-id="3d46a-360">CQD 보고서 필터를 사용 하 여 조사의 초점을 좁힐 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-360">Use CQD report filters to narrow the focus of your investigations.</span></span> <span data-ttu-id="3d46a-361">보고서 필터는 쿼리 편집기에서 렌더링 된 보고서에 필터를 추가 하거나 보고서에서 바로 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-361">Use report filters by adding a filter to the rendered report either in the Query Editor or directly in the report.</span></span> <span data-ttu-id="3d46a-362">다음 보고서 필터는 [Cqd 서식 파일](https://aka.ms/QERtemplates)에서 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-362">The following report filters are used throughout the [CQD templates](https://aka.ms/QERtemplates).</span></span>
...
### <a name="url-filters"></a><span data-ttu-id="3d46a-409">URL 필터</span><span class="sxs-lookup"><span data-stu-id="3d46a-409">URL filters</span></span>
...
| <span data-ttu-id="3d46a-439">안쪽만 보기</span><span class="sxs-lookup"><span data-stu-id="3d46a-439">View inside only</span></span>  | <span data-ttu-id="3d46a-440">관리 (내부) 또는 비관리형 (외부)에 대 한 보고서를 필터링 하는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-440">Used to filter a report for managed (inside) or unmanaged (outside).</span></span> <span data-ttu-id="3d46a-441">관리 되는 CQD 템플릿은이 필터를 사용 하 여 이미 미리 구성 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-441">The managed CQD template is already preconfigured with these filters.</span></span>       | <span data-ttu-id="3d46a-442">두 번째 내부의 Corp = 인사이드</span><span class="sxs-lookup"><span data-stu-id="3d46a-442">Second Inside Corp = Inside</span></span>        |


#### <a name="how-to-find-your-tenant-id"></a><span data-ttu-id="3d46a-443">테 넌 트 ID를 찾는 방법</span><span class="sxs-lookup"><span data-stu-id="3d46a-443">How to find your tenant ID</span></span>

<span data-ttu-id="3d46a-444">CQD의 테 넌 트 ID는 Azure의 디렉터리 ID에 해당 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-444">The tenant ID in CQD corresponds to the Directory ID in Azure.</span></span> <span data-ttu-id="3d46a-445">디렉터리 ID를 모르는 경우 Azure 포털에서 찾을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-445">If you don't know your Directory ID, you can find it in the Azure portal:</span></span>

1.  <span data-ttu-id="3d46a-446">Microsoft Azure 포털에 로그인 합니다.<https://portal.azure.com></span><span class="sxs-lookup"><span data-stu-id="3d46a-446">Sign in to the Microsoft Azure portal: <https://portal.azure.com></span></span>

2.  <span data-ttu-id="3d46a-447">**Azure Active Directory**를 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-447">Select **Azure Active Directory**.</span></span>

3.  <span data-ttu-id="3d46a-448">**관리**에서 **속성**을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-448">Under **Manage**, select **Properties**.</span></span> <span data-ttu-id="3d46a-449">테 넌 트 ID는 **디렉터리 ID** 상자에 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-449">Your tenant ID is in the **Directory ID** box.</span></span>

<span data-ttu-id="3d46a-450">PowerShell을 사용 하 여 테 넌 트 ID를 찾을 수도 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-450">You can also find your tenant ID by using PowerShell:</span></span> 
  ```
...
## <a name="comparing-teams-and-skype-for-business-cqd-data"></a><span data-ttu-id="3d46a-451">팀과 비즈니스용 Skype CQD 데이터 비교</span><span class="sxs-lookup"><span data-stu-id="3d46a-451">Comparing Teams and Skype for Business CQD data</span></span>

<span data-ttu-id="3d46a-452">최신 CQD (cqd.teams.microsoft.com) 내에도 팀과 비즈니스용 Skype 간의 데이터 차이를 확인할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-452">Even within the latest CQD (cqd.teams.microsoft.com), you'll see differences in data between Teams and Skype for Business.</span></span> <span data-ttu-id="3d46a-453">몇 가지 이유는 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-453">Some reasons:</span></span>
- <span data-ttu-id="3d46a-454">성능 및 안정성을 보장 하는 메커니즘의 차이점</span><span class="sxs-lookup"><span data-stu-id="3d46a-454">Differences in the mechanisms for ensuring performance and reliability</span></span>
  - <span data-ttu-id="3d46a-455">팀에 자동 다시 연결 및 빠른 로밍이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-455">Teams has auto-reconnect and fast roaming.</span></span> <span data-ttu-id="3d46a-456">비즈니스용 Skype는 그렇지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-456">Skype for Business doesn't.</span></span>
  - <span data-ttu-id="3d46a-457">팀은 동적 대역폭 관리를가지고 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-457">Teams has dynamic bandwidth management.</span></span> <span data-ttu-id="3d46a-458">비즈니스용 Skype는 그렇지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-458">Skype for Business doesn't.</span></span>
- <span data-ttu-id="3d46a-459">팀과 비즈니스용 Skype 간의 [IP 주소 범위](Office-365-URLs-IP-address-ranges.md) 차이</span><span class="sxs-lookup"><span data-stu-id="3d46a-459">Differences in [IP address ranges](Office-365-URLs-IP-address-ranges.md) between Teams and Skype for Business.</span></span> <span data-ttu-id="3d46a-460">팀 IP 범위는 더 최신 버전 이므로 방화벽에서 연결 문제가 발생할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-460">The Teams IP ranges are newer, which could cause connectivity problems at the firewall.</span></span>

## <a name="open-cqd-from-the-skype-for-business-legacy-portal"></a><span data-ttu-id="3d46a-461">비즈니스용 Skype 레거시 포털에서 CQD 열기</span><span class="sxs-lookup"><span data-stu-id="3d46a-461">Open CQD from the Skype for Business legacy portal</span></span>

<span data-ttu-id="3d46a-462">![비즈니스용 skype ](media/sfb-logo-30x30.png) **레거시 포털을 사용 하** 는 비즈니스용 skype 로고 아이콘</span><span class="sxs-lookup"><span data-stu-id="3d46a-462">![An icon of the Skype for Business logo](media/sfb-logo-30x30.png) **Using the Skype for Business legacy portal**</span></span>

1. <span data-ttu-id="3d46a-463">관리자 계정을 사용 하 여 Office 365 조직에 로그인 한 다음 관리 타일을 선택 **하 여 관리** 센터를 엽니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-463">Sign in to your Office 365 organization using an admin account, and then select the **Admin** tile to open the Admin center.</span></span>
2. <span data-ttu-id="3d46a-464">왼쪽 창의 **관리 센터**에서 **Microsoft 팀** 을 선택 하 여 팀 관리 센터를 엽니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-464">In the left pane, under **Admin centers**, select **Microsoft Teams** to open the Teams admin center.</span></span>
3. <span data-ttu-id="3d46a-465">팀 관리 센터의 왼쪽 창에서 **레거시 포털** 을 선택 하 고 **도구**를 선택한 다음 비즈니스용 **Skype Online 통화 품질 대시보드**를 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-465">In the Teams admin center, select **Legacy Portal** in the left pane, select **Tools**, and then select **Skype for Business Online Call Quality Dashboard**.</span></span>

     ![스크린샷: 통화 품질 대시보드를 선택 합니다.](media/6cc7f80f-b8e2-4a9b-aab8-ac871d07a261.png)

4. <span data-ttu-id="3d46a-467">열리는 페이지에서 전역 관리자 계정으로 로그인 한 다음 메시지가 표시 되 면 계정에 대 한 자격 증명을 제공 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-467">On the page that opens, sign in with your Global Administrator account, and then provide the credentials for the account when prompted.</span></span>

<span data-ttu-id="3d46a-468">처음 로그인 하면 CQD가 데이터 수집과 처리를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-468">After the first time you sign in, CQD will begin collecting and processing data.</span></span> 

> [!IMPORTANT]
> <span data-ttu-id="3d46a-469">2019 년 12 월 이전에는 레거시 포털에서 최신 CQD (cqd.teams.microsoft.com)에 대 한 링크를 제공 하지만이 경우에도 cqd.lync.com (c)의 오래 된 버전에 액세스할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-469">As of December 2019, you can still access the older version of CQD (cqd.lync.com), although the legacy portal gives you a link to the latest CQD (cqd.teams.microsoft.com).</span></span> <span data-ttu-id="3d46a-470">결과적으로 CQD의 이전 버전이 서비스 해제 됩니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-470">Eventually, the older version of CQD will be decommissioned.</span></span> <span data-ttu-id="3d46a-471">7 월 1 2020 일 (으)로 이전 버전의 CQD는 새 CQD의 데이터에 액세스 https://CQD.teams.microsoft.com) 하며, 더 이상 빌드 및 보고서 데이터를 내보낼 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-471">As of July 1, 2020, the older version of CQD accesses data from the new CQD (https://CQD.teams.microsoft.com), and you can no longer export building and report data.</span></span> <span data-ttu-id="3d46a-472">2020 후반에는 이전 CQD를 해제 하 고 더 이상 액세스할 수 없게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="3d46a-472">Sometime in late 2020, we'll turn off the old CQD and you'll no longer be able to access it.</span></span>


## <a name="related-topics"></a><span data-ttu-id="3d46a-473">관련 항목</span><span class="sxs-lookup"><span data-stu-id="3d46a-473">Related topics</span></span>

[<span data-ttu-id="3d46a-474">팀의 통화 품질 개선 및 모니터링</span><span class="sxs-lookup"><span data-stu-id="3d46a-474">Improve and monitor call quality for Teams</span></span>](monitor-call-quality-qos.md)

[<span data-ttu-id="3d46a-475">CQD 란 무엇 인가요?</span><span class="sxs-lookup"><span data-stu-id="3d46a-475">What is CQD?</span></span>](CQD-what-is-call-quality-dashboard.md)

[<span data-ttu-id="3d46a-476">CQD (통화 품질 대시보드) 설정</span><span class="sxs-lookup"><span data-stu-id="3d46a-476">Set up Call Quality Dashboard (CQD)</span></span>](turning-on-and-using-call-quality-dashboard.md)

[<span data-ttu-id="3d46a-477">테 넌 트 업로드 및 데이터 빌드</span><span class="sxs-lookup"><span data-stu-id="3d46a-477">Upload tenant and building data</span></span>](CQD-upload-tenant-building-data.md)

[<span data-ttu-id="3d46a-478">CQD를 사용 하 여 통화 및 모임 품질 관리</span><span class="sxs-lookup"><span data-stu-id="3d46a-478">Use CQD to manage call and meeting quality</span></span>](quality-of-experience-review-guide.md)

[<span data-ttu-id="3d46a-479">CQD에서 사용할 수 있는 차원과 측정값</span><span class="sxs-lookup"><span data-stu-id="3d46a-479">Dimensions and measures available in CQD</span></span>](dimensions-and-measures-available-in-call-quality-dashboard.md)

[<span data-ttu-id="3d46a-480">CQD의 스트림 분류</span><span class="sxs-lookup"><span data-stu-id="3d46a-480">Stream Classification in CQD</span></span>](stream-classification-in-call-quality-dashboard.md)

[<span data-ttu-id="3d46a-481">Power BI를 사용 하 여 CQD 데이터 분석</span><span class="sxs-lookup"><span data-stu-id="3d46a-481">Use Power BI to analyze CQD data</span></span>](CQD-Power-BI-query-templates.md)
