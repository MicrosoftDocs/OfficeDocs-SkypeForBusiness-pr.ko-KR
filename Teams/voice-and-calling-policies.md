...
ms.locfileid: "65646467"
---
# <a name="manage-voice-and-calling-policies-in-microsoft-teams"></a>Microsoft Teams 음성 및 통화 정책 관리

음성 및 통화 정책은 Microsoft Teams 음성 및 통화를 제어하는 데 사용됩니다.
...
조직에서 **직접 라우팅에 전화 시스템** 배포한 경우 [긴급 통화 라우팅 정책을 사용하여 긴급 통화](manage-emergency-call-routing-policies.md) 라우팅 위치, 향상된 응급 서비스 사용 여부 및 응급 서비스에 사용되는 번호를 확인할 수 있습니다. 이러한 정책은 PowerShell을 사용하거나 Microsoft Teams 관리 센터에서 관리됩니다.
...
[음성 라우팅 정책은](manage-voice-routing-policies.md) PSTN(공중 전화망) 사용 레코드에 대한 컨테이너입니다. 조직에서 **직접 라우팅** 을 전화 시스템 배포한 경우 이러한 정책을 사용할 수 있습니다. 음성 라우팅 정책은 PowerShell 또는 Teams 관리 센터에서 관리할 수 있습니다.
...
* [Microsoft Teams 긴급 통화 정책 관리](manage-emergency-calling-policies.md)
...
* [Microsoft Teams 정책 호출](teams-calling-policy.md)
* [대기를 호출하고 Microsoft Teams 검색](call-park-and-retrieve.md)
