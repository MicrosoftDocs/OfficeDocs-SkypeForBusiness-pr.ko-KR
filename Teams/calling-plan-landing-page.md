...
description: Teams Cloud Voice에서 조직에 가장 적합한 Microsoft 전화 시스템 통화 계획을 결정합니다.
...
[시작](get-started-with-teams-quick-start.md) 완료했습니다. 조직 전체에서 [채팅, 팀, 채널 및 앱](deploy-chat-teams-channels-microsoft-teams-landing-page.md)이 포함된 Teams를 배포했습니다. [모임 & 회의를](deploy-meetings-microsoft-teams-landing-page.md) 배포했을 수도 있습니다. 이제 클라우드 음성 워크로드를 추가할 준비가 되었으며 통화 플랜이 있는 Microsoft 전화 시스템을 사용하여 PSTN(공중 전화망)에 연결하기로 결정했습니다.

이 문서에서는 통화 플랜에 대한 핵심 배포 결정과 조직의 요구 사항에 따라 구성할 수 있는 추가 고려 사항에 대해 설명합니다. Microsoft의 [클라우드 음성](cloud-voice-landing-page.md) 제품에 대한 자세한 내용은 Microsoft Teams Cloud Voice를 참조해야 합니다.
...
Microsoft를 전화 통신 사업자로 사용하려면 통화 플랜 라이선스를 획득하고 전화 시스템 사용자에게 할당해야 합니다.
...
사용자에게 국제 통화가 필요한가요? | 자세한 내용은 [Microsoft 365 또는 Office 365 대한 통화 플랜을 참조](calling-plans-for-office-365.md)하세요. |
...
현재 서비스 공급자에서 Teams 전화 번호를 쉽게 전송할 수 있습니다. 전화 번호를 Teams 이식하면 Microsoft가 서비스 공급자가 되어 해당 전화 번호에 대한 요금을 청구합니다. 자세한 내용은 [Teams 전화 번호 전송을](phone-number-calling-plans/transfer-phone-numbers-to-teams.md) 참조하세요.
