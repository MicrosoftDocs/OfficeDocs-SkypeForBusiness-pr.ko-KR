<span data-ttu-id="bafc1-101">외부 액세스(페더레이션) 및 게스트 액세스는 서로 다릅니다.</span><span class="sxs-lookup"><span data-stu-id="bafc1-101">External access (federation) and guest access are different:</span></span>
