...
다음 표에서는 다른 유형의 사용자와 비교하여 게스트가 사용할 수 있는 통화 및 모임 기능을 보여줍니다.

| 통화 기능 | 게스트 | E1 및 E3 사용자 | E5 및 Enterprise Voice 사용자 |
| --------------- | ----- | -------------- | -------------- |
| VOIP 호출 | 예 | 예 | 예 |
| 그룹 호출 | 예 | 예 | 예 |
| 지원되는 핵심 통화 컨트롤(보류, 음소거, 비디오 on/off, 화면 공유) | 예 | 예 | 예 |
| 전송 대상 | 예 | 예 | 예 |
...
| 대상 전달 | 아니요 | 예 | 예 |
| 통화 그룹 대상 | 아니요 | 예 | 예 |
| 대상이 지정되지 않은 경우 | 아니요 | 예 | 예 |
| 페더리드 호출의 대상이 될 수 있습니다. | 아니요 | 예 | 예 |
| 페더리드 호출할 수 있습니다. | 아니요 | 예 | 예 |
| 통화를 즉시 전달할 수 있습니다. | 아니요 | 아니요 | 예 |
| 통화를 동시에 벨소리할 수 있습니다. | 아니요 | 아니요 | 예 |
| 부재 중 호출을 라우팅할 수 있습니다. | 아니요 | 아니요 | 예 |
| 부재 중 전화가 음성메일로 이동될 수 있습니다. | 아니요 | 아니요<sup>1</sup> |예 |
| 전화를 받을 수 있는 전화 번호가 있습니다. | 아니요 | 아니요 | 예 |
| 전화 번호로 전화를 걸 수 있습니다. | 아니요 | 아니요 | 예 |
| 통화 설정에 액세스할 수 있습니다. | 아니요 | 아니요 | 예 |
| 음성사서메일 인사말을 변경할 수 있습니다. | 아니요 | 아니요<sup>1</sup> | 예 |
