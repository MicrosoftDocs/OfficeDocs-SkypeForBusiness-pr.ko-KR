...
- **비정기 모임에 사용할 수 있는 모임 공간을 예약합니다.** 터치 스크린 패널을 사용하여 자리에서 사용 가능한 모임 공간을 예약하고, 회의실 또는 Teams 또는 Teams 모임에 참가할 Microsoft Teams 룸  Surface Hub 있습니다.
...
이러한 기능 및 사용 방법에 대한 자세한 내용은 패널 사용 Microsoft Teams [참조합니다](use-teams-panels.md).
...
- [모임 공간 인](#inventory-sites-and-meeting-spaces)벤토리 및 기능 계획: 조직의 사이트 및 모임 공간의 인벤토리를 만들어 패널 Teams 합니다.
...
모든 패널에 Microsoft 365 리소스 계정을 설정하려면 Teams 라이선스를 구입하는 [Microsoft Teams 룸 스탠더드 것이 좋습니다](#license-requirement). 리소스 계정을 만들고 라이선스를 할당하는 방법에 대한 자세한 내용은 리소스 계정을 사용하여 리소스 [계정 만들기를 Microsoft 365 관리 센터](resource-account-ui.md).
