...
Teams Rooms를 배포한 후 테스트해야 합니다. Teams Rooms에 로그인하고 예상되는 기능이 작동하고 있는지 검사합니다. Microsoft Teams 관리 센터의 **Teams 디바이스**  탭 아래에 있는 공동 작업 표시 막대 섹션에 있는지 확인하는 것이 좋습니다. 또한 품질 및 성능을 확인하기 위해 여러 테스트 호출 및 모임을 만드는 것이 중요합니다.
