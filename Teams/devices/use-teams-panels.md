...
Microsoft Teams 패널은 모임 공간 바로 바깥에 탑재되는 소형 디지털 디스플레이 디바이스로, 일반적으로 입구 옆에 있습니다. 이러한 터치 스크린 패널은 Microsoft Teams 및 예약된 모임에 대한 한눈에 보기를 제공하는 전용 디바이스입니다. 선명한 색으로 코딩된 LED 및 홈 화면 표시기를 사용하여 거리에서 공간을 사용할 수 있는지 또는 예약할지 확인할 수 있습니다. 패널을 사용하여 Teams 모임에 사용할 수 있는 모임 공간을 현장에서 예약할 수 있습니다.

Teams 패널 디바이스는 Microsoft Teams 일정 또는 일정을 통해 예약된 모임 세부 정보를 Outlook Teams 있습니다.

이 문서에서는 최종 사용자와 관리자 모두에게 패널 디바이스를 사용하는 Teams 제공합니다. 또한 이러한 디바이스 사용에 대해 자주 묻는 [질문에 대한 답변](#frequently-asked-questions) 도 제공합니다.
...
모임 [공간 및](#explore-teams-panels-home-screen) 모임 세부 정보를 Teams 패널 장치의 홈 화면을 탐색합니다. 또는 터치 스크린 패널에서 탭하고 스크롤하여 다른 작업을 수행할 수 있습니다.

다음 Teams 패널 디바이스를 사용하여 다음을 합니다.
...
## <a name="explore-teams-panels-home-screen"></a>패널 Teams 홈 화면 탐색

홈 화면은 패널 디바이스의 기본 Teams 인터페이스입니다.  

홈 화면에서 위치 및 모임 세부 정보를 보고, 공간을 예약하고, 예정된 예약을 보고, 현재 가용성 상태를 확인할 수 있습니다.

다음 스크린샷은 패널 홈 화면의 여러 부분 또는 Teams 보여줍니다.
...
**4-설정** | 아이콘을 **설정** 표시됩니다. 문제를 보고하거나 사용 가능한 디바이스 설정을 업데이트하려면 탭합니다.
...
타일은 예약된 모임에 예약된 모임 공간에 대해 자주색으로 표시됩니다(Outlook 또는 Teams. 모임 제목을 두드러진 텍스트, 모임 시작 및 종료 시간 및 모임 이끌이의 이름으로 표시됩니다. 모임의 Teams 경우 Teams 로고도 표시됩니다. 모임 세부 정보가 두드러진 경우 참석자들은 올바른 모임 공간, 올바른 시간 및 올바른 모임에 대해 쉽게 확인할 수 있습니다.

:::image type="content" source="../media/panels-right-tile-scheduled-meeting.png" alt-text="Teams 모임 공간이 예약되어 있는 을 표시하는 패널 홈 화면입니다.":::

> [!NOTE]
>
> - 모임을 예약한 후 일정을 동기화하고 패널 화면에 반영하는 데 최대 90초가 걸릴 수 있습니다.
> - 비공개 [로 표시된](https://support.microsoft.com/office/make-an-appointment-or-meeting-private-dc3898f0-22f5-45c6-8cc8-b4d4db84111d) 예약된 모임의 **경우 실제 모임** 제목 대신 비공개 모임이 표시됩니다.

#### <a name="meeting-space-is-reserved-for-an-ad-hoc-meeting"></a>모임 공간은 비정기 모임에 예약되어 있습니다.

이 타일은 모임 공간에 대해 자주색으로 표시되어 있으며, 이 공간은 모임을 위해 예약 [되어 있습니다](#reserve-meeting-spaces-for-ad-hoc-meetings). 모임 시작 **및** 종료 시간과 함께 두드러진 텍스트로 예약을 표시됩니다. 추가 모임은 자동으로 Teams 예약되며, 따라서 Teams 로고가 항상 화면에 표시됩니다.

:::image type="content" source="../media/panels-right-tile-reserved-adhoc.png" alt-text="Teams 모임 공간이 예약되어 있는 것으로 표시하는 패널 홈 화면이 표시됩니다.":::

#### <a name="meeting-space-is-available"></a>모임 공간을 사용할 수 있습니다.

타일이 사용 가능한 모임 공간에 대해 녹색으로 표시됩니다. 두 **드러** 진 텍스트로 사용할 수 있는 텍스트가  표시되어 있으며, 예약 단추를 탭하여 모임 공간을 예약할 [수](#reserve-meeting-spaces-for-ad-hoc-meetings) 있습니다. 모임 공간의 예정된 일정(오른쪽 아래 타일)을 확인하여 모임의 종료 시간을 결정할 수 있습니다.
...
추가 모임을 위해 [](#meeting-space-is-available) 패널에서 직접 사용 가능한 모임 공간을 예약할 수 있습니다. 모든 ad hoc 모임은 자동으로 Teams 예약됩니다. 그러나 예약된 경우 패널을 통해 해당 모임 공간을 릴리스하거나 예약할 수 없습니다. 디바이스의 리소스 계정 관리자만 공간의 예약을 취소하기 위해 Outlook Teams 모임을 취소할 수 있습니다.
...
이제 홈 화면의 오른쪽 타일이 자주색으로 표시되어 예약된 텍스트  와 Teams 표시됩니다. 이는 모임 공간이 이제 모임 모임에 대해 예약되어 Teams 나타냅니다.
  
    :::image type="content" source="../media/panels-right-tile-reserved-adhoc.png" alt-text="모임 공간이 Ad Hoc 모임에 예약되어 있는 경우를 보여주는 홈 화면입니다.":::

    > [!NOTE]
    > 모임 공간이 Microsoft Teams 회의실인 경우 이 모임에 Teams 회의실 또는 Microsoft Teams  디바이스에 Surface Hub 있습니다.
...
3. 형식 **드롭다운** 에서 요청 유형을 선택합니다.
4. 문제 **드롭다운** 에서 범주를 선택합니다.
5. 제목 **텍스트 필드** 에 패널 키패드를 사용하여 타이틀을 입력합니다.
6. 타이틀 아래 **텍스트 필드에** 필요한 경우 추가 세부 정보를 입력합니다.
...
2. 화면 **설정** 디바이스 설정을 **탭합니다**.
3. 디바이스 **설정 화면** 에서 보거나 업데이트할 설정을 탭합니다.
...
- 배경 화면 및 LED 표시기 색과 같은 디바이스의 **패널** 앱에 특정되는 관리자 설정입니다. 패널 앱의 관리자 **만** 이러한 설정에 액세스할 수 있습니다. **패널 앱 설정을** 관리자 설정의 일부로 사용할 수 있습니다. 패널 앱 설정에 액세스하려면 디바이스 및 패널 앱 모두에 대한 관리자  로그인 자격 증명 **이 있어야** 합니다.
...
관리자 설정 아래에서 패널 앱 설정 옵션을 사용하여 패널 앱 **별** 설정에 액세스할 수 있습니다. 패널 앱에 액세스하는 **단계는** 설정 OEM에 따라 다를 수 있습니다.
...
2. 6자리 코드가 Android Teams 룸 화면에 표시됩니다. 패널에 Teams 입력합니다.  
