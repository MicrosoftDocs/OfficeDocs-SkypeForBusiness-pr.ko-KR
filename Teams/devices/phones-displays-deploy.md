...
1. 디바이스 관리자 규정 준수 정책을 할당합니다.  
   ...
   1. 디바이스에 Azure Active Directory 사용자를 포함하는 Teams 그룹에 할당합니다. 준수 [정책 사용을 참조하여 Intune을](/mem/intune/protect/device-compliance-get-started)사용하여 관리하는 디바이스에 대한 규칙을 설정합니다.
