...
![먼저 사용자의 현재 상태와 가장 적합 한 작업을 구상 하 고, 필요한 장비를 선택 하 고 procuring, 사이트 readying, 서비스 구성 및 배포, 변경 및 사용자 채택을 관리, 개발 등에 대해 알아 보고 작업 및 유지 관리 절차](../media/room-systems-image2.png "먼저 사용자의 현재 상태와 가장 적합 한 작업을 구상 하 고, 필요한 장비를 선택 하 고 procuring, 사이트 readying, 서비스 구성 및 배포, 변경 및 사용자 채택을 관리, 개발 등에 대해 알아 보고 작업 및 유지 관리 절차")
