...
- Microsoft 팀 대화방 계정에는 최소한 비즈니스용 Skype Online (요금제 2) 라이선스가 필요 하지만 Exchange Online 라이선스는 필요 하지 않습니다. 자세한 내용은 [Microsoft 팀 대화방 라이선스](skype-room-systems-v2.md) 를 참조 하세요.
