...
description: 이러한 채택 리소스를 사용하여 서비스 및 기타 Microsoft Teams 서비스를 Microsoft 365 Office 365 수 있습니다.
author: serdarsoysal
ms.author: serdars
manager: serdars
ms.topic: conceptual
...
회사에서 [Teams](https://aka.ms/teamstoolkit)출시하는 데 도움이 되는 온라인 가이드인 Teams 플립북을 참조하세요. 여기에는 다양한 다운로드할 수 있는 도구, Teams 템플릿 및 기타 리소스가 포함되어 있습니다.

### <a name="teams-customer-success-kit"></a>Teams 고객 성공 키트
Teams [고객](https://aka.ms/TeamsCustomerSuccess) 성공 키트는 조직에서 서비스를 롤아웃하는 데 Teams 도구를 제공합니다. 알림, 전단지 포스터, 카운트다운 및 요령에 대한 팁을 위한 전자 메일 & 포함되어 있습니다. 또한 팀 리더 및 IT 관리자를 위한 시작 가이드도 포함됩니다.
