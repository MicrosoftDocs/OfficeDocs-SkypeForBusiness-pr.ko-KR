...
사용자에 대한 전화 번호를 Microsoft 365 Office 365 오디오 회의, 자동 참석자 및 통화 큐와 같은 서비스에 대한 무료 전화 번호를 검색하고 획득할 수 있습니다. 서비스 전화 번호는 사용자 또는 구독자 전화 번호보다 더 높은 동시 통화 용량을 습니다. 예를 들어 서비스 번호는 수백 개의 통화를 동시에 처리할 수 있는 반면, 사용자의 전화 번호는 몇 개의 호출만 동시에 처리할 수 있습니다.

### <a name="get-new-service-numbers-using-the-teams-admin-center"></a>관리 센터를 사용하여 새 서비스 Teams 수 있습니다.
