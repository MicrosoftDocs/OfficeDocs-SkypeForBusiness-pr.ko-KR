...
> [!NOTE]
> [Powershell 갤러리](https://www.powershellgallery.com/packages/MicrosoftTeams) 또는 powershell에서 최신 preview 버전을 찾을 수 있습니다 ("Find-Module MicrosoftTeams-allowprerelease" 실행).
