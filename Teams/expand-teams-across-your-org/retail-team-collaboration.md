...
![아래 목록에 설명된 대로 Teams 및 Teams 앱에서 사용할 수 있는 다양한 기능을 보여 주는 인포그래픽입니다.](../media/retail-teams-collaborate.png)
...
#### <a name="create-a-team-based-on-a-template"></a>템플릿을 기반으로 팀 만들기
