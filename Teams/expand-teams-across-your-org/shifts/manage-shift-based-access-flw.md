...
---
# <a name="manage-shift-based-access-for-frontline-workers-in-teams"></a>Teams에서 일선 작업자의 교대 근무 기반 액세스 관리
...
Microsoft Teams의 현재 상태는 사용자의 현재 상태와 다른 사용자에게 상태를 나타냅니다. 일선 직원의 현재 상태는 일반적으로 매일 동일하지 않은 다른 직원보다 예측하기가 더 낮습니다. 관리자는 조직의 일선 직원에 대한 교대 근무 기반 현재 상태 집합을 표시하도록 Teams를 구성하여 교대 근무 중일 때를 나타낼 수 있습니다.

이러한 교대 근무 기반 현재 상태는 단색 녹색 확인 표시, Shift 시 시프트 시 회색 원, Shift 끄기, 단색 빨간색 원, 다른 사용 중이 Teams의 기본 현재 상태 집합과 별개인 경우를 &mdash; ![ ](../../media/flw-presence-on-shift.png)  ![ ](../../media/flw-presence-off-shift.png)  ![ ](../../media/flw-presence-busy.png)  &mdash; 나타냅니다. [](../../presence-admins.md) 이러한 두 현재 상태 집합을 사용하면 해당 역할에 따라 조직의 사용자에 대해 서로 다른 환경을 구성할 수 있습니다.

교대 근무 기반 액세스를 사용하면 일선 작업자가 교대 근무 중일 때 Teams에 대한 액세스를 관리할 수 있습니다. 예를 들어 일선 직원들이 예정된 교대 근무가 아닌 경우 Teams를 사용하기 전에 먼저 Teams를 사용할 수 있어야 하는 메시지를 표시하는 Teams를 설정할 수 있습니다.  
...
이 기능을 사용하면 일선 작업자가 교대 근무 중일 때 Teams에 대한 액세스를 관리할 수 있습니다. 교대 근무 중일 때 Teams에 액세스하는 경우 Teams에서 일선 작업자에게 메시지를 표시하게 설정할 수 있습니다. 일선 작업자가  Teams를 사용하려면 먼저 메시지를 승인하려면 동의를 클릭해야 합니다.
...
이 예제에서는 Shift Teams 액세스 사용자 지정 메시지 해제라는 정책을 사용자 지정 remy@contoso.com.
