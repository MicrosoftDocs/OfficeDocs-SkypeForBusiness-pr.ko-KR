...
Microsoft Teams의 Shifts 앱은 일선 작업자를 연결하고 동기화된 유지합니다. 팀을 위한 빠르고 효과적인 시간 관리 및 커뮤니케이션을 위한 모바일이 먼저 구축됩니다. Shifts를 사용하면 일선 직원들과 관리자가 모바일 장치를 사용하여 일정을 관리하고 연락을 유지할 수 있습니다.
...
- 직원은 예정된 교대 근무를 보고, 다른 사람이 하루 동안 예약된 것을 보고, 교대 근무를 바꾸거나 제안하고, 근무 시간을 요청할 수 있습니다. 
...
2. 앱 목록에서 다음 중 하나를 실행합니다.
    ...
    - 조직에 대한 Shifts를 해제하려면 Shifts 앱을 검색하고 선택한 다음 차단을 **클릭합니다.**
    - 조직에 대한 Shifts를 켜려면 Shifts 앱을 검색하고 선택한 다음 허용을 **클릭합니다.**
...
### <a name="use-the-firstlineworker-app-setup-policy-to-pin-shifts-to-teams"></a>FirstlineWorker 앱 설정 정책을 사용하여 Teams에 Shifts 고정

앱 설정 정책을 사용하면 Teams를 사용자 지정하여 조직의 사용자에게 가장 중요한 앱을 강조할 수 있습니다. 정책에 설정된 앱은 Teams 데스크톱 클라이언트의 측면 및 사용자가 빠르고 쉽게 액세스할 수 있는 Teams 모바일 클라이언트의 아래쪽에 있는 앱 표시줄에 &mdash; &mdash; 고정됩니다.
 
Teams에는 조직의 일선 작업자에게 할당할 수 있는 기본 제공 FirstlineWorker 앱 설정 정책이 포함되어 있습니다. 기본적으로 정책에는 활동, 교대 근무, 채팅 및 통화 앱이 포함됩니다. 

FirstlineWorker 정책을 보기 위해 Microsoft Teams 관리 센터의 왼쪽 탐색 모음에서 **Teams** 앱 설정  >  **정책으로 이동하세요.**

![FirstlineWorker 앱 설정 정책의 스크린샷](../../media/firstline-worker-app-setup-policy.png "Microsoft Teams 관리 센터의 FirstlineWorker 앱 설정 정책 스크린샷")
