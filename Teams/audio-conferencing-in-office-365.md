...
참석자가 모임에 참석한 후에는 전화를 걸어 다른 발신자를 비즈니스용 Skype 또는 Microsoft Teams 모임에 초대할 수도 있습니다.
[다른 사용자가 참가할 수 있도록 Teams 모임에서 전화 걸기](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md) 또는 [다른 사용자가 참가할 수 있도록 비즈니스용 Skype 모임에서 전화 걸기](/SkypeForBusiness/audio-conferencing-in-office-365/dialing-out-from-a-meeting-so-other-people-can-join-it)를 참조하세요.
 ...
 **공유 전화 번호는** 다른 전화 번호 또는 365s와 공유할 수 Microsoft 365 Office 번호입니다. 누군가 이 번호 중 하나로 전화할 때 사용되는 언어를 변경할 수 없습니다.
