...
![모든 시나리오에 Teams 사용 사례의 그림](media/teams-adoption-use-cases.png)
...
![시나리오를 식별하기 위한 프레임워크의 그림](media/teams-adoption-identify-scenarios.png)
...
![다음 단계를 나타내는 아이콘: 초기 채택자 온보드 ](media/teams-adoption-next-icon.png) [및 피드백 수집.](teams-adoption-onboard-early-adopters.md)
