...
사용자 또는 기타 서비스(서비스 번호)에 할당할 수 있는 전화 번호 유형은 여러 가지가 있습니다(예: 오디오 회의의 경우) Microsoft 365 Office 365.
...
2. 왼쪽 탐색에서 **Voice** 전화  >  **로 이동합니다.**
    ...
    > [!IMPORTANT]
    > 관리 센터의  왼쪽 탐색에서 음성 옵션을 비즈니스용 Skype **E5** 라이선스, Enterprise 추가 기능 라이선스 하나 또는 오디오  전화 시스템 추가 기능 라이선스 하나 이상을 구입해야 합니다. 

3. 할당된 전화 번호를 확인한 경우 상태 **열을 참조합니다.**
...
3. 할당된 숫자를 빠르게 정렬하려면 상태 열 **제목을** 클릭합니다. 또는 필터 아이콘을 클릭한 다음 보기를 필터링하여 사용자에게 이미 할당된 전화 번호 또는 사용자에게 할당할 수 있는 할당되지 않은 번호를 볼 수 있습니다. 다음을 통해 필터링할 수 있습니다.
...
3. 필터 아이콘을 클릭하여 다음을 통해 필터링할 수 있는 **활성화** 상태로 보기를 필터링합니다.
...
[Get-CsOnlineTelephoneNumber](/powershell/module/skype/get-csonlinetelephonenumber) cmdlet을 사용하여 조직에 대한 모든 전화 번호 목록을 볼 수 있습니다. 예를 들어 다음 명령을 실행하여 각 전화 번호 및 해당 상태를 볼 수 있습니다.

```PowerShell
Get-CsOnlineTelephoneNumber | ft Id,ActivationState
```

[Get-CsOnlineUser](/powershell/module/skype/get-csonlineuser) cmdlet을 사용하여 사용자에게 할당된 모든 전화 번호를 볼 수 있습니다. 예를 들어 다음 명령을 실행하여 전화 번호가 할당된 모든 사용자를 볼 수 있습니다.
