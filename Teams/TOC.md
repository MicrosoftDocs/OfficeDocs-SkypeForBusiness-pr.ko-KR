...
### [Teams Tenant 앱에 앱 게시](tenant-apps-catalog-teams.md)
...
### [Teams에서 팀 소유자와 팀 구성원 할당](assign-roles-permissions.md)
### [Teams 사용자 설정을 대량으로 편집](edit-user-settings-in-bulk.md)
...
### [보존 정책 FAQ](retention-policies-FAQ.md)
### [보존 정책 알려진 문제](retention-policies-known-issues.md)
