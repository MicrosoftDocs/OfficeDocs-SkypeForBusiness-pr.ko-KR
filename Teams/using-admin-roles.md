...
|----- | ------------------ | ------------------------------ |
| Teams 서비스 관리자 | 팀 서비스 관리 및 Office 365 그룹 관리 및 만들기 | Microsoft 팀 관리 센터의 모든 내용과 관련 된 PowerShell 컨트롤에는 다음이 포함 됩니다.<ul><li> 모임 정책, 구성, 회의 브리지 등 모임을 관리 합니다. <sup>1, 3</sup></li><li>통화 정책, 전화 번호 목록 및 과제를 포함 하 여 음성 관리 <sup>1</sup></li><li>메시징 정책을 포함 하 여 메시지를 관리 합니다. <sup>1, 3</sup></li><li>페더레이션, 팀 업그레이드, 팀 클라이언트 설정 등의 모든 조직 차원의 설정을 관리 합니다. s<sup>1, 3</sup></li><li>조직에서 팀을 관리 하 고 멤버 자격 (PowerShell을 통해 지원 되는 그룹 관리, 팀 관리 센터의 팀 관리)를 포함 하 여 관련 설정을 관리할 때 <sup>23</sup></li><li>고급 문제 해결 도구 집합을 사용 하 여 사용자 프로필 페이지를 보고 사용자 통화 품질 문제를 해결 합니다. <sup>3</sup> </li><li> 통화 품질 대시보드 (CQD)에 표시 된 데이터를 사용 하 여 테 넌 트의 통화 품질 및 안정성에 액세스 하 고 문제를 해결 하 고 통화 품질이 나쁜 사용자에 게 제공 됩니다. 새 보고서를 만들고 필요에 따라 보고서를 업데이트 하거나 제거 합니다. CQD 데이터 빌드를 업로드 하 고 업데이트 합니다.</li><li> [팀 클라이언트에서 테 넌 트 앱 카탈로그에 앱 게시](https://docs.microsoft.com/microsoftteams/tenant-apps-catalog-teams)</li></ul> |
