...
학교 또는 대학에서 원격 학습을 위해 Microsoft Teams를 사용하도록 설정해야 하나요? 시작 1페이저 [](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/teams-for-education-getting-started-1-pager.pdf?raw=true) 및 아래 채택 자료 중 하나를 통해 빠르게 시작하세요!
...
Teams 시작을 [최대화하기 위해 디지털](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/digital-toolkit-guidance.zip?raw=true) Toolkit 지침을 확인해 보세요! 
...
- 교육, 비디오 및 대화형 [데모는](https://www.microsoft.com/en-us/education/products/teams/default.aspx) 교육용 Teams 페이지를 방문하세요.
- [Microsoft 365](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns) 관리 센터에서 Teams 켜기(Office 365 관리자로 로그인)
- Teams 클라이언트 다운로드: [모든 장치에서 Teams 다운로드](https://teams.microsoft.com/downloads)
- 교육용 Office 365 도움말 센터에서 교육용 Office 365에 [대해 자세히 알아보기](https://support.office.com/education)
