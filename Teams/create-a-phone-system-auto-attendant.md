...
**자원 계정** 하나 이상의 리소스 계정을 선택 하 여 새 자동 전화 교환에 연결 하려면이 단추를 클릭 합니다. 모든 자동 전화 교환에는 연결 된 리소스 계정이 있어야 합니다. 리소스 계정은 계정에 연결 된 전화 번호를 가질 수 있지만, 그렇지 않을 수도 있습니다. 일반적으로 최상위 자동 전화 교환에는 할당 된 전화 번호가 있는 리소스 계정이 있지만, 중첩 된 자동 전화 교환 (첫 번째 수준 자동 전화 교환이 연결 되는 수준 2 메뉴로 사용 됨)에는 해당 리소스 계정에 할당 된 전화 번호가 없을 수 있습니다.

* * *

![앞의 스크린샷은 설명선을 참조 하는 숫자 3의 아이콘](media/sfbcallout3.png)

**표준 시간대** 자동 전화 교환에 대 한 표준 시간대를 설정 해야 하지만 조직에 대해 나열 된 기본 주소의 표준 시간대에 해당 하지 않아도 됩니다. 각 자동 전화 교환은 다른 표준 시간대를 가질 수 있으며, 여기에서 선택한 표준 시간대에 따라 자동 전화 교환의 업무 시간이 설정 됩니다.

* * *

![이전 스크린샷의 설명선을 참조 하는 숫자 4의 아이콘](media/sfbcallout4.png)

**언어가** 나열 된 사용 가능한 언어 중에서 자동 전화 교환에 사용할 언어를 선택 합니다. 여기서 설정한 언어는 자동 전화 교환이이 자동 전화 교환에 연결 하는 사용자와 상호 작용 하는 데 사용할 언어 이며, 모든 시스템 메시지가이 언어로 재생 됩니다.

* * *

![이전 스크린샷의 설명선을 참조 하는 숫자 5의 아이콘](media/sfbcallout5.png)

**연산자** 이 옵션은 선택 사항이 며 자동 전화 교환에 대해 설정할 필요가 없습니다. 그러나이를 호출 하는 사람들에 게 메뉴를 사용 하 여 사용자에 게 말할 수 있도록 **교환원** 옵션을 설정할 수 있습니다.

키 0이 (가) 연산자에 자동으로 할당 됩니다.

이 옵션을 설정한 경우에는 전화를 건 사람에 게 **업무 시간 통화 처리** 페이지의 **편집 메뉴 옵션** 에서 사용할 수 있는 옵션이 있는지도 명시 해야 합니다. 자동 전화 교환에 운영자를 설정 하는 경우 **호출자가 듣기** 상자에 해당 프롬프트 텍스트를 입력 하거나이 옵션을 포함 하도록 오디오 파일을 변경 해야 합니다. 예를 들어 연산자의 경우 0을 누릅니다.

다음 연산자 중 하나를 설정할 수 있습니다.
...
- 설정한 **통화 대기열**
- 전화를 걸 사람을 보이스 메일로 보내도록 설정할 수 있습니다. 이렇게 하려면 **회사에서 사람** 을 선택 하 고이 사용자의 통화가 바로 보이스 메일로 착신 전환 되도록 설정 합니다.

* * *

![이전 스크린샷의 설명선을 참조 하는 6 번의 아이콘](media/sfbcallout6.png)

**음성 입력 사용** 이 옵션을 선택 하는 경우 음성 인식을 사용할 수 있습니다. 통화를 하는 사람들은 사용자가 [설정한 언어로](set-auto-attendant-languages-for-audio-conferencing-in-teams.md)음성 입력을 사용할 수 있습니다. 음성 인식 기능을 사용 하지 않도록 설정 하 여 다른 사용자가 전화 키패드를 사용할 수 있도록 할 수도 있습니다.
...
기본적으로 업무 시간은 월요일 ~ 금요일 5pm 9am로 설정 됩니다.  업무 시간에 포함 되지 않은 모든 시간은 업무 시간 후로 간주 됩니다. **선택 24/7** 을 클릭 하 여 업무 시간을 모두 만들 수 있습니다. **24/7 선택** 옵션을 선택 하지 않는 한, **이후 시간 통화 설정** 페이지를 사용 하 여 자동 전화 교환의 업무 시간 이후에 대 한 통화 처리를 구성 합니다.
...
기본적으로 업무 시간은 월요일 ~ 금요일, 오전 9:00-5:00 pm으로 설정 됩니다. **모든 시간 지우기** 옵션을 선택 하 여 일정의 모든 시간을 취소 합니다. **기본값으로 재설정**을 선택 하면 업무 시간이 월요일에서 금요일, 오전 9:00은 5:00 pm으로 다시 설정 됩니다.

* * *

![이전 스크린샷의 설명선을 참조 하는 숫자 2의 아이콘](media/sfbcallout2.png)

업무 시간을 변경 하려면 일정을 사용 하 여 설정 하려는 업무 시간을 강조 표시 합니다. 달력을 사용 하면 30 분 간격으로 업무 시간을 선택 하 고 여기에서 선택한 업무 시간은 **일반 정보** 페이지에서 설정한 표준 시간대에 따라 설정 됩니다. 나누기를 설정 하려면 (예: 점심 작업 나누기) 일정에서 시간을 선택 취소 하거나 끌어서 선택 취소 합니다. 업무 시간 내에 여러 휴식을 설정할 수 있습니다.
...
비즈니스 시간에 조직의 자동 전화 교환 전화 번호로 전화를 거는 사용자가 듣는 인사말, 프롬프트 및 메뉴를 설정할 수 있습니다.
...
**인사말이** 업무 시간 인사말은 선택 사항이 며 **인사말 없음으로**설정할 수 있습니다. 이 경우 호출자는 사용자가 선택한 작업 중 하나에서 통화를 처리 하기 전에 메시지 또는 인사말이 들리지 않습니다. 오디오 파일 (.wav, mp3 또는 .wma 형식)을 업로드 하거나 텍스트 읽어주기를 사용 하 여 사용자 지정 인사말을 만들 수도 있습니다.
...
- 해당 키를 누르거나 음성 인식을 사용 하 여 옵션을 선택한 경우 통화를 보낼 위치를 선택 합니다. 통화는 다음으로 전송 될 수 있습니다.
  ...
  - **회사에서** 엔터프라이즈 음성에 대해 사용 하도록 설정 되거나 Office 365에서 호출 계획을 할당 한 **전화 시스템** 라이선스가 있는 사람입니다. 전화를 걸 사람을 보이스 메일로 보낼 수 있도록 설정할 수 있습니다. 이렇게 하려면 **회사에서 사람** 을 선택 하 고이 사용자가 전화를 음성 메일로 바로 착신 전환 하도록 설정 합니다.
    ...
    - 다른 **자동 전화 교환**
     ...
     - **통화 대기열** 통화 대기열 옵션을 사용 하면 설정한 기존 통화 대기열로 통화를 전송할 수 있습니다. 
...
- **통화 리디렉션** 이를 사용 하 여 자동으로 통화를 보낼 수 있습니다.
  ...
  - 설정한 기존 통화 대기열로 통화를 전송 하는 **통화 대기열**
  - 다른 **자동 전화 교환**-하위 메뉴를 포함 하는 두 번째 수준의 메뉴 옵션을 만듭니다. 이를 중첩 된 자동 전화 교환 이라고 합니다.
