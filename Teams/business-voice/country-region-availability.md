...
통화 플랜을 지원 **하는** 국가 및 지역에서는 Microsoft에서 Business Voice를 구입한 다음 기존 전화번호를 설정하거나 Microsoft로 전송할 수 있습니다. 이렇게 하면 Microsoft 365에서 모든 전화번호를 관리할 수 있습니다. Business Voice로 이동이 완료되 면 다음을 수행합니다.
...
테넌트가 통화 플랜을 지원하는 국가 또는 지역에 있는 경우 [통화 플랜이 있는 Microsoft 365 Business Voice를 사용하려면 무엇을 구입해야 합니까?](what-to-buy.md)를 확인하세요.

통화 플랜을 지원하지 **않는** 국가 및 지역에서는 Microsoft 파트너 또는 리셀러로부터 Business Voice를 구매해야 합니다. 타사 전화 공급자와 협력하여 온-프레미스 전화 통신 하드웨어와 Microsoft 365간에 직접 라우팅을 설정합니다.
...
테넌트가 통화 플랜을 지원하지 않는 국가 또는 지역에 있는 경우 [Microsoft 리셀러 또는 파트너에게 도움 받기](reseller-partner-support.md)를 확인하세요.
...
| 국가 또는 지역    | 통화 플랜이 있는 Business Voice | 통화 플랜 없는 Business Voice(직접 라우팅) |
|----------------------|----------------------------------|-----------------------------------------------------|
| 캐나다               | X                                | X<sup>1</sup>                                       |
| 영국       | X                                | X<sup>1</sup>                                       |
| 미국        | X                                | X<sup>1</sup>                                       |
...
<sup>2</sup>  비즈니스 음성에는 전화 시스템 및 오디오 회의에 대한 라이선스가 포함됩니다. Microsoft를 통해 통화 플랜을 받을 수 없더라도 당사에 연락하여 라이선스를 구매하고 전화번호를 얻을 수 있습니다.
