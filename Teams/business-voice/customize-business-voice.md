...
| [자동 전화 교환 설정](set-up-auto-attendants.md)           | 호출 메뉴를 더 추가하여 호출자가 사용자의 주요 전화 번호로 전화를 걸 때의 옵션을 확장합니다.        |
...
| [통화 큐 설정](set-up-call-queues.md)                   | 호출자가 다음에 사용 가능한 에이전트를 위해 대기할 수 있는 큐를 만듭니다.                                  |
