...
|2021년 7월 7일 시작<br> *(완료)*  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|**모든 고객(Enterprise, 교육 및 GCC)**<br> 모임 Teams 기록하고 OneDrive SharePoint 라이브로 기록된 모임의 경우 이제 Microsoft Search 검색하여 대본에 따라 모임 녹음 파일을 찾을 수 있습니다. |
