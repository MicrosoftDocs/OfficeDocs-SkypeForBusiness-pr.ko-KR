...
- 영어 전용 자막이 있으며 캡션을 해제/해제할 수 있습니다.
- 처음에는 전체  대본을 보고 편집하고 검색할 수 없습니다(그러나 이 기능을 곧 추가하기 위해 작업 중입니다).
...
정책이 Stream으로 설정되어 있는 경우에도 설정되지 않을 수 있습니다. 일반적으로 정책이 설정되지 않은 경우 기본 설정은 **Stream입니다.** 그러나 이 새로운 변경으로 SharePoint 또는 비즈니스용 OneDrive 사용을 옵트아웃하려는 경우 Stream이 기본값이 되도록 정책을 **Stream으로** 다시 설정해야 합니다. 
...
- 비 채널 모임의 경우 기록은 모임 녹음/녹화를 시작한 사람이 속한 비즈니스용 OneDrive의 최상위 수준에 있는 기록이라는 폴더에 저장됩니다.  예제:
...
선택 자막은 Teams 클라우드 녹음/녹화에 설명된 대본을 허용하도록 옵트인한 고객을 위해 Teams 모임 녹음/녹화에서 사용할 [수 있습니다.](cloud-recording.md)
