...
|외부 사용자와의 임시/예약 된 모임|구성 도우미              |조직자의 비즈니스용 OneDrive 계정                     |이끌이는 녹음/녹화에 대 한 모든 권한을 가집니다.<br /> <br /> 이끌이와 동일한 테 넌 트의 다른 모든 모임 구성원에 게 읽기 권한이 있음 <br /><br /> 다른 모든 외부 구성원은 액세스 권한이 없으며 이끌이는이를 공유 해야 합니다.|
|외부 사용자와의 임시/예약 된 모임|다른 모임 구성원   |레코드를 클릭 한 구성원                                  | 레코드를 클릭 한 구성원에 게는 녹음/녹화 구성 도우미에 대 한 모든 권한이 있으며, 공유할 수 있습니다. <br /><br /> 이끌이와 동일한 테 넌 트의 다른 모든 모임 구성원에 게 읽기 권한이 있음 <br /><br />다른 모든 외부 구성원은 액세스 권한이 없으며 이끌이는이를 공유 해야 합니다.|
|채널 모임                            |채널 구성원         |해당 채널에 대 한 팀의 SharePoint 위치                   | 레코드를 클릭 한 구성원에 게 녹음/녹화에 대 한 편집 권한이 있는 경우 <br /> <br />다른 모든 구성원의 권한은 채널 SharePoint 사용 권한의 기반을 기준으로 합니다.|
