...
직접 라우팅에서 사용자가 예약 된 회의에 참가할 때 전화 접속 번호는 적절 한 라이선스가 필요한 Microsoft 오디오 회의 서비스에서 제공 합니다.  전화를 걸 때 Microsoft 오디오 회의 서비스는 올바른 라이선스를 필요로 하는 온라인 통화 기능을 사용 하 여 전화를 보냅니다. (참고 사용자에 게 Microsoft 오디오 회의 라이선스가 없는 경우 통화는 직접 라우팅을 통해 라우팅합니다.) 자세한 내용은 [팀과 온라인 모임](https://products.office.com/microsoft-teams/online-meeting-solutions)을 참조 하세요. 
