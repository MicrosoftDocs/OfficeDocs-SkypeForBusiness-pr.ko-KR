---
title: 'Microsoft Teams 통화 정책: 통화 및 착신 전환 기능'
author: SerdarSoysal
ms.author: tonysmit
manager: serdars
ms.topic: conceptual
...
description: 다양한 통화 정책 설정뿐만 아니라 Microsoft Teams 사용자 지정 통화 정책에 사용자를 만들고, 수정하고, 추가하는 방법을 알아봅니다.
...
Microsoft Teams 통화 정책은 사용자가 사용할 수 있는 통화 및 착신 전환 기능을 제어합니다. 통화 정책은 사용자가 개인 통화를 할 수 있는지, 다른 사용자 또는 외부 전화 번호로 통화 전달 또는 동시 벨소리를 사용할 수 있는지, 음성 메일로 통화를 라우팅하고, 통화 그룹에 전화를 걸고, 인바운드 및 아웃바운드 통화에 위임을 사용할 수 있는지 여부를 결정합니다.
...
1. Microsoft Teams 관리 센터의 왼쪽 탐색에서 **VoiceCalling** >  정책으로 이동합니다.
2. **추가** 를 선택합니다.
...
1. Microsoft Teams 관리 센터의 왼쪽 탐색 영역에서 **VoiceCalling** >  정책을 선택합니다.
...
이 설정은 Teams 모든 호출 기능을 제어합니다. Teams 모든 호출 기능을 해제하려면 이 기능을 끕니다.
