...
- 사용자가 다른 곳에서 Microsoft 작업 또는 학교 계정에 로그인하지 않은 경우, Teams을 시작할 때 단일 요인 또는 다중 요인 인증(SFA 또는 MFA)을 제공하라는 메시지가 표시됩니다. 이 프로세스는 조직에서 로그인 절차를 요구하기로 결정한 내용에 따라 달라집니다.
...
Teams을 사용하는 모든 조직에서 최신 인증을 사용할 수 있습니다. 사용자가 프로세스를 완료할 수 없는 경우 도메인 또는 조직의 Microsoft 회사 또는 학교 계정에 문제가 있을 수 있습니다.
